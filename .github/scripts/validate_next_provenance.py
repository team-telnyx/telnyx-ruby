...
PRODUCTION_POLICY_PATHS = frozenset(
    {
        ...
        ".github/scripts/test_ci_runner_policy.py",
        ...
        ".github/scripts/test_verify_rubygems_release.py",
        ".github/scripts/validate_next_provenance.py",
        ".github/scripts/verify_rubygems_release.py",
...
# Ruby promotion restores CODEOWNERS from production in addition to release
