...
class RubyNextProvenanceTests(unittest.TestCase):
    def test_generated_tree_change_is_rejected(self):
        with self.assertRaisesRegex(GateError, "lib/generated.rb"):
            require_only_allowed_changes(
                {"lib/generated.rb": A},
                {"lib/generated.rb": B},
    ...
    def test_only_enumerated_production_transform_is_allowed(self):
        require_only_allowed_changes(
            {"lib/generated.rb": A, ".github/CODEOWNERS": A},
            {"lib/generated.rb": A, ".github/CODEOWNERS": B},
            {".github/CODEOWNERS"},
            "promotion",
        )
