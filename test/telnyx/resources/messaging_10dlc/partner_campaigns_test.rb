...
class Telnyx::Test::Resources::Messaging10dlc::PartnerCampaignsTest < Telnyx::Test::ResourceTest
  def test_retrieve
    skip("Mock server tests are disabled")

    response = @telnyx.messaging_10dlc.partner_campaigns.retrieve("campaignId")

    assert_pattern do
      response => Telnyx::Messaging10dlc::TelnyxDownstreamCampaign
    end
    ...
    assert_pattern do
      response => {
        ...
        campaign_status: Telnyx::Messaging10dlc::TelnyxDownstreamCampaign::CampaignStatus | nil,
  ...
  def test_update
    ...
    response = @telnyx.messaging_10dlc.partner_campaigns.update("campaignId")
  ...
  def test_list
    ...
    response = @telnyx.messaging_10dlc.partner_campaigns.list
    ...
    assert_pattern do
      row => Telnyx::Messaging10dlc::TelnyxDownstreamCampaign
    end
  ...
  def test_list_shared_by_me
    ...
    response = @telnyx.messaging_10dlc.partner_campaigns.list_shared_by_me
    ...
    assert_pattern do
      row => Telnyx::Models::Messaging10dlc::PartnerCampaignListSharedByMeResponse
    end
  ...
  def test_retrieve_sharing_status
    ...
    assert_pattern do
      response => ^(Telnyx::Internal::Type::HashOf[Telnyx::Messaging10dlc::CampaignSharingStatus])
    end
  end
end
