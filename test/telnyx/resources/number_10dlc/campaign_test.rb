...
class Telnyx::Test::Resources::Number10dlc::CampaignTest < Telnyx::Test::ResourceTest
  ...
  def test_list_required_params
    ...
    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignListResponse
    end

    assert_pattern do
      response => {
        page: Integer | nil,
        records: ^(Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Number10dlc::CampaignListResponse::Record]) | nil,
  ...
  def test_delete
    ...
    response = @telnyx.number_10dlc.campaign.delete("campaignId")

    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignDeleteResponse
    end
  ...
  def test_appeal_required_params
    skip("Prism tests are disabled")

    response =
      @telnyx.number_10dlc.campaign.appeal(
    ...
    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignAppealResponse
    end
  ...
  def test_retrieve_mno_metadata
    skip("Prism tests are disabled")

    response = @telnyx.number_10dlc.campaign.retrieve_mno_metadata("campaignId")

    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignRetrieveMnoMetadataResponse
    end

    assert_pattern do
      response => {
        mno_10999: Telnyx::Models::Number10dlc::CampaignRetrieveMnoMetadataResponse::Mno10999 | nil
      }
    end
  end

  def test_retrieve_operation_status
    skip("Prism tests are disabled")

    response = @telnyx.number_10dlc.campaign.retrieve_operation_status("campaignId")
  ...
  def test_retrieve_sharing
    ...
    response = @telnyx.number_10dlc.campaign.retrieve_sharing("campaignId")

    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignRetrieveSharingResponse
    end
