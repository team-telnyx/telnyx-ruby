...
class Telnyx::Test::Resources::Number10dlc::CampaignTest < Telnyx::Test::ResourceTest
  def test_retrieve
    skip("Prism tests are disabled")

    response = @telnyx.number_10dlc.campaign.retrieve("campaignId")
  ...
  def test_update
    ...
    response = @telnyx.number_10dlc.campaign.update("campaignId")
  ...
  def test_list_required_params
    ...
    response = @telnyx.number_10dlc.campaign.list(brand_id: "brandId")
    ...
    assert_pattern do
      row => Telnyx::Models::Number10dlc::CampaignListResponse
    end
    ...
    assert_pattern do
      row => {
        ...
        campaign_status: Telnyx::Models::Number10dlc::CampaignListResponse::CampaignStatus | nil,
        create_date: String | nil,
        csp_id: String | nil,
        ...
        sample5: String | nil,
        status: String | nil,
        submission_status: Telnyx::Models::Number10dlc::CampaignListResponse::SubmissionStatus | nil,
        subscriber_help: Telnyx::Internal::Type::Boolean | nil,
        subscriber_optin: Telnyx::Internal::Type::Boolean | nil,
        subscriber_optout: Telnyx::Internal::Type::Boolean | nil,
  ...
  def test_accept_sharing
    ...
    response = @telnyx.number_10dlc.campaign.accept_sharing("C26F1KLZN")
  ...
  def test_deactivate
    ...
    response = @telnyx.number_10dlc.campaign.deactivate("campaignId")

    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignDeactivateResponse
    end
  ...
  def test_get_mno_metadata
    ...
    response = @telnyx.number_10dlc.campaign.get_mno_metadata("campaignId")

    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignGetMnoMetadataResponse
    end

    assert_pattern do
      response => {
        mno_10999: Telnyx::Models::Number10dlc::CampaignGetMnoMetadataResponse::Mno10999 | nil
      }
    end
  end
  ...
  def test_get_operation_status
    ...
    response = @telnyx.number_10dlc.campaign.get_operation_status("campaignId")
  ...
  def test_get_sharing_status
    ...
    response = @telnyx.number_10dlc.campaign.get_sharing_status("campaignId")

    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignGetSharingStatusResponse
    end

    assert_pattern do
      response => {
        shared_by_me: Telnyx::Number10dlc::CampaignSharingStatus | nil,
        shared_with_me: Telnyx::Number10dlc::CampaignSharingStatus | nil
      }
    end
  end
  ...
  def test_submit_appeal_required_params
    ...
    response =
      @telnyx.number_10dlc.campaign.submit_appeal(
    ...
    assert_pattern do
      response => Telnyx::Models::Number10dlc::CampaignSubmitAppealResponse
    end
