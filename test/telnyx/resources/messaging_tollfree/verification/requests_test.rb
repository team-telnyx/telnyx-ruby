  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => {
        ...
        entity_type: Telnyx::MessagingTollfree::Verification::VerificationRequestEgress::EntityType | nil,
  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        created_at: Time | nil,
        doing_business_as: String | nil,
        entity_type: Telnyx::MessagingTollfree::Verification::VerificationRequestStatus::EntityType | nil,
        help_message_response: String | nil,
        opt_in_confirmation_response: String | nil,
        opt_in_keywords: String | nil,
        privacy_policy_url: String | nil,
