...
class Telnyx::Test::Resources::PartnerCampaignsTest < Telnyx::Test::ResourceTest
  ...
  def test_list
    ...
    assert_pattern do
      response => Telnyx::Models::PartnerCampaignListResponse
    end
  ...
  def test_list_shared_by_me
    ...
    assert_pattern do
      response => Telnyx::Models::PartnerCampaignListSharedByMeResponse
    end

    assert_pattern do
      response => {
        page: Integer | nil,
        records: ^(Telnyx::Internal::Type::ArrayOf[Telnyx::Models::PartnerCampaignListSharedByMeResponse::Record]) | nil,
        total_records: Integer | nil
      }
    end
  end
