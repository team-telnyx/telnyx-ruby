...
module Telnyx
  module Models
    ...
    class DirLoaParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::DirLoaParams::Signature, nil]
      optional :signature, -> { Telnyx::DirLoaParams::Signature }

      # @!method initialize(dir_id:, phone_numbers:, agent: nil, signature: nil, request_options: {})
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::DirLoaParams} for more details.
      #
      #   @param dir_id [String]
      #
      ...
      #
      #   @param signature [Telnyx::Models::DirLoaParams::Signature] Optional. When provided the rendered PDF embeds the signature image, printed nam
      #
