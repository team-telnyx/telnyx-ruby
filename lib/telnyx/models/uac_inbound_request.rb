...
module Telnyx
  module Models
    class UacInboundRequest < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::UacInboundRequest::AniNumberFormat, nil]
      optional :ani_number_format, enum: -> { Telnyx::UacInboundRequest::AniNumberFormat }
      ...
      #   are not allowed.
      #
      #   @return [Symbol, Telnyx::Models::UacInboundRequest::DefaultRoutingMethod, nil]
      optional :default_routing_method, enum: -> { Telnyx::UacInboundRequest::DefaultRoutingMethod }

      # @!attribute dnis_number_format
      #
      #   @return [Symbol, Telnyx::Models::UacInboundRequest::DnisNumberFormat, nil]
      optional :dnis_number_format, enum: -> { Telnyx::UacInboundRequest::DnisNumberFormat }
      ...
      #
      #   @return [Symbol, Telnyx::Models::UacInboundRequest::SimultaneousRinging, nil]
      optional :simultaneous_ringing, enum: -> { Telnyx::UacInboundRequest::SimultaneousRinging }
      ...
      #
      #   @param ani_number_format [Symbol, Telnyx::Models::UacInboundRequest::AniNumberFormat] This setting allows you to set the format with which the caller's number (ANI) i
      #
      ...
      #
      #   @param default_routing_method [Symbol, Telnyx::Models::UacInboundRequest::DefaultRoutingMethod] Default routing method to be used when a number is associated with the connectio
      #
      #   @param dnis_number_format [Symbol, Telnyx::Models::UacInboundRequest::DnisNumberFormat]
      #
      ...
      #
      #   @param simultaneous_ringing [Symbol, Telnyx::Models::UacInboundRequest::SimultaneousRinging] When enabled, allows multiple devices to ring simultaneously on incoming calls.
      #
      ...
      # is sent for inbound phone calls.
      #
      # @see Telnyx::Models::UacInboundRequest#ani_number_format
      ...
      # are not allowed.
      #
      # @see Telnyx::Models::UacInboundRequest#default_routing_method
      ...
      # @see Telnyx::Models::UacInboundRequest#dnis_number_format
      ...
      # When enabled, allows multiple devices to ring simultaneously on incoming calls.
      #
      # @see Telnyx::Models::UacInboundRequest#simultaneous_ringing
