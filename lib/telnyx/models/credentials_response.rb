...
module Telnyx
  module Models
    ...
    class CredentialsResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CredentialsResponse::RecordType]
      required :record_type, enum: -> { Telnyx::CredentialsResponse::RecordType }

      # @!method initialize(connection_id:, data:, record_type:)
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::CredentialsResponse} for more details.
      #
      ...
      #
      #   @param record_type [Symbol, Telnyx::Models::CredentialsResponse::RecordType] Identifies record type.

      # Identifies record type.
      #
      # @see Telnyx::Models::CredentialsResponse#record_type
      module RecordType
