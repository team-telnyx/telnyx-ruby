...
module Telnyx
  module Models
    ...
    class RoomRecording < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::RoomRecording::Status, nil]
      optional :status, enum: -> { Telnyx::RoomRecording::Status }

      # @!attribute type
      #   Shows the room recording type.
      #
      #   @return [Symbol, Telnyx::Models::RoomRecording::Type, nil]
      optional :type, enum: -> { Telnyx::RoomRecording::Type }
      ...
      #
      #   @param status [Symbol, Telnyx::Models::RoomRecording::Status] Shows the room recording status.
      #
      #   @param type [Symbol, Telnyx::Models::RoomRecording::Type] Shows the room recording type.
      #
      #   @param updated_at [Time] ISO 8601 timestamp when the room recording was updated.

      # Shows the room recording status.
      #
      # @see Telnyx::Models::RoomRecording#status
      module Status
      ...
      # Shows the room recording type.
      #
      # @see Telnyx::Models::RoomRecording#type
      module Type
        extend Telnyx::Internal::Type::Enum
