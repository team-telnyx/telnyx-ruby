...
module Telnyx
  module Models
    ...
    class EnterpriseListResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Telnyx::Models::EnterpriseListResponse::BillingAddress, nil]
      optional :billing_address, -> { Telnyx::Models::EnterpriseListResponse::BillingAddress }

      # @!attribute billing_contact
      #
      #   @return [Telnyx::Models::EnterpriseListResponse::BillingContact, nil]
      optional :billing_contact, -> { Telnyx::Models::EnterpriseListResponse::BillingContact }
      ...
      #
      #   @return [Symbol, Telnyx::Models::EnterpriseListResponse::NumberOfEmployees, nil]
      optional :number_of_employees,
               enum: -> { Telnyx::Models::EnterpriseListResponse::NumberOfEmployees },
               nil?: true
      ...
      #
      #   @return [Telnyx::Models::EnterpriseListResponse::OrganizationContact, nil]
      optional :organization_contact, -> { Telnyx::Models::EnterpriseListResponse::OrganizationContact }

      # @!attribute organization_legal_type
      #   Legal structure type
      #
      #   @return [Symbol, Telnyx::Models::EnterpriseListResponse::OrganizationLegalType, nil]
      optional :organization_legal_type,
               enum: -> { Telnyx::Models::EnterpriseListResponse::OrganizationLegalType },
               nil?: true

      # @!attribute organization_physical_address
      #
      #   @return [Telnyx::Models::EnterpriseListResponse::OrganizationPhysicalAddress, nil]
      optional :organization_physical_address,
               -> { Telnyx::Models::EnterpriseListResponse::OrganizationPhysicalAddress }

      # @!attribute organization_type
      #   Type of organization
      #
      #   @return [Symbol, Telnyx::Models::EnterpriseListResponse::OrganizationType, nil]
      optional :organization_type, enum: -> { Telnyx::Models::EnterpriseListResponse::OrganizationType }
      ...
      #
      #   @return [Symbol, Telnyx::Models::EnterpriseListResponse::RoleType, nil]
      optional :role_type, enum: -> { Telnyx::Models::EnterpriseListResponse::RoleType }
      ...
      #   {Telnyx::Models::EnterpriseListResponse} for more details.
      #
      #   @param id [String] Unique identifier of the enterprise
      #
      #   @param billing_address [Telnyx::Models::EnterpriseListResponse::BillingAddress]
      #
      #   @param billing_contact [Telnyx::Models::EnterpriseListResponse::BillingContact]
      #
      ...
      #
      #   @param number_of_employees [Symbol, Telnyx::Models::EnterpriseListResponse::NumberOfEmployees, nil] Employee count range
      #
      #   @param organization_contact [Telnyx::Models::EnterpriseListResponse::OrganizationContact] Organization contact information. Note: the response returns this object with th
      #
      #   @param organization_legal_type [Symbol, Telnyx::Models::EnterpriseListResponse::OrganizationLegalType, nil] Legal structure type
      #
      #   @param organization_physical_address [Telnyx::Models::EnterpriseListResponse::OrganizationPhysicalAddress]
      #
      #   @param organization_type [Symbol, Telnyx::Models::EnterpriseListResponse::OrganizationType] Type of organization
      #
      ...
      #
      #   @param role_type [Symbol, Telnyx::Models::EnterpriseListResponse::RoleType] Role type in Branded Calling / Number Reputation services
      #
      #   @param updated_at [Time] When the enterprise was last updated
      #
      #   @param website [String, nil] Company website URL

      # @see Telnyx::Models::EnterpriseListResponse#billing_address
      ...
      # @see Telnyx::Models::EnterpriseListResponse#billing_contact
      ...
      # Employee count range
      #
      # @see Telnyx::Models::EnterpriseListResponse#number_of_employees
      ...
      # @see Telnyx::Models::EnterpriseListResponse#organization_contact
      ...
      # Legal structure type
      #
      # @see Telnyx::Models::EnterpriseListResponse#organization_legal_type
      ...
      # @see Telnyx::Models::EnterpriseListResponse#organization_physical_address
      ...
      # Type of organization
      #
      # @see Telnyx::Models::EnterpriseListResponse#organization_type
      ...
      # Role type in Branded Calling / Number Reputation services
      #
      # @see Telnyx::Models::EnterpriseListResponse#role_type
      module RoleType
        extend Telnyx::Internal::Type::Enum
