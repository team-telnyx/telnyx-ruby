  ...
  module Models
    module Queues
      ...
      class CallListResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Queues::CallListResponse::RecordType]
        ...
        #   {Telnyx::Models::Queues::CallListResponse} for more details.
        #
        ...
        #
        #   @param record_type [Symbol, Telnyx::Models::Queues::CallListResponse::RecordType]
        #
        ...
        # @see Telnyx::Models::Queues::CallListResponse#record_type
        module RecordType
