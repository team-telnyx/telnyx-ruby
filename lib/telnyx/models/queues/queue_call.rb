  ...
  module Models
    module Queues
      ...
      class QueueCall < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Queues::QueueCall::RecordType]
        required :record_type, enum: -> { Telnyx::Queues::QueueCall::RecordType }
        ...
        #   {Telnyx::Models::Queues::QueueCall} for more details.
        #
        ...
        #
        #   @param record_type [Symbol, Telnyx::Models::Queues::QueueCall::RecordType]
        #
        ...
        # @see Telnyx::Models::Queues::QueueCall#record_type
        module RecordType
