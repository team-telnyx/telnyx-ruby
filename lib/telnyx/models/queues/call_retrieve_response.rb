  ...
  module Models
    module Queues
      ...
      class CallRetrieveResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Queues::CallRetrieveResponse::Data, nil]
        optional :data, -> { Telnyx::Models::Queues::CallRetrieveResponse::Data }

        # @!method initialize(data: nil)
        #   @param data [Telnyx::Models::Queues::CallRetrieveResponse::Data]

        # @see Telnyx::Models::Queues::CallRetrieveResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::Queues::CallRetrieveResponse::Data::RecordType]
          ...
          #
          #   @param record_type [Symbol, Telnyx::Models::Queues::CallRetrieveResponse::Data::RecordType]
          #
