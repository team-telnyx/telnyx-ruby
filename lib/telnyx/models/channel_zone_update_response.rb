...
module Telnyx
  module Models
    ...
    class ChannelZoneUpdateResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::ChannelZoneUpdateResponse::RecordType]
      ...
      #   {Telnyx::Models::ChannelZoneUpdateResponse} for more details.
      #
      #   @param id [String]
      #
      ...
      #   @param name [String]
      #
      #   @param record_type [Symbol, Telnyx::Models::ChannelZoneUpdateResponse::RecordType]
      #
      ...
      # @see Telnyx::Models::ChannelZoneUpdateResponse#record_type
      module RecordType
