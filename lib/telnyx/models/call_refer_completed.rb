...
module Telnyx
  module Models
    class CallReferCompleted < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallReferCompleted::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallReferCompleted::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallReferCompleted::Payload, nil]
      optional :payload, -> { Telnyx::CallReferCompleted::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallReferCompleted::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallReferCompleted::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallReferCompleted::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallReferCompleted::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallReferCompleted::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallReferCompleted#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallReferCompleted#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::CallReferCompleted::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallReferCompleted#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
