...
module Telnyx
  module Models
    module SimCardGroups
      # @see Telnyx::Resources::SimCardGroups::Actions#remove_wireless_blocklist
      class ActionRemoveWirelessBlocklistResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        ...
        #   {Telnyx::Models::SimCardGroups::ActionRemoveWirelessBlocklistResponse} for more
        #   details.
        #
