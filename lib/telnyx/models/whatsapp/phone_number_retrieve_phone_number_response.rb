...
module Telnyx
  module Models
    module Whatsapp
      # @see Telnyx::Resources::Whatsapp::PhoneNumbers#retrieve_phone_number
      class PhoneNumberRetrievePhoneNumberResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data]
        required :data, -> { Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data }

        # @!method initialize(data:)
        #   @param data [Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data]

        # @see Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          #   Cloud API number.
          #
          #   @return [Symbol, Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data::CoexistenceState, nil]
          optional :coexistence_state,
                   enum: -> { Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data::CoexistenceState },
                   nil?: true
          ...
          #
          #   @return [Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data::SyncProgress, nil]
          ...
          #   {Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data} for
          #   more details.
          #
          #   @param calling_enabled [Boolean]
          #
          #   @param coexistence_state [Symbol, Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data::CoexistenceState, nil] Current lifecycle state for a coexistence number. This is null for a standard Cl
          #
          ...
          #
          #   @param sync_progress [Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data::SyncProgress, nil] Synchronization progress. This object is returned only while a coexistence numbe
          #
          ...
          # Cloud API number.
          #
          # @see Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data#coexistence_state
          ...
          # @see Telnyx::Models::Whatsapp::PhoneNumberRetrievePhoneNumberResponse::Data#sync_progress
