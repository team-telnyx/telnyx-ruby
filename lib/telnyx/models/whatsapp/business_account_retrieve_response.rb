...
module Telnyx
  module Models
    module Whatsapp
      # @see Telnyx::Resources::Whatsapp::BusinessAccounts#retrieve
      class BusinessAccountRetrieveResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Whatsapp::BusinessAccountRetrieveResponse::Data, nil]
        optional :data, -> { Telnyx::Models::Whatsapp::BusinessAccountRetrieveResponse::Data }

        # @!method initialize(data: nil)
        #   @param data [Telnyx::Models::Whatsapp::BusinessAccountRetrieveResponse::Data]

        # @see Telnyx::Models::Whatsapp::BusinessAccountRetrieveResponse#data
