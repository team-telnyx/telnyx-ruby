    ...
    module Whatsapp
      module BusinessAccounts
        ...
        class SettingUpdateResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::Whatsapp::BusinessAccounts::SettingUpdateResponse::Data, nil]
          optional :data, -> { Telnyx::Models::Whatsapp::BusinessAccounts::SettingUpdateResponse::Data }

          # @!method initialize(data: nil)
          #   @param data [Telnyx::Models::Whatsapp::BusinessAccounts::SettingUpdateResponse::Data]

          # @see Telnyx::Models::Whatsapp::BusinessAccounts::SettingUpdateResponse#data
