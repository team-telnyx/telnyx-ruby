...
module Telnyx
  module Models
    module Whatsapp
      # @see Telnyx::Resources::Whatsapp::PhoneNumbers#get
      class PhoneNumberGetResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data>, nil]
        optional :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data] }
        ...
        #   @param data [Array<Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data>]
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          #   Cloud API number.
          #
          #   @return [Symbol, Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data::CoexistenceState, nil]
          optional :coexistence_state,
                   enum: -> { Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data::CoexistenceState },
                   nil?: true
          ...
          #
          #   @return [Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data::SyncProgress, nil]
          ...
          #   {Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data} for more details.
          #
          #   @param calling_enabled [Boolean]
          #
          #   @param coexistence_state [Symbol, Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data::CoexistenceState, nil] Current lifecycle state for a coexistence number. This is null for a standard Cl
          #
          ...
          #
          #   @param sync_progress [Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data::SyncProgress, nil] Synchronization progress. This object is returned only while a coexistence numbe
          #
          ...
          # Cloud API number.
          #
          # @see Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data#coexistence_state
          ...
          # @see Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data#sync_progress
