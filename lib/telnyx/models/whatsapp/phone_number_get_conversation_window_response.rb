...
module Telnyx
  module Models
    module Whatsapp
      ...
      class PhoneNumberGetConversationWindowResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Whatsapp::PhoneNumberGetConversationWindowResponse::Data, nil]
        optional :data, -> { Telnyx::Models::Whatsapp::PhoneNumberGetConversationWindowResponse::Data }

        # @!method initialize(data: nil)
        #   @param data [Telnyx::Models::Whatsapp::PhoneNumberGetConversationWindowResponse::Data]

        # @see Telnyx::Models::Whatsapp::PhoneNumberGetConversationWindowResponse#data
