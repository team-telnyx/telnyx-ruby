      ...
      module PhoneNumbers
        module Profile
          ...
          class PhotoUploadResponse < Telnyx::Internal::Type::BaseModel
            # @!attribute data
            #
            #   @return [Telnyx::Models::Whatsapp::PhoneNumbers::Profile::PhotoUploadResponse::Data, nil]
            optional :data, -> { Telnyx::Models::Whatsapp::PhoneNumbers::Profile::PhotoUploadResponse::Data }

            # @!method initialize(data: nil)
            #   @param data [Telnyx::Models::Whatsapp::PhoneNumbers::Profile::PhotoUploadResponse::Data]

            # @see Telnyx::Models::Whatsapp::PhoneNumbers::Profile::PhotoUploadResponse#data
