    ...
    module Whatsapp
      module PhoneNumbers
        ...
        class ProfileRetrieveResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::Whatsapp::PhoneNumbers::ProfileRetrieveResponse::Data, nil]
          optional :data, -> { Telnyx::Models::Whatsapp::PhoneNumbers::ProfileRetrieveResponse::Data }

          # @!method initialize(data: nil)
          #   @param data [Telnyx::Models::Whatsapp::PhoneNumbers::ProfileRetrieveResponse::Data]

          # @see Telnyx::Models::Whatsapp::PhoneNumbers::ProfileRetrieveResponse#data
