  ...
  module Models
    module Whatsapp
      module PhoneNumbers
        ...
        class ProfileUpdateResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::Whatsapp::PhoneNumbers::ProfileUpdateResponse::Data, nil]
          optional :data, -> { Telnyx::Models::Whatsapp::PhoneNumbers::ProfileUpdateResponse::Data }

          # @!method initialize(data: nil)
          #   @param data [Telnyx::Models::Whatsapp::PhoneNumbers::ProfileUpdateResponse::Data]

          # @see Telnyx::Models::Whatsapp::PhoneNumbers::ProfileUpdateResponse#data
