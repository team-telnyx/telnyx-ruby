...
module Telnyx
  module Models
    ...
    class ShortCodeListResponse < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute meta
      #
      #   @return [Telnyx::Models::ShortCodeListResponse::Meta, nil]
      optional :meta, -> { Telnyx::Models::ShortCodeListResponse::Meta }

      # @!method initialize(data: nil, meta: nil)
      #   @param data [Array<Telnyx::Models::ShortCode>]
      #   @param meta [Telnyx::Models::ShortCodeListResponse::Meta]

      # @see Telnyx::Models::ShortCodeListResponse#meta
