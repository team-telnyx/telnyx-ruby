...
module Telnyx
  module Models
    ...
    class RoomRecordingListParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::RoomRecordingListParams::Filter, nil]
      optional :filter, -> { Telnyx::RoomRecordingListParams::Filter }

      # @!attribute page
      #   Consolidated page parameter (deepObject style). Originally: page[size],
      #   page[number]
      #
      #   @return [Telnyx::Models::RoomRecordingListParams::Page, nil]
      optional :page, -> { Telnyx::RoomRecordingListParams::Page }
      ...
      class Filter < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::RoomRecordingListParams::Filter::DateEndedAt, nil]
        optional :date_ended_at, -> { Telnyx::RoomRecordingListParams::Filter::DateEndedAt }

        # @!attribute date_started_at
        #
        #   @return [Telnyx::Models::RoomRecordingListParams::Filter::DateStartedAt, nil]
        optional :date_started_at, -> { Telnyx::RoomRecordingListParams::Filter::DateStartedAt }
        ...
        #   filter[duration_secs]
        #
        #   @param date_ended_at [Telnyx::Models::RoomRecordingListParams::Filter::DateEndedAt]
        #
        #   @param date_started_at [Telnyx::Models::RoomRecordingListParams::Filter::DateStartedAt]
        #
        ...
        # @see Telnyx::Models::RoomRecordingListParams::Filter#date_ended_at
        ...
        # @see Telnyx::Models::RoomRecordingListParams::Filter#date_started_at
