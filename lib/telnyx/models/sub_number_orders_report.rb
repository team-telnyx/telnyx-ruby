...
module Telnyx
  module Models
    class SubNumberOrdersReportAPI < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::SubNumberOrdersReportAPI::Filters, nil]
      ...
      #
      #   @return [Symbol, Telnyx::Models::SubNumberOrdersReportAPI::Status, nil]
      ...
      #   {Telnyx::Models::SubNumberOrdersReportAPI} for more details.
      #
      #   @param id [String] Identifies the resource.
      #
      #   @param created_at [Time] ISO 8601 formatted date indicating when the resource was created.
      #
      #   @param filters [Telnyx::Models::SubNumberOrdersReportAPI::Filters] The filters that were applied to generate this report
      #
      #   @param order_type [String] The type of order report.
      #
      #   @param status [Symbol, Telnyx::Models::SubNumberOrdersReportAPI::Status] Indicates the completion level of the sub number orders report. The report must
      #
      ...
      # @see Telnyx::Models::SubNumberOrdersReportAPI#filters
      ...
      # have a status of 'success' before it can be downloaded.
      #
      # @see Telnyx::Models::SubNumberOrdersReportAPI#status
      module Status
