...
module Telnyx
  module Models
    ...
    class VirtualCrossConnectsCoverageListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #   connect.
      #
      #   @return [Symbol, Telnyx::Models::VirtualCrossConnectsCoverageListResponse::CloudProvider, nil]
      ...
      # @!attribute location
      #
      #   @return [Telnyx::Models::VirtualCrossConnectsCoverageListResponse::Location, nil]
      optional :location, -> { Telnyx::Models::VirtualCrossConnectsCoverageListResponse::Location }
      ...
      #   {Telnyx::Models::VirtualCrossConnectsCoverageListResponse} for more details.
      #
      #   @param available_bandwidth [Array<Float>] The available throughput in Megabits per Second (Mbps) for your Virtual Cross Co
      #
      #   @param cloud_provider [Symbol, Telnyx::Models::VirtualCrossConnectsCoverageListResponse::CloudProvider] The Virtual Private Cloud with which you would like to establish a cross connect
      #
      #   @param cloud_provider_region [String] The region where your Virtual Private Cloud hosts are located. Should be identic
      #
      #   @param location [Telnyx::Models::VirtualCrossConnectsCoverageListResponse::Location]
      #
      ...
      # connect.
      #
      # @see Telnyx::Models::VirtualCrossConnectsCoverageListResponse#cloud_provider
      ...
      # @see Telnyx::Models::VirtualCrossConnectsCoverageListResponse#location
