...
module Telnyx
  module Models
    ...
    class CredentialConnectionCreateParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CredentialConnectionCreateParams::NoiseSuppression, nil]
      optional :noise_suppression, enum: -> { Telnyx::CredentialConnectionCreateParams::NoiseSuppression }
      ...
      #
      #   @return [Telnyx::Models::CredentialConnectionCreateParams::NoiseSuppressionDetails, nil]
      ...
      #   account (internal).
      #
      #   @return [Symbol, Telnyx::Models::CredentialConnectionCreateParams::SipUriCallingPreference, nil]
      optional :sip_uri_calling_preference,
               enum: -> { Telnyx::CredentialConnectionCreateParams::SipUriCallingPreference }
      ...
      #
      #   @return [Symbol, Telnyx::Models::CredentialConnectionCreateParams::WebhookAPIVersion, nil]
      optional :webhook_api_version, enum: -> { Telnyx::CredentialConnectionCreateParams::WebhookAPIVersion }
