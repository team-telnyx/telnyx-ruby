...
module Telnyx
  module Models
    # @see Telnyx::Resources::Messaging10dlc#get_enum
    module Messaging10dlcGetEnumResponse
      extend Telnyx::Internal::Type::Union

      variant -> { Telnyx::Models::Messaging10dlcGetEnumResponse::StringArray }
      ...
      variant -> { Telnyx::Models::Messaging10dlcGetEnumResponse::EnumPaginatedResponse }
