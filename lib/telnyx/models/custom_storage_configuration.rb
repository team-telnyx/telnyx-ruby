...
module Telnyx
  module Models
    class CustomStorageConfiguration < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::GcsConfigurationData, Telnyx::Models::S3ConfigurationData, Telnyx::Models::S3GenericConfigurationData, Telnyx::Models::AzureConfigurationData]
      ...
      #   @param configuration [Telnyx::Models::GcsConfigurationData, Telnyx::Models::S3ConfigurationData, Telnyx::Models::S3GenericConfigurationData, Telnyx::Models::AzureConfigurationData]
      ...
      module Configuration
        ...
        variant :"s3-generic", -> { Telnyx::S3GenericConfigurationData }

        variant :azure, -> { Telnyx::AzureConfigurationData }

        # @!method self.variants
        #   @return [Array(Telnyx::Models::GcsConfigurationData, Telnyx::Models::S3ConfigurationData, Telnyx::Models::S3GenericConfigurationData, Telnyx::Models::AzureConfigurationData)]
      end
    end
  end
end
