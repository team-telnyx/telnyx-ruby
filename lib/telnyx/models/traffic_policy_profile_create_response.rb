...
module Telnyx
  module Models
    ...
    class TrafficPolicyProfileCreateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::TrafficPolicyProfileCreateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::TrafficPolicyProfileCreateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::TrafficPolicyProfileCreateResponse::Data]
