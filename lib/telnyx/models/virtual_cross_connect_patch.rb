...
module Telnyx
  module Models
    class VirtualCrossConnectPatch < Telnyx::Internal::Type::BaseModel
      ...
      # @!method initialize(primary_cloud_ip: nil, primary_enabled: nil, primary_routing_announcement: nil, secondary_cloud_ip: nil, secondary_enabled: nil, secondary_routing_announcement: nil)
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::VirtualCrossConnectPatch} for more details.
      #
