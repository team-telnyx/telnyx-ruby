...
module Telnyx
  module Models
    class CountryCoverageAPI < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute local
      #
      #   @return [Telnyx::Models::CountryCoverageAPI::Local, nil]
      ...
      # @!attribute toll_free
      #
      #   @return [Telnyx::Models::CountryCoverageAPI::TollFree, nil]
      ...
      #
      #   @param local [Telnyx::Models::CountryCoverageAPI::Local]
      #
      ...
      #
      #   @param toll_free [Telnyx::Models::CountryCoverageAPI::TollFree]

      # @see Telnyx::Models::CountryCoverageAPI#local
      ...
      # @see Telnyx::Models::CountryCoverageAPI#toll_free
