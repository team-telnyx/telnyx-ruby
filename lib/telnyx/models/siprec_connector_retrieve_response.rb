...
module Telnyx
  module Models
    ...
    class SiprecConnectorRetrieveResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::SiprecConnectorRetrieveResponse::Data]
      required :data, -> { Telnyx::Models::SiprecConnectorRetrieveResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::SiprecConnectorRetrieveResponse::Data]

      # @see Telnyx::Models::SiprecConnectorRetrieveResponse#data
