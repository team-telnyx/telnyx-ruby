...
module Telnyx
  module Models
    ...
    class MessageSendShortCodeParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::MessageSendShortCodeParams::Encoding, nil]
      optional :encoding, enum: -> { Telnyx::MessageSendShortCodeParams::Encoding }
      ...
      #
      #   @return [Symbol, Telnyx::Models::MessageSendShortCodeParams::Type, nil]
      optional :type, enum: -> { Telnyx::MessageSendShortCodeParams::Type }
      ...
      # @!method initialize(from:, to:, auto_detect: nil, encoding: nil, media_urls: nil, subject: nil, text: nil, type: nil, use_profile_webhooks: nil, webhook_failover_url: nil, webhook_url: nil, request_options: {})
