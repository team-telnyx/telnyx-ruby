...
module Telnyx
  module Models
    class ConferenceParticipantPlaybackStartedWebhookEvent < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data, nil]
      optional :data, -> { Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data]

      # @see Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data::EventType, nil]
        optional :event_type,
                 enum: -> { Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::EventType }

        # @!attribute payload
        #
        #   @return [Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data::Payload, nil]
        optional :payload, -> { Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::Payload }

        # @!attribute record_type
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data::RecordType, nil]
        optional :record_type,
                 enum: -> { Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::RecordType }

        # @!method initialize(id: nil, event_type: nil, payload: nil, record_type: nil)
        #   @param id [String] Identifies the type of resource.
        #
        #   @param event_type [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data::EventType] The type of event being delivered.
        #
        #   @param payload [Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data::Payload]
        #
        #   @param record_type [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data::RecordType] Identifies the type of the resource.

        # The type of event being delivered.
        #
        # @see Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data#event_type
        module EventType
        ...
        # @see Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data::Payload}
          #   for more details.
          #
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::ConferenceParticipantPlaybackStartedWebhookEvent::Data#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
