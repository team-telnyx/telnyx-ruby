...
module Telnyx
  module Models
    ...
    class InfringementClaimContestResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::InfringementClaimContestResponse::Data]
      required :data, -> { Telnyx::Models::InfringementClaimContestResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::InfringementClaimContestResponse::Data]

      # @see Telnyx::Models::InfringementClaimContestResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::ClaimType, nil]
        optional :claim_type, enum: -> { Telnyx::Models::InfringementClaimContestResponse::Data::ClaimType }
        ...
        #
        #   @return [Array<Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument>, nil]
        optional :contest_documents,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument] }

        # @!attribute dir
        #   Snapshot of the DIR the claim is filed against, embedded for convenience.
        #
        #   @return [Telnyx::Models::InfringementClaimContestResponse::Data::Dir, nil]
        optional :dir, -> { Telnyx::Models::InfringementClaimContestResponse::Data::Dir }
        ...
        #
        #   @return [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::Resolution, nil]
        optional :resolution,
                 enum: -> { Telnyx::Models::InfringementClaimContestResponse::Data::Resolution },
                 nil?: true
        ...
        #   `resolved` — final.
        #
        #   @return [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::Status, nil]
        optional :status, enum: -> { Telnyx::Models::InfringementClaimContestResponse::Data::Status }
        ...
        response_only do
          ...
          #
          #   @return [Array<Telnyx::Models::InfringementClaimContestResponse::Data::ContestHistory>, nil]
          optional :contest_history,
                   -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::InfringementClaimContestResponse::Data::ContestHistory] }
        ...
        #   {Telnyx::Models::InfringementClaimContestResponse::Data} for more details.
        #
        #   @param id [String]
        #
        ...
        #
        #   @param claim_type [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::ClaimType] Category of infringement being claimed.
        #
        #   @param claimant_contact [String]
        #
        #   @param claimant_name [String]
        #
        #   @param contest_documents [Array<Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument>] Aggregated across all customer contest submissions on this claim.
        #
        #   @param contest_history [Array<Telnyx::Models::InfringementClaimContestResponse::Data::ContestHistory>] Per-round submission audit trail. Each entry records one `POST /infringement_cla
        #
        #   @param created_at [Time]
        #
        #   @param dir [Telnyx::Models::InfringementClaimContestResponse::Data::Dir] Snapshot of the DIR the claim is filed against, embedded for convenience.
        #
        #   @param dir_id [String]
        #
        #   @param enterprise_id [String]
        #
        #   @param resolution [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::Resolution, nil] Set only when `status` is `resolved`.
        #
        #   @param resolution_date [Time, nil]
        #
        #   @param resolution_notes [String, nil]
        #
        #   @param status [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::Status] Lifecycle status. `pending` — newly filed; the DIR is auto-suspended. `contested
        #
        #   @param updated_at [Time]

        # Category of infringement being claimed.
        #
        # @see Telnyx::Models::InfringementClaimContestResponse::Data#claim_type
        module ClaimType
        ...
        class ContestDocument < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument::DocumentType]
          required :document_type,
                   enum: -> { Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument::DocumentType }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument} for
          #   more details.
          #
          #   @param document_id [String] Id returned by the Telnyx Documents API after you upload the file (upload via `P
          #
          #   @param document_type [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument::DocumentType] Type of supporting document. Pick the closest match to what the file actually co
          #
          ...
          # short_name reference list is at `GET /v2/dir/document_types`.
          #
          # @see Telnyx::Models::InfringementClaimContestResponse::Data::ContestDocument#document_type
          module DocumentType
            extend Telnyx::Internal::Type::Enum
        ...
        # @see Telnyx::Models::InfringementClaimContestResponse::Data#dir
        class Dir < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::Dir::Status, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::InfringementClaimContestResponse::Data::Dir} for more details.
          #
          #   Snapshot of the DIR the claim is filed against, embedded for convenience.
          #
          #   @param id [String]
          ...
          #   @param enterprise_id [String]
          #
          #   @param status [Symbol, Telnyx::Models::InfringementClaimContestResponse::Data::Dir::Status] DIR lifecycle status.
          ...
          # - `permanently_rejected` — terminal; cannot be resubmitted.
          #
          # @see Telnyx::Models::InfringementClaimContestResponse::Data::Dir#status
          module Status
            extend Telnyx::Internal::Type::Enum
        ...
        # Set only when `status` is `resolved`.
        #
        # @see Telnyx::Models::InfringementClaimContestResponse::Data#resolution
        module Resolution
          extend Telnyx::Internal::Type::Enum
        ...
        # `resolved` — final.
        #
        # @see Telnyx::Models::InfringementClaimContestResponse::Data#status
        module Status
          extend Telnyx::Internal::Type::Enum
