...
module Telnyx
  module Models
    ...
    class DirRetrieveResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::DirRetrieveResponse::Data]
      required :data, -> { Telnyx::Models::DirRetrieveResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::DirRetrieveResponse::Data]

      # @see Telnyx::Models::DirRetrieveResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Telnyx::Models::DirRetrieveResponse::Data::CallReason>, nil]
        optional :call_reasons,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirRetrieveResponse::Data::CallReason] }
        ...
        # @!attribute documents
        #
        #   @return [Array<Telnyx::Models::DirRetrieveResponse::Data::Document>, nil]
        optional :documents,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirRetrieveResponse::Data::Document] },
                 nil?: true
        ...
        #   approval.
        #
        #   @return [Array<Telnyx::Models::DirRetrieveResponse::Data::RejectionReason>, nil]
        optional :rejection_reasons,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirRetrieveResponse::Data::RejectionReason] },
                 nil?: true
        ...
        #
        #   @return [Symbol, Telnyx::Models::DirRetrieveResponse::Data::Status, nil]
        optional :status, enum: -> { Telnyx::Models::DirRetrieveResponse::Data::Status }
        ...
        #   {Telnyx::Models::DirRetrieveResponse::Data} for more details.
        #
        #   @param id [String]
        #
        ...
        #
        #   @param call_reasons [Array<Telnyx::Models::DirRetrieveResponse::Data::CallReason>]
        #
        ...
        #
        #   @param documents [Array<Telnyx::Models::DirRetrieveResponse::Data::Document>, nil]
        #
        ...
        #
        #   @param rejection_reasons [Array<Telnyx::Models::DirRetrieveResponse::Data::RejectionReason>, nil] Populated when `status` is `rejected`; cleared on `/submit` or successful approv
        #
        #   @param reselling [Boolean]
        #
        #   @param status [Symbol, Telnyx::Models::DirRetrieveResponse::Data::Status] DIR lifecycle status.
        #
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::DirRetrieveResponse::Data::Document::DocumentType]
          required :document_type, enum: -> { Telnyx::Models::DirRetrieveResponse::Data::Document::DocumentType }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::DirRetrieveResponse::Data::Document} for more details.
          #
          #   @param document_id [String] Id returned by the Telnyx Documents API after you upload the file (upload via `P
          #
          #   @param document_type [Symbol, Telnyx::Models::DirRetrieveResponse::Data::Document::DocumentType] Type of supporting document. Pick the closest match to what the file actually co
          #
          ...
          # short_name reference list is at `GET /v2/dir/document_types`.
          #
          # @see Telnyx::Models::DirRetrieveResponse::Data::Document#document_type
          module DocumentType
        ...
        class RejectionReason < Telnyx::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::DirRetrieveResponse::Data::RejectionReason} for more details.
          #
          #   @param code [String]
          #
          #   @param detail [String]
        ...
        # - `permanently_rejected` - terminal; cannot be resubmitted.
        #
        # @see Telnyx::Models::DirRetrieveResponse::Data#status
        module Status
          extend Telnyx::Internal::Type::Enum
