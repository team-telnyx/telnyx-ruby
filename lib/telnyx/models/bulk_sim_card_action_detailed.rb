...
module Telnyx
  module Models
    ...
    class BulkSimCardActionDetailed < Telnyx::Internal::Type::BaseModel
      ...
      response_only do
        ...
        #   </ul>
        #
        #   @return [Symbol, Telnyx::Models::BulkSimCardActionDetailed::ActionType, nil]
        optional :action_type, enum: -> { Telnyx::BulkSimCardActionDetailed::ActionType }
      ...
      #   {Telnyx::Models::BulkSimCardActionDetailed} for more details.
      #
      #   @param id [String] Identifies the resource.
      #
      #   @param action_type [Symbol, Telnyx::Models::BulkSimCardActionDetailed::ActionType] The action type. It can be one of the following: <br/>
      #
      ...
      # </ul>
      #
      # @see Telnyx::Models::BulkSimCardActionDetailed#action_type
      module ActionType
