...
module Telnyx
  module Models
    ...
    class CredentialConnectionListParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::CredentialConnectionListParams::Filter, nil]
      optional :filter, -> { Telnyx::CredentialConnectionListParams::Filter }

      # @!attribute page
      #   Consolidated page parameter (deepObject style). Originally: page[size],
      #   page[number]
      #
      #   @return [Telnyx::Models::CredentialConnectionListParams::Page, nil]
      optional :page, -> { Telnyx::CredentialConnectionListParams::Page }
      ...
      #
      #   @return [Symbol, Telnyx::Models::CredentialConnectionListParams::Sort, nil]
      optional :sort, enum: -> { Telnyx::CredentialConnectionListParams::Sort }
      ...
      class Filter < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::CredentialConnectionListParams::Filter::ConnectionName, nil]
        optional :connection_name, -> { Telnyx::CredentialConnectionListParams::Filter::ConnectionName }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::CredentialConnectionListParams::Filter} for more details.
        #
        #   Consolidated filter parameter (deepObject style). Originally:
        #   filter[connection_name], filter[fqdn], filter[outbound_voice_profile_id],
        #   filter[outbound.outbound_voice_profile_id]
        #
        #   @param connection_name [Telnyx::Models::CredentialConnectionListParams::Filter::ConnectionName] Filter by connection_name using nested operations
        #
        ...
        # @see Telnyx::Models::CredentialConnectionListParams::Filter#connection_name
        class ConnectionName < Telnyx::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::CredentialConnectionListParams::Filter::ConnectionName} for
          #   more details.
          #
          #   Filter by connection_name using nested operations
          #
