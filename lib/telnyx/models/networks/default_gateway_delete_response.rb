  ...
  module Models
    module Networks
      ...
      class DefaultGatewayDeleteResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::Networks::DefaultGatewayDeleteResponse::Data>, nil]
        optional :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Networks::DefaultGatewayDeleteResponse::Data] }
