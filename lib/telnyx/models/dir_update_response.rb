...
module Telnyx
  module Models
    ...
    class DirUpdateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::DirUpdateResponse::Data]
      required :data, -> { Telnyx::Models::DirUpdateResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::DirUpdateResponse::Data]

      # @see Telnyx::Models::DirUpdateResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Telnyx::Models::DirUpdateResponse::Data::CallReason>, nil]
        ...
        # @!attribute documents
        #
        #   @return [Array<Telnyx::Models::DirUpdateResponse::Data::Document>, nil]
        optional :documents,
        ...
        #   approval.
        #
        #   @return [Array<Telnyx::Models::DirUpdateResponse::Data::RejectionReason>, nil]
        ...
        #
        #   @return [Symbol, Telnyx::Models::DirUpdateResponse::Data::Status, nil]
        ...
        #   {Telnyx::Models::DirUpdateResponse::Data} for more details.
        #
        #   @param id [String]
        #
        ...
        #
        #   @param call_reasons [Array<Telnyx::Models::DirUpdateResponse::Data::CallReason>]
        #
        ...
        #
        #   @param documents [Array<Telnyx::Models::DirUpdateResponse::Data::Document>, nil]
        #
        ...
        #
        #   @param rejection_reasons [Array<Telnyx::Models::DirUpdateResponse::Data::RejectionReason>, nil] Populated when `status` is `rejected`; cleared on `/submit` or successful approv
        #
        #   @param reselling [Boolean]
        #
        #   @param status [Symbol, Telnyx::Models::DirUpdateResponse::Data::Status] DIR lifecycle status.
        #
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::DirUpdateResponse::Data::Document::DocumentType]
          required :document_type, enum: -> { Telnyx::Models::DirUpdateResponse::Data::Document::DocumentType }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::DirUpdateResponse::Data::Document} for more details.
          #
          #   @param document_id [String] Id returned by the Telnyx Documents API after you upload the file (upload via `P
          #
          #   @param document_type [Symbol, Telnyx::Models::DirUpdateResponse::Data::Document::DocumentType] Type of supporting document. Pick the closest match to what the file actually co
          #
          ...
          # short_name reference list is at `GET /v2/dir/document_types`.
          #
          # @see Telnyx::Models::DirUpdateResponse::Data::Document#document_type
          module DocumentType
        ...
        class RejectionReason < Telnyx::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::DirUpdateResponse::Data::RejectionReason} for more details.
          #
          #   @param code [String]
          #
          #   @param detail [String]
        ...
        # - `permanently_rejected` - terminal; cannot be resubmitted.
        #
        # @see Telnyx::Models::DirUpdateResponse::Data#status
        module Status
          extend Telnyx::Internal::Type::Enum
