      ...
      module Accounts
        module Transcriptions
          ...
          class TexmlRecordingTranscription < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Telnyx::Models::Texml::Accounts::Transcriptions::TexmlRecordingTranscription::Status, nil]
            optional :status,
                     enum: -> { Telnyx::Texml::Accounts::Transcriptions::TexmlRecordingTranscription::Status }
            ...
            #   {Telnyx::Models::Texml::Accounts::Transcriptions::TexmlRecordingTranscription}
            #   for more details.
            #
            ...
            #
            #   @param status [Symbol, Telnyx::Models::Texml::Accounts::Transcriptions::TexmlRecordingTranscription::Status] The status of the recording transcriptions. The transcription text will be avail
            #
            ...
            # available only when the status is completed.
            #
            # @see Telnyx::Models::Texml::Accounts::Transcriptions::TexmlRecordingTranscription#status
            module Status
        ...
        TexmlRecordingTranscription = Transcriptions::TexmlRecordingTranscription
      end
    end
  end
end
