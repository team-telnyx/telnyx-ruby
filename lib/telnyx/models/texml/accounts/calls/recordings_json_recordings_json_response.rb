      ...
      module Accounts
        module Calls
          ...
          class RecordingsJsonRecordingsJsonResponse < Telnyx::Internal::Type::BaseModel
            ...
            # @!attribute channels
            #
            #   @return [Integer, Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Channels, nil]
            optional :channels,
                     enum: -> { Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Channels }
            ...
            #
            #   @return [Symbol, Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Source, nil]
            optional :source,
                     enum: -> { Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Source }
            ...
            #
            #   @return [Symbol, Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Track, nil]
            optional :track,
                     enum: -> { Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Track }
            ...
            #
            #   @param channels [Integer, Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Channels]
            #
            ...
            #
            #   @param source [Symbol, Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Source] Defines how the recording was created.
            #
            #   @param start_time [Time]
            #
            #   @param track [Symbol, Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse::Track] The audio track to record for the call. The default is `both`.
            #
            #   @param uri [String] The relative URI for this recording resource.

            # @see Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse#channels
            module Channels
            ...
            # Defines how the recording was created.
            #
            # @see Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse#source
            module Source
              extend Telnyx::Internal::Type::Enum
            ...
            # The audio track to record for the call. The default is `both`.
            #
            # @see Telnyx::Models::Texml::Accounts::Calls::RecordingsJsonRecordingsJsonResponse#track
            module Track
              extend Telnyx::Internal::Type::Enum
