    ...
    module Texml
      module Accounts
        ...
        class ConferenceUpdateResponse < Telnyx::Internal::Type::BaseModel
          ...
          #   null.
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::ReasonConferenceEnded, nil]
          ...
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::Status, nil]
          ...
          #   {Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse} for more details.
          #
          ...
          #
          #   @param reason_conference_ended [Symbol, Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::ReasonConferenceEnded] The reason why a conference ended. When a conference is in progress, will be nul
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::Status] The status of this conference.
          #
          ...
          # null.
          #
          # @see Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse#reason_conference_ended
          ...
          # The status of this conference.
          #
          # @see Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse#status
          module Status
            extend Telnyx::Internal::Type::Enum
