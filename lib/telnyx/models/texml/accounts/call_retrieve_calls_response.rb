    ...
    module Texml
      module Accounts
        ...
        class CallRetrieveCallsResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute calls
          #
          #   @return [Array<Telnyx::Models::Texml::Accounts::CallResource>, nil]
          optional :calls, -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Texml::Accounts::CallResource] }
          ...
          #
          #   @param calls [Array<Telnyx::Models::Texml::Accounts::CallResource>]
          #
