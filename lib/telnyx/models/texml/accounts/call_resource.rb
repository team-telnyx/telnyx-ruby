    ...
    module Texml
      module Accounts
        ...
        class CallResource < Telnyx::Internal::Type::BaseModel
          ...
          #   for the call.
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::CallResource::AnsweredBy, nil]
          optional :answered_by, enum: -> { Telnyx::Texml::Accounts::CallResource::AnsweredBy }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::CallResource::Direction, nil]
          optional :direction, enum: -> { Telnyx::Texml::Accounts::CallResource::Direction }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::CallResource::Status, nil]
          optional :status, enum: -> { Telnyx::Texml::Accounts::CallResource::Status }
          ...
          #   {Telnyx::Models::Texml::Accounts::CallResource} for more details.
          #
          #   @param account_sid [String] The id of the account the resource belongs to.
          #
          #   @param answered_by [Symbol, Telnyx::Models::Texml::Accounts::CallResource::AnsweredBy] The value of the answering machine detection result, if this feature was enabled
          #
          ...
          #
          #   @param direction [Symbol, Telnyx::Models::Texml::Accounts::CallResource::Direction] The direction of this call.
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Texml::Accounts::CallResource::Status] The status of this call.
          #
          ...
          # for the call.
          #
          # @see Telnyx::Models::Texml::Accounts::CallResource#answered_by
          module AnsweredBy
          ...
          # The direction of this call.
          #
          # @see Telnyx::Models::Texml::Accounts::CallResource#direction
          module Direction
            extend Telnyx::Internal::Type::Enum
          ...
          # The status of this call.
          #
          # @see Telnyx::Models::Texml::Accounts::CallResource#status
          module Status
            extend Telnyx::Internal::Type::Enum
