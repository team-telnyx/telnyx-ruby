    ...
    module Texml
      module Accounts
        module Conferences
          ...
          class ParticipantResource < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Telnyx::Models::Texml::Accounts::Conferences::ParticipantResource::Status, nil]
            ...
            #
            #   @param status [Symbol, Telnyx::Models::Texml::Accounts::Conferences::ParticipantResource::Status] The status of the participant's call in the conference.
            #
            #   @param uri [String] The relative URI for this participant.

            # The status of the participant's call in the conference.
            #
            # @see Telnyx::Models::Texml::Accounts::Conferences::ParticipantResource#status
            module Status
