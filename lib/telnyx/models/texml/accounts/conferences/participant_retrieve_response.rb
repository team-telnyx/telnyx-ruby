      ...
      module Accounts
        module Conferences
          ...
          class ParticipantRetrieveResponse < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Telnyx::Models::Texml::Accounts::Conferences::ParticipantRetrieveResponse::Status, nil]
            optional :status,
            ...
            #
            #   @param status [Symbol, Telnyx::Models::Texml::Accounts::Conferences::ParticipantRetrieveResponse::Status] The status of the participant's call in the conference.
            #
            #   @param uri [String] The relative URI for this participant.

            # The status of the participant's call in the conference.
            #
            # @see Telnyx::Models::Texml::Accounts::Conferences::ParticipantRetrieveResponse#status
            module Status
