    ...
    module Texml
      module Accounts
        ...
        class CallUpdateResponse < Telnyx::Internal::Type::BaseModel
          ...
          #   for the call.
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::CallUpdateResponse::AnsweredBy, nil]
          optional :answered_by, enum: -> { Telnyx::Models::Texml::Accounts::CallUpdateResponse::AnsweredBy }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::CallUpdateResponse::Direction, nil]
          optional :direction, enum: -> { Telnyx::Models::Texml::Accounts::CallUpdateResponse::Direction }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::CallUpdateResponse::Status, nil]
          optional :status, enum: -> { Telnyx::Models::Texml::Accounts::CallUpdateResponse::Status }
          ...
          #   {Telnyx::Models::Texml::Accounts::CallUpdateResponse} for more details.
          #
          #   @param account_sid [String] The id of the account the resource belongs to.
          #
          #   @param answered_by [Symbol, Telnyx::Models::Texml::Accounts::CallUpdateResponse::AnsweredBy] The value of the answering machine detection result, if this feature was enabled
          #
          ...
          #
          #   @param direction [Symbol, Telnyx::Models::Texml::Accounts::CallUpdateResponse::Direction] The direction of this call.
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Texml::Accounts::CallUpdateResponse::Status] The status of this call.
          #
          ...
          # for the call.
          #
          # @see Telnyx::Models::Texml::Accounts::CallUpdateResponse#answered_by
          module AnsweredBy
          ...
          # The direction of this call.
          #
          # @see Telnyx::Models::Texml::Accounts::CallUpdateResponse#direction
          module Direction
            extend Telnyx::Internal::Type::Enum
          ...
          # The status of this call.
          #
          # @see Telnyx::Models::Texml::Accounts::CallUpdateResponse#status
          module Status
            extend Telnyx::Internal::Type::Enum
