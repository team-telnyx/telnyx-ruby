  ...
  module Models
    module Texml
      module Accounts
        ...
        class ConferenceResource < Telnyx::Internal::Type::BaseModel
          ...
          #   null.
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::ConferenceResource::ReasonConferenceEnded, nil]
          optional :reason_conference_ended,
                   enum: -> { Telnyx::Texml::Accounts::ConferenceResource::ReasonConferenceEnded }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Texml::Accounts::ConferenceResource::Status, nil]
          optional :status, enum: -> { Telnyx::Texml::Accounts::ConferenceResource::Status }
          ...
          #   {Telnyx::Models::Texml::Accounts::ConferenceResource} for more details.
          #
          ...
          #
          #   @param reason_conference_ended [Symbol, Telnyx::Models::Texml::Accounts::ConferenceResource::ReasonConferenceEnded] The reason why a conference ended. When a conference is in progress, will be nul
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Texml::Accounts::ConferenceResource::Status] The status of this conference.
          #
          ...
          # null.
          #
          # @see Telnyx::Models::Texml::Accounts::ConferenceResource#reason_conference_ended
          ...
          # The status of this conference.
          #
          # @see Telnyx::Models::Texml::Accounts::ConferenceResource#status
          module Status
            extend Telnyx::Internal::Type::Enum
