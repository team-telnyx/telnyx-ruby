  ...
  module Models
    module Texml
      ...
      class AccountRetrieveTranscriptionsJsonResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Telnyx::Models::Texml::Accounts::Transcriptions::TexmlRecordingTranscription>, nil]
        optional :transcriptions,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Texml::Accounts::Transcriptions::TexmlRecordingTranscription] }
        ...
        #
        #   @param transcriptions [Array<Telnyx::Models::Texml::Accounts::Transcriptions::TexmlRecordingTranscription>]
        #
