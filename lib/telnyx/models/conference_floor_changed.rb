...
module Telnyx
  module Models
    class ConferenceFloorChanged < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceFloorChanged::EventType, nil]
      optional :event_type, enum: -> { Telnyx::ConferenceFloorChanged::EventType }

      # @!attribute payload
      #
      #   @return [Telnyx::Models::ConferenceFloorChanged::Payload, nil]
      optional :payload, -> { Telnyx::ConferenceFloorChanged::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::ConferenceFloorChanged::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::ConferenceFloorChanged::RecordType }

      # @!method initialize(id: nil, event_type: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::ConferenceFloorChanged::EventType] The type of event being delivered.
      #
      #   @param payload [Telnyx::Models::ConferenceFloorChanged::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::ConferenceFloorChanged::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::ConferenceFloorChanged#event_type
      module EventType
      ...
      # @see Telnyx::Models::ConferenceFloorChanged#payload
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::ConferenceFloorChanged#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
