...
module Telnyx
  module Models
    ...
    class PortingOrder < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Telnyx::Models::PortingPhoneNumber>, nil]
      optional :phone_numbers, -> { Telnyx::Internal::Type::ArrayOf[Telnyx::PortingPhoneNumber] }
      ...
      #
      #   @param phone_numbers [Array<Telnyx::Models::PortingPhoneNumber>] List of phone numbers associated with this porting order
      #
