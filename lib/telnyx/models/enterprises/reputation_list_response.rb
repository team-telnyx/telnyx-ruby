  ...
  module Models
    module Enterprises
      ...
      class ReputationListResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Enterprises::ReputationListResponse::Data, nil]
        optional :data, -> { Telnyx::Models::Enterprises::ReputationListResponse::Data }

        # @!method initialize(data: nil)
        #   @param data [Telnyx::Models::Enterprises::ReputationListResponse::Data]

        # @see Telnyx::Models::Enterprises::ReputationListResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          # @!attribute check_frequency
          #   Frequency for refreshing reputation data
          #
          #   @return [Symbol, Telnyx::Models::Enterprises::ReputationListResponse::Data::CheckFrequency, nil]
          optional :check_frequency,
                   enum: -> { Telnyx::Models::Enterprises::ReputationListResponse::Data::CheckFrequency }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Enterprises::ReputationListResponse::Data::Status, nil]
          optional :status, enum: -> { Telnyx::Models::Enterprises::ReputationListResponse::Data::Status }
          ...
          #   @param check_frequency [Symbol, Telnyx::Models::Enterprises::ReputationListResponse::Data::CheckFrequency] Frequency for refreshing reputation data
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Enterprises::ReputationListResponse::Data::Status] Current enrollment status
          #
          #   @param updated_at [Time] When the reputation settings were last updated

          # Frequency for refreshing reputation data
          #
          # @see Telnyx::Models::Enterprises::ReputationListResponse::Data#check_frequency
          ...
          # Current enrollment status
          #
          # @see Telnyx::Models::Enterprises::ReputationListResponse::Data#status
          module Status
            extend Telnyx::Internal::Type::Enum
