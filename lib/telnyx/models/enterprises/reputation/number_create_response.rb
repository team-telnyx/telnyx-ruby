    ...
    module Enterprises
      module Reputation
        ...
        class NumberCreateResponse < Telnyx::Internal::Type::BaseModel
          ...
          # @!attribute meta
          #
          #   @return [Telnyx::Models::Enterprises::Reputation::NumberCreateResponse::Meta, nil]
          optional :meta, -> { Telnyx::Models::Enterprises::Reputation::NumberCreateResponse::Meta }

          # @!method initialize(data: nil, meta: nil)
          #   @param data [Array<Telnyx::Models::Enterprises::Reputation::NumberCreateResponse::Data>]
          #   @param meta [Telnyx::Models::Enterprises::Reputation::NumberCreateResponse::Meta]
          ...
          # @see Telnyx::Models::Enterprises::Reputation::NumberCreateResponse#meta
