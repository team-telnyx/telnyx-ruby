    ...
    module Enterprises
      module Reputation
        ...
        class NumberRetrieveResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data, nil]
          optional :data, -> { Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data }

          # @!method initialize(data: nil)
          #   @param data [Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data]

          # @see Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse#data
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData, Object, nil]
            optional :reputation_data,
                     union: -> { Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData }
            ...
            #
            #   @param reputation_data [Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData, Object, nil] Reputation metrics (null if not yet fetched)
            #
            #   @param updated_at [Time] When the record was last updated

            # Reputation metrics (null if not yet fetched)
            #
            # @see Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data#reputation_data
            module ReputationData
              extend Telnyx::Internal::Type::Union

              # Reputation metrics
              variant -> { Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData }
              ...
              class ReputationData < Telnyx::Internal::Type::BaseModel
                ...
                #
                #   @return [Symbol, Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData::SpamRisk, nil]
                optional :spam_risk,
                         enum: -> { Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData::SpamRisk },
                         nil?: true
                ...
                #
                #   @param spam_risk [Symbol, Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData::SpamRisk, nil] Overall spam risk level

                # Overall spam risk level
                #
                # @see Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData#spam_risk
                module SpamRisk
              ...
              #   @return [Array(Telnyx::Models::Enterprises::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData, Object)]
            end
          end
        end
      end
