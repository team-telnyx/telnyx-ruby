    ...
    module Enterprises
      module Reputation
        ...
        class RemediationRequestWrapped < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Telnyx::Models::Enterprises::Reputation::RemediationRequestWrapped::Data]
          required :data, -> { Telnyx::Enterprises::Reputation::RemediationRequestWrapped::Data }

          # @!method initialize(data:)
          #   @param data [Telnyx::Models::Enterprises::Reputation::RemediationRequestWrapped::Data] Full detail of a remediation request, returned on submit and GET by id.

          # @see Telnyx::Models::Enterprises::Reputation::RemediationRequestWrapped#data
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Telnyx::Models::Enterprises::Reputation::RemediationRequestWrapped::Data::Results, nil]
            optional :results,
                     -> { Telnyx::Enterprises::Reputation::RemediationRequestWrapped::Data::Results },
                     nil?: true
            ...
            #   {Telnyx::Models::Enterprises::Reputation::RemediationRequestWrapped::Data} for
            #   more details.
            #
            #   Full detail of a remediation request, returned on submit and GET by id.
            #
            ...
            #
            #   @param results [Telnyx::Models::Enterprises::Reputation::RemediationRequestWrapped::Data::Results, nil] Per-category buckets. Populated once results are available. Null while the reque
            #
            ...
            # @see Telnyx::Models::Enterprises::Reputation::RemediationRequestWrapped::Data#results
