    ...
    module Enterprises
      module Reputation
        ...
        class NumberListResponse < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData, Object, nil]
          optional :reputation_data,
                   union: -> { Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData }
          ...
          #
          #   @param reputation_data [Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData, Object, nil] Reputation metrics (null if not yet fetched)
          #
          #   @param updated_at [Time] When the record was last updated

          # Reputation metrics (null if not yet fetched)
          #
          # @see Telnyx::Models::Enterprises::Reputation::NumberListResponse#reputation_data
          module ReputationData
            extend Telnyx::Internal::Type::Union

            # Reputation metrics
            variant -> { Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData }
            ...
            class ReputationData < Telnyx::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData::SpamRisk, nil]
              optional :spam_risk,
                       enum: -> { Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData::SpamRisk },
                       nil?: true
              ...
              #
              #   @param spam_risk [Symbol, Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData::SpamRisk, nil] Overall spam risk level

              # Overall spam risk level
              #
              # @see Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData#spam_risk
              module SpamRisk
            ...
            #   @return [Array(Telnyx::Models::Enterprises::Reputation::NumberListResponse::ReputationData::ReputationData, Object)]
          end
        end
      end
    end
