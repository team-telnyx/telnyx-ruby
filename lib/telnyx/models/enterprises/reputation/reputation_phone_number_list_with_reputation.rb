...
module Telnyx
  module Models
    module Enterprises
      module Reputation
        class ReputationPhoneNumberListWithReputation < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          ...
          #   {Telnyx::Models::Enterprises::Reputation::ReputationPhoneNumberListWithReputation}
          #   for more details.
          #
      ...
      ReputationPhoneNumberListWithReputation = Reputation::ReputationPhoneNumberListWithReputation
    end
  end
end
