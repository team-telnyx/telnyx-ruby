  ...
  module Models
    module Enterprises
      ...
      class ReputationEnableResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Enterprises::ReputationEnableResponse::Data, nil]
        optional :data, -> { Telnyx::Models::Enterprises::ReputationEnableResponse::Data }

        # @!method initialize(data: nil)
        #   @param data [Telnyx::Models::Enterprises::ReputationEnableResponse::Data]

        # @see Telnyx::Models::Enterprises::ReputationEnableResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          # @!attribute check_frequency
          #   Frequency for refreshing reputation data
          #
          #   @return [Symbol, Telnyx::Models::Enterprises::ReputationEnableResponse::Data::CheckFrequency, nil]
          optional :check_frequency,
                   enum: -> { Telnyx::Models::Enterprises::ReputationEnableResponse::Data::CheckFrequency }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Enterprises::ReputationEnableResponse::Data::Status, nil]
          optional :status, enum: -> { Telnyx::Models::Enterprises::ReputationEnableResponse::Data::Status }
          ...
          #   @param check_frequency [Symbol, Telnyx::Models::Enterprises::ReputationEnableResponse::Data::CheckFrequency] Frequency for refreshing reputation data
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Enterprises::ReputationEnableResponse::Data::Status] Current enrollment status
          #
          #   @param updated_at [Time] When the reputation settings were last updated

          # Frequency for refreshing reputation data
          #
          # @see Telnyx::Models::Enterprises::ReputationEnableResponse::Data#check_frequency
          ...
          # Current enrollment status
          #
          # @see Telnyx::Models::Enterprises::ReputationEnableResponse::Data#status
          module Status
            extend Telnyx::Internal::Type::Enum
