  ...
  module Models
    module Enterprises
      ...
      class ReputationRetrieveResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data, nil]
        optional :data, -> { Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data }

        # @!method initialize(data: nil)
        #   @param data [Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data]

        # @see Telnyx::Models::Enterprises::ReputationRetrieveResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          # @!attribute check_frequency
          #   Frequency for refreshing reputation data
          #
          #   @return [Symbol, Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data::CheckFrequency, nil]
          optional :check_frequency,
                   enum: -> { Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data::CheckFrequency }
          ...
          #
          #   @return [Symbol, Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data::Status, nil]
          optional :status, enum: -> { Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data::Status }
          ...
          #   @param check_frequency [Symbol, Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data::CheckFrequency] Frequency for refreshing reputation data
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data::Status] Current enrollment status
          #
          #   @param updated_at [Time] When the reputation settings were last updated

          # Frequency for refreshing reputation data
          #
          # @see Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data#check_frequency
          ...
          # Current enrollment status
          #
          # @see Telnyx::Models::Enterprises::ReputationRetrieveResponse::Data#status
          module Status
            extend Telnyx::Internal::Type::Enum
