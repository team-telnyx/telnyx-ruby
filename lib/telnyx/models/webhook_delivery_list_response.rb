...
module Telnyx
  module Models
    ...
    class WebhookDeliveryListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Telnyx::Models::WebhookDeliveryListResponse::Attempt>, nil]
      optional :attempts,
      ...
      #
      #   @param attempts [Array<Telnyx::Models::WebhookDeliveryListResponse::Attempt>] Detailed delivery attempts, ordered by most recent.
      #
      ...
      class Attempt < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP, nil]
        optional :http, -> { Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP }
        ...
        # @!attribute status
        #
        #   @return [Symbol, Telnyx::Models::WebhookDeliveryListResponse::Attempt::Status, nil]
        optional :status, enum: -> { Telnyx::Models::WebhookDeliveryListResponse::Attempt::Status }
        ...
        #
        #   @param http [Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP] HTTP request and response information.
        #
        #   @param started_at [Time] ISO 8601 timestamp indicating when the attempt was initiated.
        #
        #   @param status [Symbol, Telnyx::Models::WebhookDeliveryListResponse::Attempt::Status]

        # @see Telnyx::Models::WebhookDeliveryListResponse::Attempt#http
        class HTTP < Telnyx::Internal::Type::BaseModel
          # @!attribute request
          #   Request details.
          #
          #   @return [Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP::Request, nil]
          optional :request, -> { Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP::Request }

          # @!attribute response
          #   Response details, optional.
          #
          #   @return [Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP::Response, nil]
          optional :response, -> { Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP::Response }

          # @!method initialize(request: nil, response: nil)
          #   HTTP request and response information.
          #
          #   @param request [Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP::Request] Request details.
          #
          #   @param response [Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP::Response] Response details, optional.

          # @see Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP#request
          ...
          # @see Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP#response
        ...
        # @see Telnyx::Models::WebhookDeliveryListResponse::Attempt#status
        module Status
