...
module Telnyx
  module Models
    module MobilePhoneNumbers
      ...
      class MobilePhoneNumberWithMessagingSettings < Telnyx::Internal::Type::BaseModel
        ...
        response_only do
          ...
          # @!attribute features
          #
          #   @return [Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Features, nil]
          optional :features, -> { Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Features }
          ...
          #
          #   @return [Symbol, Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::RecordType, nil]
          optional :record_type,
                   enum: -> { Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::RecordType }
          ...
          #
          #   @return [Symbol, Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Type, nil]
          optional :type, enum: -> { Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Type }
        ...
        #
        #   @param features [Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Features]
        #
        ...
        #
        #   @param record_type [Symbol, Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::RecordType] Identifies the type of the resource.
        #
        ...
        #
        #   @param type [Symbol, Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Type] The type of the phone number
        #
        #   @param updated_at [Time] ISO 8601 formatted date indicating when the resource was updated.

        # @see Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings#features
        class Features < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Features}
          #   for more details.
          #
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings#record_type
        module RecordType
        ...
        # The type of the phone number
        #
        # @see Telnyx::Models::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings#type
        module Type
          extend Telnyx::Internal::Type::Enum
    ...
    MobilePhoneNumberWithMessagingSettings = MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings
  end
end
