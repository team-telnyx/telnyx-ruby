...
module Telnyx
  module Models
    ...
    class MobileNetworkOperatorListResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<Telnyx::Models::MobileNetworkOperatorListResponse::Data>, nil]
      optional :data,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::MobileNetworkOperatorListResponse::Data] }
      ...
      #   @param data [Array<Telnyx::Models::MobileNetworkOperatorListResponse::Data>]
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::MobileNetworkOperatorListResponse::Data} for more details.
        #
