...
module Telnyx
  module Models
    ...
    class PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute records
      #
      #   @return [Array<Telnyx::Models::PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse::Record>]
      required :records,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse::Record] }

      # @!method initialize(records:)
      #   @param records [Array<Telnyx::Models::PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse::Record>]
