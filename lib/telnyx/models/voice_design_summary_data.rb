...
module Telnyx
  module Models
    ...
    class VoiceDesignSummaryData < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::VoiceDesignSummaryData::Provider, nil]
      optional :provider, enum: -> { Telnyx::VoiceDesignSummaryData::Provider }, nil?: true
      ...
      #
      #   @return [Symbol, Telnyx::Models::VoiceDesignSummaryData::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::VoiceDesignSummaryData::RecordType }
      ...
      #
      #   @param provider [Symbol, Telnyx::Models::VoiceDesignSummaryData::Provider, nil] Voice synthesis provider used for this design.
      #
      #   @param provider_supported_models [Array<String>] List of TTS model identifiers supported by this design's provider.
      #
      #   @param record_type [Symbol, Telnyx::Models::VoiceDesignSummaryData::RecordType] Identifies the resource type.
      #
      #   @param updated_at [Time] Timestamp when the voice design was last updated.

      # Voice synthesis provider used for this design.
      #
      # @see Telnyx::Models::VoiceDesignSummaryData#provider
      module Provider
      ...
      # Identifies the resource type.
      #
      # @see Telnyx::Models::VoiceDesignSummaryData#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
