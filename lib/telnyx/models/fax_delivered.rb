...
module Telnyx
  module Models
    class FaxDelivered < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::FaxDelivered::Data, nil]
      optional :data, -> { Telnyx::FaxDelivered::Data }

      # @!attribute meta
      #   Metadata about the webhook delivery.
      #
      #   @return [Telnyx::Models::FaxDelivered::Meta, nil]
      optional :meta, -> { Telnyx::FaxDelivered::Meta }

      # @!method initialize(data: nil, meta: nil)
      #   @param data [Telnyx::Models::FaxDelivered::Data]
      #
      #   @param meta [Telnyx::Models::FaxDelivered::Meta] Metadata about the webhook delivery.

      # @see Telnyx::Models::FaxDelivered#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::FaxDelivered::Data::EventType, nil]
        optional :event_type, enum: -> { Telnyx::FaxDelivered::Data::EventType }
        ...
        # @!attribute payload
        #
        #   @return [Telnyx::Models::FaxDelivered::Data::Payload, nil]
        optional :payload, -> { Telnyx::FaxDelivered::Data::Payload }

        # @!attribute record_type
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::FaxDelivered::Data::RecordType, nil]
        optional :record_type, enum: -> { Telnyx::FaxDelivered::Data::RecordType }

        # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
        #   @param id [String] Identifies the type of resource.
        #
        #   @param event_type [Symbol, Telnyx::Models::FaxDelivered::Data::EventType] The type of event being delivered.
        #
        #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
        #
        #   @param payload [Telnyx::Models::FaxDelivered::Data::Payload]
        #
        #   @param record_type [Symbol, Telnyx::Models::FaxDelivered::Data::RecordType] Identifies the type of the resource.

        # The type of event being delivered.
        #
        # @see Telnyx::Models::FaxDelivered::Data#event_type
        module EventType
        ...
        # @see Telnyx::Models::FaxDelivered::Data#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::FaxDelivered::Data::Payload::Direction, nil]
          ...
          #
          #   @return [Symbol, Telnyx::Models::FaxDelivered::Data::Payload::Status, nil]
          ...
          #   {Telnyx::Models::FaxDelivered::Data::Payload} for more details.
          #
          ...
          #
          #   @param direction [Symbol, Telnyx::Models::FaxDelivered::Data::Payload::Direction] The direction of the fax.
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::FaxDelivered::Data::Payload::Status] The status of the fax.
          #
          ...
          # The direction of the fax.
          #
          # @see Telnyx::Models::FaxDelivered::Data::Payload#direction
          module Direction
            extend Telnyx::Internal::Type::Enum
          ...
          # The status of the fax.
          #
          # @see Telnyx::Models::FaxDelivered::Data::Payload#status
          module Status
            extend Telnyx::Internal::Type::Enum
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::FaxDelivered::Data#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
      ...
      # @see Telnyx::Models::FaxDelivered#meta
