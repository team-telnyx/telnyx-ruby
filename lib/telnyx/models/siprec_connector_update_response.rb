...
module Telnyx
  module Models
    ...
    class SiprecConnectorUpdateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::SiprecConnectorUpdateResponse::Data]
      required :data, -> { Telnyx::Models::SiprecConnectorUpdateResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::SiprecConnectorUpdateResponse::Data]

      # @see Telnyx::Models::SiprecConnectorUpdateResponse#data
