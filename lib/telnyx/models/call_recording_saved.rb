...
module Telnyx
  module Models
    class CallRecordingSaved < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallRecordingSaved::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallRecordingSaved::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallRecordingSaved::Payload, nil]
      optional :payload, -> { Telnyx::CallRecordingSaved::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallRecordingSaved::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallRecordingSaved::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallRecordingSaved::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallRecordingSaved::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallRecordingSaved::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallRecordingSaved#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallRecordingSaved#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::CallRecordingSaved::Payload::Channels, nil]
        ...
        #
        #   @return [Telnyx::Models::CallRecordingSaved::Payload::PublicRecordingURLs, nil]
        ...
        #
        #   @return [Telnyx::Models::CallRecordingSaved::Payload::RecordingURLs, nil]
        ...
        #   {Telnyx::Models::CallRecordingSaved::Payload} for more details.
        #
        ...
        #
        #   @param channels [Symbol, Telnyx::Models::CallRecordingSaved::Payload::Channels] Whether recording was recorded in `single` or `dual` channel.
        #
        ...
        #
        #   @param public_recording_urls [Telnyx::Models::CallRecordingSaved::Payload::PublicRecordingURLs] Recording URLs in requested format. The URL is valid for as long as the file exi
        #
        ...
        #
        #   @param recording_urls [Telnyx::Models::CallRecordingSaved::Payload::RecordingURLs] Recording URLs in requested format. These URLs are valid for 10 minutes. After 1

        # Whether recording was recorded in `single` or `dual` channel.
        #
        # @see Telnyx::Models::CallRecordingSaved::Payload#channels
        module Channels
          extend Telnyx::Internal::Type::Enum
        ...
        # @see Telnyx::Models::CallRecordingSaved::Payload#public_recording_urls
        ...
        # @see Telnyx::Models::CallRecordingSaved::Payload#recording_urls
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallRecordingSaved#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
