...
module Telnyx
  module Models
    ...
    class DialogflowConnectionCreateParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::DialogflowConnectionCreateParams::DialogflowAPI, nil]
      optional :dialogflow_api, enum: -> { Telnyx::DialogflowConnectionCreateParams::DialogflowAPI }
