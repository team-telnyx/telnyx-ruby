...
module Telnyx
  module Models
    module Legacy
      module Reporting
        module UsageReports
          # @see Telnyx::Resources::Legacy::Reporting::UsageReports::NumberLookup#retrieve
          class NumberLookupRetrieveResponse < Telnyx::Internal::Type::BaseModel
            # @!attribute data
            #   Telco data usage report response
            #
            #   @return [Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data, nil]
            optional :data, -> { Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data }

            # @!method initialize(data: nil)
            #   @param data [Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data] Telco data usage report response

            # @see Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse#data
            class Data < Telnyx::Internal::Type::BaseModel
              ...
              #
              #   @return [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data::Result>, nil]
              optional :result,
                       -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data::Result] }
              ...
              #
              #   @param result [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data::Result>] Array of usage records
              #
              ...
              class Result < Telnyx::Internal::Type::BaseModel
                ...
                #
                #   @return [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data::Result::Aggregation>, nil]
                optional :aggregations,
                         -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data::Result::Aggregation] }
                ...
                #   @param aggregations [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupRetrieveResponse::Data::Result::Aggregation>] List of aggregations by lookup type
                #
                #   @param record_type [String] Record type identifier
                #
