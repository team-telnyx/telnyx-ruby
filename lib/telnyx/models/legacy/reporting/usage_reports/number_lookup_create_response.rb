      ...
      module Reporting
        module UsageReports
          ...
          class NumberLookupCreateResponse < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data, nil]
            optional :data, -> { Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data }

            # @!method initialize(data: nil)
            #   @param data [Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data] Telco data usage report response

            # @see Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse#data
            class Data < Telnyx::Internal::Type::BaseModel
              ...
              #
              #   @return [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data::Result>, nil]
              optional :result,
                       -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data::Result] }
              ...
              #
              #   @param result [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data::Result>] Array of usage records
              #
              ...
              class Result < Telnyx::Internal::Type::BaseModel
                ...
                #
                #   @return [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data::Result::Aggregation>, nil]
                optional :aggregations,
                         -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data::Result::Aggregation] }
                ...
                #   @param aggregations [Array<Telnyx::Models::Legacy::Reporting::UsageReports::NumberLookupCreateResponse::Data::Result::Aggregation>] List of aggregations by lookup type
                #
                #   @param record_type [String] Record type identifier
                #
