      ...
      module Reporting
        module BatchDetailRecords
          ...
          class VoiceDeleteResponse < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data, nil]
            optional :data, -> { Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data }

            # @!method initialize(data: nil)
            #   @param data [Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data] Response object for CDR detailed report

            # @see Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse#data
            class Data < Telnyx::Internal::Type::BaseModel
              ...
              #   List of filters
              #
              #   @return [Array<Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter>, nil]
              optional :filters,
                       -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter] }
              ...
              #   {Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data}
              #   for more details.
              #
              #   Response object for CDR detailed report
              #
              ...
              #
              #   @param filters [Array<Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter>] List of filters
              #
              ...
              class Filter < Telnyx::Internal::Type::BaseModel
                ...
                #
                #   @return [Symbol, Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::CldFilter, nil]
                optional :cld_filter,
                         enum: -> { Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::CldFilter }
                ...
                #
                #   @return [Symbol, Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::CliFilter, nil]
                optional :cli_filter,
                         enum: -> { Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::CliFilter }

                # @!attribute filter_type
                #   Logical operator for combining filters
                #
                #   @return [Symbol, Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::FilterType, nil]
                optional :filter_type,
                         enum: -> { Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::FilterType }
                ...
                #
                #   @param cld_filter [Symbol, Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::CldFilter] Filter type for CLD matching
                #
                #   @param cli [String] Calling line identification (caller ID)
                #
                #   @param cli_filter [Symbol, Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::CliFilter] Filter type for CLI matching
                #
                #   @param filter_type [Symbol, Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter::FilterType] Logical operator for combining filters
                #
                #   @param tags_list [String] Tag name to filter by

                # Filter type for CLD matching
                #
                # @see Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter#cld_filter
                module CldFilter
                ...
                # Filter type for CLI matching
                #
                # @see Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter#cli_filter
                module CliFilter
                  extend Telnyx::Internal::Type::Enum
                ...
                # Logical operator for combining filters
                #
                # @see Telnyx::Models::Legacy::Reporting::BatchDetailRecords::VoiceDeleteResponse::Data::Filter#filter_type
                module FilterType
                  extend Telnyx::Internal::Type::Enum
