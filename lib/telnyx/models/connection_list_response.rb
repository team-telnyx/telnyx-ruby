...
module Telnyx
  module Models
    ...
    class ConnectionListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConnectionListResponse::WebhookAPIVersion, nil]
      ...
      #   {Telnyx::Models::ConnectionListResponse} for more details.
      #
      ...
      #
      #   @param webhook_api_version [Symbol, Telnyx::Models::ConnectionListResponse::WebhookAPIVersion] Determines which webhook format will be used, Telnyx API v1 or v2.
      #
      ...
      # Determines which webhook format will be used, Telnyx API v1 or v2.
      #
      # @see Telnyx::Models::ConnectionListResponse#webhook_api_version
