...
module Telnyx
  module Models
    ...
    class ConferenceUpdateParticipantResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::ConferenceUpdateParticipantResponse::Data, nil]
      optional :data, -> { Telnyx::Models::ConferenceUpdateParticipantResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::ConferenceUpdateParticipantResponse::Data]

      # @see Telnyx::Models::ConferenceUpdateParticipantResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::ConferenceUpdateParticipantResponse::Data::Status, nil]
        optional :status, enum: -> { Telnyx::Models::ConferenceUpdateParticipantResponse::Data::Status }
        ...
        #
        #   @param status [Symbol, Telnyx::Models::ConferenceUpdateParticipantResponse::Data::Status] Status of the participant.
        #
        ...
        # Status of the participant.
        #
        # @see Telnyx::Models::ConferenceUpdateParticipantResponse::Data#status
        module Status
