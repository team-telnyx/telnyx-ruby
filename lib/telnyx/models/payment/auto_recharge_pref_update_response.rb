  ...
  module Models
    module Payment
      ...
      class AutoRechargePrefUpdateResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data, nil]
        optional :data, -> { Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data }

        # @!method initialize(data: nil)
        #   @param data [Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data]

        # @see Telnyx::Models::Payment::AutoRechargePrefUpdateResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data::Preference, nil]
          optional :preference,
                   enum: -> { Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data::Preference }
          ...
          #   {Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data} for more
          #   details.
          #
          ...
          #
          #   @param preference [Symbol, Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data::Preference] The payment preference for auto recharge.
          #
          ...
          # The payment preference for auto recharge.
          #
          # @see Telnyx::Models::Payment::AutoRechargePrefUpdateResponse::Data#preference
          module Preference
