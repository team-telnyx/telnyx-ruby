...
module Telnyx
  module Models
    module Payment
      class AutoRechargePref < Telnyx::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Symbol, Telnyx::Models::Payment::AutoRechargePref::Preference, nil]
        ...
        #   {Telnyx::Models::Payment::AutoRechargePref} for more details.
        #
        ...
        #
        #   @param preference [Symbol, Telnyx::Models::Payment::AutoRechargePref::Preference] The payment preference for auto recharge.
        #
        ...
        # The payment preference for auto recharge.
        #
        # @see Telnyx::Models::Payment::AutoRechargePref#preference
        module Preference
