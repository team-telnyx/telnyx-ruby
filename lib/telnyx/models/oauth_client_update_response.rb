...
module Telnyx
  module Models
    ...
    class OAuthClientUpdateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::OAuthClientUpdateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::OAuthClientUpdateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::OAuthClientUpdateResponse::Data]
