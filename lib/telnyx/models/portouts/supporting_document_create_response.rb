  ...
  module Models
    module Portouts
      ...
      class SupportingDocumentCreateResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::Portouts::SupportingDocumentCreateResponse::Data>, nil]
        optional :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Portouts::SupportingDocumentCreateResponse::Data] }

        # @!method initialize(data: nil)
        #   @param data [Array<Telnyx::Models::Portouts::SupportingDocumentCreateResponse::Data>]
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          response_only do
            ...
            #
            #   @return [Symbol, Telnyx::Models::Portouts::SupportingDocumentCreateResponse::Data::Type]
            required :type, enum: -> { Telnyx::Models::Portouts::SupportingDocumentCreateResponse::Data::Type }
          end
          ...
          #
          #   @param type [Symbol, Telnyx::Models::Portouts::SupportingDocumentCreateResponse::Data::Type] Identifies the type of the document
          #
          #   @param updated_at [String] Supporting document last changed timestamp in ISO 8601 format

          # Identifies the type of the document
          #
          # @see Telnyx::Models::Portouts::SupportingDocumentCreateResponse::Data#type
          module Type
