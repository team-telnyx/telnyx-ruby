  ...
  module Models
    module Portouts
      class WebhookPortoutStatusChanged < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::AvailableNotificationMethod>, nil]
        optional :available_notification_methods,
                 -> { Telnyx::Internal::Type::ArrayOf[enum: Telnyx::Portouts::WebhookPortoutStatusChanged::AvailableNotificationMethod] }
        ...
        #
        #   @return [Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::EventType, nil]
        optional :event_type, enum: -> { Telnyx::Portouts::WebhookPortoutStatusChanged::EventType }

        # @!attribute payload
        #   The webhook payload for the portout.status_changed event
        #
        #   @return [Telnyx::Models::Portouts::WebhookPortoutStatusChanged::Payload, nil]
        optional :payload, -> { Telnyx::Portouts::WebhookPortoutStatusChanged::Payload }

        # @!attribute payload_status
        #   The status of the payload generation.
        #
        #   @return [Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::PayloadStatus, nil]
        optional :payload_status, enum: -> { Telnyx::Portouts::WebhookPortoutStatusChanged::PayloadStatus }
        ...
        #
        #   @param available_notification_methods [Array<Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::AvailableNotificationMethod>] Indicates the notification methods used.
        #
        #   @param created_at [Time] ISO 8601 formatted date indicating when the resource was created.
        #
        #   @param event_type [Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::EventType] Identifies the event type
        #
        #   @param payload [Telnyx::Models::Portouts::WebhookPortoutStatusChanged::Payload] The webhook payload for the portout.status_changed event
        #
        #   @param payload_status [Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::PayloadStatus] The status of the payload generation.
        #
        ...
        # Identifies the event type
        #
        # @see Telnyx::Models::Portouts::WebhookPortoutStatusChanged#event_type
        module EventType
          extend Telnyx::Internal::Type::Enum
        ...
        # @see Telnyx::Models::Portouts::WebhookPortoutStatusChanged#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::Payload::Status, nil]
          ...
          #   {Telnyx::Models::Portouts::WebhookPortoutStatusChanged::Payload} for more
          #   details.
          #
          #   The webhook payload for the portout.status_changed event
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::Portouts::WebhookPortoutStatusChanged::Payload::Status] The new status of the port out.
          #
          ...
          # The new status of the port out.
          #
          # @see Telnyx::Models::Portouts::WebhookPortoutStatusChanged::Payload#status
          module Status
            extend Telnyx::Internal::Type::Enum
        ...
        # The status of the payload generation.
        #
        # @see Telnyx::Models::Portouts::WebhookPortoutStatusChanged#payload_status
