    ...
    module Portouts
      class PortOutSupportingDocument < Telnyx::Internal::Type::BaseModel
        ...
        response_only do
          ...
          #
          #   @return [Symbol, Telnyx::Models::Portouts::PortOutSupportingDocument::Type]
          required :type, enum: -> { Telnyx::Portouts::PortOutSupportingDocument::Type }
        end
        ...
        #
        #   @param type [Symbol, Telnyx::Models::Portouts::PortOutSupportingDocument::Type] Identifies the type of the document
        #
        #   @param updated_at [String] Supporting document last changed timestamp in ISO 8601 format

        # Identifies the type of the document
        #
        # @see Telnyx::Models::Portouts::PortOutSupportingDocument#type
        module Type
