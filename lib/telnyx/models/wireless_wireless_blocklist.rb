...
module Telnyx
  module Models
    ...
    class WirelessWirelessBlocklist < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::WirelessWirelessBlocklist::Type, nil]
      optional :type, enum: -> { Telnyx::WirelessWirelessBlocklist::Type }
      ...
      # @!method initialize(id: nil, created_at: nil, name: nil, type: nil, updated_at: nil, values: nil)
      ...
      #
      #   @param type [Symbol, Telnyx::Models::WirelessWirelessBlocklist::Type] The type of the wireless blocklist.
      #
      ...
      # The type of the wireless blocklist.
      #
      # @see Telnyx::Models::WirelessWirelessBlocklist#type
      module Type
