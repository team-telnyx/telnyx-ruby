...
module Telnyx
  module Models
    class TelnyxCampaignCsp < Telnyx::Internal::Type::BaseModel
      ...
      #   Campaign status
      #
      #   @return [Symbol, Telnyx::Models::TelnyxCampaignCsp::CampaignStatus, nil]
      optional :campaign_status,
               enum: -> { Telnyx::TelnyxCampaignCsp::CampaignStatus },
      ...
      #
      #   @return [Symbol, Telnyx::Models::TelnyxCampaignCsp::SubmissionStatus, nil]
      optional :submission_status,
               enum: -> { Telnyx::TelnyxCampaignCsp::SubmissionStatus },
      ...
      #   {Telnyx::Models::TelnyxCampaignCsp} for more details.
      #
      ...
      #
      #   @param campaign_status [Symbol, Telnyx::Models::TelnyxCampaignCsp::CampaignStatus] Campaign status
      #
      ...
      #
      #   @param submission_status [Symbol, Telnyx::Models::TelnyxCampaignCsp::SubmissionStatus] Campaign submission status
      #
      ...
      # Campaign status
      #
      # @see Telnyx::Models::TelnyxCampaignCsp#campaign_status
      ...
      # Campaign submission status
      #
      # @see Telnyx::Models::TelnyxCampaignCsp#submission_status
