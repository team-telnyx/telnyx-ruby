...
module Telnyx
  module Models
    # @see Telnyx::Resources::MobileVoiceConnections#create
    class MobileVoiceConnectionCreateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::MobileVoiceConnectionCreateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::MobileVoiceConnectionCreateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::MobileVoiceConnectionCreateResponse::Data]

      # @see Telnyx::Models::MobileVoiceConnectionCreateResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        # @!attribute inbound
        #
        #   @return [Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::Inbound, nil]
        optional :inbound, -> { Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::Inbound }

        # @!attribute outbound
        #
        #   @return [Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::Outbound, nil]
        optional :outbound, -> { Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::Outbound }
        ...
        #
        #   @return [Symbol, Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::WebhookAPIVersion, nil]
        optional :webhook_api_version,
                 enum: -> { Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::WebhookAPIVersion },
                 nil?: true
        ...
        response_only do
          ...
          #
          #   @return [Symbol, Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::RecordType, nil]
          optional :record_type, enum: -> { Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::RecordType }
        ...
        #
        #   @param inbound [Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::Inbound]
        #
        #   @param outbound [Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::Outbound]
        #
        #   @param record_type [Symbol, Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::RecordType] Identifies the type of the resource.
        #
        #   @param tags [Array<String>] A list of tags associated with the connection.
        #
        #   @param updated_at [Time]
        #
        #   @param webhook_api_version [Symbol, Telnyx::Models::MobileVoiceConnectionCreateResponse::Data::WebhookAPIVersion, nil] The API version for webhooks.
        #
        ...
        # @see Telnyx::Models::MobileVoiceConnectionCreateResponse::Data#inbound
        ...
        # @see Telnyx::Models::MobileVoiceConnectionCreateResponse::Data#outbound
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::MobileVoiceConnectionCreateResponse::Data#record_type
        module RecordType
        ...
        # The API version for webhooks.
        #
        # @see Telnyx::Models::MobileVoiceConnectionCreateResponse::Data#webhook_api_version
