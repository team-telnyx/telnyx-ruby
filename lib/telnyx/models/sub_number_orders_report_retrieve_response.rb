...
module Telnyx
  module Models
    ...
    class SubNumberOrdersReportRetrieveResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data, nil]
      optional :data, -> { Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data]

      # @see Telnyx::Models::SubNumberOrdersReportRetrieveResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        # @!attribute filters
        #   The filters that were applied to generate this report
        #
        #   @return [Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data::Filters, nil]
        optional :filters, -> { Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data::Filters }
        ...
        #
        #   @return [Symbol, Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data::Status, nil]
        optional :status, enum: -> { Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data::Status }
        ...
        #   {Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data} for more details.
        #
        #   @param id [String] Identifies the resource.
        #
        #   @param created_at [Time] ISO 8601 formatted date indicating when the resource was created.
        #
        #   @param filters [Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data::Filters] The filters that were applied to generate this report
        #
        #   @param order_type [String] The type of order report.
        #
        #   @param status [Symbol, Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data::Status] Indicates the completion level of the sub number orders report. The report must
        #
        ...
        # @see Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data#filters
        ...
        # have a status of 'success' before it can be downloaded.
        #
        # @see Telnyx::Models::SubNumberOrdersReportRetrieveResponse::Data#status
        module Status
