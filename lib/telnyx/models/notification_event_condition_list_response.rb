...
module Telnyx
  module Models
    ...
    class NotificationEventConditionListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::NotificationEventConditionListResponse::AssociatedRecordType, nil]
      ...
      #
      #   @return [Array<Telnyx::Models::NotificationEventConditionListResponse::Parameter>, nil]
      optional :parameters,
      ...
      #   {Telnyx::Models::NotificationEventConditionListResponse} for more details.
      #
      ...
      #
      #   @param associated_record_type [Symbol, Telnyx::Models::NotificationEventConditionListResponse::AssociatedRecordType]
      #
      ...
      #
      #   @param parameters [Array<Telnyx::Models::NotificationEventConditionListResponse::Parameter>]
      #
      ...
      # @see Telnyx::Models::NotificationEventConditionListResponse#associated_record_type
