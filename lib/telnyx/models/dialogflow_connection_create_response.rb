...
module Telnyx
  module Models
    ...
    class DialogflowConnectionCreateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::DialogflowConnectionCreateResponse::Data]
      required :data, -> { Telnyx::Models::DialogflowConnectionCreateResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::DialogflowConnectionCreateResponse::Data]

      # @see Telnyx::Models::DialogflowConnectionCreateResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::DialogflowConnectionCreateResponse::Data} for more details.
        #
