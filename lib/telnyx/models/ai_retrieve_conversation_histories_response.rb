...
module Telnyx
  module Models
    ...
    class AIRetrieveConversationHistoriesResponse < Telnyx::Internal::Type::BaseModel
      ...
      #   descending.
      #
      #   @return [Array<Telnyx::Models::AIRetrieveConversationHistoriesResponse::Data>]
      required :data,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::AIRetrieveConversationHistoriesResponse::Data] }

      # @!attribute meta
      #   Pagination metadata following the standard Telnyx V2 API format.
      #
      #   @return [Telnyx::Models::AIRetrieveConversationHistoriesResponse::Meta]
      required :meta, -> { Telnyx::Models::AIRetrieveConversationHistoriesResponse::Meta }

      # @!method initialize(data:, meta:)
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::AIRetrieveConversationHistoriesResponse} for more details.
      #
      #   Search response following the standard Telnyx V2 API format.
      #
      #   @param data [Array<Telnyx::Models::AIRetrieveConversationHistoriesResponse::Data>] Ranked list of matching text chunks, sorted by cosine similarity score descendin
      #
      #   @param meta [Telnyx::Models::AIRetrieveConversationHistoriesResponse::Meta] Pagination metadata following the standard Telnyx V2 API format.
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::AIRetrieveConversationHistoriesResponse::Data::Region]
        required :region, enum: -> { Telnyx::Models::AIRetrieveConversationHistoriesResponse::Data::Region }
        ...
        # The region where this record is stored.
        #
        # @see Telnyx::Models::AIRetrieveConversationHistoriesResponse::Data#region
        module Region
