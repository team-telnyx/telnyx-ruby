...
module Telnyx
  module Models
    ...
    class AIRetrieveConversationHistoriesResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::AIRetrieveConversationHistoriesResponse::Region]
      ...
      #
      #   @param region [Symbol, Telnyx::Models::AIRetrieveConversationHistoriesResponse::Region] The region where this record is stored.
      #
      ...
      # The region where this record is stored.
      #
      # @see Telnyx::Models::AIRetrieveConversationHistoriesResponse#region
      module Region
