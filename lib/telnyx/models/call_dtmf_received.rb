...
module Telnyx
  module Models
    class CallDtmfReceived < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallDtmfReceived::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallDtmfReceived::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallDtmfReceived::Payload, nil]
      optional :payload, -> { Telnyx::CallDtmfReceived::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallDtmfReceived::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallDtmfReceived::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallDtmfReceived::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallDtmfReceived::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallDtmfReceived::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallDtmfReceived#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallDtmfReceived#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::CallDtmfReceived::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallDtmfReceived#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
