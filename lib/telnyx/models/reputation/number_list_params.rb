  ...
  module Models
    module Reputation
      ...
      class NumberListParams < Telnyx::Internal::Type::BaseModel
        ...
        # @!method initialize(filter_enterprise_id: nil, filter_phone_number_contains: nil, filter_phone_number_eq: nil, page_number: nil, page_size: nil, phone_number: nil, request_options: {})
