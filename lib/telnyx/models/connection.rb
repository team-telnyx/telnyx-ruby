...
module Telnyx
  module Models
    ...
    class Connection < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::Connection::WebhookAPIVersion, nil]
      optional :webhook_api_version, enum: -> { Telnyx::Connection::WebhookAPIVersion }
      ...
      #   {Telnyx::Models::Connection} for more details.
      #
      ...
      #
      #   @param webhook_api_version [Symbol, Telnyx::Models::Connection::WebhookAPIVersion] Determines which webhook format will be used, Telnyx API v1 or v2.
      #
      ...
      # Determines which webhook format will be used, Telnyx API v1 or v2.
      #
      # @see Telnyx::Models::Connection#webhook_api_version
