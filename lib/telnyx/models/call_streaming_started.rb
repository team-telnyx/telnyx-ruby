...
module Telnyx
  module Models
    class CallStreamingStarted < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallStreamingStarted::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallStreamingStarted::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallStreamingStarted::Payload, nil]
      optional :payload, -> { Telnyx::CallStreamingStarted::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallStreamingStarted::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallStreamingStarted::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallStreamingStarted::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallStreamingStarted::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallStreamingStarted::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallStreamingStarted#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallStreamingStarted#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::CallStreamingStarted::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallStreamingStarted#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
