...
module Telnyx
  module Models
    module Number10dlc
      # @see Telnyx::Resources::Number10dlc::PhoneNumberCampaigns#list
      class PhoneNumberCampaignListParams < Telnyx::Internal::Type::BaseModel
        ...
        #   filter[tcr_brand_id]
        #
        #   @return [Telnyx::Models::Number10dlc::PhoneNumberCampaignListParams::Filter, nil]
        optional :filter, -> { Telnyx::Number10dlc::PhoneNumberCampaignListParams::Filter }
        ...
        #
        #   @return [Symbol, Telnyx::Models::Number10dlc::PhoneNumberCampaignListParams::Sort, nil]
        optional :sort, enum: -> { Telnyx::Number10dlc::PhoneNumberCampaignListParams::Sort }
