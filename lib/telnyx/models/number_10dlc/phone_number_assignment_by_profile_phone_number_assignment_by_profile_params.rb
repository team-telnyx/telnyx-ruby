...
module Telnyx
  module Models
    module Number10dlc
      # @see Telnyx::Resources::Number10dlc::PhoneNumberAssignmentByProfile#phone_number_assignment_by_profile
      class PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams < Telnyx::Internal::Type::BaseModel
