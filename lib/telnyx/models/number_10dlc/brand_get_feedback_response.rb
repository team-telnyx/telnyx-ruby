...
module Telnyx
  module Models
    module Number10dlc
      # @see Telnyx::Resources::Number10dlc::Brand#get_feedback
      class BrandGetFeedbackResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Telnyx::Models::Number10dlc::BrandGetFeedbackResponse::Category>]
        required :category,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Number10dlc::BrandGetFeedbackResponse::Category] }

        # @!method initialize(brand_id:, category:)
        #   @param brand_id [String] ID of the brand being queried about
        #
        #   @param category [Array<Telnyx::Models::Number10dlc::BrandGetFeedbackResponse::Category>] A list of reasons why brand creation/revetting didn't go as planned
