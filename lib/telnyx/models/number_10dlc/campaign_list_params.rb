...
module Telnyx
  module Models
    module Number10dlc
      # @see Telnyx::Resources::Number10dlc::Campaign#list
      class CampaignListParams < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Number10dlc::CampaignListParams::Sort, nil]
        optional :sort, enum: -> { Telnyx::Number10dlc::CampaignListParams::Sort }
