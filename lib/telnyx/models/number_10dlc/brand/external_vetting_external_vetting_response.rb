...
module Telnyx
  module Models
    module Number10dlc
      module Brand
        # @see Telnyx::Resources::Number10dlc::Brand::ExternalVetting#external_vetting
        class ExternalVettingExternalVettingResponse < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::Number10dlc::Brand::ExternalVettingExternalVettingResponse} for
          #   more details.
          #
