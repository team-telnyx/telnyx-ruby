...
module Telnyx
  module Models
    module Number10dlc
      module Brand
        # @see Telnyx::Resources::Number10dlc::Brand::ExternalVetting#order
        class ExternalVettingOrderResponse < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::Number10dlc::Brand::ExternalVettingOrderResponse} for more
          #   details.
          #
