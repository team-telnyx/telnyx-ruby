...
module Telnyx
  module Models
    module Number10dlc
      module Brand
        # @see Telnyx::Resources::Number10dlc::Brand::ExternalVetting#import
        class ExternalVettingImportResponse < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::Number10dlc::Brand::ExternalVettingImportResponse} for more
          #   details.
          #
