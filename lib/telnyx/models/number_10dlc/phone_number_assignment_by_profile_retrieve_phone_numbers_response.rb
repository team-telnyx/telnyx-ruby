...
module Telnyx
  module Models
    module Number10dlc
      # @see Telnyx::Resources::Number10dlc::PhoneNumberAssignmentByProfile#retrieve_phone_numbers
      class PhoneNumberAssignmentByProfileRetrievePhoneNumbersResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute records
        #
        #   @return [Array<Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileRetrievePhoneNumbersResponse::Record>]
        required :records,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileRetrievePhoneNumbersResponse::Record] }

        # @!method initialize(records:)
        #   @param records [Array<Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileRetrievePhoneNumbersResponse::Record>]
