  ...
  module Models
    module Number10dlc
      ...
      class CampaignListResponse < Telnyx::Internal::Type::BaseModel
        ...
        # @!attribute records
        #
        #   @return [Array<Telnyx::Models::Number10dlc::CampaignListResponse::Record>, nil]
        optional :records,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Number10dlc::CampaignListResponse::Record] }
        ...
        #   @param page [Integer]
        #   @param records [Array<Telnyx::Models::Number10dlc::CampaignListResponse::Record>]
        ...
        class Record < Telnyx::Internal::Type::BaseModel
          ...
          #   Campaign status
          #
          #   @return [Symbol, Telnyx::Models::Number10dlc::CampaignListResponse::Record::CampaignStatus, nil]
          optional :campaign_status,
                   enum: -> { Telnyx::Models::Number10dlc::CampaignListResponse::Record::CampaignStatus },
          ...
          #
          #   @return [Symbol, Telnyx::Models::Number10dlc::CampaignListResponse::Record::SubmissionStatus, nil]
          optional :submission_status,
                   enum: -> { Telnyx::Models::Number10dlc::CampaignListResponse::Record::SubmissionStatus },
          ...
          #   {Telnyx::Models::Number10dlc::CampaignListResponse::Record} for more details.
          #
          ...
          #
          #   @param campaign_status [Symbol, Telnyx::Models::Number10dlc::CampaignListResponse::Record::CampaignStatus] Campaign status
          #
          ...
          #
          #   @param submission_status [Symbol, Telnyx::Models::Number10dlc::CampaignListResponse::Record::SubmissionStatus] Campaign submission status
          #
          ...
          # Campaign status
          #
          # @see Telnyx::Models::Number10dlc::CampaignListResponse::Record#campaign_status
          ...
          # Campaign submission status
          #
          # @see Telnyx::Models::Number10dlc::CampaignListResponse::Record#submission_status
