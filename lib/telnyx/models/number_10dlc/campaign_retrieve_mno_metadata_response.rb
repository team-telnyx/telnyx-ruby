...
module Telnyx
  module Models
    module Number10dlc
      # @see Telnyx::Resources::Number10dlc::Campaign#retrieve_mno_metadata
      class CampaignRetrieveMnoMetadataResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute mno_10999
        #
        #   @return [Telnyx::Models::Number10dlc::CampaignRetrieveMnoMetadataResponse::Mno10999, nil]
        optional :mno_10999,
                 -> { Telnyx::Models::Number10dlc::CampaignRetrieveMnoMetadataResponse::Mno10999 },
                 api_name: :"10999"

        # @!method initialize(mno_10999: nil)
        #   @param mno_10999 [Telnyx::Models::Number10dlc::CampaignRetrieveMnoMetadataResponse::Mno10999]

        # @see Telnyx::Models::Number10dlc::CampaignRetrieveMnoMetadataResponse#mno_10999
