...
module Telnyx
  module Models
    module Number10dlc
      # @see Telnyx::Resources::Number10dlc::PhoneNumberCampaigns#create
      class PhoneNumberCampaign < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Number10dlc::PhoneNumberCampaign::AssignmentStatus, nil]
        optional :assignment_status,
                 enum: -> { Telnyx::Number10dlc::PhoneNumberCampaign::AssignmentStatus },
        ...
        #   {Telnyx::Models::Number10dlc::PhoneNumberCampaign} for more details.
        #
        ...
        #
        #   @param assignment_status [Symbol, Telnyx::Models::Number10dlc::PhoneNumberCampaign::AssignmentStatus] The assignment status of the number.
        #
        ...
        # The assignment status of the number.
        #
        # @see Telnyx::Models::Number10dlc::PhoneNumberCampaign#assignment_status
