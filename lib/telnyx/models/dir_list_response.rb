...
module Telnyx
  module Models
    ...
    class DirListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Telnyx::Models::DirListResponse::CallReason>, nil]
      optional :call_reasons,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirListResponse::CallReason] }
      ...
      # @!attribute documents
      #
      #   @return [Array<Telnyx::Models::DirListResponse::Document>, nil]
      optional :documents,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirListResponse::Document] },
               nil?: true
      ...
      #   approval.
      #
      #   @return [Array<Telnyx::Models::DirListResponse::RejectionReason>, nil]
      optional :rejection_reasons,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirListResponse::RejectionReason] },
               nil?: true
      ...
      #
      #   @return [Symbol, Telnyx::Models::DirListResponse::Status, nil]
      optional :status, enum: -> { Telnyx::Models::DirListResponse::Status }
      ...
      #   {Telnyx::Models::DirListResponse} for more details.
      #
      #   @param id [String]
      #
      ...
      #
      #   @param call_reasons [Array<Telnyx::Models::DirListResponse::CallReason>]
      #
      ...
      #
      #   @param documents [Array<Telnyx::Models::DirListResponse::Document>, nil]
      #
      ...
      #
      #   @param rejection_reasons [Array<Telnyx::Models::DirListResponse::RejectionReason>, nil] Populated when `status` is `rejected`; cleared on `/submit` or successful approv
      #
      #   @param reselling [Boolean]
      #
      #   @param status [Symbol, Telnyx::Models::DirListResponse::Status] DIR lifecycle status.
      #
      ...
      class Document < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::DirListResponse::Document::DocumentType]
        required :document_type, enum: -> { Telnyx::Models::DirListResponse::Document::DocumentType }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::DirListResponse::Document} for more details.
        #
        #   @param document_id [String] Id returned by the Telnyx Documents API after you upload the file (upload via `P
        #
        #   @param document_type [Symbol, Telnyx::Models::DirListResponse::Document::DocumentType] Type of supporting document. Pick the closest match to what the file actually co
        #
        ...
        # short_name reference list is at `GET /v2/dir/document_types`.
        #
        # @see Telnyx::Models::DirListResponse::Document#document_type
        module DocumentType
      ...
      class RejectionReason < Telnyx::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::DirListResponse::RejectionReason} for more details.
        #
        #   @param code [String]
        #
        #   @param detail [String]
      ...
      # - `permanently_rejected` - terminal; cannot be resubmitted.
      #
      # @see Telnyx::Models::DirListResponse#status
      module Status
        extend Telnyx::Internal::Type::Enum
