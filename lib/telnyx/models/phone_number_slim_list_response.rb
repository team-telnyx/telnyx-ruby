...
module Telnyx
  module Models
    ...
    class PhoneNumberSlimListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #   enabled/disabled.
      #
      #   @return [Symbol, Telnyx::Models::PhoneNumberSlimListResponse::EmergencyStatus, nil]
      ...
      #
      #   @return [Symbol, Telnyx::Models::PhoneNumberSlimListResponse::InboundCallScreening, nil]
      ...
      response_only do
        ...
        #
        #   @return [Symbol, Telnyx::Models::PhoneNumberSlimListResponse::PhoneNumberType, nil]
        optional :phone_number_type, enum: -> { Telnyx::Models::PhoneNumberSlimListResponse::PhoneNumberType }
        ...
        #
        #   @return [Symbol, Telnyx::Models::PhoneNumberSlimListResponse::Status, nil]
        optional :status, enum: -> { Telnyx::Models::PhoneNumberSlimListResponse::Status }
      ...
      #
      #   @param emergency_status [Symbol, Telnyx::Models::PhoneNumberSlimListResponse::EmergencyStatus] Indicates the status of the provisioning of emergency services for the phone num
      #
      ...
      #
      #   @param phone_number_type [Symbol, Telnyx::Models::PhoneNumberSlimListResponse::PhoneNumberType] The phone number's type.
      #
      ...
      # enabled/disabled.
      #
      # @see Telnyx::Models::PhoneNumberSlimListResponse#emergency_status
      ...
      # feature has an additional per-number monthly cost associated with it.
      #
      # @see Telnyx::Models::PhoneNumberSlimListResponse#inbound_call_screening
      ...
      # values `tollfree`, `shortcode` or `longcode` may be returned instead.
      #
      # @see Telnyx::Models::PhoneNumberSlimListResponse#phone_number_type
      ...
      # The phone number's current status.
      #
      # @see Telnyx::Models::PhoneNumberSlimListResponse#status
      module Status
        extend Telnyx::Internal::Type::Enum
