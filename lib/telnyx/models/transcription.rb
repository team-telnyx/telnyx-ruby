...
module Telnyx
  module Models
    class Transcription < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::Transcription::EventType, nil]
      optional :event_type, enum: -> { Telnyx::Transcription::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::Transcription::Payload, nil]
      optional :payload, -> { Telnyx::Transcription::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::Transcription::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::Transcription::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::Transcription::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::Transcription::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::Transcription::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::Transcription#event_type
      module EventType
      ...
      # @see Telnyx::Models::Transcription#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::Transcription::Payload::TranscriptionData, nil]
        optional :transcription_data, -> { Telnyx::Transcription::Payload::TranscriptionData }
        ...
        #   {Telnyx::Models::Transcription::Payload} for more details.
        #
        ...
        #
        #   @param transcription_data [Telnyx::Models::Transcription::Payload::TranscriptionData]
        ...
        class TranscriptionData < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::Transcription::Payload::TranscriptionData::TranscriptionTrack, nil]
          optional :transcription_track,
                   enum: -> { Telnyx::Transcription::Payload::TranscriptionData::TranscriptionTrack }
          ...
          #
          #   @param transcription_track [Symbol, Telnyx::Models::Transcription::Payload::TranscriptionData::TranscriptionTrack] Indicates which leg of the call has been transcribed. This is only available whe

          # Indicates which leg of the call has been transcribed. This is only available
          # when `transcription_engine` is set to `B`.
          #
          # @see Telnyx::Models::Transcription::Payload::TranscriptionData#transcription_track
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::Transcription#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
