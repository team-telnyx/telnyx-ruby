...
module Telnyx
  module Models
    class ConferenceParticipantSpeakEnded < Telnyx::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceParticipantSpeakEnded::EventType, nil]
      optional :event_type, enum: -> { Telnyx::ConferenceParticipantSpeakEnded::EventType }

      # @!attribute payload
      #
      #   @return [Telnyx::Models::ConferenceParticipantSpeakEnded::Payload, nil]
      optional :payload, -> { Telnyx::ConferenceParticipantSpeakEnded::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::ConferenceParticipantSpeakEnded::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::ConferenceParticipantSpeakEnded::RecordType }

      # @!method initialize(id: nil, event_type: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::ConferenceParticipantSpeakEnded::EventType] The type of event being delivered.
      #
      #   @param payload [Telnyx::Models::ConferenceParticipantSpeakEnded::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::ConferenceParticipantSpeakEnded::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::ConferenceParticipantSpeakEnded#event_type
      module EventType
      ...
      # @see Telnyx::Models::ConferenceParticipantSpeakEnded#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::ConferenceParticipantSpeakEnded::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::ConferenceParticipantSpeakEnded#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
