...
module Telnyx
  module Models
    class ConferenceCreated < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceCreated::EventType, nil]
      optional :event_type, enum: -> { Telnyx::ConferenceCreated::EventType }

      # @!attribute payload
      #
      #   @return [Telnyx::Models::ConferenceCreated::Payload, nil]
      optional :payload, -> { Telnyx::ConferenceCreated::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::ConferenceCreated::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::ConferenceCreated::RecordType }

      # @!method initialize(id: nil, event_type: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::ConferenceCreated::EventType] The type of event being delivered.
      #
      #   @param payload [Telnyx::Models::ConferenceCreated::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::ConferenceCreated::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::ConferenceCreated#event_type
      module EventType
      ...
      # @see Telnyx::Models::ConferenceCreated#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::ConferenceCreated::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::ConferenceCreated#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
