...
module Telnyx
  module Models
    class Comment < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::Comment::CommentRecordType, nil]
      ...
      response_only do
        ...
        #
        #   @return [Symbol, Telnyx::Models::Comment::CommenterType, nil]
        optional :commenter_type, enum: -> { Telnyx::Comment::CommenterType }
      ...
      #
      #   @param commenter_type [Symbol, Telnyx::Models::Comment::CommenterType]
      #
      ...
      # @see Telnyx::Models::Comment#comment_record_type
      ...
      # @see Telnyx::Models::Comment#commenter_type
