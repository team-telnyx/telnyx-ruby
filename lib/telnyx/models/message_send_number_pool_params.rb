...
module Telnyx
  module Models
    ...
    class MessageSendNumberPoolParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::MessageSendNumberPoolParams::Encoding, nil]
      optional :encoding, enum: -> { Telnyx::MessageSendNumberPoolParams::Encoding }
      ...
      #
      #   @return [Symbol, Telnyx::Models::MessageSendNumberPoolParams::Type, nil]
      optional :type, enum: -> { Telnyx::MessageSendNumberPoolParams::Type }
      ...
      # @!method initialize(messaging_profile_id:, to:, auto_detect: nil, encoding: nil, media_urls: nil, subject: nil, text: nil, type: nil, use_profile_webhooks: nil, webhook_failover_url: nil, webhook_url: nil, request_options: {})
