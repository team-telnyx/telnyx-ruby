...
module Telnyx
  module Models
    ...
    class MessageSendNumberPoolParams < Telnyx::Internal::Type::BaseModel
      ...
      # @!method initialize(messaging_profile_id:, to:, auto_detect: nil, media_urls: nil, subject: nil, text: nil, type: nil, use_profile_webhooks: nil, webhook_failover_url: nil, webhook_url: nil, request_options: {})
