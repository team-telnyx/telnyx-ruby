...
module Telnyx
  module Models
    # @see Telnyx::Resources::DialogflowConnections#create
    class DialogflowConnectionResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::DialogflowConnectionResponse::Data]
      required :data, -> { Telnyx::DialogflowConnectionResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::DialogflowConnectionResponse::Data]

      # @see Telnyx::Models::DialogflowConnectionResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::DialogflowConnectionResponse::Data} for more details.
        #
