...
module Telnyx
  module Models
    class FaxFailed < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::FaxFailed::Data, nil]
      optional :data, -> { Telnyx::FaxFailed::Data }

      # @!attribute meta
      #   Metadata about the webhook delivery.
      #
      #   @return [Telnyx::Models::FaxFailed::Meta, nil]
      optional :meta, -> { Telnyx::FaxFailed::Meta }

      # @!method initialize(data: nil, meta: nil)
      #   @param data [Telnyx::Models::FaxFailed::Data]
      #
      #   @param meta [Telnyx::Models::FaxFailed::Meta] Metadata about the webhook delivery.

      # @see Telnyx::Models::FaxFailed#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::FaxFailed::Data::EventType, nil]
        optional :event_type, enum: -> { Telnyx::FaxFailed::Data::EventType }
        ...
        # @!attribute payload
        #
        #   @return [Telnyx::Models::FaxFailed::Data::Payload, nil]
        optional :payload, -> { Telnyx::FaxFailed::Data::Payload }

        # @!attribute record_type
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::FaxFailed::Data::RecordType, nil]
        optional :record_type, enum: -> { Telnyx::FaxFailed::Data::RecordType }

        # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
        #   @param id [String] Identifies the type of resource.
        #
        #   @param event_type [Symbol, Telnyx::Models::FaxFailed::Data::EventType] The type of event being delivered.
        #
        #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
        #
        #   @param payload [Telnyx::Models::FaxFailed::Data::Payload]
        #
        #   @param record_type [Symbol, Telnyx::Models::FaxFailed::Data::RecordType] Identifies the type of the resource.

        # The type of event being delivered.
        #
        # @see Telnyx::Models::FaxFailed::Data#event_type
        module EventType
        ...
        # @see Telnyx::Models::FaxFailed::Data#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::FaxFailed::Data::Payload::Direction, nil]
          ...
          #
          #   @return [Symbol, Telnyx::Models::FaxFailed::Data::Payload::Status, nil]
          optional :status, enum: -> { Telnyx::FaxFailed::Data::Payload::Status }
          ...
          #
          #   @param status [Symbol, Telnyx::Models::FaxFailed::Data::Payload::Status] The status of the fax.
          #
          ...
          # The direction of the fax.
          #
          # @see Telnyx::Models::FaxFailed::Data::Payload#direction
          module Direction
            extend Telnyx::Internal::Type::Enum
          ...
          # The status of the fax.
          #
          # @see Telnyx::Models::FaxFailed::Data::Payload#status
          module Status
            extend Telnyx::Internal::Type::Enum
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::FaxFailed::Data#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
      ...
      # @see Telnyx::Models::FaxFailed#meta
