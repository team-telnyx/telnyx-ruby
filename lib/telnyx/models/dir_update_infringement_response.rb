...
module Telnyx
  module Models
    ...
    class DirUpdateInfringementResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::DirUpdateInfringementResponse::Data]
      required :data, -> { Telnyx::Models::DirUpdateInfringementResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::DirUpdateInfringementResponse::Data]

      # @see Telnyx::Models::DirUpdateInfringementResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Telnyx::Models::DirUpdateInfringementResponse::Data::CallReason>, nil]
        optional :call_reasons,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirUpdateInfringementResponse::Data::CallReason] }
        ...
        # @!attribute documents
        #
        #   @return [Array<Telnyx::Models::DirUpdateInfringementResponse::Data::Document>, nil]
        optional :documents,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirUpdateInfringementResponse::Data::Document] },
                 nil?: true
        ...
        #   approval.
        #
        #   @return [Array<Telnyx::Models::DirUpdateInfringementResponse::Data::RejectionReason>, nil]
        optional :rejection_reasons,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DirUpdateInfringementResponse::Data::RejectionReason] },
                 nil?: true
        ...
        #
        #   @return [Symbol, Telnyx::Models::DirUpdateInfringementResponse::Data::Status, nil]
        optional :status, enum: -> { Telnyx::Models::DirUpdateInfringementResponse::Data::Status }
        ...
        #   {Telnyx::Models::DirUpdateInfringementResponse::Data} for more details.
        #
        #   @param id [String]
        #
        ...
        #
        #   @param call_reasons [Array<Telnyx::Models::DirUpdateInfringementResponse::Data::CallReason>]
        #
        ...
        #
        #   @param documents [Array<Telnyx::Models::DirUpdateInfringementResponse::Data::Document>, nil]
        #
        ...
        #
        #   @param rejection_reasons [Array<Telnyx::Models::DirUpdateInfringementResponse::Data::RejectionReason>, nil] Populated when `status` is `rejected`; cleared on `/submit` or successful approv
        #
        #   @param reselling [Boolean]
        #
        #   @param status [Symbol, Telnyx::Models::DirUpdateInfringementResponse::Data::Status] DIR lifecycle status.
        #
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::DirUpdateInfringementResponse::Data::Document::DocumentType]
          required :document_type,
                   enum: -> { Telnyx::Models::DirUpdateInfringementResponse::Data::Document::DocumentType }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::DirUpdateInfringementResponse::Data::Document} for more
          #   details.
          #
          #   @param document_id [String] Id returned by the Telnyx Documents API after you upload the file (upload via `P
          #
          #   @param document_type [Symbol, Telnyx::Models::DirUpdateInfringementResponse::Data::Document::DocumentType] Type of supporting document. Pick the closest match to what the file actually co
          #
          ...
          # short_name reference list is at `GET /v2/dir/document_types`.
          #
          # @see Telnyx::Models::DirUpdateInfringementResponse::Data::Document#document_type
          module DocumentType
        ...
        class RejectionReason < Telnyx::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::DirUpdateInfringementResponse::Data::RejectionReason} for more
          #   details.
          #
          #   @param code [String]
          #
        ...
        # - `permanently_rejected` — terminal; cannot be resubmitted.
        #
        # @see Telnyx::Models::DirUpdateInfringementResponse::Data#status
        module Status
          extend Telnyx::Internal::Type::Enum
