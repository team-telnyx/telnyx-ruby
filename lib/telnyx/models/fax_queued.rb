...
module Telnyx
  module Models
    class FaxQueued < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::FaxQueued::Data, nil]
      optional :data, -> { Telnyx::FaxQueued::Data }

      # @!attribute meta
      #   Metadata about the webhook delivery.
      #
      #   @return [Telnyx::Models::FaxQueued::Meta, nil]
      optional :meta, -> { Telnyx::FaxQueued::Meta }

      # @!method initialize(data: nil, meta: nil)
      #   @param data [Telnyx::Models::FaxQueued::Data]
      #
      #   @param meta [Telnyx::Models::FaxQueued::Meta] Metadata about the webhook delivery.

      # @see Telnyx::Models::FaxQueued#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::FaxQueued::Data::EventType, nil]
        optional :event_type, enum: -> { Telnyx::FaxQueued::Data::EventType }
        ...
        # @!attribute payload
        #
        #   @return [Telnyx::Models::FaxQueued::Data::Payload, nil]
        optional :payload, -> { Telnyx::FaxQueued::Data::Payload }

        # @!attribute record_type
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::FaxQueued::Data::RecordType, nil]
        optional :record_type, enum: -> { Telnyx::FaxQueued::Data::RecordType }

        # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
        #   @param id [String] Identifies the type of resource.
        #
        #   @param event_type [Symbol, Telnyx::Models::FaxQueued::Data::EventType] The type of event being delivered.
        #
        #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
        #
        #   @param payload [Telnyx::Models::FaxQueued::Data::Payload]
        #
        #   @param record_type [Symbol, Telnyx::Models::FaxQueued::Data::RecordType] Identifies the type of the resource.

        # The type of event being delivered.
        #
        # @see Telnyx::Models::FaxQueued::Data#event_type
        module EventType
        ...
        # @see Telnyx::Models::FaxQueued::Data#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::FaxQueued::Data::Payload::Direction, nil]
          optional :direction, enum: -> { Telnyx::FaxQueued::Data::Payload::Direction }
          ...
          #
          #   @return [Symbol, Telnyx::Models::FaxQueued::Data::Payload::Status, nil]
          optional :status, enum: -> { Telnyx::FaxQueued::Data::Payload::Status }
          ...
          #   {Telnyx::Models::FaxQueued::Data::Payload} for more details.
          #
          ...
          #
          #   @param direction [Symbol, Telnyx::Models::FaxQueued::Data::Payload::Direction] The direction of the fax.
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::FaxQueued::Data::Payload::Status] The status of the fax.
          #
          ...
          # The direction of the fax.
          #
          # @see Telnyx::Models::FaxQueued::Data::Payload#direction
          module Direction
            extend Telnyx::Internal::Type::Enum
          ...
          # The status of the fax.
          #
          # @see Telnyx::Models::FaxQueued::Data::Payload#status
          module Status
            extend Telnyx::Internal::Type::Enum
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::FaxQueued::Data#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
      ...
      # @see Telnyx::Models::FaxQueued#meta
