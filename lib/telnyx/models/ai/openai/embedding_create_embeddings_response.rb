...
module Telnyx
  module Models
    module AI
      module OpenAI
        # @see Telnyx::Resources::AI::OpenAI::Embeddings#create_embeddings
        class EmbeddingCreateEmbeddingsResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #   List of embedding objects
          #
          #   @return [Array<Telnyx::Models::AI::OpenAI::EmbeddingCreateEmbeddingsResponse::Data>]
          required :data,
                   -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::AI::OpenAI::EmbeddingCreateEmbeddingsResponse::Data] }
          ...
          # @!attribute usage
          #
          #   @return [Telnyx::Models::AI::OpenAI::EmbeddingCreateEmbeddingsResponse::Usage]
          required :usage, -> { Telnyx::Models::AI::OpenAI::EmbeddingCreateEmbeddingsResponse::Usage }

          # @!method initialize(data:, model:, object:, usage:)
          #   @param data [Array<Telnyx::Models::AI::OpenAI::EmbeddingCreateEmbeddingsResponse::Data>] List of embedding objects
          #
          #   @param model [String] The model used for embedding
          #
          #   @param object [String] The object type, always 'list'
          #
          #   @param usage [Telnyx::Models::AI::OpenAI::EmbeddingCreateEmbeddingsResponse::Usage]
          ...
          # @see Telnyx::Models::AI::OpenAI::EmbeddingCreateEmbeddingsResponse#usage
