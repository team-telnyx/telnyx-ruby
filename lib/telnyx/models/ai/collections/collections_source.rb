...
module Telnyx
  module Models
    module AI
      module Collections
        class CollectionsSource < Telnyx::Internal::Type::BaseModel
          # @!attribute id
          #
          #   @return [String, nil]
          optional :id, String
          ...
          #   {Telnyx::Models::AI::Collections::CollectionsSource} for more details.
          #
          #   @param id [String]
          #
      ...
      CollectionsSource = Collections::CollectionsSource
    end
  end
end
