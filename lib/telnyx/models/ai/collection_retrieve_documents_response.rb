  ...
  module Models
    module AI
      ...
      class CollectionRetrieveDocumentsResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Data>, nil]
        optional :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Data] }

        # @!attribute meta
        #
        #   @return [Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Meta, nil]
        optional :meta, -> { Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Meta }

        # @!method initialize(data: nil, meta: nil)
        #   @param data [Array<Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Data>]
        #   @param meta [Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Meta]
        ...
        # @see Telnyx::Models::AI::CollectionRetrieveDocumentsResponse#meta
