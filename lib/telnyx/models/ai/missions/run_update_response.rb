  ...
  module Models
    module AI
      module Missions
        ...
        class RunUpdateResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::AI::Missions::RunUpdateResponse::Data]
          required :data, -> { Telnyx::Models::AI::Missions::RunUpdateResponse::Data }

          # @!method initialize(data:)
          #   @param data [Telnyx::Models::AI::Missions::RunUpdateResponse::Data]

          # @see Telnyx::Models::AI::Missions::RunUpdateResponse#data
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, Telnyx::Models::AI::Missions::RunUpdateResponse::Data::Status]
            required :status, enum: -> { Telnyx::Models::AI::Missions::RunUpdateResponse::Data::Status }
            ...
            #   @param status [Symbol, Telnyx::Models::AI::Missions::RunUpdateResponse::Data::Status]
            ...
            # @see Telnyx::Models::AI::Missions::RunUpdateResponse::Data#status
            module Status
