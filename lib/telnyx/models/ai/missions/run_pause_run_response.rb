...
module Telnyx
  module Models
    module AI
      module Missions
        # @see Telnyx::Resources::AI::Missions::Runs#pause_run
        class RunPauseRunResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::AI::Missions::RunPauseRunResponse::Data]
          required :data, -> { Telnyx::Models::AI::Missions::RunPauseRunResponse::Data }

          # @!method initialize(data:)
          #   @param data [Telnyx::Models::AI::Missions::RunPauseRunResponse::Data]

          # @see Telnyx::Models::AI::Missions::RunPauseRunResponse#data
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, Telnyx::Models::AI::Missions::RunPauseRunResponse::Data::Status]
            required :status, enum: -> { Telnyx::Models::AI::Missions::RunPauseRunResponse::Data::Status }
            ...
            #   @param status [Symbol, Telnyx::Models::AI::Missions::RunPauseRunResponse::Data::Status]
            ...
            # @see Telnyx::Models::AI::Missions::RunPauseRunResponse::Data#status
            module Status
