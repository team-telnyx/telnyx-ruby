    ...
    module AI
      module Missions
        ...
        class RunListRunsResponse < Telnyx::Internal::Type::BaseModel
          ...
          # @!attribute status
          #
          #   @return [Symbol, Telnyx::Models::AI::Missions::RunListRunsResponse::Status]
          required :status, enum: -> { Telnyx::Models::AI::Missions::RunListRunsResponse::Status }
          ...
          #   @param status [Symbol, Telnyx::Models::AI::Missions::RunListRunsResponse::Status]
          ...
          # @see Telnyx::Models::AI::Missions::RunListRunsResponse#status
          module Status
