      ...
      module Missions
        module Runs
          ...
          class EventListResponse < Telnyx::Internal::Type::BaseModel
            ...
            # @!attribute type
            #
            #   @return [Symbol, Telnyx::Models::AI::Missions::Runs::EventListResponse::Type]
            required :type, enum: -> { Telnyx::Models::AI::Missions::Runs::EventListResponse::Type }
            ...
            #   @param type [Symbol, Telnyx::Models::AI::Missions::Runs::EventListResponse::Type]
            #   @param agent_id [String]
            #   @param idempotency_key [String]
            #   @param payload [Hash{Symbol=>Object}]
            #   @param step_id [String]

            # @see Telnyx::Models::AI::Missions::Runs::EventListResponse#type
            module Type
