    ...
    module AI
      module Missions
        ...
        class RunResumeRunResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::AI::Missions::RunResumeRunResponse::Data]
          required :data, -> { Telnyx::Models::AI::Missions::RunResumeRunResponse::Data }

          # @!method initialize(data:)
          #   @param data [Telnyx::Models::AI::Missions::RunResumeRunResponse::Data]

          # @see Telnyx::Models::AI::Missions::RunResumeRunResponse#data
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, Telnyx::Models::AI::Missions::RunResumeRunResponse::Data::Status]
            required :status, enum: -> { Telnyx::Models::AI::Missions::RunResumeRunResponse::Data::Status }
            ...
            #   @param status [Symbol, Telnyx::Models::AI::Missions::RunResumeRunResponse::Data::Status]
            ...
            # @see Telnyx::Models::AI::Missions::RunResumeRunResponse::Data#status
            module Status
