  ...
  module Models
    module AI
      module Missions
        ...
        class RunRetrieveResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::AI::Missions::RunRetrieveResponse::Data]
          required :data, -> { Telnyx::Models::AI::Missions::RunRetrieveResponse::Data }

          # @!method initialize(data:)
          #   @param data [Telnyx::Models::AI::Missions::RunRetrieveResponse::Data]

          # @see Telnyx::Models::AI::Missions::RunRetrieveResponse#data
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, Telnyx::Models::AI::Missions::RunRetrieveResponse::Data::Status]
            required :status, enum: -> { Telnyx::Models::AI::Missions::RunRetrieveResponse::Data::Status }
            ...
            #   @param status [Symbol, Telnyx::Models::AI::Missions::RunRetrieveResponse::Data::Status]
            ...
            # @see Telnyx::Models::AI::Missions::RunRetrieveResponse::Data#status
            module Status
