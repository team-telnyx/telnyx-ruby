    ...
    module AI
      module Missions
        ...
        class RunCreateResponse < Telnyx::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [Telnyx::Models::AI::Missions::RunCreateResponse::Data]
          required :data, -> { Telnyx::Models::AI::Missions::RunCreateResponse::Data }

          # @!method initialize(data:)
          #   @param data [Telnyx::Models::AI::Missions::RunCreateResponse::Data]

          # @see Telnyx::Models::AI::Missions::RunCreateResponse#data
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            # @!attribute status
            #
            #   @return [Symbol, Telnyx::Models::AI::Missions::RunCreateResponse::Data::Status]
            required :status, enum: -> { Telnyx::Models::AI::Missions::RunCreateResponse::Data::Status }
            ...
            #   @param status [Symbol, Telnyx::Models::AI::Missions::RunCreateResponse::Data::Status]
            ...
            # @see Telnyx::Models::AI::Missions::RunCreateResponse::Data#status
            module Status
