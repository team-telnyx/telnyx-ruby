      ...
      class FlowEdge < Telnyx::Internal::Type::BaseModel
        ...
        module Condition
          ...
          class Llm < Telnyx::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Telnyx::Models::AI::FlowEdge::Condition::Llm} for more details.
            #
            ...
            #
            #   @param prompt [String] Natural-language criterion the model routes on. On calls this is offered to the
            #
