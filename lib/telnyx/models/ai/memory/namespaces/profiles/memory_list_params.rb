        ...
        module Namespaces
          module Profiles
            ...
            class MemoryListParams < Telnyx::Internal::Type::BaseModel
              ...
              # @!method initialize(namespace:, profile_id:, page_number: nil, page_size: nil, session_id: nil, source_id: nil, request_options: {})
              ...
              #
              #   @param source_id [String, nil] Narrows the listing to the memories extracted from one source, a remembered fact
              #
