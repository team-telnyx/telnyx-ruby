  ...
  module Models
    module AI
      class SpeakNode < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::AI::SpeakNode::Type, nil]
        optional :type, enum: -> { Telnyx::AI::SpeakNode::Type }

        # @!method initialize(id:, message:, name: nil, position: nil, type: nil)
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::AI::SpeakNode} for more details.
        #
        ...
        #
        #   @param type [Symbol, Telnyx::Models::AI::SpeakNode::Type] Node kind discriminator. Always `speak` for a speak node.

        # Node kind discriminator. Always `speak` for a speak node.
        #
        # @see Telnyx::Models::AI::SpeakNode#type
        module Type
