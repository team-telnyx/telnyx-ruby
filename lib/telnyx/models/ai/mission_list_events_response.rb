  ...
  module Models
    module AI
      ...
      class MissionListEventsResponse < Telnyx::Internal::Type::BaseModel
        ...
        # @!attribute type
        #
        #   @return [Symbol, Telnyx::Models::AI::MissionListEventsResponse::Type]
        required :type, enum: -> { Telnyx::Models::AI::MissionListEventsResponse::Type }
        ...
        #   @param type [Symbol, Telnyx::Models::AI::MissionListEventsResponse::Type]
        #   @param agent_id [String]
        #   @param idempotency_key [String]
        #   @param payload [Hash{Symbol=>Object}]
        #   @param step_id [String]

        # @see Telnyx::Models::AI::MissionListEventsResponse#type
        module Type
