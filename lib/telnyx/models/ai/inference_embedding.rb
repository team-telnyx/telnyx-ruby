        ...
        class ConversationFlow < Telnyx::Internal::Type::BaseModel
          ...
          module Node
            ...
            class Prompt < Telnyx::Internal::Type::BaseModel
              ...
              #
              #   @return [Telnyx::Models::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm, nil]
              optional :external_llm, -> { Telnyx::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm }
              ...
              #
              #   @param external_llm [Telnyx::Models::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm] Override for `Assistant.external_llm` while this node is active. Use this to rou
              #
              ...
              # @see Telnyx::Models::AI::InferenceEmbedding::ConversationFlow::Node::Prompt#external_llm
              class ExternalLlm < Telnyx::Internal::Type::BaseModel
                ...
                #
                #   @return [Symbol, Telnyx::Models::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm::AuthenticationMethod, nil]
                optional :authentication_method,
                         enum: -> { Telnyx::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm::AuthenticationMethod }
                ...
                #   Some parameter documentations has been truncated, see
                #   {Telnyx::Models::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm}
                #   for more details.
                #
                #   Override for `Assistant.external_llm` while this node is active. Use this to
                #   route a node's turns to a different external LLM (different `model`, `base_url`,
                ...
                #
                #   @param authentication_method [Symbol, Telnyx::Models::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm::AuthenticationMethod] Authentication method used when connecting to the external LLM endpoint.
                #
                ...
                # Authentication method used when connecting to the external LLM endpoint.
                #
                # @see Telnyx::Models::AI::InferenceEmbedding::ConversationFlow::Node::Prompt::ExternalLlm#authentication_method
