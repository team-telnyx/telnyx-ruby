...
module Telnyx
  module Models
    class SimCardGroup < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::SimCardGroup::DataLimit, nil]
      optional :data_limit, -> { Telnyx::SimCardGroup::DataLimit }
      ...
      # @!method initialize(id: nil, consumed_data: nil, created_at: nil, data_limit: nil, default: nil, name: nil, private_wireless_gateway_id: nil, record_type: nil, updated_at: nil, wireless_blocklist_id: nil)
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::SimCardGroup} for more details.
      #
      ...
      #
      #   @param data_limit [Telnyx::Models::SimCardGroup::DataLimit] Upper limit on the amount of data the SIM cards, within the group, can use.
      #
      ...
      # @see Telnyx::Models::SimCardGroup#data_limit
