...
module Telnyx
  module Models
    # @see Telnyx::Resources::Connections#list
    class ConnectionListParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::ConnectionListParams::Filter, nil]
      optional :filter, -> { Telnyx::ConnectionListParams::Filter }

      # @!attribute page
      #   Consolidated page parameter (deepObject style). Originally: page[size],
      #   page[number]
      #
      #   @return [Telnyx::Models::ConnectionListParams::Page, nil]
      optional :page, -> { Telnyx::ConnectionListParams::Page }
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConnectionListParams::Sort, nil]
      optional :sort, enum: -> { Telnyx::ConnectionListParams::Sort }
      ...
      class Filter < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::ConnectionListParams::Filter::ConnectionName, nil]
        optional :connection_name, -> { Telnyx::ConnectionListParams::Filter::ConnectionName }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::ConnectionListParams::Filter} for more details.
        #
        #   Consolidated filter parameter (deepObject style). Originally:
        #   filter[connection_name], filter[fqdn], filter[outbound_voice_profile_id],
        #   filter[outbound.outbound_voice_profile_id]
        #
        #   @param connection_name [Telnyx::Models::ConnectionListParams::Filter::ConnectionName] Filter by connection_name using nested operations
        #
        ...
        # @see Telnyx::Models::ConnectionListParams::Filter#connection_name
        class ConnectionName < Telnyx::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::ConnectionListParams::Filter::ConnectionName} for more details.
          #
          #   Filter by connection_name using nested operations
          #
