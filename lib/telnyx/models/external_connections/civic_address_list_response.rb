  ...
  module Models
    module ExternalConnections
      ...
      class CivicAddressListResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::ExternalConnections::CivicAddressListResponse::Data>, nil]
        optional :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::ExternalConnections::CivicAddressListResponse::Data] }

        # @!method initialize(data: nil)
        #   @param data [Array<Telnyx::Models::ExternalConnections::CivicAddressListResponse::Data>]
