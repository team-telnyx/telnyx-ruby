  ...
  module Models
    module ExternalConnections
      ...
      class Release < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::ExternalConnections::Release::Status, nil]
        optional :status, enum: -> { Telnyx::ExternalConnections::Release::Status }
        ...
        #
        #   @param status [Symbol, Telnyx::Models::ExternalConnections::Release::Status] Represents the status of the release on Microsoft Teams.
        #
        ...
        # Represents the status of the release on Microsoft Teams.
        #
        # @see Telnyx::Models::ExternalConnections::Release#status
        module Status
