  ...
  module Models
    module ExternalConnections
      ...
      class ReleaseListResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::ExternalConnections::ReleaseListResponse::Status, nil]
        optional :status, enum: -> { Telnyx::Models::ExternalConnections::ReleaseListResponse::Status }
        ...
        # Represents the status of the release on Microsoft Teams.
        #
        # @see Telnyx::Models::ExternalConnections::ReleaseListResponse#status
        module Status
