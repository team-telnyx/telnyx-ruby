  ...
  module Models
    module ExternalConnections
      ...
      class LogMessage < Telnyx::Internal::Type::BaseModel
        ...
        # @!attribute meta
        #
        #   @return [Telnyx::Models::ExternalConnections::LogMessage::Meta, nil]
        optional :meta, -> { Telnyx::ExternalConnections::LogMessage::Meta }

        # @!attribute source
        #
        #   @return [Telnyx::Models::ExternalConnections::LogMessage::Source, nil]
        optional :source, -> { Telnyx::ExternalConnections::LogMessage::Source }

        # @!method initialize(code:, title:, detail: nil, meta: nil, source: nil)
        #   @param code [String]
        #   @param title [String]
        #   @param detail [String]
        #   @param meta [Telnyx::Models::ExternalConnections::LogMessage::Meta]
        #   @param source [Telnyx::Models::ExternalConnections::LogMessage::Source]

        # @see Telnyx::Models::ExternalConnections::LogMessage#meta
        ...
        # @see Telnyx::Models::ExternalConnections::LogMessage#source
