...
module Telnyx
  module Models
    ...
    class RoomRecordingListResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<Telnyx::Models::RoomRecordingListResponse::Data>, nil]
      optional :data, -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::RoomRecordingListResponse::Data] }
      ...
      #   @param data [Array<Telnyx::Models::RoomRecordingListResponse::Data>]
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::RoomRecordingListResponse::Data::Status, nil]
        optional :status, enum: -> { Telnyx::Models::RoomRecordingListResponse::Data::Status }

        # @!attribute type
        #   Shows the room recording type.
        #
        #   @return [Symbol, Telnyx::Models::RoomRecordingListResponse::Data::Type, nil]
        optional :type, enum: -> { Telnyx::Models::RoomRecordingListResponse::Data::Type }
        ...
        #
        #   @param status [Symbol, Telnyx::Models::RoomRecordingListResponse::Data::Status] Shows the room recording status.
        #
        #   @param type [Symbol, Telnyx::Models::RoomRecordingListResponse::Data::Type] Shows the room recording type.
        #
        #   @param updated_at [Time] ISO 8601 timestamp when the room recording was updated.

        # Shows the room recording status.
        #
        # @see Telnyx::Models::RoomRecordingListResponse::Data#status
        module Status
        ...
        # Shows the room recording type.
        #
        # @see Telnyx::Models::RoomRecordingListResponse::Data#type
        module Type
          extend Telnyx::Internal::Type::Enum
