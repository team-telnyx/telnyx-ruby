...
module Telnyx
  module Models
    class TelnyxDownstreamCampaign < Telnyx::Internal::Type::BaseModel
      ...
      #   Campaign status
      #
      #   @return [Symbol, Telnyx::Models::TelnyxDownstreamCampaign::CampaignStatus, nil]
      optional :campaign_status,
               enum: -> { Telnyx::TelnyxDownstreamCampaign::CampaignStatus },
      ...
      #
      #   @return [Boolean, nil]
      optional :is_number_pooling_enabled, Telnyx::Internal::Type::Boolean, api_name: :isNumberPoolingEnabled
      ...
      #   {Telnyx::Models::TelnyxDownstreamCampaign} for more details.
      #
      ...
      #
      #   @param campaign_status [Symbol, Telnyx::Models::TelnyxDownstreamCampaign::CampaignStatus] Campaign status
      #
      ...
      # Campaign status
      #
      # @see Telnyx::Models::TelnyxDownstreamCampaign#campaign_status
