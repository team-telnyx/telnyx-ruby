  ...
  module Models
    module Calls
      ...
      class ActionGatherParams < Telnyx::Internal::Type::BaseModel
        ...
        # @!method initialize(call_control_id:, client_state: nil, command_id: nil, gather_id: nil, initial_timeout_millis: nil, inter_digit_timeout_millis: nil, maximum_digits: nil, minimum_digits: nil, terminating_digit: nil, timeout_millis: nil, valid_digits: nil, request_options: {})
