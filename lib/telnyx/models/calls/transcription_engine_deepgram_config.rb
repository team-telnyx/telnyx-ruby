    ...
    module Calls
      module TranscriptionEngineDeepgramConfig
        ...
        class DeepgramNova2 < Telnyx::Internal::Type::BaseModel
          ...
          # @!method initialize(transcription_engine:, interim_results: nil, keywords_boosting: nil, language: nil, utterance_end_ms: nil, transcription_model: :"deepgram/nova-2")
        ...
        class DeepgramNova3 < Telnyx::Internal::Type::BaseModel
          ...
          # @!method initialize(transcription_engine:, interim_results: nil, keywords_boosting: nil, language: nil, utterance_end_ms: nil, transcription_model: :"deepgram/nova-3")
          #   Some parameter documentations has been truncated, see
