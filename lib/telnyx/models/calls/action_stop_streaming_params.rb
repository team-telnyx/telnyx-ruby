...
module Telnyx
  module Models
    module Calls
      # @see Telnyx::Resources::Calls::Actions#stop_streaming
      class ActionStopStreamingParams < Telnyx::Internal::Type::BaseModel
        ...
        # @!method initialize(call_control_id:, client_state: nil, command_id: nil, stream_id: nil, request_options: {})
