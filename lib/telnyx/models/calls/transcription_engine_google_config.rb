  ...
  module Models
    module Calls
      class TranscriptionEngineGoogleConfig < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Calls::TranscriptionEngineGoogleConfig::Model, nil]
        optional :model, enum: -> { Telnyx::Calls::TranscriptionEngineGoogleConfig::Model }
        ...
        #
        #   @return [Array<Telnyx::Models::Calls::TranscriptionEngineGoogleConfig::SpeechContext>, nil]
        optional :speech_context,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Calls::TranscriptionEngineGoogleConfig::SpeechContext] }

        # @!attribute transcription_engine
        #   Engine identifier for Google transcription service
        #
        #   @return [Symbol, Telnyx::Models::Calls::TranscriptionEngineGoogleConfig::TranscriptionEngine, nil]
        optional :transcription_engine,
                 enum: -> { Telnyx::Calls::TranscriptionEngineGoogleConfig::TranscriptionEngine }
        ...
        #   {Telnyx::Models::Calls::TranscriptionEngineGoogleConfig} for more details.
        #
        ...
        #
        #   @param model [Symbol, Telnyx::Models::Calls::TranscriptionEngineGoogleConfig::Model] The model to use for transcription.
        #
        #   @param profanity_filter [Boolean] Enables profanity_filter.
        #
        #   @param speech_context [Array<Telnyx::Models::Calls::TranscriptionEngineGoogleConfig::SpeechContext>] Speech context to improve transcription accuracy.
        #
        #   @param transcription_engine [Symbol, Telnyx::Models::Calls::TranscriptionEngineGoogleConfig::TranscriptionEngine] Engine identifier for Google transcription service
        #
        #   @param use_enhanced [Boolean] Enables enhanced transcription, this works for models `phone_call` and `video`.

        # The model to use for transcription.
        #
        # @see Telnyx::Models::Calls::TranscriptionEngineGoogleConfig#model
        module Model
        ...
        # Engine identifier for Google transcription service
        #
        # @see Telnyx::Models::Calls::TranscriptionEngineGoogleConfig#transcription_engine
