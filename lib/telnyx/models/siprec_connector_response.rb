...
module Telnyx
  module Models
    ...
    class SiprecConnectorResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::SiprecConnectorResponse::Data]
      required :data, -> { Telnyx::SiprecConnectorResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::SiprecConnectorResponse::Data]

      # @see Telnyx::Models::SiprecConnectorResponse#data
