...
module Telnyx
  module Models
    ...
    class DocumentLinkListResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<Telnyx::Models::DocumentLinkListResponse::Data>, nil]
      optional :data, -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::DocumentLinkListResponse::Data] }
      ...
      #   @param data [Array<Telnyx::Models::DocumentLinkListResponse::Data>]
