...
module Telnyx
  module Models
    ...
    class NumbersPhoneNumberDetailed < Telnyx::Internal::Type::BaseModel
      ...
      #   enabled/disabled.
      #
      #   @return [Symbol, Telnyx::Models::NumbersPhoneNumberDetailed::EmergencyStatus, nil]
      optional :emergency_status, enum: -> { Telnyx::NumbersPhoneNumberDetailed::EmergencyStatus }
      ...
      response_only do
        ...
        #
        #   @return [Symbol, Telnyx::Models::NumbersPhoneNumberDetailed::PhoneNumberType]
        required :phone_number_type, enum: -> { Telnyx::NumbersPhoneNumberDetailed::PhoneNumberType }
        ...
        #
        #   @return [Symbol, Telnyx::Models::NumbersPhoneNumberDetailed::Status]
        required :status, enum: -> { Telnyx::NumbersPhoneNumberDetailed::Status }
        ...
        #
        #   @return [Symbol, Telnyx::Models::NumbersPhoneNumberDetailed::SourceType, nil]
        optional :source_type, enum: -> { Telnyx::NumbersPhoneNumberDetailed::SourceType }, nil?: true
      ...
      #
      #   @param phone_number_type [Symbol, Telnyx::Models::NumbersPhoneNumberDetailed::PhoneNumberType] The phone number's type.
      #
      #   @param purchased_at [String] ISO 8601 formatted date indicating when the resource was purchased.
      #
      #   @param record_type [String] Identifies the type of the resource.
      #
      #   @param status [Symbol, Telnyx::Models::NumbersPhoneNumberDetailed::Status] The phone number's current status.
      #
      ...
      #
      #   @param emergency_status [Symbol, Telnyx::Models::NumbersPhoneNumberDetailed::EmergencyStatus] Indicates the status of the provisioning of emergency services for the phone num
      #
      ...
      # values `tollfree`, `shortcode` or `longcode` may be returned instead.
      #
      # @see Telnyx::Models::NumbersPhoneNumberDetailed#phone_number_type
      ...
      # The phone number's current status.
      #
      # @see Telnyx::Models::NumbersPhoneNumberDetailed#status
      module Status
        extend Telnyx::Internal::Type::Enum
      ...
      # enabled/disabled.
      #
      # @see Telnyx::Models::NumbersPhoneNumberDetailed#emergency_status
      ...
      # feature has an additional per-number monthly cost associated with it.
      #
      # @see Telnyx::Models::NumbersPhoneNumberDetailed#inbound_call_screening
      ...
      # information may not be available.
      #
      # @see Telnyx::Models::NumbersPhoneNumberDetailed#source_type
      module SourceType
        extend Telnyx::Internal::Type::Enum
