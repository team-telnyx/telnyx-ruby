  ...
  module Models
    module SimCards
      ...
      class ActionBulkEnableVoiceResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data, nil]
        optional :data, -> { Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data }

        # @!method initialize(data: nil)
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse} for more details.
        #
        #   @param data [Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data] This object represents a bulk SIM card action. It groups SIM card actions create

        # @see Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          response_only do
            ...
            #   </ul>
            #
            #   @return [Symbol, Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data::ActionType, nil]
            optional :action_type,
                     enum: -> { Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data::ActionType }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data} for more
          #   details.
          #
          #   This object represents a bulk SIM card action. It groups SIM card actions
          #   created through a bulk endpoint under a single resource for further lookup.
          ...
          #
          #   @param action_type [Symbol, Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data::ActionType] The action type. It can be one of the following: <br/>
          #
          ...
          # </ul>
          #
          # @see Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data#action_type
          module ActionType
