...
module Telnyx
  module Models
    module SimCards
      # @see Telnyx::Resources::SimCards::Actions#set_standby
      class ActionSetStandbyResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        ...
        #   {Telnyx::Models::SimCards::ActionSetStandbyResponse} for more details.
        #
