...
module Telnyx
  module Models
    module SimCards
      # @see Telnyx::Resources::SimCards::Actions#remove_public_ip
      class ActionRemovePublicIPResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        ...
        #   {Telnyx::Models::SimCards::ActionRemovePublicIPResponse} for more details.
        #
