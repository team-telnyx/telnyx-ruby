  ...
  module Models
    module SimCards
      ...
      class WirelessSimCardAction < Telnyx::Internal::Type::BaseModel
        # @!attribute status
        #
        #   @return [Telnyx::Models::SimCards::WirelessSimCardAction::Status, nil]
        optional :status, -> { Telnyx::SimCards::WirelessSimCardAction::Status }
        ...
        response_only do
          ...
          optional :action_type, enum: -> { Telnyx::SimCards::WirelessSimCardAction::ActionType }
        ...
        #   {Telnyx::Models::SimCards::WirelessSimCardAction} for more details.
        #
        ...
        #
        #   @param action_type [Symbol, Telnyx::Models::SimCards::WirelessSimCardAction::ActionType] The operation type. It can be one of the following: <br/>
        #
        ...
        #
        #   @param status [Telnyx::Models::SimCards::WirelessSimCardAction::Status]
        #
        ...
        # @see Telnyx::Models::SimCards::WirelessSimCardAction#status
        class Status < Telnyx::Internal::Type::BaseModel
          response_only do
            ...
            #
            #   @return [Symbol, Telnyx::Models::SimCards::WirelessSimCardAction::Status::Value, nil]
            optional :value, enum: -> { Telnyx::SimCards::WirelessSimCardAction::Status::Value }
          end

          # @!method initialize(reason: nil, value: nil)
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::SimCards::WirelessSimCardAction::Status} for more details.
          #
          #   @param reason [String] It describes why the SIM card action is in the current status. This will be <cod
          #
          #   @param value [Symbol, Telnyx::Models::SimCards::WirelessSimCardAction::Status::Value] The current status of the SIM card action.

          # The current status of the SIM card action.
          #
          # @see Telnyx::Models::SimCards::WirelessSimCardAction::Status#value
          module Value
            extend Telnyx::Internal::Type::Enum
