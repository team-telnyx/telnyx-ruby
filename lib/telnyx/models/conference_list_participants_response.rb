...
module Telnyx
  module Models
    ...
    class ConferenceListParticipantsResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::ConferenceListParticipantsResponse::Conference]
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceListParticipantsResponse::RecordType]
      ...
      #   conference
      #
      #   @return [Symbol, Telnyx::Models::ConferenceListParticipantsResponse::Status]
      ...
      #   {Telnyx::Models::ConferenceListParticipantsResponse} for more details.
      #
      ...
      #
      #   @param conference [Telnyx::Models::ConferenceListParticipantsResponse::Conference] Info about the conference that the participant is in
      #
      ...
      #
      #   @param record_type [Symbol, Telnyx::Models::ConferenceListParticipantsResponse::RecordType]
      #
      #   @param soft_end_conference_on_exit [Boolean] Whether the conference will end after the participant leaves the conference.
      #
      #   @param status [Symbol, Telnyx::Models::ConferenceListParticipantsResponse::Status] The status of the participant with respect to the lifecycle within the conferenc
      #
      ...
      # @see Telnyx::Models::ConferenceListParticipantsResponse#conference
      ...
      # @see Telnyx::Models::ConferenceListParticipantsResponse#record_type
      module RecordType
      ...
      # conference
      #
      # @see Telnyx::Models::ConferenceListParticipantsResponse#status
      module Status
        extend Telnyx::Internal::Type::Enum
