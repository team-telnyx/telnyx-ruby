...
module Telnyx
  module Models
    ...
    class RequirementRetrieveResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::RequirementRetrieveResponse::Data, nil]
      optional :data, -> { Telnyx::Models::RequirementRetrieveResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::RequirementRetrieveResponse::Data]

      # @see Telnyx::Models::RequirementRetrieveResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        # @!attribute action
        #   Indicates whether this requirement applies to branded_calling, ordering,
        #   porting, or both ordering and porting
        #
        #   @return [Symbol, Telnyx::Models::RequirementRetrieveResponse::Data::Action, nil]
        ...
        #
        #   @return [Symbol, Telnyx::Models::RequirementRetrieveResponse::Data::PhoneNumberType, nil]
        ...
        #   {Telnyx::Models::RequirementRetrieveResponse::Data} for more details.
        #
        #   @param id [String] Identifies the associated document
        #
        #   @param action [Symbol, Telnyx::Models::RequirementRetrieveResponse::Data::Action] Indicates whether this requirement applies to branded_calling, ordering, porting
        #
        ...
        #
        #   @param phone_number_type [Symbol, Telnyx::Models::RequirementRetrieveResponse::Data::PhoneNumberType] Indicates the phone_number_type this requirement applies to. Leave blank if this
        #
        ...
        # porting, or both ordering and porting
        #
        # @see Telnyx::Models::RequirementRetrieveResponse::Data#action
        module Action
        ...
        # requirement applies to all number_types.
        #
        # @see Telnyx::Models::RequirementRetrieveResponse::Data#phone_number_type
