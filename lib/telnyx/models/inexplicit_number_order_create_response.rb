...
module Telnyx
  module Models
    ...
    class InexplicitNumberOrderCreateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::InexplicitNumberOrderCreateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::InexplicitNumberOrderCreateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::InexplicitNumberOrderCreateResponse::Data]

      # @see Telnyx::Models::InexplicitNumberOrderCreateResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup>, nil]
        optional :ordering_groups,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup] }
        ...
        #
        #   @param ordering_groups [Array<Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup>]
        #
        ...
        class OrderingGroup < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Order>, nil]
          optional :orders,
                   -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Order] }
          ...
          #
          #   @return [Symbol, Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Status, nil]
          optional :status,
                   enum: -> { Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Status }

          # @!attribute strategy
          #   Ordering strategy used
          #
          #   @return [Symbol, Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Strategy, nil]
          optional :strategy,
                   enum: -> { Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Strategy }
          ...
          #
          #   @param strategy [Symbol, Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Strategy] Ordering strategy used
          #
          ...
          # Status of the ordering group
          #
          # @see Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup#status
          module Status
          ...
          # Ordering strategy used
          #
          # @see Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup#strategy
          module Strategy
            extend Telnyx::Internal::Type::Enum
