...
module Telnyx
  module Models
    class CallInitiatedWebhookEvent < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::CallInitiatedWebhookEvent::Data, nil]
      optional :data, -> { Telnyx::CallInitiatedWebhookEvent::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::CallInitiatedWebhookEvent::Data]

      # @see Telnyx::Models::CallInitiatedWebhookEvent#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::EventType, nil]
        optional :event_type, enum: -> { Telnyx::CallInitiatedWebhookEvent::Data::EventType }
        ...
        # @!attribute payload
        #
        #   @return [Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload, nil]
        optional :payload, -> { Telnyx::CallInitiatedWebhookEvent::Data::Payload }

        # @!attribute record_type
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::RecordType, nil]
        optional :record_type, enum: -> { Telnyx::CallInitiatedWebhookEvent::Data::RecordType }

        # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
        #   @param id [String] Identifies the type of resource.
        #
        #   @param event_type [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::EventType] The type of event being delivered.
        #
        #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
        #
        #   @param payload [Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload]
        #
        #   @param record_type [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::RecordType] Identifies the type of the resource.

        # The type of event being delivered.
        #
        # @see Telnyx::Models::CallInitiatedWebhookEvent::Data#event_type
        module EventType
        ...
        # @see Telnyx::Models::CallInitiatedWebhookEvent::Data#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload::Direction, nil]
          optional :direction, enum: -> { Telnyx::CallInitiatedWebhookEvent::Data::Payload::Direction }
          ...
          #   State received from a command.
          #
          #   @return [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload::State, nil]
          optional :state, enum: -> { Telnyx::CallInitiatedWebhookEvent::Data::Payload::State }
          ...
          #   {Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload} for more details.
          #
          ...
          #
          #   @param direction [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload::Direction] Whether the call is `incoming` or `outgoing`.
          #
          ...
          #
          #   @param state [Symbol, Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload::State] State received from a command.
          #
          ...
          # Whether the call is `incoming` or `outgoing`.
          #
          # @see Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload#direction
          module Direction
            extend Telnyx::Internal::Type::Enum
          ...
          # State received from a command.
          #
          # @see Telnyx::Models::CallInitiatedWebhookEvent::Data::Payload#state
          module State
            extend Telnyx::Internal::Type::Enum
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::CallInitiatedWebhookEvent::Data#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
