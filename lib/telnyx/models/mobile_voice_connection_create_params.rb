...
module Telnyx
  module Models
    ...
    class MobileVoiceConnectionCreateParams < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute inbound
      #
      #   @return [Telnyx::Models::MobileVoiceConnectionCreateParams::Inbound, nil]
      optional :inbound, -> { Telnyx::MobileVoiceConnectionCreateParams::Inbound }

      # @!attribute outbound
      #
      #   @return [Telnyx::Models::MobileVoiceConnectionCreateParams::Outbound, nil]
      ...
      #
      #   @return [Symbol, Telnyx::Models::MobileVoiceConnectionCreateParams::WebhookAPIVersion, nil]
