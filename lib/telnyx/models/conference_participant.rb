...
module Telnyx
  module Models
    class ConferenceParticipant < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceParticipant::Status, nil]
      ...
      #
      #   @param status [Symbol, Telnyx::Models::ConferenceParticipant::Status] Status of the participant.
      #
      ...
      # Status of the participant.
      #
      # @see Telnyx::Models::ConferenceParticipant#status
      module Status
