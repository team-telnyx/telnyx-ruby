...
module Telnyx
  module Models
    class CallStreamingStopped < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallStreamingStopped::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallStreamingStopped::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallStreamingStopped::Payload, nil]
      optional :payload, -> { Telnyx::CallStreamingStopped::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallStreamingStopped::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallStreamingStopped::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallStreamingStopped::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallStreamingStopped::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallStreamingStopped::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallStreamingStopped#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallStreamingStopped#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::CallStreamingStopped::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallStreamingStopped#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
