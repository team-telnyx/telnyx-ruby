  ...
  module Models
    module Pricing
      ...
      class ProductRetrieveResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::Pricing::ProductRetrieveResponse::Data>]
        required :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Pricing::ProductRetrieveResponse::Data] }

        # @!attribute meta
        #
        #   @return [Telnyx::Models::Pricing::PricingPaginationMeta]
        required :meta, -> { Telnyx::Pricing::PricingPaginationMeta }

        # @!method initialize(data:, meta:)
        #   @param data [Array<Telnyx::Models::Pricing::ProductRetrieveResponse::Data>]
        #   @param meta [Telnyx::Models::Pricing::PricingPaginationMeta]
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          optional :rate, union: -> { Telnyx::Models::Pricing::ProductRetrieveResponse::Data::Rate }, nil?: true
          ...
          #   {Telnyx::Models::Pricing::ProductRetrieveResponse::Data} for more details.
          #
          ...
          # Null for rate-deck products.
          #
          # @see Telnyx::Models::Pricing::ProductRetrieveResponse::Data#rate
          module Rate
