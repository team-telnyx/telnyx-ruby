...
module Telnyx
  module Models
    class CallPlaybackEnded < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallPlaybackEnded::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallPlaybackEnded::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallPlaybackEnded::Payload, nil]
      optional :payload, -> { Telnyx::CallPlaybackEnded::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallPlaybackEnded::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallPlaybackEnded::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallPlaybackEnded::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallPlaybackEnded::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallPlaybackEnded::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallPlaybackEnded#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallPlaybackEnded#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::CallPlaybackEnded::Payload::Status, nil]
        optional :status, enum: -> { Telnyx::CallPlaybackEnded::Payload::Status }
        ...
        #   {Telnyx::Models::CallPlaybackEnded::Payload} for more details.
        #
        ...
        #
        #   @param status [Symbol, Telnyx::Models::CallPlaybackEnded::Payload::Status] Reflects how command ended.
        #
        #   @param status_detail [String] Provides details in case of failure.

        # Reflects how command ended.
        #
        # @see Telnyx::Models::CallPlaybackEnded::Payload#status
        module Status
          extend Telnyx::Internal::Type::Enum
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallPlaybackEnded#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
