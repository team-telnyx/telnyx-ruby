...
module Telnyx
  module Models
    ...
    class CallDialParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Telnyx::Models::ConversationRelayEmbeddedConfig, nil]
      optional :conversation_relay_config, -> { Telnyx::ConversationRelayEmbeddedConfig }
