...
module Telnyx
  module Models
    class CallHangupWebhookEvent < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::CallHangupWebhookEvent::Data, nil]
      optional :data, -> { Telnyx::CallHangupWebhookEvent::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::CallHangupWebhookEvent::Data]

      # @see Telnyx::Models::CallHangupWebhookEvent#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::EventType, nil]
        optional :event_type, enum: -> { Telnyx::CallHangupWebhookEvent::Data::EventType }
        ...
        # @!attribute payload
        #
        #   @return [Telnyx::Models::CallHangupWebhookEvent::Data::Payload, nil]
        optional :payload, -> { Telnyx::CallHangupWebhookEvent::Data::Payload }

        # @!attribute record_type
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::RecordType, nil]
        optional :record_type, enum: -> { Telnyx::CallHangupWebhookEvent::Data::RecordType }

        # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
        #   @param id [String] Identifies the type of resource.
        #
        #   @param event_type [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::EventType] The type of event being delivered.
        #
        #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
        #
        #   @param payload [Telnyx::Models::CallHangupWebhookEvent::Data::Payload]
        #
        #   @param record_type [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::RecordType] Identifies the type of the resource.

        # The type of event being delivered.
        #
        # @see Telnyx::Models::CallHangupWebhookEvent::Data#event_type
        module EventType
        ...
        # @see Telnyx::Models::CallHangupWebhookEvent::Data#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats, nil]
          ...
          #
          #   @return [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::Payload::HangupSource, nil]
          ...
          #   State received from a command.
          #
          #   @return [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::Payload::State, nil]
          ...
          #   {Telnyx::Models::CallHangupWebhookEvent::Data::Payload} for more details.
          #
          ...
          #
          #   @param call_quality_stats [Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats, nil] Call quality statistics aggregated from the CHANNEL_HANGUP_COMPLETE event. Only
          #
          ...
          #
          #   @param hangup_cause [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::Payload::HangupCause] The reason the call was ended (`call_rejected`, `normal_clearing`, `originator_c
          #
          #   @param hangup_source [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::Payload::HangupSource] The party who ended the call (`callee`, `caller`, `unknown`).
          #
          ...
          #
          #   @param state [Symbol, Telnyx::Models::CallHangupWebhookEvent::Data::Payload::State] State received from a command.
          #
          #   @param tags [Array<String>] Array of tags associated to number.
          #
          #   @param to [String] Destination number or SIP URI of the call.

          # @see Telnyx::Models::CallHangupWebhookEvent::Data::Payload#call_quality_stats
          class CallQualityStats < Telnyx::Internal::Type::BaseModel
            # @!attribute inbound
            #   Inbound call quality statistics.
            #
            #   @return [Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats::Inbound, nil]
            optional :inbound, -> { Telnyx::CallHangupWebhookEvent::Data::Payload::CallQualityStats::Inbound }

            # @!attribute outbound
            #   Outbound call quality statistics.
            #
            #   @return [Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats::Outbound, nil]
            optional :outbound, -> { Telnyx::CallHangupWebhookEvent::Data::Payload::CallQualityStats::Outbound }
            ...
            #   metrics are available.
            #
            #   @param inbound [Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats::Inbound] Inbound call quality statistics.
            #
            #   @param outbound [Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats::Outbound] Outbound call quality statistics.

            # @see Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats#inbound
            ...
            # @see Telnyx::Models::CallHangupWebhookEvent::Data::Payload::CallQualityStats#outbound
          ...
          # The party who ended the call (`callee`, `caller`, `unknown`).
          #
          # @see Telnyx::Models::CallHangupWebhookEvent::Data::Payload#hangup_source
          module HangupSource
            extend Telnyx::Internal::Type::Enum
          ...
          # State received from a command.
          #
          # @see Telnyx::Models::CallHangupWebhookEvent::Data::Payload#state
          module State
            extend Telnyx::Internal::Type::Enum
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::CallHangupWebhookEvent::Data#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
