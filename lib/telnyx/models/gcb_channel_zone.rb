...
module Telnyx
  module Models
    ...
    class GcbChannelZone < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::GcbChannelZone::RecordType]
      required :record_type, enum: -> { Telnyx::GcbChannelZone::RecordType }
      ...
      #   {Telnyx::Models::GcbChannelZone} for more details.
      #
      #   @param id [String]
      #
      ...
      #   @param name [String]
      #
      #   @param record_type [Symbol, Telnyx::Models::GcbChannelZone::RecordType]
      #
      ...
      # @see Telnyx::Models::GcbChannelZone#record_type
      module RecordType
