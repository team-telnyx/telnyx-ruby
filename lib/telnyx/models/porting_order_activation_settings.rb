  ...
  module Models
    class PortingOrderActivationSettings < Telnyx::Internal::Type::BaseModel
      ...
      optional :activation_status,
               enum: -> { Telnyx::PortingOrderActivationSettings::ActivationStatus },
               nil?: true
      ...
      #   @param activation_status [Symbol, Telnyx::Models::PortingOrderActivationSettings::ActivationStatus, nil] Activation status
      #
