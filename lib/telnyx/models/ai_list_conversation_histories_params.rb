...
module Telnyx
  module Models
    ...
    class AIListConversationHistoriesParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::AIListConversationHistoriesParams::Region, nil]
      optional :region, enum: -> { Telnyx::AIListConversationHistoriesParams::Region }
