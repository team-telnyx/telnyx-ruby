...
module Telnyx
  module Models
    class ConferenceParticipantPlaybackStarted < Telnyx::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStarted::EventType, nil]
      optional :event_type, enum: -> { Telnyx::ConferenceParticipantPlaybackStarted::EventType }

      # @!attribute payload
      #
      #   @return [Telnyx::Models::ConferenceParticipantPlaybackStarted::Payload, nil]
      optional :payload, -> { Telnyx::ConferenceParticipantPlaybackStarted::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStarted::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::ConferenceParticipantPlaybackStarted::RecordType }

      # @!method initialize(id: nil, event_type: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStarted::EventType] The type of event being delivered.
      #
      #   @param payload [Telnyx::Models::ConferenceParticipantPlaybackStarted::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::ConferenceParticipantPlaybackStarted::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::ConferenceParticipantPlaybackStarted#event_type
      module EventType
      ...
      # @see Telnyx::Models::ConferenceParticipantPlaybackStarted#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::ConferenceParticipantPlaybackStarted::Payload} for more
        #   details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::ConferenceParticipantPlaybackStarted#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
