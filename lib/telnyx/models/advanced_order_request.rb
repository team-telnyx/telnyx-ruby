...
module Telnyx
  module Models
    class AdvancedOrderRequest < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute features
      #
      #   @return [Array<Symbol, Telnyx::Models::AdvancedOrderRequest::Feature>, nil]
      optional :features, -> { Telnyx::Internal::Type::ArrayOf[enum: Telnyx::AdvancedOrderRequest::Feature] }

      # @!attribute phone_number_type
      #
      #   @return [Symbol, Telnyx::Models::AdvancedOrderRequest::PhoneNumberType, nil]
      optional :phone_number_type, enum: -> { Telnyx::AdvancedOrderRequest::PhoneNumberType }
      ...
      # @see Telnyx::Models::AdvancedOrderRequest#phone_number_type
