...
module Telnyx
  module Models
    ...
    module DetailRecordListResponse
      ...
      variant -> { Telnyx::Models::DetailRecordListResponse::MessageDetailRecord }

      variant -> { Telnyx::Models::DetailRecordListResponse::ConferenceDetailRecord }

      variant -> { Telnyx::Models::DetailRecordListResponse::ConferenceParticipantDetailRecord }

      variant -> { Telnyx::Models::DetailRecordListResponse::AmdDetailRecord }

      variant -> { Telnyx::Models::DetailRecordListResponse::VerifyDetailRecord }

      variant -> { Telnyx::Models::DetailRecordListResponse::SimCardUsageDetailRecord }

      variant -> { Telnyx::Models::DetailRecordListResponse::MediaStorageDetailRecord }
      ...
      class MessageDetailRecord < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::DetailRecordListResponse::MessageDetailRecord::Direction, nil]
        ...
        #
        #   @return [Symbol, Telnyx::Models::DetailRecordListResponse::MessageDetailRecord::MessageType, nil]
        ...
        #
        #   @return [Symbol, Telnyx::Models::DetailRecordListResponse::MessageDetailRecord::Status, nil]
        ...
        #   {Telnyx::Models::DetailRecordListResponse::MessageDetailRecord} for more
        #   details.
        #
        ...
        #
        #   @param direction [Symbol, Telnyx::Models::DetailRecordListResponse::MessageDetailRecord::Direction] Logical direction of the message from the Telnyx customer's perspective. It's in
        #
        ...
        #
        #   @param message_type [Symbol, Telnyx::Models::DetailRecordListResponse::MessageDetailRecord::MessageType] Describes the Messaging service used to send the message. Available services are
        #
        ...
        #
        #   @param status [Symbol, Telnyx::Models::DetailRecordListResponse::MessageDetailRecord::Status] Final status of the message after the delivery attempt
        #
        ...
        # inbound when the Telnyx customer receives the message, or outbound otherwise
        #
        # @see Telnyx::Models::DetailRecordListResponse::MessageDetailRecord#direction
        module Direction
        ...
        # Communication Services (RCS)
        #
        # @see Telnyx::Models::DetailRecordListResponse::MessageDetailRecord#message_type
        module MessageType
          extend Telnyx::Internal::Type::Enum
        ...
        # Final status of the message after the delivery attempt
        #
        # @see Telnyx::Models::DetailRecordListResponse::MessageDetailRecord#status
        module Status
          extend Telnyx::Internal::Type::Enum
      ...
      class AmdDetailRecord < Telnyx::Internal::Type::BaseModel
        ...
        #   Feature name
        #
        #   @return [Symbol, Telnyx::Models::DetailRecordListResponse::AmdDetailRecord::Feature, nil]
        optional :feature, enum: -> { Telnyx::Models::DetailRecordListResponse::AmdDetailRecord::Feature }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::DetailRecordListResponse::AmdDetailRecord} for more details.
        #
        #   @param record_type [String]
        #
        ...
        #   @param currency [String] Telnyx account currency used to describe monetary values, including billing cost
        #
        #   @param feature [Symbol, Telnyx::Models::DetailRecordListResponse::AmdDetailRecord::Feature] Feature name
        #
        ...
        # Feature name
        #
        # @see Telnyx::Models::DetailRecordListResponse::AmdDetailRecord#feature
        module Feature
          extend Telnyx::Internal::Type::Enum
      ...
      class VerifyDetailRecord < Telnyx::Internal::Type::BaseModel
        ...
        #   ---
        #
        #   @return [Symbol, Telnyx::Models::DetailRecordListResponse::VerifyDetailRecord::VerifyChannelType, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::DetailRecordListResponse::VerifyDetailRecord} for more details.
        #
        #   @param record_type [String]
        #
        ...
        #
        #   @param verify_channel_type [Symbol, Telnyx::Models::DetailRecordListResponse::VerifyDetailRecord::VerifyChannelType] Depending on the type of verification, the `verify_channel_id`
        #
        ...
        # ---
        #
        # @see Telnyx::Models::DetailRecordListResponse::VerifyDetailRecord#verify_channel_type
      ...
      class SimCardUsageDetailRecord < Telnyx::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::DetailRecordListResponse::SimCardUsageDetailRecord} for more
        #   details.
        #
        #   @param record_type [String]
        #
      ...
      class MediaStorageDetailRecord < Telnyx::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::DetailRecordListResponse::MediaStorageDetailRecord} for more
        #   details.
        #
        #   @param record_type [String]
        #
