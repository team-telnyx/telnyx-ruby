...
module Telnyx
  module Models
    ...
    class WebhookDelivery < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::WebhookDelivery::Status, nil]
      optional :status, enum: -> { Telnyx::WebhookDelivery::Status }
      ...
      #
      #   @return [Telnyx::Models::WebhookDelivery::Webhook, nil]
      optional :webhook, -> { Telnyx::WebhookDelivery::Webhook }
      ...
      #   {Telnyx::Models::WebhookDelivery} for more details.
      #
      ...
      #
      #   @param status [Symbol, Telnyx::Models::WebhookDelivery::Status] Delivery status: 'delivered' when successfuly delivered or 'failed' if all attem
      #
      #   @param user_id [String] Uniquely identifies the user that owns the webhook_delivery record.
      #
      #   @param webhook [Telnyx::Models::WebhookDelivery::Webhook] Original webhook JSON data. Payload fields vary according to event type.

      # Delivery status: 'delivered' when successfuly delivered or 'failed' if all
      # attempts have failed.
      #
      # @see Telnyx::Models::WebhookDelivery#status
      module Status
      ...
      # @see Telnyx::Models::WebhookDelivery#webhook
      class Webhook < Telnyx::Internal::Type::BaseModel
        ...
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::WebhookDelivery::Webhook::RecordType, nil]
        ...
        #
        #   @param record_type [Symbol, Telnyx::Models::WebhookDelivery::Webhook::RecordType] Identifies the type of the resource.

        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::WebhookDelivery::Webhook#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
