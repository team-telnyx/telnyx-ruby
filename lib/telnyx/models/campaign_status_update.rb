...
module Telnyx
  module Models
    class CampaignStatusUpdate < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CampaignStatusUpdate::Status, nil]
      optional :status, enum: -> { Telnyx::CampaignStatusUpdate::Status }

      # @!attribute type
      #
      #   @return [Symbol, Telnyx::Models::CampaignStatusUpdate::Type, nil]
      ...
      #
      #   @param status [Symbol, Telnyx::Models::CampaignStatusUpdate::Status] The status of the campaign.
      #
      #   @param type [Symbol, Telnyx::Models::CampaignStatusUpdate::Type]

      # The status of the campaign.
      #
      # @see Telnyx::Models::CampaignStatusUpdate#status
      module Status
      ...
      # @see Telnyx::Models::CampaignStatusUpdate#type
      module Type
        extend Telnyx::Internal::Type::Enum
