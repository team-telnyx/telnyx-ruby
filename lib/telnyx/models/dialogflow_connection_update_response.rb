...
module Telnyx
  module Models
    ...
    class DialogflowConnectionUpdateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::DialogflowConnectionUpdateResponse::Data]
      required :data, -> { Telnyx::Models::DialogflowConnectionUpdateResponse::Data }

      # @!method initialize(data:)
      #   @param data [Telnyx::Models::DialogflowConnectionUpdateResponse::Data]

      # @see Telnyx::Models::DialogflowConnectionUpdateResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::DialogflowConnectionUpdateResponse::Data} for more details.
        #
