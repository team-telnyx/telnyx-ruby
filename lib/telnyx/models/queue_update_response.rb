...
module Telnyx
  module Models
    ...
    class QueueUpdateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::QueueUpdateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::QueueUpdateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::QueueUpdateResponse::Data]
