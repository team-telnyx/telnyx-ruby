  ...
  module Models
    module Porting
      ...
      class LoaConfigurationCreateParams < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::Porting::LoaConfigurationCreateParams::Address]
        required :address, -> { Telnyx::Porting::LoaConfigurationCreateParams::Address }
        ...
        #
        #   @return [Telnyx::Models::Porting::LoaConfigurationCreateParams::Contact]
        required :contact, -> { Telnyx::Porting::LoaConfigurationCreateParams::Contact }

        # @!attribute logo
        #   The logo of the LOA configuration
        #
        #   @return [Telnyx::Models::Porting::LoaConfigurationCreateParams::Logo]
        required :logo, -> { Telnyx::Porting::LoaConfigurationCreateParams::Logo }
