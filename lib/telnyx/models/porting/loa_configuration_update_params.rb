...
module Telnyx
  module Models
    module Porting
      # @see Telnyx::Resources::Porting::LoaConfigurations#update
      class LoaConfigurationUpdateParams < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::Porting::LoaConfigurationUpdateParams::Address]
        required :address, -> { Telnyx::Porting::LoaConfigurationUpdateParams::Address }
        ...
        #
        #   @return [Telnyx::Models::Porting::LoaConfigurationUpdateParams::Contact]
        required :contact, -> { Telnyx::Porting::LoaConfigurationUpdateParams::Contact }

        # @!attribute logo
        #   The logo of the LOA configuration
        #
        #   @return [Telnyx::Models::Porting::LoaConfigurationUpdateParams::Logo]
        required :logo, -> { Telnyx::Porting::LoaConfigurationUpdateParams::Logo }
