...
module Telnyx
  module Models
    ...
    class VoiceDesignCreateParams < Telnyx::Internal::Type::BaseModel
      ...
      # @!method initialize(prompt:, text:, language: nil, max_new_tokens: nil, name: nil, repetition_penalty: nil, temperature: nil, top_k: nil, top_p: nil, voice_design_id: nil, request_options: {})
