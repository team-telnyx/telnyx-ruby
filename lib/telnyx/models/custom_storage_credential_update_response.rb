...
module Telnyx
  module Models
    ...
    class CustomStorageCredentialUpdateResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CustomStorageCredentialUpdateResponse::RecordType]
      required :record_type, enum: -> { Telnyx::Models::CustomStorageCredentialUpdateResponse::RecordType }

      # @!method initialize(connection_id:, data:, record_type:)
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::CustomStorageCredentialUpdateResponse} for more details.
      #
      ...
      #
      #   @param record_type [Symbol, Telnyx::Models::CustomStorageCredentialUpdateResponse::RecordType] Identifies record type.

      # Identifies record type.
      #
      # @see Telnyx::Models::CustomStorageCredentialUpdateResponse#record_type
      module RecordType
