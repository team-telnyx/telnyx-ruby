  ...
  module Models
    module TermsOfService
      ...
      class BrandedCallingAgreeResponse < Telnyx::Internal::Type::BaseModel
        ...
        required :data, -> { Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse::Data }

        # @!method initialize(data:)
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse} for more details.
        #
        #   @param data [Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse::Data] A recorded user agreement to a product's Terms of Service. The `user_id` is inte

        # @see Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          # @!attribute product_type
          #   Telnyx product the Terms of Service apply to.
          #
          #   @return [Symbol, Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse::Data::ProductType, nil]
          optional :product_type,
                   enum: -> { Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse::Data::ProductType }
          ...
          #
          #   @param product_type [Symbol, Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse::Data::ProductType] Telnyx product the Terms of Service apply to.
          #
          ...
          # Telnyx product the Terms of Service apply to.
          #
          # @see Telnyx::Models::TermsOfService::BrandedCallingAgreeResponse::Data#product_type
          module ProductType
