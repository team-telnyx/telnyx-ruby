...
module Telnyx
  module Models
    module TermsOfService
      ...
      class AgreementListResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute product_type
        #   Telnyx product the Terms of Service apply to.
        #
        #   @return [Symbol, Telnyx::Models::TermsOfService::AgreementListResponse::ProductType, nil]
        optional :product_type, enum: -> { Telnyx::Models::TermsOfService::AgreementListResponse::ProductType }
        ...
        #
        #   @param product_type [Symbol, Telnyx::Models::TermsOfService::AgreementListResponse::ProductType] Telnyx product the Terms of Service apply to.
        #
        ...
        # Telnyx product the Terms of Service apply to.
        #
        # @see Telnyx::Models::TermsOfService::AgreementListResponse#product_type
        module ProductType
