...
module Telnyx
  module Models
    ...
    class TrafficPolicyProfileUpdateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::TrafficPolicyProfileUpdateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::TrafficPolicyProfileUpdateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::TrafficPolicyProfileUpdateResponse::Data]
