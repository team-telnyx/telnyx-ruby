...
module Telnyx
  module Models
    module Organizations
      ...
      class OrganizationUser < Telnyx::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Symbol, Telnyx::Models::Organizations::OrganizationUser::UserStatus, nil]
        ...
        #   {Telnyx::Models::Organizations::OrganizationUser} for more details.
        #
        ...
        #
        #   @param user_status [Symbol, Telnyx::Models::Organizations::OrganizationUser::UserStatus] The status of the account.

        # The status of the account.
        #
        # @see Telnyx::Models::Organizations::OrganizationUser#user_status
        module UserStatus
    ...
    OrganizationUser = Organizations::OrganizationUser
  end
end
