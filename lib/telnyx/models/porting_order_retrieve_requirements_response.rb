...
module Telnyx
  module Models
    ...
    class PortingOrderRetrieveRequirementsResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data>, nil]
      optional :data,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data] }
      ...
      #   @param data [Array<Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data>]
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data::FieldType, nil]
        optional :field_type,
                 enum: -> { Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data::FieldType }
        ...
        #
        #   @return [Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data::RequirementType, nil]
        ...
        #   @param field_type [Symbol, Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data::FieldType] Type of value expected on field_value field
        #
        ...
        #
        #   @param requirement_type [Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data::RequirementType] Identifies the requirement type that meets this requirement

        # Type of value expected on field_value field
        #
        # @see Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data#field_type
        module FieldType
        ...
        # @see Telnyx::Models::PortingOrderRetrieveRequirementsResponse::Data#requirement_type
