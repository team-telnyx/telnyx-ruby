...
module Telnyx
  module Models
    ...
    class PhoneNumberCampaignListParams < Telnyx::Internal::Type::BaseModel
      ...
      #   filter[tcr_brand_id]
      #
      #   @return [Telnyx::Models::PhoneNumberCampaignListParams::Filter, nil]
      optional :filter, -> { Telnyx::PhoneNumberCampaignListParams::Filter }
      ...
      #
      #   @return [Symbol, Telnyx::Models::PhoneNumberCampaignListParams::Sort, nil]
      optional :sort, enum: -> { Telnyx::PhoneNumberCampaignListParams::Sort }
