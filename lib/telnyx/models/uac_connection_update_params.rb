  ...
  module Models
    ...
    class UacConnectionUpdateParams < Telnyx::Internal::Type::BaseModel
      ...
      class Inbound < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionUpdateParams::Inbound::SipRegion, nil]
        optional :sip_region, enum: -> { Telnyx::UacConnectionUpdateParams::Inbound::SipRegion }
        ...
        #
        #   @param sip_region [Symbol, Telnyx::Models::UacConnectionUpdateParams::Inbound::SipRegion] Selects which `sip_region` to receive inbound calls from. If null, the default r
        #
        ...
        # region (US) will be used.
        #
        # @see Telnyx::Models::UacConnectionUpdateParams::Inbound#sip_region
        module SipRegion
          extend Telnyx::Internal::Type::Enum
