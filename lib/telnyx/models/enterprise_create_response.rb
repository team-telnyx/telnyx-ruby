...
module Telnyx
  module Models
    ...
    class EnterpriseCreateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::EnterpriseCreateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::EnterpriseCreateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::EnterpriseCreateResponse::Data]
