  ...
  module Models
    ...
    class NumberOrderListResponse < Telnyx::Internal::Type::BaseModel
      ...
      response_only do
        ...
        #
        #   @return [Symbol, Telnyx::Models::NumberOrderListResponse::Status, nil]
        optional :status, enum: -> { Telnyx::Models::NumberOrderListResponse::Status }
      ...
      #
      #   @param status [Symbol, Telnyx::Models::NumberOrderListResponse::Status] The status of the order.
      #
      ...
      # The status of the order.
      #
      # @see Telnyx::Models::NumberOrderListResponse#status
      module Status
