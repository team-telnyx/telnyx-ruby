...
module Telnyx
  module Models
    module MessagingTollfree
      module Verification
        class MessagingTollFreeVerificationTfVerificationRequest < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::MessagingTollfree::Verification::MessagingTollFreeVerificationTfVerificationRequest}
          #   for more details.
          #
