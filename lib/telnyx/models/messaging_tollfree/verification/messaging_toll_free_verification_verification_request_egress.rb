  ...
  module Models
    module MessagingTollfree
      module Verification
        ...
        class MessagingTollFreeVerificationVerificationRequestEgress < Telnyx::Internal::Type::BaseModel
          # @!attribute id
          #
          #   @return [String]
          required :id, String
          ...
          # @!attribute verification_request_id
          #
          #   @return [String]
          ...
          #
          #   @return [Symbol, Telnyx::Models::MessagingTollfree::Verification::MessagingTollFreeVerificationEntityType, nil]
          ...
          #   {Telnyx::Models::MessagingTollfree::Verification::MessagingTollFreeVerificationVerificationRequestEgress}
          #   for more details.
          #
          ...
          #
          #   @param entity_type [Symbol, Telnyx::Models::MessagingTollfree::Verification::MessagingTollFreeVerificationEntityType] Business entity classification
          #
