...
module Telnyx
  module Models
    class CallSiprecStopped < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallSiprecStopped::EventType, nil]
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallSiprecStopped::Payload, nil]
      optional :payload, -> { Telnyx::CallSiprecStopped::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallSiprecStopped::RecordType, nil]
      ...
      #
      #   @param event_type [Symbol, Telnyx::Models::CallSiprecStopped::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallSiprecStopped::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallSiprecStopped::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallSiprecStopped#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallSiprecStopped#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::CallSiprecStopped::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallSiprecStopped#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
