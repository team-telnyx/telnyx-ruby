...
module Telnyx
  module Models
    class CallReferStarted < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallReferStarted::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallReferStarted::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallReferStarted::Payload, nil]
      optional :payload, -> { Telnyx::CallReferStarted::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallReferStarted::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallReferStarted::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallReferStarted::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallReferStarted::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallReferStarted::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallReferStarted#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallReferStarted#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::CallReferStarted::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallReferStarted#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
