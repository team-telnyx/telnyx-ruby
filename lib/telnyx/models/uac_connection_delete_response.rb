...
module Telnyx
  module Models
    ...
    class UacConnectionDeleteResponse < Telnyx::Internal::Type::BaseModel
      ...
      #   registration.
      #
      #   @return [Telnyx::Models::UacConnectionDeleteResponse::Data, nil]
      optional :data, -> { Telnyx::Models::UacConnectionDeleteResponse::Data }

      # @!method initialize(data: nil)
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::UacConnectionDeleteResponse} for more details.
      #
      #   @param data [Telnyx::Models::UacConnectionDeleteResponse::Data] A UAC (User Agent Client) Connection registers Telnyx to your PBX — the opposite

      # @see Telnyx::Models::UacConnectionDeleteResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Authentication, nil]
        optional :authentication, enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Authentication }
        ...
        #
        #   @return [Telnyx::Models::UacConnectionDeleteResponse::Data::ExternalUacSettings, nil]
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::FqdnOutboundAuthentication, nil]
        optional :fqdn_outbound_authentication,
                 enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::FqdnOutboundAuthentication }
        ...
        # @!attribute inbound
        #
        #   @return [Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound, nil]
        optional :inbound, -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound }

        # @!attribute internal_uac_settings
        #   Internal Telnyx-side settings for a UAC connection.
        #
        #   @return [Telnyx::Models::UacConnectionDeleteResponse::Data::InternalUacSettings, nil]
        optional :internal_uac_settings,
                 -> { Telnyx::Models::UacConnectionDeleteResponse::Data::InternalUacSettings }
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::NoiseSuppression, nil]
        optional :noise_suppression,
                 enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::NoiseSuppression }
        ...
        # @!attribute outbound
        #
        #   @return [Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound, nil]
        optional :outbound, -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound }
        ...
        #   account (internal).
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::SipUriCallingPreference, nil]
        optional :sip_uri_calling_preference,
                 enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::SipUriCallingPreference }
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::WebhookAPIVersion, nil]
        optional :webhook_api_version,
                 enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::WebhookAPIVersion }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::UacConnectionDeleteResponse::Data} for more details.
        #
        #   A UAC (User Agent Client) Connection registers Telnyx to your PBX — the opposite
        #   of a standard SIP trunk, where the PBX registers to Telnyx. Use UAC when your
        #   PBX doesn’t support outbound SIP registration or you need Telnyx to maintain the
        ...
        #
        #   @param authentication [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Authentication] The authentication strategy used by this connection.
        #
        ...
        #
        #   @param external_uac_settings [Telnyx::Models::UacConnectionDeleteResponse::Data::ExternalUacSettings] External SIP peer settings used by Telnyx when registering to your PBX and routi
        #
        #   @param fqdn [String] The Telnyx-managed FQDN generated for the UAC connection.
        #
        #   @param fqdn_outbound_authentication [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::FqdnOutboundAuthentication] The fixed outbound authentication mode used by UAC FQDN records.
        #
        #   @param fqdns [Array<Telnyx::Models::Fqdn>] FQDN records managed automatically by the UAC connection lifecycle.
        #
        #   @param inbound [Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound]
        #
        #   @param internal_uac_settings [Telnyx::Models::UacConnectionDeleteResponse::Data::InternalUacSettings] Internal Telnyx-side settings for a UAC connection.
        #
        ...
        #
        #   @param noise_suppression [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::NoiseSuppression] Controls when noise suppression is applied to calls. When set to 'inbound', nois
        #
        ...
        #
        #   @param outbound [Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound]
        #
        ...
        #
        #   @param sip_uri_calling_preference [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::SipUriCallingPreference] This feature enables inbound SIP URI calls to your Credential Auth Connection. I
        #
        ...
        #
        #   @param webhook_api_version [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::WebhookAPIVersion] Determines which webhook format will be used, Telnyx API v1 or v2.
        #
        ...
        # The authentication strategy used by this connection.
        #
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#authentication
        ...
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#external_uac_settings
        class ExternalUacSettings < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::ExternalUacSettings::Transport, nil]
          optional :transport,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::ExternalUacSettings::Transport },
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionDeleteResponse::Data::ExternalUacSettings} for
          #   more details.
          #
          #   External SIP peer settings used by Telnyx when registering to your PBX and
          #   routing outbound calls.
          ...
          #
          #   @param transport [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::ExternalUacSettings::Transport, nil] The transport protocol used for SIP signaling when communicating with the extern
          #
          ...
          # external SIP peer. One of UDP, TLS, or TCP.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::ExternalUacSettings#transport
          module Transport
            extend Telnyx::Internal::Type::Enum
        ...
        # The fixed outbound authentication mode used by UAC FQDN records.
        #
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#fqdn_outbound_authentication
        ...
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#inbound
        class Inbound < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::AniNumberFormat, nil]
          optional :ani_number_format,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::AniNumberFormat }
          ...
          #   are not allowed.
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::DefaultRoutingMethod, nil]
          optional :default_routing_method,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::DefaultRoutingMethod }

          # @!attribute dnis_number_format
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::DnisNumberFormat, nil]
          optional :dnis_number_format,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::DnisNumberFormat }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SimultaneousRinging, nil]
          optional :simultaneous_ringing,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SimultaneousRinging }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SipRegion, nil]
          optional :sip_region, enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SipRegion }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SipSubdomainReceiveSettings, nil]
          optional :sip_subdomain_receive_settings,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SipSubdomainReceiveSettings }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound} for more details.
          #
          #   @param ani_number_format [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::AniNumberFormat] This setting allows you to set the format with which the caller's number (ANI) i
          #
          ...
          #
          #   @param default_routing_method [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::DefaultRoutingMethod] Default routing method to be used when a number is associated with the connectio
          #
          #   @param dnis_number_format [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::DnisNumberFormat]
          #
          ...
          #
          #   @param simultaneous_ringing [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SimultaneousRinging] When enabled, allows multiple devices to ring simultaneously on incoming calls.
          #
          #   @param sip_compact_headers_enabled [Boolean] Defaults to true.
          #
          #   @param sip_region [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SipRegion] Selects which `sip_region` to receive inbound calls from. If null, the default r
          #
          #   @param sip_subdomain [String] The Telnyx-generated SIP subdomain for this UAC connection.
          #
          #   @param sip_subdomain_receive_settings [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound::SipSubdomainReceiveSettings] Controls which SIP URI callers may reach this connection.
          #
          ...
          # is sent for inbound phone calls.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound#ani_number_format
          ...
          # are not allowed.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound#default_routing_method
          ...
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound#dnis_number_format
          ...
          # When enabled, allows multiple devices to ring simultaneously on incoming calls.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound#simultaneous_ringing
          ...
          # region (US) will be used.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound#sip_region
          module SipRegion
            extend Telnyx::Internal::Type::Enum
          ...
          # Controls which SIP URI callers may reach this connection.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Inbound#sip_subdomain_receive_settings
        ...
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#internal_uac_settings
        class InternalUacSettings < Telnyx::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionDeleteResponse::Data::InternalUacSettings} for
          #   more details.
          #
          #   Internal Telnyx-side settings for a UAC connection.
          #
        ...
        # When set to 'disabled', noise suppression is turned off.
        #
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#noise_suppression
        ...
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#outbound
        class Outbound < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound::AniOverrideType, nil]
          optional :ani_override_type,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound::AniOverrideType }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound::T38ReinviteSource, nil]
          optional :t38_reinvite_source,
                   enum: -> { Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound::T38ReinviteSource }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound} for more details.
          #
          #   @param ani_override [String] Set a phone number as the ani_override value to override caller id number on out
          #
          #   @param ani_override_type [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound::AniOverrideType] Specifies when we apply your ani_override setting. Only applies when ani_overrid
          #
          ...
          #
          #   @param t38_reinvite_source [Symbol, Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound::T38ReinviteSource] This setting only affects connections with Fax-type Outbound Voice Profiles. The

          # Specifies when we apply your ani_override setting. Only applies when
          # ani_override is not blank.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound#ani_override_type
          ...
          # expected to send the t.38 reinvite.
          #
          # @see Telnyx::Models::UacConnectionDeleteResponse::Data::Outbound#t38_reinvite_source
        ...
        # account (internal).
        #
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#sip_uri_calling_preference
        ...
        # Determines which webhook format will be used, Telnyx API v1 or v2.
        #
        # @see Telnyx::Models::UacConnectionDeleteResponse::Data#webhook_api_version
