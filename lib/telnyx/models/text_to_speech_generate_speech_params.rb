...
module Telnyx
  module Models
    ...
    class TextToSpeechGenerateSpeechParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::TextToSpeechGenerateSpeechParams::AudioFormat, nil]
      optional :audio_format, enum: -> { Telnyx::TextToSpeechGenerateSpeechParams::AudioFormat }
