...
module Telnyx
  module Models
    class PortingOrderPhoneNumberConfiguration < Telnyx::Internal::Type::BaseModel
      ...
      #   @param billing_group_id [String, nil] identifies the billing group to set on the numbers when ported
      #
      #   @param connection_id [String, nil] identifies the connection to set on the numbers when ported
      #
      #   @param emergency_address_id [String, nil] identifies the emergency address to set on the numbers when ported
      #
      #   @param messaging_profile_id [String, nil] identifies the messaging profile to set on the numbers when ported
      #
