...
module Telnyx
  module Models
    # @see Telnyx::Resources::CallControlApplications#update
    class CallControlApplicationUpdateParams < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallControlApplicationUpdateParams::DtmfType, nil]
      optional :dtmf_type, enum: -> { Telnyx::CallControlApplicationUpdateParams::DtmfType }
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallControlApplicationUpdateParams::WebhookAPIVersion, nil]
      optional :webhook_api_version, enum: -> { Telnyx::CallControlApplicationUpdateParams::WebhookAPIVersion }
