...
module Telnyx
  module Models
    class TelnyxBrand < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::TelnyxBrand::BrandRelationship]
      required :brand_relationship,
               enum: -> { Telnyx::TelnyxBrand::BrandRelationship },
      ...
      #
      #   @return [Telnyx::Models::TelnyxBrand::OptionalAttributes, nil]
      ...
      #   Status of the brand
      #
      #   @return [Symbol, Telnyx::Models::TelnyxBrand::Status, nil]
      optional :status, enum: -> { Telnyx::TelnyxBrand::Status }
      ...
      #   {Telnyx::Models::TelnyxBrand} for more details.
      #
      #   Telnyx-specific extensions to The Campaign Registry's `Brand` type
      #
      #   @param brand_relationship [Symbol, Telnyx::Models::TelnyxBrand::BrandRelationship] Brand relationship to the CSP.
      #
      ...
      #
      #   @param optional_attributes [Telnyx::Models::TelnyxBrand::OptionalAttributes]
      #
      ...
      #
      #   @param status [Symbol, Telnyx::Models::TelnyxBrand::Status] Status of the brand
      #
      ...
      # Brand relationship to the CSP.
      #
      # @see Telnyx::Models::TelnyxBrand#brand_relationship
      ...
      # @see Telnyx::Models::TelnyxBrand#optional_attributes
      ...
      # Status of the brand
      #
      # @see Telnyx::Models::TelnyxBrand#status
      module Status
        extend Telnyx::Internal::Type::Enum
