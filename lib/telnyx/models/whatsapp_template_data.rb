...
module Telnyx
  module Models
    class WhatsappTemplateData < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute category
      #
      #   @return [Symbol, Telnyx::Models::WhatsappTemplateData::Category, nil]
      ...
      #
      #   @return [Telnyx::Models::WhatsappTemplateData::WhatsappBusinessAccount, nil]
      ...
      #
      #   @param whatsapp_business_account [Telnyx::Models::WhatsappTemplateData::WhatsappBusinessAccount]

      # @see Telnyx::Models::WhatsappTemplateData#category
      module Category
      ...
      # @see Telnyx::Models::WhatsappTemplateData#whatsapp_business_account
