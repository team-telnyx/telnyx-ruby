...
module Telnyx
  module Models
    ...
    class ManagedAccountListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::ManagedAccountListResponse::RecordType]
      ...
      #   {Telnyx::Models::ManagedAccountListResponse} for more details.
      #
      ...
      #
      #   @param record_type [Symbol, Telnyx::Models::ManagedAccountListResponse::RecordType] Identifies the type of the resource.
      #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::ManagedAccountListResponse#record_type
      module RecordType
