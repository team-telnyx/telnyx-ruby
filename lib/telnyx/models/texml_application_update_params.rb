...
module Telnyx
  module Models
    ...
    class TexmlApplicationUpdateParams < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute inbound
      #
      #   @return [Telnyx::Models::TexmlApplicationUpdateParams::Inbound, nil]
      optional :inbound, -> { Telnyx::TexmlApplicationUpdateParams::Inbound }

      # @!attribute outbound
      #
      #   @return [Telnyx::Models::TexmlApplicationUpdateParams::Outbound, nil]
      optional :outbound, -> { Telnyx::TexmlApplicationUpdateParams::Outbound }
      ...
      #
      #   @return [Symbol, Telnyx::Models::TexmlApplicationUpdateParams::StatusCallbackMethod, nil]
      optional :status_callback_method, enum: -> { Telnyx::TexmlApplicationUpdateParams::StatusCallbackMethod }
      ...
      class Inbound < Telnyx::Internal::Type::BaseModel
        ...
        #   same Telnyx user).
        #
        #   @return [Symbol, Telnyx::Models::TexmlApplicationUpdateParams::Inbound::SipSubdomainReceiveSettings, nil]
        optional :sip_subdomain_receive_settings,
                 enum: -> { Telnyx::TexmlApplicationUpdateParams::Inbound::SipSubdomainReceiveSettings }

        # @!method initialize(channel_limit: nil, shaken_stir_enabled: nil, sip_subdomain: nil, sip_subdomain_receive_settings: nil)
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::TexmlApplicationUpdateParams::Inbound} for more details.
        #
        ...
        #
        #   @param sip_subdomain_receive_settings [Symbol, Telnyx::Models::TexmlApplicationUpdateParams::Inbound::SipSubdomainReceiveSettings] This option can be enabled to receive calls from: "Anyone" (any SIP endpoint in

        # This option can be enabled to receive calls from: "Anyone" (any SIP endpoint in
        # the public Internet) or "Only my connections" (any connection assigned to the
        # same Telnyx user).
        #
        # @see Telnyx::Models::TexmlApplicationUpdateParams::Inbound#sip_subdomain_receive_settings
      ...
      class Outbound < Telnyx::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::TexmlApplicationUpdateParams::Outbound} for more details.
        #
