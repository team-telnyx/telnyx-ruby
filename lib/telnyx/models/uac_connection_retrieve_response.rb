...
module Telnyx
  module Models
    # @see Telnyx::Resources::UacConnections#retrieve
    class UacConnectionRetrieveResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      ...
      #   registration.
      #
      #   @return [Telnyx::Models::UacConnectionRetrieveResponse::Data, nil]
      optional :data, -> { Telnyx::Models::UacConnectionRetrieveResponse::Data }

      # @!method initialize(data: nil)
      #   Some parameter documentations has been truncated, see
      #   {Telnyx::Models::UacConnectionRetrieveResponse} for more details.
      #
      #   @param data [Telnyx::Models::UacConnectionRetrieveResponse::Data] A UAC (User Agent Client) Connection registers Telnyx to your PBX — the opposite

      # @see Telnyx::Models::UacConnectionRetrieveResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Authentication, nil]
        optional :authentication, enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Authentication }
        ...
        #
        #   @return [Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings, nil]
        optional :external_uac_settings,
                 -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings }
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::FqdnOutboundAuthentication, nil]
        optional :fqdn_outbound_authentication,
                 enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::FqdnOutboundAuthentication }
        ...
        # @!attribute inbound
        #
        #   @return [Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound, nil]
        optional :inbound, -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound }

        # @!attribute internal_uac_settings
        #   Internal Telnyx-side settings for a UAC connection.
        #
        #   @return [Telnyx::Models::UacConnectionRetrieveResponse::Data::InternalUacSettings, nil]
        optional :internal_uac_settings,
                 -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::InternalUacSettings }
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::NoiseSuppression, nil]
        optional :noise_suppression,
                 enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::NoiseSuppression }
        ...
        # @!attribute outbound
        #
        #   @return [Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound, nil]
        optional :outbound, -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound }
        ...
        #   account (internal).
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::SipUriCallingPreference, nil]
        optional :sip_uri_calling_preference,
                 enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::SipUriCallingPreference }
        ...
        #
        #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::WebhookAPIVersion, nil]
        optional :webhook_api_version,
                 enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::WebhookAPIVersion }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::UacConnectionRetrieveResponse::Data} for more details.
        #
        #   A UAC (User Agent Client) Connection registers Telnyx to your PBX — the opposite
        #   of a standard SIP trunk, where the PBX registers to Telnyx. Use UAC when your
        #   PBX doesn’t support outbound SIP registration or you need Telnyx to maintain the
        ...
        #
        #   @param authentication [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Authentication] The authentication strategy used by this connection.
        #
        ...
        #
        #   @param external_uac_settings [Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings] External SIP peer settings used by Telnyx when registering to your PBX and routi
        #
        #   @param fqdn [String] The Telnyx-managed FQDN generated for the UAC connection.
        #
        #   @param fqdn_outbound_authentication [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::FqdnOutboundAuthentication] The fixed outbound authentication mode used by UAC FQDN records.
        #
        #   @param fqdns [Array<Telnyx::Models::Fqdn>] FQDN records managed automatically by the UAC connection lifecycle.
        #
        #   @param inbound [Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound]
        #
        #   @param internal_uac_settings [Telnyx::Models::UacConnectionRetrieveResponse::Data::InternalUacSettings] Internal Telnyx-side settings for a UAC connection.
        #
        ...
        #
        #   @param noise_suppression [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::NoiseSuppression] Controls when noise suppression is applied to calls. When set to 'inbound', nois
        #
        ...
        #
        #   @param outbound [Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound]
        #
        ...
        #
        #   @param sip_uri_calling_preference [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::SipUriCallingPreference] This feature enables inbound SIP URI calls to your Credential Auth Connection. I
        #
        ...
        #
        #   @param webhook_api_version [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::WebhookAPIVersion] Determines which webhook format will be used, Telnyx API v1 or v2.
        #
        ...
        # The authentication strategy used by this connection.
        #
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#authentication
        ...
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#external_uac_settings
        class ExternalUacSettings < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings::Transport, nil]
          optional :transport,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings::Transport },
                   nil?: true
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings} for
          #   more details.
          #
          #   External SIP peer settings used by Telnyx when registering to your PBX and
          #   routing outbound calls.
          ...
          #
          #   @param transport [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings::Transport, nil] The transport protocol used for SIP signaling when communicating with the extern
          #
          ...
          # external SIP peer. One of UDP, TLS, or TCP.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::ExternalUacSettings#transport
          module Transport
            extend Telnyx::Internal::Type::Enum
        ...
        # The fixed outbound authentication mode used by UAC FQDN records.
        #
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#fqdn_outbound_authentication
        ...
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#inbound
        class Inbound < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::AniNumberFormat, nil]
          optional :ani_number_format,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::AniNumberFormat }
          ...
          #   are not allowed.
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::DefaultRoutingMethod, nil]
          optional :default_routing_method,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::DefaultRoutingMethod }

          # @!attribute dnis_number_format
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::DnisNumberFormat, nil]
          optional :dnis_number_format,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::DnisNumberFormat }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SimultaneousRinging, nil]
          optional :simultaneous_ringing,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SimultaneousRinging }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SipRegion, nil]
          optional :sip_region, enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SipRegion }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SipSubdomainReceiveSettings, nil]
          optional :sip_subdomain_receive_settings,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SipSubdomainReceiveSettings }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound} for more details.
          #
          #   @param ani_number_format [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::AniNumberFormat] This setting allows you to set the format with which the caller's number (ANI) i
          #
          ...
          #
          #   @param default_routing_method [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::DefaultRoutingMethod] Default routing method to be used when a number is associated with the connectio
          #
          #   @param dnis_number_format [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::DnisNumberFormat]
          #
          ...
          #
          #   @param simultaneous_ringing [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SimultaneousRinging] When enabled, allows multiple devices to ring simultaneously on incoming calls.
          #
          #   @param sip_compact_headers_enabled [Boolean] Defaults to true.
          #
          #   @param sip_region [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SipRegion] Selects which `sip_region` to receive inbound calls from. If null, the default r
          #
          #   @param sip_subdomain [String] The Telnyx-generated SIP subdomain for this UAC connection.
          #
          #   @param sip_subdomain_receive_settings [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound::SipSubdomainReceiveSettings] Controls which SIP URI callers may reach this connection.
          #
          ...
          # is sent for inbound phone calls.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound#ani_number_format
          ...
          # are not allowed.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound#default_routing_method
          ...
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound#dnis_number_format
          ...
          # When enabled, allows multiple devices to ring simultaneously on incoming calls.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound#simultaneous_ringing
          ...
          # region (US) will be used.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound#sip_region
          module SipRegion
            extend Telnyx::Internal::Type::Enum
          ...
          # Controls which SIP URI callers may reach this connection.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Inbound#sip_subdomain_receive_settings
        ...
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#internal_uac_settings
        class InternalUacSettings < Telnyx::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionRetrieveResponse::Data::InternalUacSettings} for
          #   more details.
          #
          #   Internal Telnyx-side settings for a UAC connection.
          #
        ...
        # When set to 'disabled', noise suppression is turned off.
        #
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#noise_suppression
        ...
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#outbound
        class Outbound < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound::AniOverrideType, nil]
          optional :ani_override_type,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound::AniOverrideType }
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound::T38ReinviteSource, nil]
          optional :t38_reinvite_source,
                   enum: -> { Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound::T38ReinviteSource }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound} for more
          #   details.
          #
          #   @param ani_override [String] Set a phone number as the ani_override value to override caller id number on out
          #
          #   @param ani_override_type [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound::AniOverrideType] Specifies when we apply your ani_override setting. Only applies when ani_overrid
          #
          ...
          #
          #   @param t38_reinvite_source [Symbol, Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound::T38ReinviteSource] This setting only affects connections with Fax-type Outbound Voice Profiles. The

          # Specifies when we apply your ani_override setting. Only applies when
          # ani_override is not blank.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound#ani_override_type
          ...
          # expected to send the t.38 reinvite.
          #
          # @see Telnyx::Models::UacConnectionRetrieveResponse::Data::Outbound#t38_reinvite_source
        ...
        # account (internal).
        #
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#sip_uri_calling_preference
        ...
        # Determines which webhook format will be used, Telnyx API v1 or v2.
        #
        # @see Telnyx::Models::UacConnectionRetrieveResponse::Data#webhook_api_version
