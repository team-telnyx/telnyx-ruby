...
module Telnyx
  module Models
    module UnsafeUnwrapWebhookEvent
      ...
      variant -> { Telnyx::ArtifactCompletedWebhookEvent }

      variant -> { Telnyx::ArtifactFailedWebhookEvent }
      ...
      variant -> { Telnyx::CallPaymentCompletedWebhookEvent }

      variant -> { Telnyx::CallPaymentProgressWebhookEvent }
