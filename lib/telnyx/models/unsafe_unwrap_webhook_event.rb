...
module Telnyx
  module Models
    module UnsafeUnwrapWebhookEvent
      ...
      variant -> { Telnyx::CallAIGatherEnded }

      variant -> { Telnyx::CallAIGatherMessageHistoryUpdated }
