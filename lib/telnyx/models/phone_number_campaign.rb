...
module Telnyx
  module Models
    ...
    class PhoneNumberCampaign < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::PhoneNumberCampaign::AssignmentStatus, nil]
      optional :assignment_status,
               enum: -> { Telnyx::PhoneNumberCampaign::AssignmentStatus },
      ...
      #   {Telnyx::Models::PhoneNumberCampaign} for more details.
      #
      ...
      #
      #   @param assignment_status [Symbol, Telnyx::Models::PhoneNumberCampaign::AssignmentStatus] The assignment status of the number.
      #
      ...
      # The assignment status of the number.
      #
      # @see Telnyx::Models::PhoneNumberCampaign#assignment_status
