  ...
  module Models
    module Conferences
      ...
      class ActionSpeakParams < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::Calls::ElevenLabsVoiceSettings, Telnyx::Models::Calls::TelnyxVoiceSettings, Telnyx::Models::Calls::AwsVoiceSettings, Telnyx::Models::MinimaxVoiceSettings, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Rime, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble, nil]
        ...
        module VoiceSettings
          ...
          variant :azure, -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Azure }

          variant :rime, -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Rime }

          variant :resemble, -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Resemble }
          ...
          class Azure < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure::Effect, nil]
            optional :effect, enum: -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Azure::Effect }

            # @!attribute gender
            #   Voice gender filter.
            #
            #   @return [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure::Gender, nil]
            optional :gender, enum: -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Azure::Gender }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure} for more
            #   details.
            #
            ...
            #
            #   @param effect [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure::Effect] Audio effect to apply.
            #
            #   @param gender [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure::Gender] Voice gender filter.
            #
            ...
            # Audio effect to apply.
            #
            # @see Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure#effect
            module Effect
              extend Telnyx::Internal::Type::Enum
            ...
            # Voice gender filter.
            #
            # @see Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Azure#gender
            module Gender
              extend Telnyx::Internal::Type::Enum
          ...
          class Resemble < Telnyx::Internal::Type::BaseModel
            ...
            #   Output audio format.
            #
            #   @return [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble::Format, nil]
            optional :format_,
                     enum: -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Resemble::Format },
                     api_name: :format

            # @!attribute precision
            #   Audio precision format.
            #
            #   @return [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble::Precision, nil]
            optional :precision,
                     enum: -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Resemble::Precision }

            # @!attribute sample_rate
            #   Audio sample rate in Hz.
            #
            #   @return [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble::SampleRate, nil]
            optional :sample_rate,
                     enum: -> { Telnyx::Conferences::ActionSpeakParams::VoiceSettings::Resemble::SampleRate }

            # @!method initialize(format_: nil, precision: nil, sample_rate: nil, type: :resemble)
            #   @param format_ [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble::Format] Output audio format.
            #
            #   @param precision [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble::Precision] Audio precision format.
            #
            #   @param sample_rate [Symbol, Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble::SampleRate] Audio sample rate in Hz.
            #
            #   @param type [Symbol, :resemble] Voice settings provider type

            # Output audio format.
            #
            # @see Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble#format_
            module Format
              extend Telnyx::Internal::Type::Enum
            ...
            # Audio precision format.
            #
            # @see Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble#precision
            module Precision
              extend Telnyx::Internal::Type::Enum
            ...
            # Audio sample rate in Hz.
            #
            # @see Telnyx::Models::Conferences::ActionSpeakParams::VoiceSettings::Resemble#sample_rate
            module SampleRate
              extend Telnyx::Internal::Type::Enum
