    ...
    module Messaging10dlc
      module Brand
        class ExternalVettingListResponseItem < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::Messaging10dlc::Brand::ExternalVettingListResponseItem} for
          #   more details.
          #
        ...
        ExternalVettingListResponse =
          Telnyx::Internal::Type::ArrayOf[-> { Telnyx::Models::Messaging10dlc::Brand::ExternalVettingListResponseItem }]
      end
    end
  end
end
