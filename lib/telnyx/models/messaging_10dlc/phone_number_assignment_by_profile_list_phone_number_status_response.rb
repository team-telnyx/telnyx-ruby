  ...
  module Models
    module Messaging10dlc
      ...
      class PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute records
        #
        #   @return [Array<Telnyx::Models::Messaging10dlc::PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse::Record>]
        required :records,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Messaging10dlc::PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse::Record] }

        # @!method initialize(records:)
        #   @param records [Array<Telnyx::Models::Messaging10dlc::PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse::Record>]
