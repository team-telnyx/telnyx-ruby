  ...
  module Models
    module Messaging10dlc
      ...
      class BrandListResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Messaging10dlc::EntityType, nil]
        ...
        #   Status of the brand
        #
        #   @return [Symbol, Telnyx::Models::Messaging10dlc::BrandListResponse::Status, nil]
        ...
        #
        #   @param status [Symbol, Telnyx::Models::Messaging10dlc::BrandListResponse::Status] Status of the brand
        #
        ...
        # Status of the brand
        #
        # @see Telnyx::Models::Messaging10dlc::BrandListResponse#status
        module Status
