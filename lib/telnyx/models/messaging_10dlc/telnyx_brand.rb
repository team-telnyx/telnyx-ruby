...
module Telnyx
  module Models
    module Messaging10dlc
      # @see Telnyx::Resources::Messaging10dlc::Brand#create
      class TelnyxBrand < Telnyx::Internal::Type::BaseModel
        # @!attribute brand_relationship
        #   Brand relationship to the CSP.
        #
        #   @return [Symbol, Telnyx::Models::Messaging10dlc::TelnyxBrand::BrandRelationship]
        ...
        #   Status of the brand
        #
        #   @return [Symbol, Telnyx::Models::Messaging10dlc::TelnyxBrand::Status, nil]
        ...
        #   {Telnyx::Models::Messaging10dlc::TelnyxBrand} for more details.
        #
        #   Telnyx-specific extensions to The Campaign Registry's `Brand` type
        #
        #   @param brand_relationship [Symbol, Telnyx::Models::Messaging10dlc::TelnyxBrand::BrandRelationship] Brand relationship to the CSP.
        #
        ...
        #
        #   @param status [Symbol, Telnyx::Models::Messaging10dlc::TelnyxBrand::Status] Status of the brand
        #
        ...
        # Brand relationship to the CSP.
        #
        # @see Telnyx::Models::Messaging10dlc::TelnyxBrand#brand_relationship
        ...
        # Status of the brand
        #
        # @see Telnyx::Models::Messaging10dlc::TelnyxBrand#status
        module Status
          extend Telnyx::Internal::Type::Enum
