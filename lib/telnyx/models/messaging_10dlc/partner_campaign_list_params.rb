...
module Telnyx
  module Models
    module Messaging10dlc
      # @see Telnyx::Resources::Messaging10dlc::PartnerCampaigns#list
      class PartnerCampaignListParams < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Messaging10dlc::PartnerCampaignListParams::Sort, nil]
        optional :sort, enum: -> { Telnyx::Messaging10dlc::PartnerCampaignListParams::Sort }
