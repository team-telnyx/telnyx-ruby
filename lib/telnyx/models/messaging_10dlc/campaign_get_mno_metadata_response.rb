...
module Telnyx
  module Models
    module Messaging10dlc
      # @see Telnyx::Resources::Messaging10dlc::Campaign#get_mno_metadata
      class CampaignGetMnoMetadataResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute mno_10999
        #
        #   @return [Telnyx::Models::Messaging10dlc::CampaignGetMnoMetadataResponse::Mno10999, nil]
        optional :mno_10999,
                 -> { Telnyx::Models::Messaging10dlc::CampaignGetMnoMetadataResponse::Mno10999 },
                 api_name: :"10999"

        # @!method initialize(mno_10999: nil)
        #   @param mno_10999 [Telnyx::Models::Messaging10dlc::CampaignGetMnoMetadataResponse::Mno10999]

        # @see Telnyx::Models::Messaging10dlc::CampaignGetMnoMetadataResponse#mno_10999
