...
module Telnyx
  module Models
    module Messaging10dlc
      # @see Telnyx::Resources::Messaging10dlc::Campaign#list
      class CampaignListParams < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::Messaging10dlc::CampaignListParams::Sort, nil]
        optional :sort, enum: -> { Telnyx::Messaging10dlc::CampaignListParams::Sort }
