...
module Telnyx
  module Models
    # @see Telnyx::Resources::OAuthClients#retrieve
    class OAuthClientRetrieveResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::OAuthClientRetrieveResponse::Data, nil]
      optional :data, -> { Telnyx::Models::OAuthClientRetrieveResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::OAuthClientRetrieveResponse::Data]
