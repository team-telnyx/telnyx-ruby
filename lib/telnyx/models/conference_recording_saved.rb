...
module Telnyx
  module Models
    class ConferenceRecordingSaved < Telnyx::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceRecordingSaved::EventType, nil]
      optional :event_type, enum: -> { Telnyx::ConferenceRecordingSaved::EventType }

      # @!attribute payload
      #
      #   @return [Telnyx::Models::ConferenceRecordingSaved::Payload, nil]
      optional :payload, -> { Telnyx::ConferenceRecordingSaved::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::ConferenceRecordingSaved::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::ConferenceRecordingSaved::RecordType }

      # @!method initialize(id: nil, event_type: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::ConferenceRecordingSaved::EventType] The type of event being delivered.
      #
      #   @param payload [Telnyx::Models::ConferenceRecordingSaved::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::ConferenceRecordingSaved::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::ConferenceRecordingSaved#event_type
      module EventType
      ...
      # @see Telnyx::Models::ConferenceRecordingSaved#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::ConferenceRecordingSaved::Payload::Channels, nil]
        optional :channels, enum: -> { Telnyx::ConferenceRecordingSaved::Payload::Channels }
        ...
        #   or `wav`.
        #
        #   @return [Symbol, Telnyx::Models::ConferenceRecordingSaved::Payload::Format, nil]
        optional :file_format,
                 enum: -> {
                   Telnyx::ConferenceRecordingSaved::Payload::Format
                 },
                 api_name: :format
        ...
        #
        #   @return [Telnyx::Models::ConferenceRecordingSaved::Payload::PublicRecordingURLs, nil]
        optional :public_recording_urls, -> { Telnyx::ConferenceRecordingSaved::Payload::PublicRecordingURLs }
        ...
        #
        #   @return [Telnyx::Models::ConferenceRecordingSaved::Payload::RecordingURLs, nil]
        optional :recording_urls, -> { Telnyx::ConferenceRecordingSaved::Payload::RecordingURLs }
        ...
        #   {Telnyx::Models::ConferenceRecordingSaved::Payload} for more details.
        #
        ...
        #
        #   @param channels [Symbol, Telnyx::Models::ConferenceRecordingSaved::Payload::Channels] Whether recording was recorded in `single` or `dual` channel.
        #
        ...
        #
        #   @param file_format [Symbol, Telnyx::Models::ConferenceRecordingSaved::Payload::Format] The audio file format used when storing the call recording. Can be either `mp3`
        #
        #   @param public_recording_urls [Telnyx::Models::ConferenceRecordingSaved::Payload::PublicRecordingURLs] Recording URLs in requested format. The URL is valid for as long as the file exi
        #
        ...
        #
        #   @param recording_urls [Telnyx::Models::ConferenceRecordingSaved::Payload::RecordingURLs] Recording URLs in requested format. These URLs are valid for 10 minutes. After 1

        # Whether recording was recorded in `single` or `dual` channel.
        #
        # @see Telnyx::Models::ConferenceRecordingSaved::Payload#channels
        module Channels
          extend Telnyx::Internal::Type::Enum
        ...
        # or `wav`.
        #
        # @see Telnyx::Models::ConferenceRecordingSaved::Payload#file_format
        module Format
          extend Telnyx::Internal::Type::Enum
        ...
        # @see Telnyx::Models::ConferenceRecordingSaved::Payload#public_recording_urls
        ...
        # @see Telnyx::Models::ConferenceRecordingSaved::Payload#recording_urls
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::ConferenceRecordingSaved#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
