...
module Telnyx
  module Models
    ...
    class ReportListMdrsResponse < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute meta
      #
      #   @return [Telnyx::Models::ReportListMdrsResponse::Meta, nil]
      optional :meta, -> { Telnyx::Models::ReportListMdrsResponse::Meta }

      # @!method initialize(data: nil, meta: nil)
      #   @param data [Array<Telnyx::Models::ReportListMdrsResponse::Data>]
      #   @param meta [Telnyx::Models::ReportListMdrsResponse::Meta]
      ...
      # @see Telnyx::Models::ReportListMdrsResponse#meta
