...
module Telnyx
  module Models
    module PortingOrders
      ...
      class PortingActionRequirement < Telnyx::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Symbol, Telnyx::Models::PortingOrders::PortingActionRequirement::RecordType, nil]
        optional :record_type, enum: -> { Telnyx::PortingOrders::PortingActionRequirement::RecordType }
        ...
        #
        #   @return [Symbol, Telnyx::Models::PortingOrders::PortingActionRequirement::Status, nil]
        optional :status, enum: -> { Telnyx::PortingOrders::PortingActionRequirement::Status }
        ...
        #
        #   @param record_type [Symbol, Telnyx::Models::PortingOrders::PortingActionRequirement::RecordType] Identifies the type of the resource
        #
        #   @param requirement_type_id [String] The ID of the requirement type
        #
        #   @param status [Symbol, Telnyx::Models::PortingOrders::PortingActionRequirement::Status] Current status of the action requirement
        #
        #   @param updated_at [Time] ISO 8601 formatted date-time indicating when the resource was updated

        # Identifies the type of the resource
        #
        # @see Telnyx::Models::PortingOrders::PortingActionRequirement#record_type
        module RecordType
        ...
        # Current status of the action requirement
        #
        # @see Telnyx::Models::PortingOrders::PortingActionRequirement#status
        module Status
          extend Telnyx::Internal::Type::Enum
