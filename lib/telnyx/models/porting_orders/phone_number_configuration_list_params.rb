  ...
  module Models
    module PortingOrders
      ...
      class PhoneNumberConfigurationListParams < Telnyx::Internal::Type::BaseModel
        ...
        #   page[number]
        #
        #   @return [Telnyx::Models::PortingOrders::PhoneNumberConfigurationListParams::Page, nil]
        optional :page, -> { Telnyx::PortingOrders::PhoneNumberConfigurationListParams::Page }
