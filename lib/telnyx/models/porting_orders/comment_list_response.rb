  ...
  module Models
    module PortingOrders
      ...
      class CommentListResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::PortingOrders::CommentListResponse::UserType, nil]
        optional :user_type, enum: -> { Telnyx::Models::PortingOrders::CommentListResponse::UserType }
        ...
        #
        #   @param user_type [Symbol, Telnyx::Models::PortingOrders::CommentListResponse::UserType] Indicates whether this comment was created by a Telnyx Admin, user, or system

        # Indicates whether this comment was created by a Telnyx Admin, user, or system
        #
        # @see Telnyx::Models::PortingOrders::CommentListResponse#user_type
        module UserType
