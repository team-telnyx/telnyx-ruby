  ...
  module Models
    module PortingOrders
      ...
      class PhoneNumberConfigurationCreateResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::PortingOrders::PhoneNumberConfigurationCreateResponse::Data>, nil]
        optional :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::PortingOrders::PhoneNumberConfigurationCreateResponse::Data] }

        # @!method initialize(data: nil)
        #   @param data [Array<Telnyx::Models::PortingOrders::PhoneNumberConfigurationCreateResponse::Data>]
