...
module Telnyx
  module Models
    module PortingOrders
      ...
      class PortingAdditionalDocument < Telnyx::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [Symbol, Telnyx::Models::PortingOrders::PortingAdditionalDocument::DocumentType, nil]
        optional :document_type, enum: -> { Telnyx::PortingOrders::PortingAdditionalDocument::DocumentType }
        ...
        #
        #   @param document_type [Symbol, Telnyx::Models::PortingOrders::PortingAdditionalDocument::DocumentType] Identifies the type of additional document
        #
        ...
        # Identifies the type of additional document
        #
        # @see Telnyx::Models::PortingOrders::PortingAdditionalDocument#document_type
        module DocumentType
