  ...
  module Models
    module PortingOrders
      ...
      class PortingOrdersComment < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::PortingOrders::PortingOrdersComment::UserType, nil]
        optional :user_type, enum: -> { Telnyx::PortingOrders::PortingOrdersComment::UserType }
        ...
        #
        #   @param user_type [Symbol, Telnyx::Models::PortingOrders::PortingOrdersComment::UserType] Indicates whether this comment was created by a Telnyx Admin, user, or system

        # Indicates whether this comment was created by a Telnyx Admin, user, or system
        #
        # @see Telnyx::Models::PortingOrders::PortingOrdersComment#user_type
        module UserType
