  ...
  module Models
    module PortingOrders
      ...
      class VerificationCodeVerifyResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::PortingOrders::VerificationCodeVerifyResponse::Data>, nil]
        optional :data,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::PortingOrders::VerificationCodeVerifyResponse::Data] }

        # @!method initialize(data: nil)
        #   @param data [Array<Telnyx::Models::PortingOrders::VerificationCodeVerifyResponse::Data>]
