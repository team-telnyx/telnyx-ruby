...
module Telnyx
  module Models
    class CallEnqueuedWebhookEvent < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::CallEnqueuedWebhookEvent::Data, nil]
      optional :data, -> { Telnyx::CallEnqueuedWebhookEvent::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::CallEnqueuedWebhookEvent::Data]

      # @see Telnyx::Models::CallEnqueuedWebhookEvent#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::CallEnqueuedWebhookEvent::Data::EventType, nil]
        optional :event_type, enum: -> { Telnyx::CallEnqueuedWebhookEvent::Data::EventType }
        ...
        # @!attribute payload
        #
        #   @return [Telnyx::Models::CallEnqueuedWebhookEvent::Data::Payload, nil]
        optional :payload, -> { Telnyx::CallEnqueuedWebhookEvent::Data::Payload }

        # @!attribute record_type
        #   Identifies the type of the resource.
        #
        #   @return [Symbol, Telnyx::Models::CallEnqueuedWebhookEvent::Data::RecordType, nil]
        optional :record_type, enum: -> { Telnyx::CallEnqueuedWebhookEvent::Data::RecordType }

        # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
        #   @param id [String] Identifies the type of resource.
        #
        #   @param event_type [Symbol, Telnyx::Models::CallEnqueuedWebhookEvent::Data::EventType] The type of event being delivered.
        #
        #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
        #
        #   @param payload [Telnyx::Models::CallEnqueuedWebhookEvent::Data::Payload]
        #
        #   @param record_type [Symbol, Telnyx::Models::CallEnqueuedWebhookEvent::Data::RecordType] Identifies the type of the resource.

        # The type of event being delivered.
        #
        # @see Telnyx::Models::CallEnqueuedWebhookEvent::Data#event_type
        module EventType
        ...
        # @see Telnyx::Models::CallEnqueuedWebhookEvent::Data#payload
        class Payload < Telnyx::Internal::Type::BaseModel
          ...
          #   {Telnyx::Models::CallEnqueuedWebhookEvent::Data::Payload} for more details.
          #
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::CallEnqueuedWebhookEvent::Data#record_type
        module RecordType
          extend Telnyx::Internal::Type::Enum
