...
module Telnyx
  module Models
    class ConferenceParticipantPlaybackEnded < Telnyx::Internal::Type::BaseModel
      # @!attribute id
      ...
      #
      #   @return [Symbol, Telnyx::Models::ConferenceParticipantPlaybackEnded::EventType, nil]
      optional :event_type, enum: -> { Telnyx::ConferenceParticipantPlaybackEnded::EventType }

      # @!attribute payload
      #
      #   @return [Telnyx::Models::ConferenceParticipantPlaybackEnded::Payload, nil]
      optional :payload, -> { Telnyx::ConferenceParticipantPlaybackEnded::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::ConferenceParticipantPlaybackEnded::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::ConferenceParticipantPlaybackEnded::RecordType }

      # @!method initialize(id: nil, event_type: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::ConferenceParticipantPlaybackEnded::EventType] The type of event being delivered.
      #
      #   @param payload [Telnyx::Models::ConferenceParticipantPlaybackEnded::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::ConferenceParticipantPlaybackEnded::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::ConferenceParticipantPlaybackEnded#event_type
      module EventType
      ...
      # @see Telnyx::Models::ConferenceParticipantPlaybackEnded#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::ConferenceParticipantPlaybackEnded::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::ConferenceParticipantPlaybackEnded#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
