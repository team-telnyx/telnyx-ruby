...
module Telnyx
  module Models
    # @see Telnyx::Resources::FaxApplications#create
    class FaxApplicationCreateParams < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute inbound
      #
      #   @return [Telnyx::Models::FaxApplicationCreateParams::Inbound, nil]
      optional :inbound, -> { Telnyx::FaxApplicationCreateParams::Inbound }

      # @!attribute outbound
      #
      #   @return [Telnyx::Models::FaxApplicationCreateParams::Outbound, nil]
      ...
      # @!method initialize(application_name:, webhook_event_url:, active: nil, anchorsite_override: nil, inbound: nil, outbound: nil, tags: nil, webhook_event_failover_url: nil, webhook_timeout_secs: nil, request_options: {})
      ...
      class Outbound < Telnyx::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::FaxApplicationCreateParams::Outbound} for more details.
        #
