...
module Telnyx
  module Models
    ...
    class RequirementListResponse < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::RequirementListResponse::Action, nil]
      optional :action, enum: -> { Telnyx::Models::RequirementListResponse::Action }
      ...
      #
      #   @return [Symbol, Telnyx::Models::RequirementListResponse::PhoneNumberType, nil]
      optional :phone_number_type, enum: -> { Telnyx::Models::RequirementListResponse::PhoneNumberType }
      ...
      #   {Telnyx::Models::RequirementListResponse} for more details.
      #
      #   @param id [String] Identifies the associated document
      #
      #   @param action [Symbol, Telnyx::Models::RequirementListResponse::Action] Indicates whether this requirement applies to branded_calling, ordering, porting
      #
      ...
      #
      #   @param phone_number_type [Symbol, Telnyx::Models::RequirementListResponse::PhoneNumberType] Indicates the phone_number_type this requirement applies to. Leave blank if this
      #
      ...
      # porting, or both ordering and porting
      #
      # @see Telnyx::Models::RequirementListResponse#action
      module Action
      ...
      # requirement applies to all number_types.
      #
      # @see Telnyx::Models::RequirementListResponse#phone_number_type
