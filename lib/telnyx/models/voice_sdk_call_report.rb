...
module Telnyx
  module Models
    ...
    class VoiceSDKCallReport < Telnyx::Internal::Type::BaseModel
      # @!attribute call_id
      ...
      #
      #   @return [Array<Telnyx::Models::VoiceSDKCallReportLogEntry>, Telnyx::Models::VoiceSDKCallReport::Logs::Entries, nil]
      optional :logs, union: -> { Telnyx::VoiceSDKCallReport::Logs }
      ...
      #   {Telnyx::Models::VoiceSDKCallReport} for more details.
      #
      ...
      #
      #   @param logs [Array<Telnyx::Models::VoiceSDKCallReportLogEntry>, Telnyx::Models::VoiceSDKCallReport::Logs::Entries] Raw logs payload emitted by the Voice SDK and stored without normalization. Live
      #
      ...
      # payloads are also allowed for compatibility.
      #
      # @see Telnyx::Models::VoiceSDKCallReport#logs
      module Logs
        extend Telnyx::Internal::Type::Union

        # Raw log entries emitted by the Voice SDK.
        variant -> { Telnyx::Models::VoiceSDKCallReport::Logs::VoiceSDKCallReportLogEntryArray }

        # Raw logs object emitted by the Voice SDK when logs are grouped under an entries field.
        variant -> { Telnyx::VoiceSDKCallReport::Logs::Entries }
        ...
        #   @return [Array(Array<Telnyx::Models::VoiceSDKCallReportLogEntry>, Telnyx::Models::VoiceSDKCallReport::Logs::Entries)]
      ...
      # allowed for compatibility.
      #
      # @see Telnyx::Models::VoiceSDKCallReport#stats
      module Stats
        extend Telnyx::Internal::Type::Union
