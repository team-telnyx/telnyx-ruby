...
module Telnyx
  module Models
    module Dir
      ...
      class PhoneNumberBatchListResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute dir_id
        #
        #   @return [String, nil]
        ...
        #
        #   @return [Array<Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document>, nil]
        optional :documents,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document] }
        ...
        #
        #   @return [Array<Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber>, nil]
        optional :phone_numbers,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber] }
        ...
        #   etc.).
        #
        #   @return [Symbol, Telnyx::Models::Dir::PhoneNumberBatchListResponse::Status, nil]
        optional :status, enum: -> { Telnyx::Models::Dir::PhoneNumberBatchListResponse::Status }
        ...
        #   {Telnyx::Models::Dir::PhoneNumberBatchListResponse} for more details.
        #
        ...
        #   @param dir_id [String]
        #
        #   @param documents [Array<Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document>] Documents attached to this batch (e.g. a Letter of Authorization). Empty when no
        #
        #   @param enterprise_id [String]
        #
        #   @param phone_numbers [Array<Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber>] All phone numbers in this batch, with per-number status.
        #
        #   @param status [Symbol, Telnyx::Models::Dir::PhoneNumberBatchListResponse::Status] Aggregate batch status. Mirrors the values used on individual phone numbers (`su
        #
        ...
        class PhoneNumber < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::RejectionReason, nil]
          ...
          #     you own.
          #
          #   @return [Symbol, Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::Status, nil]
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber} for more
          #   details.
          #
          #   @param id [String]
          #
          ...
          #
          #   @param rejection_reason [Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::RejectionReason, nil] Populated when `status` is `unsuccessful` or `permanently_rejected`.
          #
          #   @param status [Symbol, Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::Status] Phone-number lifecycle status.
          #
          #   @param updated_at [Time]
          #
          #   @param verified_at [Time, nil]

          # @see Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber#rejection_reason
          ...
          #   you own.
          #
          # @see Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber#status
          module Status
            extend Telnyx::Internal::Type::Enum
        ...
        # etc.).
        #
        # @see Telnyx::Models::Dir::PhoneNumberBatchListResponse#status
        module Status
          extend Telnyx::Internal::Type::Enum
