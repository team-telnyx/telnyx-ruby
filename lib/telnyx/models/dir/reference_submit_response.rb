  ...
  module Models
    module Dir
      ...
      class ReferenceSubmitResponse < Telnyx::Internal::Type::BaseModel
        # @!attribute data
        #
        #   @return [Array<Telnyx::Models::Dir::ReferenceSubmitResponse::Data>]
        required :data, -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Dir::ReferenceSubmitResponse::Data] }

        # @!method initialize(data:)
        #   @param data [Array<Telnyx::Models::Dir::ReferenceSubmitResponse::Data>]
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::Dir::ReferenceSubmitResponse::Data::RefType]
          required :ref_type, enum: -> { Telnyx::Models::Dir::ReferenceSubmitResponse::Data::RefType }
          ...
          response_only do
            ...
            #
            #   @return [Symbol, Telnyx::Models::Dir::ReferenceSubmitResponse::Data::RecordType]
            required :record_type, enum: -> { Telnyx::Models::Dir::ReferenceSubmitResponse::Data::RecordType }
          end
          ...
          #   {Telnyx::Models::Dir::ReferenceSubmitResponse::Data} for more details.
          #
          ...
          #
          #   @param record_type [Symbol, Telnyx::Models::Dir::ReferenceSubmitResponse::Data::RecordType] Always `dir_reference`.
          #
          #   @param ref_type [Symbol, Telnyx::Models::Dir::ReferenceSubmitResponse::Data::RefType] Whether this is a business reference or the financial reference.
          #
          ...
          # Always `dir_reference`.
          #
          # @see Telnyx::Models::Dir::ReferenceSubmitResponse::Data#record_type
          module RecordType
          ...
          # Whether this is a business reference or the financial reference.
          #
          # @see Telnyx::Models::Dir::ReferenceSubmitResponse::Data#ref_type
          module RefType
            extend Telnyx::Internal::Type::Enum
