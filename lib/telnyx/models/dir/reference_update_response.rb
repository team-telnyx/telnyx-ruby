  ...
  module Models
    module Dir
      ...
      class ReferenceUpdateResponse < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::Dir::ReferenceUpdateResponse::Data]
        required :data, -> { Telnyx::Models::Dir::ReferenceUpdateResponse::Data }

        # @!method initialize(data:)
        #   Some parameter documentations has been truncated, see
        #   {Telnyx::Models::Dir::ReferenceUpdateResponse} for more details.
        #
        #   @param data [Telnyx::Models::Dir::ReferenceUpdateResponse::Data] A reference (business or financial) on a DIR, in the customer-facing shape. No i

        # @see Telnyx::Models::Dir::ReferenceUpdateResponse#data
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::Dir::ReferenceUpdateResponse::Data::RefType]
          required :ref_type, enum: -> { Telnyx::Models::Dir::ReferenceUpdateResponse::Data::RefType }
          ...
          response_only do
            ...
            #
            #   @return [Symbol, Telnyx::Models::Dir::ReferenceUpdateResponse::Data::RecordType]
            required :record_type, enum: -> { Telnyx::Models::Dir::ReferenceUpdateResponse::Data::RecordType }
          end
          ...
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::Dir::ReferenceUpdateResponse::Data} for more details.
          #
          #   A reference (business or financial) on a DIR, in the customer-facing shape. No
          #   internal identifiers are exposed.
          #
          ...
          #
          #   @param record_type [Symbol, Telnyx::Models::Dir::ReferenceUpdateResponse::Data::RecordType] Always `dir_reference`.
          #
          #   @param ref_type [Symbol, Telnyx::Models::Dir::ReferenceUpdateResponse::Data::RefType] Whether this is a business reference or the financial reference.
          #
          ...
          # Always `dir_reference`.
          #
          # @see Telnyx::Models::Dir::ReferenceUpdateResponse::Data#record_type
          module RecordType
          ...
          # Whether this is a business reference or the financial reference.
          #
          # @see Telnyx::Models::Dir::ReferenceUpdateResponse::Data#ref_type
          module RefType
            extend Telnyx::Internal::Type::Enum
