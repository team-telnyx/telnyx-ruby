  ...
  module Models
    module Dir
      ...
      class PhoneNumberDeleteAllResponse < Telnyx::Internal::Type::BaseModel
        ...
        # @!attribute meta
        #
        #   @return [Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta]
        required :meta, -> { Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta }
        ...
        #
        #   @param meta [Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta]

        # @see Telnyx::Models::Dir::PhoneNumberDeleteAllResponse#meta
        class Meta < Telnyx::Internal::Type::BaseModel
          # @!attribute errors
          #   Per-number failures that did not block the call. Each entry has `phone_number`,
          #   `code`, `title`, `detail`.
          #
          #   @return [Array<Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error>]
          required :errors,
                   -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error] }

          # @!method initialize(errors:)
          #   Some parameter documentations has been truncated, see
          #   {Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta} for more details.
          #
          #   @param errors [Array<Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error>] Per-number failures that did not block the call. Each entry has `phone_number`,
          ...
          class Error < Telnyx::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error::Code]
            required :code, enum: -> { Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error::Code }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error} for more
            #   details.
            #
            ...
            #   failure category.
            #
            #   @param code [Symbol, Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error::Code] Stable per-number error code. Currently only `not_associated` is emitted, when t
            #
            #   @param detail [String]
            #
            ...
            # the number is not attached to this DIR.
            #
            # @see Telnyx::Models::Dir::PhoneNumberDeleteAllResponse::Meta::Error#code
            module Code
