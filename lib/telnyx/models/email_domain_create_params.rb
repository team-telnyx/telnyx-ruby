...
module Telnyx
  module Models
    ...
    class EmailDomainCreateParams < Telnyx::Internal::Type::BaseModel
      ...
      # @!method initialize(domain:, dmarc_policy: nil, inbound_enabled: nil, tracking: nil, request_options: {})
