...
module Telnyx
  module Models
    ...
    class InexplicitNumberOrderListResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Array<Telnyx::Models::InexplicitNumberOrderListResponse::Data>, nil]
      optional :data,
               -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::InexplicitNumberOrderListResponse::Data] }
      ...
      #   @param data [Array<Telnyx::Models::InexplicitNumberOrderListResponse::Data>]
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup>, nil]
        optional :ordering_groups,
                 -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup] }
        ...
        #
        #   @param ordering_groups [Array<Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup>]
        #
        ...
        class OrderingGroup < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Order>, nil]
          optional :orders,
                   -> { Telnyx::Internal::Type::ArrayOf[Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Order] }
          ...
          #
          #   @return [Symbol, Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Status, nil]
          optional :status,
                   enum: -> { Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Status }

          # @!attribute strategy
          #   Ordering strategy used
          #
          #   @return [Symbol, Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Strategy, nil]
          optional :strategy,
                   enum: -> { Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Strategy }
          ...
          #   {Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup} for
          #   more details.
          #
          ...
          #
          #   @param orders [Array<Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Order>] Array of orders created to fulfill the inexplicit order
          #
          ...
          #
          #   @param status [Symbol, Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Status] Status of the ordering group
          #
          #   @param strategy [Symbol, Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup::Strategy] Ordering strategy used
          #
          ...
          # Status of the ordering group
          #
          # @see Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup#status
          module Status
          ...
          # Ordering strategy used
          #
          # @see Telnyx::Models::InexplicitNumberOrderListResponse::Data::OrderingGroup#strategy
          module Strategy
            extend Telnyx::Internal::Type::Enum
