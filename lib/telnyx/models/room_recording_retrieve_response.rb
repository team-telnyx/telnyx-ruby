...
module Telnyx
  module Models
    ...
    class RoomRecordingRetrieveResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::RoomRecordingRetrieveResponse::Data, nil]
      optional :data, -> { Telnyx::Models::RoomRecordingRetrieveResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::RoomRecordingRetrieveResponse::Data]

      # @see Telnyx::Models::RoomRecordingRetrieveResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Telnyx::Models::RoomRecordingRetrieveResponse::Data::Status, nil]
        optional :status, enum: -> { Telnyx::Models::RoomRecordingRetrieveResponse::Data::Status }

        # @!attribute type
        #   Shows the room recording type.
        #
        #   @return [Symbol, Telnyx::Models::RoomRecordingRetrieveResponse::Data::Type, nil]
        ...
        #
        #   @param status [Symbol, Telnyx::Models::RoomRecordingRetrieveResponse::Data::Status] Shows the room recording status.
        #
        #   @param type [Symbol, Telnyx::Models::RoomRecordingRetrieveResponse::Data::Type] Shows the room recording type.
        #
        #   @param updated_at [Time] ISO 8601 timestamp when the room recording was updated.

        # Shows the room recording status.
        #
        # @see Telnyx::Models::RoomRecordingRetrieveResponse::Data#status
        module Status
        ...
        # Shows the room recording type.
        #
        # @see Telnyx::Models::RoomRecordingRetrieveResponse::Data#type
        module Type
          extend Telnyx::Internal::Type::Enum
