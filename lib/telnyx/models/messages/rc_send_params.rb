  ...
  module Models
    module Messages
      ...
      class RcSendParams < Telnyx::Internal::Type::BaseModel
        ...
        #
        #   @return [Telnyx::Models::Messages::RcSendParams::MmsFallback, nil]
        optional :mms_fallback, -> { Telnyx::Messages::RcSendParams::MmsFallback }

        # @!attribute sms_fallback
        #
        #   @return [Telnyx::Models::Messages::RcSendParams::SMSFallback, nil]
        optional :sms_fallback, -> { Telnyx::Messages::RcSendParams::SMSFallback }

        # @!attribute type
        #   Message type - must be set to "RCS"
        #
        #   @return [Symbol, Telnyx::Models::Messages::RcSendParams::Type, nil]
        optional :type, enum: -> { Telnyx::Messages::RcSendParams::Type }
