...
module Telnyx
  module Models
    ...
    class MobileVoiceConnectionUpdateResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data, nil]
      optional :data, -> { Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data]

      # @see Telnyx::Models::MobileVoiceConnectionUpdateResponse#data
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        # @!attribute inbound
        #
        #   @return [Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::Inbound, nil]
        optional :inbound, -> { Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::Inbound }

        # @!attribute outbound
        #
        #   @return [Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::Outbound, nil]
        optional :outbound, -> { Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::Outbound }
        ...
        #
        #   @return [Symbol, Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::WebhookAPIVersion, nil]
        optional :webhook_api_version,
                 enum: -> { Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::WebhookAPIVersion },
                 nil?: true
        ...
        response_only do
          ...
          #
          #   @return [Symbol, Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::RecordType, nil]
          optional :record_type, enum: -> { Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::RecordType }
        ...
        #
        #   @param inbound [Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::Inbound]
        #
        #   @param outbound [Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::Outbound]
        #
        #   @param record_type [Symbol, Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::RecordType] Identifies the type of the resource.
        #
        #   @param tags [Array<String>] A list of tags associated with the connection.
        #
        #   @param updated_at [Time]
        #
        #   @param webhook_api_version [Symbol, Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data::WebhookAPIVersion, nil] The API version for webhooks.
        #
        ...
        # @see Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data#inbound
        ...
        # @see Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data#outbound
        ...
        # Identifies the type of the resource.
        #
        # @see Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data#record_type
        module RecordType
        ...
        # The API version for webhooks.
        #
        # @see Telnyx::Models::MobileVoiceConnectionUpdateResponse::Data#webhook_api_version
