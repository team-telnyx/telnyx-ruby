...
module Telnyx
  module Models
    class CallReferFailed < Telnyx::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Telnyx::Models::CallReferFailed::EventType, nil]
      optional :event_type, enum: -> { Telnyx::CallReferFailed::EventType }
      ...
      # @!attribute payload
      #
      #   @return [Telnyx::Models::CallReferFailed::Payload, nil]
      optional :payload, -> { Telnyx::CallReferFailed::Payload }

      # @!attribute record_type
      #   Identifies the type of the resource.
      #
      #   @return [Symbol, Telnyx::Models::CallReferFailed::RecordType, nil]
      optional :record_type, enum: -> { Telnyx::CallReferFailed::RecordType }

      # @!method initialize(id: nil, event_type: nil, occurred_at: nil, payload: nil, record_type: nil)
      #   @param id [String] Identifies the type of resource.
      #
      #   @param event_type [Symbol, Telnyx::Models::CallReferFailed::EventType] The type of event being delivered.
      #
      #   @param occurred_at [Time] ISO 8601 datetime of when the event occurred.
      #
      #   @param payload [Telnyx::Models::CallReferFailed::Payload]
      #
      #   @param record_type [Symbol, Telnyx::Models::CallReferFailed::RecordType] Identifies the type of the resource.

      # The type of event being delivered.
      #
      # @see Telnyx::Models::CallReferFailed#event_type
      module EventType
      ...
      # @see Telnyx::Models::CallReferFailed#payload
      class Payload < Telnyx::Internal::Type::BaseModel
        ...
        #   {Telnyx::Models::CallReferFailed::Payload} for more details.
        #
      ...
      # Identifies the type of the resource.
      #
      # @see Telnyx::Models::CallReferFailed#record_type
      module RecordType
        extend Telnyx::Internal::Type::Enum
