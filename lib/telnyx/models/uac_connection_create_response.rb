    ...
    class UacConnectionCreateResponse < Telnyx::Internal::Type::BaseModel
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        class Inbound < Telnyx::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Telnyx::Models::UacConnectionCreateResponse::Data::Inbound::SipRegion, nil]
          optional :sip_region, enum: -> { Telnyx::Models::UacConnectionCreateResponse::Data::Inbound::SipRegion }
          ...
          #
          #   @param sip_region [Symbol, Telnyx::Models::UacConnectionCreateResponse::Data::Inbound::SipRegion] Selects which `sip_region` to receive inbound calls from. If null, the default r
          #
          ...
          # region (US) will be used.
          #
          # @see Telnyx::Models::UacConnectionCreateResponse::Data::Inbound#sip_region
          module SipRegion
            extend Telnyx::Internal::Type::Enum
