...
module Telnyx
  module Models
    ...
    class PublicInternetGatewayListResponse < Telnyx::Internal::Type::BaseModel
      ...
      # @!attribute region
      #
      #   @return [Telnyx::Models::PublicInternetGatewayListResponse::Region, nil]
      optional :region, -> { Telnyx::Models::PublicInternetGatewayListResponse::Region }
      ...
      #
      #   @param region [Telnyx::Models::PublicInternetGatewayListResponse::Region]
      #
      #   @param region_code [String] The region interface is deployed to.

      # @see Telnyx::Models::PublicInternetGatewayListResponse#region
