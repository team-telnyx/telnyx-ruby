...
module Telnyx
  module Models
    # @see Telnyx::Resources::OAuthGrants#delete
    class OAuthGrantDeleteResponse < Telnyx::Internal::Type::BaseModel
      # @!attribute data
      #
      #   @return [Telnyx::Models::OAuthGrantDeleteResponse::Data, nil]
      optional :data, -> { Telnyx::Models::OAuthGrantDeleteResponse::Data }

      # @!method initialize(data: nil)
      #   @param data [Telnyx::Models::OAuthGrantDeleteResponse::Data]
