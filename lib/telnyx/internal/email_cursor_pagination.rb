...
module Telnyx
  module Internal
    ...
    #
    # @example
    #   if email_cursor_pagination.has_next?
    #     email_cursor_pagination = email_cursor_pagination.next_page
    #   end
    #
    # @example
    ...
    class EmailCursorPagination
      ...
      def next_page
        ...
        req = Telnyx::Internal::Util.deep_merge(@req, {query: {page_cursor: meta&.page_cursor}})
        @client.request(req)
      end
      ...
      def initialize(client:, req:, headers:, page_data:)
        ...
        in {meta: Hash | nil => meta}
          @meta = Telnyx::Internal::Type::Converter.coerce(
            Telnyx::Internal::EmailCursorPagination::Meta,
            meta
          )
        else
        end
