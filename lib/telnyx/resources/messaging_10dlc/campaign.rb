...
module Telnyx
  module Resources
    class Messaging10dlc
      class Campaign
        # @return [Telnyx::Resources::Messaging10dlc::Campaign::Usecase]
        attr_reader :usecase

        # @return [Telnyx::Resources::Messaging10dlc::Campaign::Osr]
        attr_reader :osr
        ...
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignRetrieveParams
        ...
        # @return [Telnyx::Models::Messaging10dlc::TelnyxCampaignCsp]
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignUpdateParams
        def update(campaign_id, params = {})
          parsed, options = Telnyx::Messaging10dlc::CampaignUpdateParams.dump_request(params)
          @client.request(
            method: :put,
            path: ["10dlc/campaign/%1$s", campaign_id],
            body: parsed,
        ...
        #
        # @param sort [Symbol, Telnyx::Models::Messaging10dlc::CampaignListParams::Sort] Specifies the sort order for results. If not given, results are sorted by create
        #
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Telnyx::Internal::PerPagePaginationV2<Telnyx::Models::Messaging10dlc::CampaignListResponse>]
        #
        ...
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignAcceptSharingParams
        ...
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignDeactivateParams
        def deactivate(campaign_id, params = {})
          @client.request(
            method: :delete,
            path: ["10dlc/campaign/%1$s", campaign_id],
            model: Telnyx::Models::Messaging10dlc::CampaignDeactivateResponse,
            options: params[:request_options]
          )
        end
        ...
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Telnyx::Models::Messaging10dlc::CampaignGetMnoMetadataResponse]
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignGetMnoMetadataParams
        def get_mno_metadata(campaign_id, params = {})
          @client.request(
            method: :get,
            path: ["10dlc/campaign/%1$s/mnoMetadata", campaign_id],
            model: Telnyx::Models::Messaging10dlc::CampaignGetMnoMetadataResponse,
            options: params[:request_options]
          )
        end
        ...
        # @return [Hash{Symbol=>Object}]
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignGetOperationStatusParams
        ...
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Telnyx::Models::Messaging10dlc::CampaignGetSharingStatusResponse]
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignGetSharingStatusParams
        def get_sharing_status(campaign_id, params = {})
          @client.request(
            method: :get,
            path: ["10dlc/campaign/%1$s/sharing", campaign_id],
            model: Telnyx::Models::Messaging10dlc::CampaignGetSharingStatusResponse,
            options: params[:request_options]
          )
        end
        ...
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Telnyx::Models::Messaging10dlc::CampaignSubmitAppealResponse]
        #
        # @see Telnyx::Models::Messaging10dlc::CampaignSubmitAppealParams
        def submit_appeal(campaign_id, params)
          parsed, options = Telnyx::Messaging10dlc::CampaignSubmitAppealParams.dump_request(params)
          @client.request(
            method: :post,
            path: ["10dlc/campaign/%1$s/appeal", campaign_id],
            body: parsed,
            model: Telnyx::Models::Messaging10dlc::CampaignSubmitAppealResponse,
            options: options
          )
        end
        ...
        def initialize(client:)
          @client = client
          @usecase = Telnyx::Resources::Messaging10dlc::Campaign::Usecase.new(client: client)
          @osr = Telnyx::Resources::Messaging10dlc::Campaign::Osr.new(client: client)
        end
      end
    end
  end
