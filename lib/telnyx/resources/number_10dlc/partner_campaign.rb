  ...
  module Resources
    class Number10dlc
      class PartnerCampaign
        ...
        # {Telnyx::Models::Number10dlc::PartnerCampaignRetrieveSharedByMeParams} for more
        # details.
        #
        ...
        #
        # @overload retrieve_shared_by_me(page: nil, records_per_page: nil, request_options: {})
        #
        ...
        #
        # @return [Telnyx::Models::Number10dlc::PartnerCampaignRetrieveSharedByMeResponse]
        #
        # @see Telnyx::Models::Number10dlc::PartnerCampaignRetrieveSharedByMeParams
        def retrieve_shared_by_me(params = {})
          parsed, options = Telnyx::Number10dlc::PartnerCampaignRetrieveSharedByMeParams.dump_request(params)
          @client.request(
            method: :get,
            path: "10dlc/partnerCampaign/sharedByMe",
            query: parsed.transform_keys(records_per_page: "recordsPerPage"),
            model: Telnyx::Models::Number10dlc::PartnerCampaignRetrieveSharedByMeResponse,
            options: options
          )
        end
        ...
        #
        # @see Telnyx::Models::Number10dlc::PartnerCampaignRetrieveSharingParams
