  ...
  module Resources
    class Number10dlc
      class PhoneNumberAssignmentByProfile
        ...
        # {Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileAssignParams} for
        # more details.
        #
        ...
        #
        # @return [Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileAssignResponse]
        #
        # @see Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileAssignParams
        def assign(params)
          parsed, options = Telnyx::Number10dlc::PhoneNumberAssignmentByProfileAssignParams.dump_request(params)
          @client.request(
            method: :post,
            path: "10dlc/phoneNumberAssignmentByProfile",
            body: parsed,
            model: Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileAssignResponse,
            options: options
          )
        end
        ...
        #
        # @overload get_phone_number_status(task_id, page: nil, records_per_page: nil, request_options: {})
        #
        ...
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse]
        #
        # @see Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileGetPhoneNumberStatusParams
        def get_phone_number_status(task_id, params = {})
          parsed, options =
            Telnyx::Number10dlc::PhoneNumberAssignmentByProfileGetPhoneNumberStatusParams.dump_request(params)
          @client.request(
            method: :get,
            ...
            model: Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileGetPhoneNumberStatusResponse,
            options: options
          )
        end
        ...
        #
        # @overload get_task_status(task_id, request_options: {})
        #
        # @param task_id [String]
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileGetTaskStatusResponse]
        #
        # @see Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileGetTaskStatusParams
        def get_task_status(task_id, params = {})
          @client.request(
            method: :get,
            path: ["10dlc/phoneNumberAssignmentByProfile/%1$s", task_id],
            model: Telnyx::Models::Number10dlc::PhoneNumberAssignmentByProfileGetTaskStatusResponse,
