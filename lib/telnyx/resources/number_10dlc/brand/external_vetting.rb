    ...
    class Number10dlc
      class Brand
        class ExternalVetting
          ...
          #
          # @return [Array<Telnyx::Models::Number10dlc::Brand::ExternalVettingListResponseItem>]
          #
          # @see Telnyx::Models::Number10dlc::Brand::ExternalVettingListParams
          def list(brand_id, params = {})
            @client.request(
              method: :get,
              path: ["10dlc/brand/%1$s/externalVetting", brand_id],
              model: Telnyx::Internal::Type::ArrayOf[Telnyx::Models::Number10dlc::Brand::ExternalVettingListResponseItem],
          ...
          # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [Telnyx::Models::Number10dlc::Brand::ExternalVettingOrderResponse]
          #
          # @see Telnyx::Models::Number10dlc::Brand::ExternalVettingOrderParams
          def order(brand_id, params)
            parsed, options = Telnyx::Number10dlc::Brand::ExternalVettingOrderParams.dump_request(params)
            @client.request(
              method: :post,
              path: ["10dlc/brand/%1$s/externalVetting", brand_id],
              body: parsed,
              model: Telnyx::Models::Number10dlc::Brand::ExternalVettingOrderResponse,
              options: options
            )
          end
