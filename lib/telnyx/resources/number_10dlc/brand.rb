  ...
  module Resources
    class Number10dlc
      class Brand
        ...
        #
        # @overload number_2fa_email(brand_id, request_options: {})
        #
        # @param brand_id [String]
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [nil]
        #
        # @see Telnyx::Models::Number10dlc::Brand2faEmailParams
        def number_2fa_email(brand_id, params = {})
          @client.request(
            method: :post,
        ...
        # months.
        #
        # @overload update_revet(brand_id, request_options: {})
        #
        # @param brand_id [String]
        # @param request_options [Telnyx::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [Telnyx::Models::TelnyxBrand]
        #
        # @see Telnyx::Models::Number10dlc::BrandUpdateRevetParams
        def update_revet(brand_id, params = {})
          @client.request(
            method: :put,
