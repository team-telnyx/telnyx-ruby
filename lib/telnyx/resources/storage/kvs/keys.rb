    ...
    class Storage
      class Kvs
        ...
        class Keys
          ...
          #
          # @overload set(key, id:, body:, ttl_secs: nil, request_options: {})
          #
          ...
          # @return [nil]
          #
          # @see Telnyx::Models::Storage::Kvs::KeySetParams
          def set(key, params)
            parsed, options = Telnyx::Storage::Kvs::KeySetParams.dump_request(params)
