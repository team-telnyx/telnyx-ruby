...
module Telnyx
  module Resources
    class Messaging10dlc
      ...
      #
      # @return [Array<String>, Array<Hash{Symbol=>Object}>, Hash{Symbol=>String}, Hash{Symbol=>Hash{Symbol=>Object}}, Telnyx::Models::Messaging10dlcGetEnumResponse::EnumPaginatedResponse]
      #
