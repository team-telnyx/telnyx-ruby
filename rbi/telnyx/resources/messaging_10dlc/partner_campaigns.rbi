      ...
      class PartnerCampaigns
        ...
        sig do
          params(
            ...
            sort:
              Telnyx::Messaging10dlc::PartnerCampaignListParams::Sort::OrSymbol,
            request_options: Telnyx::RequestOptions::OrHash
          ).returns(
            Telnyx::Internal::PerPagePaginationV2[
              Telnyx::Messaging10dlc::TelnyxDownstreamCampaign
            ]
          )
        end
        def list(
        ...
        sig do
          params(
            ...
            T::Hash[Symbol, Telnyx::Messaging10dlc::CampaignSharingStatus]
          )
        end
