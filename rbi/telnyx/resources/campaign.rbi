    ...
    class Campaign
      ...
      sig do
        params(
          campaign_id: String,
          request_options: Telnyx::RequestOptions::OrHash
        ).returns(Telnyx::Models::CampaignDeactivateResponse)
      end
      ...
      sig do
        params(
          campaign_id: String,
          request_options: Telnyx::RequestOptions::OrHash
        ).returns(Telnyx::Models::CampaignGetMnoMetadataResponse)
      end
      ...
      sig do
        params(
          campaign_id: String,
          request_options: Telnyx::RequestOptions::OrHash
        ).returns(Telnyx::Models::CampaignGetSharingStatusResponse)
      end
      ...
      sig do
        params(
          ...
          request_options: Telnyx::RequestOptions::OrHash
        ).returns(Telnyx::Models::CampaignSubmitAppealResponse)
      end
      def submit_appeal(
