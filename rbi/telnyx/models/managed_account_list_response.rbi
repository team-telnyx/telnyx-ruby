...
module Telnyx
  module Models
    class ManagedAccountListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Telnyx::Models::ManagedAccountListResponse::RecordType::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          record_type:
            Telnyx::Models::ManagedAccountListResponse::RecordType::OrSymbol,
          updated_at: String,
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::ManagedAccountListResponse::RecordType
            )
          end
