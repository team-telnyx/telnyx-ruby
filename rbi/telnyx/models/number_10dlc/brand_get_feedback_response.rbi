    ...
    module Number10dlc
      class BrandGetFeedbackResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::Number10dlc::BrandGetFeedbackResponse,
        ...
        sig do
          returns(
            T::Array[
              Telnyx::Models::Number10dlc::BrandGetFeedbackResponse::Category
            ]
          )
        end
        ...
        sig do
          params(
            ...
            category:
              T::Array[
                Telnyx::Models::Number10dlc::BrandGetFeedbackResponse::Category::OrHash
              ]
