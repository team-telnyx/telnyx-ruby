    ...
    module Number10dlc
      class PhoneNumberCampaign < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Number10dlc::PhoneNumberCampaign::AssignmentStatus::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            assignment_status:
              Telnyx::Number10dlc::PhoneNumberCampaign::AssignmentStatus::OrSymbol
          ).void
        end
        ...
        module AssignmentStatus
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Number10dlc::PhoneNumberCampaign::AssignmentStatus
              )
            end
