  ...
  module Models
    module Number10dlc
      class TelnyxBrand < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Telnyx::Number10dlc::TelnyxBrand, Telnyx::Internal::AnyHash)
          end

        # Brand relationship to the CSP.
        sig do
          returns(
            Telnyx::Number10dlc::TelnyxBrand::BrandRelationship::TaggedSymbol
          )
        end
        ...
        sig { returns(Telnyx::Number10dlc::EntityType::TaggedSymbol) }
        ...
        sig do
          returns(
            T.nilable(Telnyx::Number10dlc::AltBusinessIDType::TaggedSymbol)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::Number10dlc::BrandIdentityStatus::TaggedSymbol)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::Number10dlc::TelnyxBrand::OptionalAttributes)
          )
        end
        ...
        sig do
          params(
            optional_attributes:
              Telnyx::Number10dlc::TelnyxBrand::OptionalAttributes::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::Number10dlc::TelnyxBrand::Status::TaggedSymbol)
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status: Telnyx::Number10dlc::TelnyxBrand::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          returns(T.nilable(Telnyx::Number10dlc::StockExchange::TaggedSymbol))
        end
        ...
        sig do
          params(
            brand_relationship:
              Telnyx::Number10dlc::TelnyxBrand::BrandRelationship::OrSymbol,
            country: String,
            display_name: String,
            email: String,
          ...
          override.returns(
            {
              ...
              display_name: String,
              email: String,
              entity_type: Telnyx::Number10dlc::EntityType::TaggedSymbol,
              vertical: String,
              alt_business_id: String,
              alt_business_id_type:
                Telnyx::Number10dlc::AltBusinessIDType::TaggedSymbol,
              brand_id: String,
              business_contact_email: String,
              city: String,
              company_name: String,
              ...
              reference_id: String,
              state: String,
              status: Telnyx::Number10dlc::TelnyxBrand::Status::TaggedSymbol,
              stock_exchange: Telnyx::Number10dlc::StockExchange::TaggedSymbol,
              stock_symbol: String,
              street: String,
              tcr_brand_id: String,
              universal_ein: String,
        ...
        module BrandRelationship
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Number10dlc::TelnyxBrand::BrandRelationship)
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Number10dlc::TelnyxBrand::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          OK =
            T.let(:OK, Telnyx::Number10dlc::TelnyxBrand::Status::TaggedSymbol)
          REGISTRATION_PENDING =
            T.let(
              :REGISTRATION_PENDING,
              Telnyx::Number10dlc::TelnyxBrand::Status::TaggedSymbol
            )
          REGISTRATION_FAILED =
            T.let(
              :REGISTRATION_FAILED,
          ...
          sig do
            override.returns(
              T::Array[Telnyx::Number10dlc::TelnyxBrand::Status::TaggedSymbol]
            )
          end
          def self.values
          end
