    ...
    module Number10dlc
      class PhoneNumberCampaignListParams < Telnyx::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Number10dlc::PhoneNumberCampaignListParams,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Number10dlc::PhoneNumberCampaignListParams::Filter
            )
          )
        end
        attr_reader :filter
        ...
        sig do
          params(
            filter:
              Telnyx::Number10dlc::PhoneNumberCampaignListParams::Filter::OrHash
          ).void
        end
        attr_writer :filter
        ...
        module Sort
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Number10dlc::PhoneNumberCampaignListParams::Sort
              )
            end
          ...
          ASSIGNMENT_STATUS =
            T.let(
              :assignmentStatus,
              Telnyx::Number10dlc::PhoneNumberCampaignListParams::Sort::TaggedSymbol
            )
