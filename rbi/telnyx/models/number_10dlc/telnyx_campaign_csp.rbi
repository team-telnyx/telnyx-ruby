    ...
    module Number10dlc
      class TelnyxCampaignCsp < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Number10dlc::TelnyxCampaignCsp,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Number10dlc::TelnyxCampaignCsp::CampaignStatus::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            campaign_status:
              Telnyx::Number10dlc::TelnyxCampaignCsp::CampaignStatus::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Number10dlc::TelnyxCampaignCsp::SubmissionStatus::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            submission_status:
              Telnyx::Number10dlc::TelnyxCampaignCsp::SubmissionStatus::OrSymbol
          ).void
        end
        ...
        module CampaignStatus
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Number10dlc::TelnyxCampaignCsp::CampaignStatus
              )
            end
        ...
        module SubmissionStatus
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Number10dlc::TelnyxCampaignCsp::SubmissionStatus
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
