  ...
  module Models
    module Number10dlc
      class BrandListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(Telnyx::Number10dlc::EntityType::TaggedSymbol))
        end
        attr_reader :entity_type

        sig do
          params(entity_type: Telnyx::Number10dlc::EntityType::OrSymbol).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Number10dlc::BrandListResponse::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::Number10dlc::BrandListResponse::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::Number10dlc::BrandListResponse::Status
              )
            end
