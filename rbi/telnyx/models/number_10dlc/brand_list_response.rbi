    ...
    module Number10dlc
      class BrandListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::Number10dlc::BrandListResponse::Record]
            )
          )
        end
        attr_reader :records
        ...
        sig do
          params(
            records:
              T::Array[
                Telnyx::Models::Number10dlc::BrandListResponse::Record::OrHash
              ]
          ).void
        end
        attr_writer :records
          ...
          override.returns(
            {
              ...
              records:
                T::Array[
                  Telnyx::Models::Number10dlc::BrandListResponse::Record
                ],
              total_records: Integer
            }
          )
        ...
        class Record < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Number10dlc::BrandListResponse::Record::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::Number10dlc::BrandListResponse::Record::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Number10dlc::BrandListResponse::Record::Status
                )
              end
