    ...
    module Number10dlc
      class CampaignListParams < Telnyx::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Number10dlc::CampaignListParams,
        ...
        sig do
          returns(
            T.nilable(Telnyx::Number10dlc::CampaignListParams::Sort::OrSymbol)
          )
        end
        attr_reader :sort
        ...
        module Sort
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Number10dlc::CampaignListParams::Sort)
            end
          ...
          ASSIGNED_PHONE_NUMBERS_COUNT =
            T.let(
              ...
              Telnyx::Number10dlc::CampaignListParams::Sort::TaggedSymbol
            )
