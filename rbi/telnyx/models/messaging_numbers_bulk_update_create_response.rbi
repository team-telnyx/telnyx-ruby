  ...
  module Models
    class MessagingNumbersBulkUpdateCreateResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::MessagingNumbersBulkUpdateCreateResponse,
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::MessagingNumbersBulkUpdateCreateResponse::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::MessagingNumbersBulkUpdateCreateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: Telnyx::Models::MessagingNumbersBulkUpdateCreateResponse::Data
          }
        )
      end
      def to_hash
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MessagingNumbersBulkUpdateCreateResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::MessagingNumbersBulkUpdateCreateResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::MessagingNumbersBulkUpdateCreateResponse::Data::RecordType
              )
            end
