...
module Telnyx
  module Models
    class VoiceCloneCreateResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Telnyx::Models::VoiceCloneCreateResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::VoiceCloneCreateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::VoiceCloneCreateResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::VoiceCloneCreateResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::VoiceCloneCreateResponse::Data::Gender::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::VoiceCloneCreateResponse::Data::Provider::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            provider:
              Telnyx::Models::VoiceCloneCreateResponse::Data::Provider::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::VoiceCloneCreateResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::VoiceCloneCreateResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        sig do
          params(
            ...
            gender:
              T.nilable(
                Telnyx::Models::VoiceCloneCreateResponse::Data::Gender::OrSymbol
              ),
        ...
        module Gender
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::VoiceCloneCreateResponse::Data::Gender
              )
            end
        ...
        module Provider
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::VoiceCloneCreateResponse::Data::Provider
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::VoiceCloneCreateResponse::Data::RecordType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
