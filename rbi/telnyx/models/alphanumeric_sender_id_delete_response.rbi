...
module Telnyx
  module Models
    class AlphanumericSenderIDDeleteResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::AlphanumericSenderIDDeleteResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Telnyx::Models::AlphanumericSenderIDDeleteResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::AlphanumericSenderIDDeleteResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::AlphanumericSenderIDDeleteResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::AlphanumericSenderIDDeleteResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::AlphanumericSenderIDDeleteResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::AlphanumericSenderIDDeleteResponse::Data::RecordType
              )
            end
