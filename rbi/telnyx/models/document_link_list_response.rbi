...
module Telnyx
  module Models
    class DocumentLinkListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::DocumentLinkListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: T::Array[Telnyx::Models::DocumentLinkListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        params(
          data:
            T::Array[Telnyx::Models::DocumentLinkListResponse::Data::OrHash],
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::DocumentLinkListResponse::Data],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DocumentLinkListResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
