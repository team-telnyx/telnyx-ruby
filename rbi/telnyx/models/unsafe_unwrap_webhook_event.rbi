    ...
    module UnsafeUnwrapWebhookEvent
      ...
      Variants =
        T.type_alias do
          T.any(
            ...
            Telnyx::UnsafeUnwrapWebhookEvent::CampaignStatusUpdateEvent,
            Telnyx::UnsafeUnwrapWebhookEvent::CampaignSuspendedEvent,
      ...
      class CampaignSuspendedEvent < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::UnsafeUnwrapWebhookEvent::CampaignSuspendedEvent::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::UnsafeUnwrapWebhookEvent::CampaignSuspendedEvent::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::UnsafeUnwrapWebhookEvent::CampaignSuspendedEvent::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              Telnyx::UnsafeUnwrapWebhookEvent::CampaignSuspendedEvent::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::UnsafeUnwrapWebhookEvent::CampaignSuspendedEvent::Status
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::UnsafeUnwrapWebhookEvent::CampaignSuspendedEvent::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
