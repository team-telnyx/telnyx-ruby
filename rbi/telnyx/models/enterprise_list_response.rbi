...
module Telnyx
  module Models
    class EnterpriseListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::EnterpriseListResponse::BillingAddress)
        )
      end
      ...
      sig do
        params(
          billing_address:
            Telnyx::Models::EnterpriseListResponse::BillingAddress::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::EnterpriseListResponse::BillingContact)
        )
      end
      ...
      sig do
        params(
          billing_contact:
            Telnyx::Models::EnterpriseListResponse::BillingContact::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::EnterpriseListResponse::NumberOfEmployees::TaggedSymbol
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::EnterpriseListResponse::OrganizationContact)
        )
      end
      ...
      sig do
        params(
          organization_contact:
            Telnyx::Models::EnterpriseListResponse::OrganizationContact::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::EnterpriseListResponse::OrganizationLegalType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          organization_physical_address:
            Telnyx::Models::EnterpriseListResponse::OrganizationPhysicalAddress::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::EnterpriseListResponse::OrganizationType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          organization_type:
            Telnyx::Models::EnterpriseListResponse::OrganizationType::OrSymbol
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::EnterpriseListResponse::RoleType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          role_type: Telnyx::Models::EnterpriseListResponse::RoleType::OrSymbol
        ).void
      end
      ...
      sig do
        params(
          ...
          number_of_employees:
            T.nilable(
              Telnyx::Models::EnterpriseListResponse::NumberOfEmployees::OrSymbol
            ),
          organization_contact:
            Telnyx::Models::EnterpriseListResponse::OrganizationContact::OrHash,
          organization_legal_type:
            T.nilable(
              Telnyx::Models::EnterpriseListResponse::OrganizationLegalType::OrSymbol
            ),
          organization_physical_address:
            Telnyx::Models::EnterpriseListResponse::OrganizationPhysicalAddress::OrHash,
          organization_type:
        ...
        override.returns(
          {
            id: String,
            billing_address:
              Telnyx::Models::EnterpriseListResponse::BillingAddress,
            billing_contact:
              Telnyx::Models::EnterpriseListResponse::BillingContact,
            corporate_registration_number: T.nilable(String),
            country_code: String,
            created_at: Time,
            customer_reference: T.nilable(String),
            ...
            organization_contact:
              Telnyx::Models::EnterpriseListResponse::OrganizationContact,
            organization_legal_type:
              T.nilable(
                Telnyx::Models::EnterpriseListResponse::OrganizationLegalType::TaggedSymbol
              ),
      ...
      module NumberOfEmployees
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::EnterpriseListResponse::NumberOfEmployees
            )
          end
      ...
      module OrganizationLegalType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::EnterpriseListResponse::OrganizationLegalType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module OrganizationType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::EnterpriseListResponse::OrganizationType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module RoleType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::Models::EnterpriseListResponse::RoleType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
