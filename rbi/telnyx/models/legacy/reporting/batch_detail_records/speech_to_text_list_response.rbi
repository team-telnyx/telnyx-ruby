          ...
          class SpeechToTextListResponse < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Telnyx::Models::Legacy::Reporting::BatchDetailRecords::SpeechToTextListResponse::Data
                  ]
                )
              )
            end
            ...
            sig do
              params(
                data:
                  T::Array[
                    Telnyx::Models::Legacy::Reporting::BatchDetailRecords::SpeechToTextListResponse::Data::OrHash
                  ]
              ).void
            end
            attr_writer :data
            ...
            class Data < Telnyx::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Telnyx::Models::Legacy::Reporting::BatchDetailRecords::SpeechToTextListResponse::Data::Status::TaggedSymbol
                  )
                )
              end
              attr_reader :status
              ...
              sig do
                params(
                  status:
                    Telnyx::Models::Legacy::Reporting::BatchDetailRecords::SpeechToTextListResponse::Data::Status::OrSymbol
                ).void
              end
              attr_writer :status
