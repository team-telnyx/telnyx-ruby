        ...
        module UsageReports
          class MessagingCreateResponse < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Models::Legacy::Reporting::UsageReports::MessagingCreateResponse::Data
                )
              )
            end
            attr_reader :data
            ...
            sig do
              params(
                data:
                  Telnyx::Models::Legacy::Reporting::UsageReports::MessagingCreateResponse::Data::OrHash
              ).void
            end
            attr_writer :data
