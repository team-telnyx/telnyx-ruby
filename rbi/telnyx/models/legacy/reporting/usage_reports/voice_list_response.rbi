          ...
          class VoiceListResponse < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Telnyx::Models::Legacy::Reporting::UsageReports::VoiceListResponse::Data
                  ]
                )
              )
            end
            ...
            sig do
              params(
                data:
                  T::Array[
                    Telnyx::Models::Legacy::Reporting::UsageReports::VoiceListResponse::Data::OrHash
                  ]
              ).void
            end
            attr_writer :data
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Models::Legacy::Reporting::UsageReports::VoiceListResponse::Meta
                )
              )
            end
            attr_reader :meta
            ...
            sig do
              params(
                meta:
                  Telnyx::Models::Legacy::Reporting::UsageReports::VoiceListResponse::Meta::OrHash
              ).void
            end
            attr_writer :meta
