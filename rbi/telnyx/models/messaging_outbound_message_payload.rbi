...
module Telnyx
  module Models
    class MessagingOutboundMessagePayload < Telnyx::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Telnyx::MessagingOutboundMessagePayload::Cost)) }
      attr_reader :cost

      sig do
        params(
          cost: T.nilable(Telnyx::MessagingOutboundMessagePayload::Cost::OrHash)
        ).void
      end
      attr_writer :cost
      ...
      sig do
        params(
          cost_breakdown:
            T.nilable(
              Telnyx::MessagingOutboundMessagePayload::CostBreakdown::OrHash
            )
        ).void
      end
      ...
      sig { returns(T.nilable(Telnyx::MessagingOutboundMessagePayload::From)) }
      attr_reader :from

      sig do
        params(from: Telnyx::MessagingOutboundMessagePayload::From::OrHash).void
      end
      attr_writer :from

      sig do
        returns(
          T.nilable(T::Array[Telnyx::MessagingOutboundMessagePayload::Media])
        )
      end
      attr_reader :media
      ...
      sig do
        params(
          media:
            T::Array[Telnyx::MessagingOutboundMessagePayload::Media::OrHash]
        ).void
      end
      attr_writer :media
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::MessagingOutboundMessagePayload::To])
        )
      end
      attr_reader :to
      ...
      sig do
        params(
          to: T::Array[Telnyx::MessagingOutboundMessagePayload::To::OrHash]
        ).void
      end
      attr_writer :to
      ...
      sig do
        params(
          ...
          cost:
            T.nilable(Telnyx::MessagingOutboundMessagePayload::Cost::OrHash),
          cost_breakdown:
            T.nilable(
              Telnyx::MessagingOutboundMessagePayload::CostBreakdown::OrHash
            ),
          ...
          from: Telnyx::MessagingOutboundMessagePayload::From::OrHash,
          media:
            T::Array[Telnyx::MessagingOutboundMessagePayload::Media::OrHash],
        ...
        override.returns(
          {
            ...
            media: T::Array[Telnyx::MessagingOutboundMessagePayload::Media],
            messaging_profile_id: String,
            num_chars: Integer,
            organization_id: String,
            parts: Integer,
      ...
      class Cc < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::MessagingOutboundMessagePayload::Cc,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        module LineType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::MessagingOutboundMessagePayload::Cc::LineType
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::MessagingOutboundMessagePayload::Cc::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Cost < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::MessagingOutboundMessagePayload::Cost,
              Telnyx::Internal::AnyHash
            )
          end
      ...
      class CostBreakdown < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::MessagingOutboundMessagePayload::CostBreakdown,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::MessagingOutboundMessagePayload::CostBreakdown::CarrierFee
            )
          )
        end
        ...
        sig do
          params(
            carrier_fee:
              Telnyx::MessagingOutboundMessagePayload::CostBreakdown::CarrierFee::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::MessagingOutboundMessagePayload::CostBreakdown::Rate
            )
          )
        end
        attr_reader :rate
        ...
        sig do
          params(
            rate:
              Telnyx::MessagingOutboundMessagePayload::CostBreakdown::Rate::OrHash
          ).void
        end
        attr_writer :rate
          ...
          override.returns(
            {
              carrier_fee:
                Telnyx::MessagingOutboundMessagePayload::CostBreakdown::CarrierFee,
              rate: Telnyx::MessagingOutboundMessagePayload::CostBreakdown::Rate
            }
          )
        end
        def to_hash
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::MessagingOutboundMessagePayload::Direction)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class From < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::MessagingOutboundMessagePayload::From,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        module LineType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::MessagingOutboundMessagePayload::From::LineType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Media < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::MessagingOutboundMessagePayload::Media,
              Telnyx::Internal::AnyHash
            )
          end
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::MessagingOutboundMessagePayload::RecordType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class To < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::MessagingOutboundMessagePayload::To,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        module LineType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::MessagingOutboundMessagePayload::To::LineType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::MessagingOutboundMessagePayload::To::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::MessagingOutboundMessagePayload::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
