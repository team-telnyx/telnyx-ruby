...
module Telnyx
  module Models
    class DirUpdateResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::Models::DirUpdateResponse, Telnyx::Internal::AnyHash)
        end

      sig { returns(Telnyx::Models::DirUpdateResponse::Data) }
      attr_reader :data

      sig { params(data: Telnyx::Models::DirUpdateResponse::Data::OrHash).void }
      attr_writer :data

      sig do
        params(data: Telnyx::Models::DirUpdateResponse::Data::OrHash).returns(
          T.attached_class
        )
      end
      def self.new(data:)
      ...
      sig do
        override.returns({ data: Telnyx::Models::DirUpdateResponse::Data })
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DirUpdateResponse::Data,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::DirUpdateResponse::Data::CallReason]
            )
          )
        end
        ...
        sig do
          params(
            call_reasons:
              T::Array[
                Telnyx::Models::DirUpdateResponse::Data::CallReason::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::DirUpdateResponse::Data::Document]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::DirUpdateResponse::Data::RejectionReason]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::DirUpdateResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status: Telnyx::Models::DirUpdateResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          params(
            ...
            documents:
              T.nilable(
                T::Array[
                  Telnyx::Models::DirUpdateResponse::Data::Document::OrHash
                ]
              ),
            ...
            rejection_reasons:
              T.nilable(
                T::Array[
                  Telnyx::Models::DirUpdateResponse::Data::RejectionReason::OrHash
                ]
              ),
            reselling: T::Boolean,
            status: Telnyx::Models::DirUpdateResponse::Data::Status::OrSymbol,
          ...
          override.returns(
            {
              ...
              rejection_reasons:
                T.nilable(
                  T::Array[
                    Telnyx::Models::DirUpdateResponse::Data::RejectionReason
                  ]
                ),
              reselling: T::Boolean,
              status:
        ...
        class CallReason < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::DirUpdateResponse::Data::CallReason,
                Telnyx::Internal::AnyHash
              )
            end
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::DirUpdateResponse::Data::Document,
                Telnyx::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Telnyx::Models::DirUpdateResponse::Data::Document::DocumentType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              document_id: String,
              document_type:
                Telnyx::Models::DirUpdateResponse::Data::Document::DocumentType::OrSymbol,
              description: String
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::DirUpdateResponse::Data::Document::DocumentType
                )
              end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Models::DirUpdateResponse::Data::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
