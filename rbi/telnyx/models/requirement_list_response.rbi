...
module Telnyx
  module Models
    class RequirementListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::RequirementListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: T::Array[Telnyx::Models::RequirementListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::RequirementListResponse::Data],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::RequirementListResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::RequirementListResponse::Data::Action::TaggedSymbol
            )
          )
        end
        attr_reader :action
        ...
        sig do
          params(
            action:
              Telnyx::Models::RequirementListResponse::Data::Action::OrSymbol
          ).void
        end
        attr_writer :action
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::RequirementListResponse::Data::PhoneNumberType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            phone_number_type:
              Telnyx::Models::RequirementListResponse::Data::PhoneNumberType::OrSymbol
          ).void
        end
        ...
        module PhoneNumberType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::RequirementListResponse::Data::PhoneNumberType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
