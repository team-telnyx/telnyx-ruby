    ...
    module Messaging10dlc
      ...
      module Vertical
        ...
        HUMAN_RESOURCES =
          T.let(
            :HUMAN_RESOURCES,
            Telnyx::Messaging10dlc::Vertical::TaggedSymbol
          )
        INSURANCE =
          T.let(:INSURANCE, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
        LEGAL = T.let(:LEGAL, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
        MANUFACTURING =
          T.let(:MANUFACTURING, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
        NGO = T.let(:NGO, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
        POLITICAL =
          T.let(:POLITICAL, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
        POSTAL = T.let(:POSTAL, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
        PROFESSIONAL =
          T.let(:PROFESSIONAL, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
        REAL_ESTATE =
        ...
        TRANSPORTATION =
          T.let(:TRANSPORTATION, Telnyx::Messaging10dlc::Vertical::TaggedSymbol)
