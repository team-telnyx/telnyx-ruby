    ...
    module Messaging10dlc
      class TelnyxBrand < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Messaging10dlc::TelnyxBrand,
        ...
        sig do
          returns(
            Telnyx::Messaging10dlc::TelnyxBrand::BrandRelationship::TaggedSymbol
          )
        end
        ...
        sig { returns(Telnyx::Messaging10dlc::EntityType::TaggedSymbol) }
        ...
        sig do
          returns(
            T.nilable(Telnyx::Messaging10dlc::AltBusinessIDType::TaggedSymbol)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::Messaging10dlc::BrandIdentityStatus::TaggedSymbol)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::Messaging10dlc::TelnyxBrand::Status::TaggedSymbol)
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status: Telnyx::Messaging10dlc::TelnyxBrand::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          returns(
            T.nilable(Telnyx::Messaging10dlc::StockExchange::TaggedSymbol)
          )
        end
        ...
        sig do
          params(
            brand_relationship:
              Telnyx::Messaging10dlc::TelnyxBrand::BrandRelationship::OrSymbol,
            country: String,
            display_name: String,
            email: String,
          ...
          override.returns(
            {
              ...
              display_name: String,
              email: String,
              entity_type: Telnyx::Messaging10dlc::EntityType::TaggedSymbol,
              vertical: String,
              alt_business_id: String,
              alt_business_id_type:
                Telnyx::Messaging10dlc::AltBusinessIDType::TaggedSymbol,
              brand_id: String,
              business_contact_email: String,
              city: String,
              company_name: String,
              ...
              reference_id: String,
              state: String,
              status: Telnyx::Messaging10dlc::TelnyxBrand::Status::TaggedSymbol,
              stock_exchange:
                Telnyx::Messaging10dlc::StockExchange::TaggedSymbol,
              stock_symbol: String,
              street: String,
              tcr_brand_id: String,
              universal_ein: String,
        ...
        module BrandRelationship
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Messaging10dlc::TelnyxBrand::BrandRelationship
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Messaging10dlc::TelnyxBrand::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          OK =
            T.let(
              :OK,
              Telnyx::Messaging10dlc::TelnyxBrand::Status::TaggedSymbol
            )
