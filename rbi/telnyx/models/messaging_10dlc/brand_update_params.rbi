    ...
    module Messaging10dlc
      class BrandUpdateParams < Telnyx::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Messaging10dlc::BrandUpdateParams,
        ...
        sig do
          returns(
            T.nilable(Telnyx::Messaging10dlc::AltBusinessIDType::OrSymbol)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::Messaging10dlc::BrandIdentityStatus::OrSymbol)
          )
        end
