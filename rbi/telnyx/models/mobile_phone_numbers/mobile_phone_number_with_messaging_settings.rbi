...
module Telnyx
  module Models
    MobilePhoneNumberWithMessagingSettings =
      MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings
    ...
    module MobilePhoneNumbers
      class MobilePhoneNumberWithMessagingSettings < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Features
            )
          )
        end
        ...
        sig do
          params(
            features:
              Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Features::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::RecordType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::RecordType
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::MobilePhoneNumbers::MobilePhoneNumberWithMessagingSettings::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
