  ...
  module Models
    class PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T::Array[
            Telnyx::Models::PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse::Record
          ]
        )
      end
      ...
      sig do
        params(
          records:
            T::Array[
              Telnyx::Models::PhoneNumberAssignmentByProfileListPhoneNumberStatusResponse::Record::OrHash
            ]
