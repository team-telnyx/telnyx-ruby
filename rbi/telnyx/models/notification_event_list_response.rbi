  ...
  module Models
    class NotificationEventListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Telnyx::Models::NotificationEventListResponse::Data]
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[
              Telnyx::Models::NotificationEventListResponse::Data::OrHash
            ]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::NotificationEventListResponse::Data],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::NotificationEventListResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
