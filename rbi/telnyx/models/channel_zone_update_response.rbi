...
module Telnyx
  module Models
    class ChannelZoneUpdateResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Telnyx::Models::ChannelZoneUpdateResponse::RecordType::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          name: String,
          record_type:
            Telnyx::Models::ChannelZoneUpdateResponse::RecordType::OrSymbol,
          created_at: String,
          updated_at: String
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::Models::ChannelZoneUpdateResponse::RecordType)
          end
