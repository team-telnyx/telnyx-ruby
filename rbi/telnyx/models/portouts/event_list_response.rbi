    ...
    module Portouts
      class EventListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::Portouts::EventListResponse::Data]
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              T::Array[
                Telnyx::Models::Portouts::EventListResponse::Data::OrHash
              ]
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: T::Array[Telnyx::Models::Portouts::EventListResponse::Data],
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::Portouts::EventListResponse::Data,
                Telnyx::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Telnyx::Models::Portouts::EventListResponse::Data::AvailableNotificationMethod::TaggedSymbol
                ]
              )
            )
          end
          ...
          sig do
            params(
              available_notification_methods:
                T::Array[
                  Telnyx::Models::Portouts::EventListResponse::Data::AvailableNotificationMethod::OrSymbol
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Portouts::EventListResponse::Data::EventType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              event_type:
                Telnyx::Models::Portouts::EventListResponse::Data::EventType::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Portouts::EventListResponse::Data::Payload::Variants
              )
            )
          end
          attr_reader :payload
          ...
          sig do
            params(
              payload:
                T.any(
                  Telnyx::Models::Portouts::EventListResponse::Data::Payload::WebhookPortoutStatusChangedPayload::OrHash,
                  Telnyx::Models::Portouts::EventListResponse::Data::Payload::WebhookPortoutNewCommentPayload::OrHash,
                  Telnyx::Models::Portouts::EventListResponse::Data::Payload::WebhookPortoutFocDateChangedPayload::OrHash
                )
            ).void
          end
          attr_writer :payload
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Portouts::EventListResponse::Data::PayloadStatus::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              payload_status:
                Telnyx::Models::Portouts::EventListResponse::Data::PayloadStatus::OrSymbol
            ).void
          end
          ...
          module AvailableNotificationMethod
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Portouts::EventListResponse::Data::AvailableNotificationMethod
                )
              end
          ...
          module EventType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Portouts::EventListResponse::Data::EventType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module PayloadStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Portouts::EventListResponse::Data::PayloadStatus
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
