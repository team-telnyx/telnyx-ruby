...
module Telnyx
  module Models
    class OAuthClientRetrieveResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Telnyx::Models::OAuthClientRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::OAuthClientRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Telnyx::Models::OAuthClientRetrieveResponse::Data::ClientType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            Telnyx::Models::OAuthClientRetrieveResponse::Data::RecordType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::OAuthClientRetrieveResponse::Data::AllowedGrantType::TaggedSymbol
              ]
            )
          )
        end
        ...
        sig do
          params(
            allowed_grant_types:
              T::Array[
                Telnyx::Models::OAuthClientRetrieveResponse::Data::AllowedGrantType::OrSymbol
              ]
          ).void
        end
        ...
        sig do
          params(
            client_id: String,
            client_type:
              Telnyx::Models::OAuthClientRetrieveResponse::Data::ClientType::OrSymbol,
            created_at: Time,
            name: String,
            org_id: String,
            record_type:
              Telnyx::Models::OAuthClientRetrieveResponse::Data::RecordType::OrSymbol,
        ...
        module ClientType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::OAuthClientRetrieveResponse::Data::ClientType
              )
            end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::OAuthClientRetrieveResponse::Data::RecordType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module AllowedGrantType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::OAuthClientRetrieveResponse::Data::AllowedGrantType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
