  ...
  module Models
    module PhoneNumbers
      class MessagingListParams < Telnyx::Internal::Type::BaseModel
        ...
        # page[size]
        sig do
          returns(T.nilable(Telnyx::PhoneNumbers::MessagingListParams::Page))
        end
        attr_reader :page
        ...
        sig do
          override.returns(
            {
              page: Telnyx::PhoneNumbers::MessagingListParams::Page,
        ...
        class Page < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::PhoneNumbers::MessagingListParams::Page,
                Telnyx::Internal::AnyHash
              )
            end
