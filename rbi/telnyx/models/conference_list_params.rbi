...
module Telnyx
  module Models
    class ConferenceListParams < Telnyx::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Telnyx::ConferenceListParams, Telnyx::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Telnyx::ConferenceListParams::Filter)) }
      attr_reader :filter

      sig { params(filter: Telnyx::ConferenceListParams::Filter::OrHash).void }
      attr_writer :filter

      # Consolidated page parameter (deepObject style). Originally: page[after],
      # page[before], page[limit], page[size], page[number]
      sig { returns(T.nilable(Telnyx::ConferenceListParams::Page)) }
      attr_reader :page
      ...
      class Filter < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Telnyx::ConferenceListParams::Filter::ApplicationName)
          )
        end
        ...
        sig do
          params(
            application_name:
              Telnyx::ConferenceListParams::Filter::ApplicationName::OrHash
          ).void
        end
        ...
        sig do
          returns(T.nilable(Telnyx::ConferenceListParams::Filter::OccurredAt))
        end
        ...
        sig do
          params(
            occurred_at:
              Telnyx::ConferenceListParams::Filter::OccurredAt::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::ConferenceListParams::Filter::Product::OrSymbol)
          )
        end
        attr_reader :product
        ...
        sig do
          params(
            product: Telnyx::ConferenceListParams::Filter::Product::OrSymbol
          ).void
        end
        attr_writer :product
        ...
        sig do
          returns(
            T.nilable(Telnyx::ConferenceListParams::Filter::Status::OrSymbol)
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status: Telnyx::ConferenceListParams::Filter::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          returns(
            T.nilable(Telnyx::ConferenceListParams::Filter::Type::OrSymbol)
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type: Telnyx::ConferenceListParams::Filter::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        module Product
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::ConferenceListParams::Filter::Product)
            end
          ...
          CALL_CONTROL =
            T.let(
              :call_control,
              Telnyx::ConferenceListParams::Filter::Product::TaggedSymbol
            )
          FAX =
            T.let(
              :fax,
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::ConferenceListParams::Filter::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          INIT =
            T.let(
              :init,
              Telnyx::ConferenceListParams::Filter::Status::TaggedSymbol
            )
          IN_PROGRESS =
            T.let(
              :in_progress,
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::ConferenceListParams::Filter::Type)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          COMMAND =
            T.let(
              :command,
              Telnyx::ConferenceListParams::Filter::Type::TaggedSymbol
            )
          WEBHOOK =
            T.let(
              :webhook,
          ...
          sig do
            override.returns(
              T::Array[Telnyx::ConferenceListParams::Filter::Type::TaggedSymbol]
            )
          end
          def self.values
          end
      ...
      class Page < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Telnyx::ConferenceListParams::Page, Telnyx::Internal::AnyHash)
          end
