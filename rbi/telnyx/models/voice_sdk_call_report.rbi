...
module Telnyx
  module Models
    class VoiceSDKCallReport < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::VoiceSDKCallReport, Telnyx::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Telnyx::VoiceSDKCallReport::Logs::Variants)) }
      attr_reader :logs
        ...
        params(
          logs:
            T.any(
              ...
              Telnyx::VoiceSDKCallReport::Logs::Entries::OrHash
            )
        ).void
      end
      attr_writer :logs
      ...
      sig { returns(T.nilable(Telnyx::VoiceSDKCallReport::Stats::Variants)) }
      attr_reader :stats
        ...
        override.returns(
          {
            ...
            created_at: Time,
            flush_reason: T::Hash[Symbol, T.anything],
            logs: Telnyx::VoiceSDKCallReport::Logs::Variants,
            organization_id: String,
            segment: Integer,
            stats: Telnyx::VoiceSDKCallReport::Stats::Variants,
            stored_at: Time,
            summary: T::Hash[Symbol, T.anything],
            telnyx_leg_id: String,
            telnyx_session_id: String,
      ...
      module Logs
        ...
        Variants =
          T.type_alias do
            T.any(
              ...
              Telnyx::VoiceSDKCallReport::Logs::Entries
            )
          end
        ...
        sig do
          override.returns(T::Array[Telnyx::VoiceSDKCallReport::Logs::Variants])
        end
        def self.variants
        end
      ...
      module Stats
        ...
        sig do
          override.returns(
            T::Array[Telnyx::VoiceSDKCallReport::Stats::Variants]
          )
        end
        def self.variants
        end
