    ...
    class CommentMarkAsReadResponse < Telnyx::Internal::Type::BaseModel
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::CommentMarkAsReadResponse::Data::CommentRecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            comment_record_type:
              Telnyx::Models::CommentMarkAsReadResponse::Data::CommentRecordType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::CommentMarkAsReadResponse::Data::CommenterType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            commenter_type:
              Telnyx::Models::CommentMarkAsReadResponse::Data::CommenterType::OrSymbol
          ).void
        end
        ...
        module CommentRecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::CommentMarkAsReadResponse::Data::CommentRecordType
              )
            end
        ...
        module CommenterType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::CommentMarkAsReadResponse::Data::CommenterType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
