...
module Telnyx
  module Models
    class PublicInternetGatewayListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::PublicInternetGatewayListResponse::Region)
        )
      end
      attr_reader :region
      ...
      sig do
        params(
          region:
            Telnyx::Models::PublicInternetGatewayListResponse::Region::OrHash
        ).void
      end
      attr_writer :region
        ...
        override.returns(
          {
            ...
            public_ip: String,
            region: Telnyx::Models::PublicInternetGatewayListResponse::Region,
            region_code: String
          }
        )
      end
      ...
      class Region < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::PublicInternetGatewayListResponse::Region,
              Telnyx::Internal::AnyHash
            )
          end
