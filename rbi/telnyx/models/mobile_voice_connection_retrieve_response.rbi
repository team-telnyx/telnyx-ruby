  ...
  module Models
    class MobileVoiceConnectionRetrieveResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::MobileVoiceConnectionRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::Inbound
            )
          )
        end
        attr_reader :inbound
        ...
        sig do
          params(
            inbound:
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::Inbound::OrHash
          ).void
        end
        attr_writer :inbound
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::Outbound
            )
          )
        end
        ...
        sig do
          params(
            outbound:
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::Outbound::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::WebhookAPIVersion::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        sig do
          params(
            ...
            webhook_api_version:
              T.nilable(
                Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::WebhookAPIVersion::OrSymbol
              ),
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::RecordType
              )
            end
        ...
        module WebhookAPIVersion
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::MobileVoiceConnectionRetrieveResponse::Data::WebhookAPIVersion
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
