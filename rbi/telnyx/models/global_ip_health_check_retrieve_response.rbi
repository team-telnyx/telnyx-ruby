  ...
  module Models
    class GlobalIPHealthCheckRetrieveResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::GlobalIPHealthCheckRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::GlobalIPHealthCheckRetrieveResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::GlobalIPHealthCheckRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
