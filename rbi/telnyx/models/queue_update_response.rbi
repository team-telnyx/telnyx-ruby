...
module Telnyx
  module Models
    class QueueUpdateResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Telnyx::Models::QueueUpdateResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Telnyx::Models::QueueUpdateResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(data: Telnyx::Models::QueueUpdateResponse::Data::OrHash).returns(
          T.attached_class
        )
      end
      ...
      sig do
        override.returns({ data: Telnyx::Models::QueueUpdateResponse::Data })
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::QueueUpdateResponse::Data,
        ...
        sig do
          returns(
            Telnyx::Models::QueueUpdateResponse::Data::RecordType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            name: String,
            record_type:
              Telnyx::Models::QueueUpdateResponse::Data::RecordType::OrSymbol,
            updated_at: String
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::QueueUpdateResponse::Data::RecordType
              )
            end
