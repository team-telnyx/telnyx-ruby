  ...
  module Models
    class PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T::Array[
            Telnyx::Models::PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse::Record
          ]
        )
      end
      ...
      sig do
        params(
          records:
            T::Array[
              Telnyx::Models::PhoneNumberAssignmentByProfileRetrievePhoneNumberStatusResponse::Record::OrHash
            ]
