    ...
    module Enterprises
      class ReputationUpdateFrequencyResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data::CheckFrequency::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              check_frequency:
                Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data::CheckFrequency::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module CheckFrequency
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data::CheckFrequency
                )
              end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Enterprises::ReputationUpdateFrequencyResponse::Data::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
