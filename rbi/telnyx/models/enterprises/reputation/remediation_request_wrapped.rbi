    ...
    module Enterprises
      module Reputation
        class RemediationRequestWrapped < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Telnyx::Enterprises::Reputation::RemediationRequestWrapped::Data
            )
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Telnyx::Enterprises::Reputation::RemediationRequestWrapped::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          class Data < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              params(
                results:
                  T.nilable(
                    Telnyx::Enterprises::Reputation::RemediationRequestWrapped::Data::Results::OrHash
                  )
              ).void
            end
            attr_writer :results
