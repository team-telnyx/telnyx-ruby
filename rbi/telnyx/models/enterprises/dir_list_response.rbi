    ...
    module Enterprises
      class DirListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::Enterprises::DirListResponse::CallReason]
            )
          )
        end
        ...
        sig do
          params(
            call_reasons:
              T::Array[
                Telnyx::Models::Enterprises::DirListResponse::CallReason::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::Enterprises::DirListResponse::Document]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::Enterprises::DirListResponse::RejectionReason
              ]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Enterprises::DirListResponse::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::Enterprises::DirListResponse::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          params(
            ...
            documents:
              T.nilable(
                T::Array[
                  Telnyx::Models::Enterprises::DirListResponse::Document::OrHash
                ]
              ),
            ...
            rejection_reasons:
              T.nilable(
                T::Array[
                  Telnyx::Models::Enterprises::DirListResponse::RejectionReason::OrHash
                ]
              ),
            reselling: T::Boolean,
            status:
          ...
          override.returns(
            {
              ...
              call_reasons:
                T::Array[
                  Telnyx::Models::Enterprises::DirListResponse::CallReason
                ],
              certify_brand_is_accurate: T::Boolean,
              certify_ip_ownership: T::Boolean,
              certify_no_shaft_content: T::Boolean,
              ...
              documents:
                T.nilable(
                  T::Array[
                    Telnyx::Models::Enterprises::DirListResponse::Document
                  ]
                ),
              enterprise_id: String,
              expiring_at: T.nilable(Time),
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Telnyx::Models::Enterprises::DirListResponse::Document::DocumentType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              document_id: String,
              document_type:
                Telnyx::Models::Enterprises::DirListResponse::Document::DocumentType::OrSymbol,
              description: String
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Enterprises::DirListResponse::Document::DocumentType
                )
              end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::Enterprises::DirListResponse::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
