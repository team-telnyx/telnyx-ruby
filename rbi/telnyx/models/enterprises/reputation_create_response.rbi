    ...
    module Enterprises
      class ReputationCreateResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Enterprises::ReputationCreateResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::Enterprises::ReputationCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: Telnyx::Models::Enterprises::ReputationCreateResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Enterprises::ReputationCreateResponse::Data::CheckFrequency::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              check_frequency:
                Telnyx::Models::Enterprises::ReputationCreateResponse::Data::CheckFrequency::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Enterprises::ReputationCreateResponse::Data::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::Enterprises::ReputationCreateResponse::Data::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module CheckFrequency
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Enterprises::ReputationCreateResponse::Data::CheckFrequency
                )
              end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Enterprises::ReputationCreateResponse::Data::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
