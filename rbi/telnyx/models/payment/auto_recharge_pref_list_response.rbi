    ...
    module Payment
      class AutoRechargePrefListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Payment::AutoRechargePrefListResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::Payment::AutoRechargePrefListResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: Telnyx::Models::Payment::AutoRechargePrefListResponse::Data
            }
          )
        end
        def to_hash
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Payment::AutoRechargePrefListResponse::Data::Preference::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              preference:
                Telnyx::Models::Payment::AutoRechargePrefListResponse::Data::Preference::OrSymbol
            ).void
          end
          ...
          module Preference
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Payment::AutoRechargePrefListResponse::Data::Preference
                )
              end
