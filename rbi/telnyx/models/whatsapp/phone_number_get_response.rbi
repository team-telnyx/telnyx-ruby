    ...
    module Whatsapp
      class PhoneNumberGetResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::Whatsapp::PhoneNumberGetResponse,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data]
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              T::Array[
                Telnyx::Models::Whatsapp::PhoneNumberGetResponse::Data::OrHash
              ]
          ).void
        end
        attr_writer :data
