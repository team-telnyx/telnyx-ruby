    ...
    module Whatsapp
      class PhoneNumberGetConversationWindowResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::Whatsapp::PhoneNumberGetConversationWindowResponse,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Whatsapp::PhoneNumberGetConversationWindowResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::Whatsapp::PhoneNumberGetConversationWindowResponse::Data::OrHash
          ).void
        end
        attr_writer :data
