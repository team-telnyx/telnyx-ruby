    ...
    module Whatsapp
      class TemplateListResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::Whatsapp::TemplateListResponse,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Whatsapp::TemplateListResponse::Category::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            category:
              Telnyx::Models::Whatsapp::TemplateListResponse::Category::OrSymbol
          ).void
        end
        ...
        sig do
          params(
            whatsapp_business_account:
              Telnyx::Models::Whatsapp::TemplateListResponse::WhatsappBusinessAccount::OrHash
          ).void
        end
        ...
        module Category
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::Whatsapp::TemplateListResponse::Category
              )
            end
