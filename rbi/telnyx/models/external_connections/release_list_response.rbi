      ...
      class ReleaseListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::ExternalConnections::ReleaseListResponse::Data
              ]
            )
          )
        end
        ...
        sig do
          params(
            data:
              T::Array[
                Telnyx::Models::ExternalConnections::ReleaseListResponse::Data::OrHash
              ]
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::ExternalConnections::ReleaseListResponse::Data::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::ExternalConnections::ReleaseListResponse::Data::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Telnyx::Models::ExternalConnections::ReleaseListResponse::Data::TelephoneNumber
                ]
              )
            )
          end
          ...
          sig do
            params(
              telephone_numbers:
                T::Array[
                  Telnyx::Models::ExternalConnections::ReleaseListResponse::Data::TelephoneNumber::OrHash
                ]
            ).void
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::ExternalConnections::ReleaseListResponse::Data::Status
                )
              end
