      ...
      class LogMessageRetrieveResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::ExternalConnections::LogMessageRetrieveResponse::LogMessage
              ]
            )
          )
        end
        ...
        sig do
          params(
            log_messages:
              T::Array[
                Telnyx::Models::ExternalConnections::LogMessageRetrieveResponse::LogMessage::OrHash
              ]
          ).void
        end
        ...
        class LogMessage < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            params(
              meta:
                Telnyx::Models::ExternalConnections::LogMessageRetrieveResponse::LogMessage::Meta::OrHash
            ).void
          end
          attr_writer :meta
          ...
          sig do
            params(
              source:
                Telnyx::Models::ExternalConnections::LogMessageRetrieveResponse::LogMessage::Source::OrHash
            ).void
          end
          attr_writer :source
