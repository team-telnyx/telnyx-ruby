  ...
  module Models
    module ExternalConnections
      class LogMessage < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(Telnyx::ExternalConnections::LogMessage::Meta))
        end
        attr_reader :meta

        sig do
          params(
            meta: Telnyx::ExternalConnections::LogMessage::Meta::OrHash
          ).void
        end
        attr_writer :meta

        sig do
          returns(T.nilable(Telnyx::ExternalConnections::LogMessage::Source))
        end
        attr_reader :source

        sig do
          params(
            source: Telnyx::ExternalConnections::LogMessage::Source::OrHash
          ).void
        end
        attr_writer :source
          ...
          override.returns(
            {
              ...
              title: String,
              detail: String,
              meta: Telnyx::ExternalConnections::LogMessage::Meta,
              source: Telnyx::ExternalConnections::LogMessage::Source
            }
          )
        end
        def to_hash
        ...
        class Meta < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::ExternalConnections::LogMessage::Meta,
                Telnyx::Internal::AnyHash
              )
            end
        ...
        class Source < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::ExternalConnections::LogMessage::Source,
                Telnyx::Internal::AnyHash
              )
            end
