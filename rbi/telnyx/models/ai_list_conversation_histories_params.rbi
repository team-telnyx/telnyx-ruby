  ...
  module Models
    class AIListConversationHistoriesParams < Telnyx::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::AIListConversationHistoriesParams,
      ...
      sig do
        returns(
          T.nilable(Telnyx::AIListConversationHistoriesParams::Region::OrSymbol)
        )
      end
      attr_reader :region
      ...
      sig do
        params(
          region: Telnyx::AIListConversationHistoriesParams::Region::OrSymbol
        ).void
      end
      attr_writer :region
      ...
      module Region
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::AIListConversationHistoriesParams::Region)
          end
        ...
        USA =
          T.let(
            :USA,
            Telnyx::AIListConversationHistoriesParams::Region::TaggedSymbol
          )
        DEU =
          T.let(
            :DEU,
