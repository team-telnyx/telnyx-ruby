...
module Telnyx
  module Models
    class NumbersPhoneNumberDetailed < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::NumbersPhoneNumberDetailed, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::NumbersPhoneNumberDetailed::EmergencyStatus::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          emergency_status:
            Telnyx::NumbersPhoneNumberDetailed::EmergencyStatus::OrSymbol
        ).void
      end
      ...
      sig do
        returns(
          Telnyx::NumbersPhoneNumberDetailed::PhoneNumberType::TaggedSymbol
        )
      end
      ...
      sig { returns(Telnyx::NumbersPhoneNumberDetailed::Status::TaggedSymbol) }
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::NumbersPhoneNumberDetailed::SourceType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          ...
          phone_number: String,
          phone_number_type:
            Telnyx::NumbersPhoneNumberDetailed::PhoneNumberType::OrSymbol,
          purchased_at: String,
          record_type: String,
          status: Telnyx::NumbersPhoneNumberDetailed::Status::OrSymbol,
          tags: T::Array[String],
          ...
          source_type:
            T.nilable(Telnyx::NumbersPhoneNumberDetailed::SourceType::OrSymbol),
        ...
        override.returns(
          {
            ...
            purchased_at: String,
            record_type: String,
            status: Telnyx::NumbersPhoneNumberDetailed::Status::TaggedSymbol,
            tags: T::Array[String],
            activated_at: T.nilable(Time),
            billing_group_id: T.nilable(String),
            call_forwarding_enabled: T::Boolean,
      ...
      module PhoneNumberType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::NumbersPhoneNumberDetailed::PhoneNumberType)
          end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::NumbersPhoneNumberDetailed::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        PURCHASE_PENDING =
          T.let(
            :"purchase-pending",
            Telnyx::NumbersPhoneNumberDetailed::Status::TaggedSymbol
          )
        PURCHASE_FAILED =
          T.let(
            :"purchase-failed",
        ...
        sig do
          override.returns(
            T::Array[Telnyx::NumbersPhoneNumberDetailed::Status::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module EmergencyStatus
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::NumbersPhoneNumberDetailed::EmergencyStatus)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module InboundCallScreening
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::NumbersPhoneNumberDetailed::InboundCallScreening
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module SourceType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::NumbersPhoneNumberDetailed::SourceType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
