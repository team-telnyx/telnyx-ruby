  ...
  module Models
    class ConferenceListParticipantsResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Telnyx::Models::ConferenceListParticipantsResponse::Data]
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[
              Telnyx::Models::ConferenceListParticipantsResponse::Data::OrHash
            ]
        ).void
      end
      attr_writer :data
        ...
        override.returns(
          {
            data:
              T::Array[
                Telnyx::Models::ConferenceListParticipantsResponse::Data
              ],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Telnyx::Models::ConferenceListParticipantsResponse::Data::Conference
          )
        end
        ...
        sig do
          params(
            conference:
              Telnyx::Models::ConferenceListParticipantsResponse::Data::Conference::OrHash
          ).void
        end
        ...
        sig do
          returns(
            Telnyx::Models::ConferenceListParticipantsResponse::Data::RecordType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            Telnyx::Models::ConferenceListParticipantsResponse::Data::Status::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            on_hold: T::Boolean,
            record_type:
              Telnyx::Models::ConferenceListParticipantsResponse::Data::RecordType::OrSymbol,
            soft_end_conference_on_exit: T::Boolean,
            status:
              Telnyx::Models::ConferenceListParticipantsResponse::Data::Status::OrSymbol,
            updated_at: String,
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::ConferenceListParticipantsResponse::Data::RecordType
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::ConferenceListParticipantsResponse::Data::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
