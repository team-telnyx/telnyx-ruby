...
module Telnyx
  module Models
    class PortingOrder < Telnyx::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(T::Array[Telnyx::PortingPhoneNumber])) }
      attr_reader :phone_numbers

      sig do
        params(phone_numbers: T::Array[Telnyx::PortingPhoneNumber::OrHash]).void
      end
      ...
      sig do
        params(
          ...
          phone_number_configuration:
            Telnyx::PortingOrderPhoneNumberConfiguration::OrHash,
          phone_number_type: Telnyx::PortingOrder::PhoneNumberType::OrSymbol,
          phone_numbers: T::Array[Telnyx::PortingPhoneNumber::OrHash],
        ...
        override.returns(
          {
            ...
            phone_numbers: T::Array[Telnyx::PortingPhoneNumber],
            porting_phone_numbers_count: Integer,
            record_type: String,
