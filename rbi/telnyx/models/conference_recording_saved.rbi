...
module Telnyx
  module Models
    class ConferenceRecordingSaved < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::ConferenceRecordingSaved, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(Telnyx::ConferenceRecordingSaved::EventType::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          event_type: Telnyx::ConferenceRecordingSaved::EventType::OrSymbol
        ).void
      end
      attr_writer :event_type

      sig { returns(T.nilable(Telnyx::ConferenceRecordingSaved::Payload)) }
      attr_reader :payload

      sig do
        params(payload: Telnyx::ConferenceRecordingSaved::Payload::OrHash).void
      end
      attr_writer :payload
      ...
      sig do
        returns(
          T.nilable(Telnyx::ConferenceRecordingSaved::RecordType::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          record_type: Telnyx::ConferenceRecordingSaved::RecordType::OrSymbol
        ).void
      end
      ...
      sig do
        params(
          id: String,
          event_type: Telnyx::ConferenceRecordingSaved::EventType::OrSymbol,
          payload: Telnyx::ConferenceRecordingSaved::Payload::OrHash,
          record_type: Telnyx::ConferenceRecordingSaved::RecordType::OrSymbol
        ...
        override.returns(
          {
            id: String,
            event_type:
              Telnyx::ConferenceRecordingSaved::EventType::TaggedSymbol,
            payload: Telnyx::ConferenceRecordingSaved::Payload,
            record_type:
              Telnyx::ConferenceRecordingSaved::RecordType::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      module EventType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::ConferenceRecordingSaved::EventType)
          end
        ...
        sig do
          override.returns(
            T::Array[Telnyx::ConferenceRecordingSaved::EventType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class Payload < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::ConferenceRecordingSaved::Payload,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::ConferenceRecordingSaved::Payload::Channels::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            channels:
              Telnyx::ConferenceRecordingSaved::Payload::Channels::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::ConferenceRecordingSaved::Payload::Format::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            file_format:
              Telnyx::ConferenceRecordingSaved::Payload::Format::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::ConferenceRecordingSaved::Payload::PublicRecordingURLs
            )
          )
        end
        ...
        sig do
          params(
            public_recording_urls:
              Telnyx::ConferenceRecordingSaved::Payload::PublicRecordingURLs::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Telnyx::ConferenceRecordingSaved::Payload::RecordingURLs)
          )
        end
        ...
        sig do
          params(
            recording_urls:
              Telnyx::ConferenceRecordingSaved::Payload::RecordingURLs::OrHash
          ).void
        end
          ...
          override.returns(
            {
              ...
              recording_started_at: Time,
              recording_urls:
                Telnyx::ConferenceRecordingSaved::Payload::RecordingURLs
            }
          )
        end
        def to_hash
        ...
        module Channels
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::ConferenceRecordingSaved::Payload::Channels)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Format
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::ConferenceRecordingSaved::Payload::Format)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::ConferenceRecordingSaved::RecordType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        sig do
          override.returns(
            T::Array[Telnyx::ConferenceRecordingSaved::RecordType::TaggedSymbol]
          )
        end
        def self.values
        end
