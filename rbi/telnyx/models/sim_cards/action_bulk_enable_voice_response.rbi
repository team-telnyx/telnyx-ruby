    ...
    module SimCards
      class ActionBulkEnableVoiceResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data::ActionType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              action_type:
                Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data::ActionType::OrSymbol
            ).void
          end
          ...
          module ActionType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::SimCards::ActionBulkEnableVoiceResponse::Data::ActionType
                )
              end
