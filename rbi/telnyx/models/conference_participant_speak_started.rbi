  ...
  module Models
    class ConferenceParticipantSpeakStarted < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::ConferenceParticipantSpeakStarted,
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::ConferenceParticipantSpeakStarted::EventType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          event_type:
            Telnyx::ConferenceParticipantSpeakStarted::EventType::OrSymbol
        ).void
      end
      attr_writer :event_type

      sig do
        returns(T.nilable(Telnyx::ConferenceParticipantSpeakStarted::Payload))
      end
      attr_reader :payload

      sig do
        params(
          payload: Telnyx::ConferenceParticipantSpeakStarted::Payload::OrHash
        ).void
      end
      attr_writer :payload
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::ConferenceParticipantSpeakStarted::RecordType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          record_type:
            Telnyx::ConferenceParticipantSpeakStarted::RecordType::OrSymbol
        ).void
      end
        ...
        override.returns(
          {
            ...
            event_type:
              Telnyx::ConferenceParticipantSpeakStarted::EventType::TaggedSymbol,
            payload: Telnyx::ConferenceParticipantSpeakStarted::Payload,
            record_type:
              Telnyx::ConferenceParticipantSpeakStarted::RecordType::TaggedSymbol
          }
        )
      ...
      module EventType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::ConferenceParticipantSpeakStarted::EventType)
          end
      ...
      class Payload < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::ConferenceParticipantSpeakStarted::Payload,
              Telnyx::Internal::AnyHash
            )
          end
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::ConferenceParticipantSpeakStarted::RecordType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
