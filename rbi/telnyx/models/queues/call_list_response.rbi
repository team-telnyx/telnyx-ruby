  ...
  module Models
    module Queues
      class CallListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(T::Array[Telnyx::Models::Queues::CallListResponse::Data])
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              T::Array[Telnyx::Models::Queues::CallListResponse::Data::OrHash]
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: T::Array[Telnyx::Models::Queues::CallListResponse::Data],
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::Queues::CallListResponse::Data,
                Telnyx::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Telnyx::Models::Queues::CallListResponse::Data::RecordType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              record_type:
                Telnyx::Models::Queues::CallListResponse::Data::RecordType::OrSymbol,
              to: String,
          ...
          module RecordType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Queues::CallListResponse::Data::RecordType
                )
              end
