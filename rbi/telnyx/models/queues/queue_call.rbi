...
module Telnyx
  module Models
    QueueCall = Queues::QueueCall

    module Queues
      class QueueCall < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Telnyx::Queues::QueueCall, Telnyx::Internal::AnyHash)
          end
        ...
        sig { returns(Telnyx::Queues::QueueCall::RecordType::TaggedSymbol) }
        ...
        sig do
          params(
            ...
            record_type: Telnyx::Queues::QueueCall::RecordType::OrSymbol,
            to: String,
          ...
          override.returns(
            {
              ...
              queue_id: String,
              queue_position: Integer,
              record_type: Telnyx::Queues::QueueCall::RecordType::TaggedSymbol,
              to: String,
              wait_time_secs: Integer,
              is_alive: T::Boolean
            }
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Queues::QueueCall::RecordType)
            end
          ...
          QUEUE_CALL =
            T.let(
              :queue_call,
              Telnyx::Queues::QueueCall::RecordType::TaggedSymbol
            )

          sig do
            override.returns(
              T::Array[Telnyx::Queues::QueueCall::RecordType::TaggedSymbol]
            )
          end
          def self.values
          end
