...
module Telnyx
  module Models
    class CallDialParams < Telnyx::Internal::Type::BaseModel
      ...
      # fields.
      sig { returns(T.nilable(Telnyx::CallDialParams::Assistant)) }
      attr_reader :assistant

      sig { params(assistant: Telnyx::CallDialParams::Assistant::OrHash).void }
        ...
        override.returns(
          {
            ...
            assistant: Telnyx::CallDialParams::Assistant,
            audio_url: String,
            billing_group_id: String,
            bridge_intent: T::Boolean,
            bridge_on_answer: T::Boolean,
      ...
      class Assistant < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Telnyx::CallDialParams::Assistant, Telnyx::Internal::AnyHash)
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Hash[
                Symbol,
                Telnyx::CallDialParams::Assistant::DynamicVariable::Variants
              ]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                T.any(
                  Telnyx::CallDialParams::Assistant::Tool::BookAppointment,
                  Telnyx::CallDialParams::Assistant::Tool::CheckAvailability,
                  Telnyx::AI::WebhookTool,
                  Telnyx::AI::HangupTool,
                  Telnyx::AI::TransferTool,
                  Telnyx::CallDialParams::Assistant::Tool::Retrieval
                )
              ]
            )
          )
        ...
        sig do
          params(
            tools:
              T::Array[
                T.any(
                  Telnyx::CallDialParams::Assistant::Tool::BookAppointment::OrHash,
                  Telnyx::CallDialParams::Assistant::Tool::CheckAvailability::OrHash,
                  Telnyx::AI::WebhookTool::OrHash,
                  Telnyx::AI::HangupTool::OrHash,
                  Telnyx::AI::TransferTool::OrHash,
                  Telnyx::CallDialParams::Assistant::Tool::Retrieval::OrHash
                )
              ]
          ).void
        end
        ...
        module Tool
          ...
          class BookAppointment < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              params(
                book_appointment:
                  Telnyx::CallDialParams::Assistant::Tool::BookAppointment::BookAppointment::OrHash
              ).void
            end
          ...
          class CheckAvailability < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              params(
                check_availability:
                  Telnyx::CallDialParams::Assistant::Tool::CheckAvailability::CheckAvailability::OrHash
              ).void
            end
          ...
          class Retrieval < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Telnyx::CallDialParams::Assistant::Tool::Retrieval::Retrieval
              )
            end
            ...
            sig do
              params(
                retrieval:
                  Telnyx::CallDialParams::Assistant::Tool::Retrieval::Retrieval::OrHash
              ).void
            end
          ...
          sig do
            override.returns(
              T::Array[Telnyx::CallDialParams::Assistant::Tool::Variants]
            )
          end
          def self.variants
          end
