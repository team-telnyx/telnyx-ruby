  ...
  module Models
    class DialogflowConnectionRetrieveResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::DialogflowConnectionRetrieveResponse,
            Telnyx::Internal::AnyHash
          )
        end

      sig do
        returns(Telnyx::Models::DialogflowConnectionRetrieveResponse::Data)
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::DialogflowConnectionRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DialogflowConnectionRetrieveResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
