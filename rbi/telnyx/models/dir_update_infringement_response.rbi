  ...
  module Models
    class DirUpdateInfringementResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::DirUpdateInfringementResponse,
            Telnyx::Internal::AnyHash
          )
        end

      sig { returns(Telnyx::Models::DirUpdateInfringementResponse::Data) }
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::DirUpdateInfringementResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DirUpdateInfringementResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::DirUpdateInfringementResponse::Data::CallReason
              ]
            )
          )
        end
        ...
        sig do
          params(
            call_reasons:
              T::Array[
                Telnyx::Models::DirUpdateInfringementResponse::Data::CallReason::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::DirUpdateInfringementResponse::Data::Document
              ]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::DirUpdateInfringementResponse::Data::RejectionReason
              ]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::DirUpdateInfringementResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::DirUpdateInfringementResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          params(
            ...
            documents:
              T.nilable(
                T::Array[
                  Telnyx::Models::DirUpdateInfringementResponse::Data::Document::OrHash
                ]
              ),
            ...
            rejection_reasons:
              T.nilable(
                T::Array[
                  Telnyx::Models::DirUpdateInfringementResponse::Data::RejectionReason::OrHash
                ]
              ),
            reselling: T::Boolean,
            status:
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Telnyx::Models::DirUpdateInfringementResponse::Data::Document::DocumentType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              document_id: String,
              document_type:
                Telnyx::Models::DirUpdateInfringementResponse::Data::Document::DocumentType::OrSymbol,
              description: String
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::DirUpdateInfringementResponse::Data::Document::DocumentType
                )
              end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::DirUpdateInfringementResponse::Data::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
