  ...
  module Models
    class DirRetrieveDocumentTypesResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::DirRetrieveDocumentTypesResponse,
      ...
      sig do
        returns(
          T::Array[Telnyx::Models::DirRetrieveDocumentTypesResponse::Data]
        )
      end
      attr_accessor :data
      ...
      sig do
        params(
          data:
            T::Array[
              Telnyx::Models::DirRetrieveDocumentTypesResponse::Data::OrHash
            ],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DirRetrieveDocumentTypesResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
