  ...
  module Models
    class MessagingProfileListShortCodesResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::MessagingProfileListShortCodesResponse,
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::MessagingProfileListShortCodesResponse::Meta
          )
        )
      end
      attr_reader :meta
      ...
      sig do
        params(
          meta:
            Telnyx::Models::MessagingProfileListShortCodesResponse::Meta::OrHash
        ).void
      end
      attr_writer :meta
        ...
        override.returns(
          {
            ...
            meta: Telnyx::Models::MessagingProfileListShortCodesResponse::Meta
          }
        )
      end
      def to_hash
