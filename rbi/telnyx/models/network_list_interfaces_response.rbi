  ...
  module Models
    class NetworkListInterfacesResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Telnyx::Models::NetworkListInterfacesResponse::Data]
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[
              Telnyx::Models::NetworkListInterfacesResponse::Data::OrHash
            ]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::NetworkListInterfacesResponse::Data],
