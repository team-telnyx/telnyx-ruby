...
module Telnyx
  module Models
    class AIRetrieveConversationHistoriesResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          Telnyx::Models::AIRetrieveConversationHistoriesResponse::Region::TaggedSymbol
        )
      end
      ...
      sig do
        params(
          ...
          record_id: String,
          region:
            Telnyx::Models::AIRetrieveConversationHistoriesResponse::Region::OrSymbol,
          score: Float,
          text: String,
          user_id: String,
      ...
      module Region
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::AIRetrieveConversationHistoriesResponse::Region
            )
          end
