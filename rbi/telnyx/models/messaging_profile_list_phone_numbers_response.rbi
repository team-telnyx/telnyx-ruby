  ...
  module Models
    class MessagingProfileListPhoneNumbersResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::MessagingProfileListPhoneNumbersResponse,
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::MessagingProfileListPhoneNumbersResponse::Meta
          )
        )
      end
      attr_reader :meta
      ...
      sig do
        params(
          meta:
            Telnyx::Models::MessagingProfileListPhoneNumbersResponse::Meta::OrHash
        ).void
      end
      attr_writer :meta
        ...
        override.returns(
          {
            ...
            meta: Telnyx::Models::MessagingProfileListPhoneNumbersResponse::Meta
          }
        )
      end
      def to_hash
