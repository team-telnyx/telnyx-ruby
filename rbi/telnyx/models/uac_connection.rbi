...
module Telnyx
  module Models
    class UacConnection < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::UacConnection::NoiseSuppression::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          noise_suppression: Telnyx::UacConnection::NoiseSuppression::OrSymbol
        ).void
      end
        ...
        override.returns(
          {
            ...
            noise_suppression:
              Telnyx::UacConnection::NoiseSuppression::TaggedSymbol,
            noise_suppression_details:
      ...
      module NoiseSuppression
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::UacConnection::NoiseSuppression)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        INBOUND =
          T.let(:inbound, Telnyx::UacConnection::NoiseSuppression::TaggedSymbol)
        OUTBOUND =
          T.let(
            :outbound,
            Telnyx::UacConnection::NoiseSuppression::TaggedSymbol
        ...
        BOTH =
          T.let(:both, Telnyx::UacConnection::NoiseSuppression::TaggedSymbol)
        DISABLED =
          T.let(
            :disabled,
            Telnyx::UacConnection::NoiseSuppression::TaggedSymbol
        ...
        sig do
          override.returns(
            T::Array[Telnyx::UacConnection::NoiseSuppression::TaggedSymbol]
          )
        end
        def self.values
        end
