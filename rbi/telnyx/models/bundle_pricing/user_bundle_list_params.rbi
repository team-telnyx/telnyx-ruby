  ...
  module Models
    module BundlePricing
      class UserBundleListParams < Telnyx::Internal::Type::BaseModel
        ...
        # page[number]
        sig do
          returns(T.nilable(Telnyx::BundlePricing::UserBundleListParams::Page))
        end
        attr_reader :page
          ...
          override.returns(
            {
              ...
              page: Telnyx::BundlePricing::UserBundleListParams::Page,
              authorization_bearer: String,
        ...
        class Page < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::BundlePricing::UserBundleListParams::Page,
                Telnyx::Internal::AnyHash
              )
            end
