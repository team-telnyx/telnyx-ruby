...
module Telnyx
  module Models
    class SimCardGroupListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::SimCardGroupListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: T::Array[Telnyx::Models::SimCardGroupListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        params(
          data:
            T::Array[Telnyx::Models::SimCardGroupListResponse::Data::OrHash],
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::SimCardGroupListResponse::Data],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::SimCardGroupListResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(Telnyx::Models::SimCardGroupListResponse::Data::DataLimit)
          )
        end
        ...
        sig do
          params(
            data_limit:
              Telnyx::Models::SimCardGroupListResponse::Data::DataLimit::OrHash
          ).void
        end
