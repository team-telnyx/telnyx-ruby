  ...
  module Models
    class ConferenceParticipantPlaybackEnded < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::ConferenceParticipantPlaybackEnded,
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::ConferenceParticipantPlaybackEnded::EventType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          event_type:
            Telnyx::ConferenceParticipantPlaybackEnded::EventType::OrSymbol
        ).void
      end
      attr_writer :event_type

      sig do
        returns(T.nilable(Telnyx::ConferenceParticipantPlaybackEnded::Payload))
      end
      attr_reader :payload

      sig do
        params(
          payload: Telnyx::ConferenceParticipantPlaybackEnded::Payload::OrHash
        ).void
      end
      attr_writer :payload
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::ConferenceParticipantPlaybackEnded::RecordType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          record_type:
            Telnyx::ConferenceParticipantPlaybackEnded::RecordType::OrSymbol
        ).void
      end
        ...
        override.returns(
          {
            ...
            event_type:
              Telnyx::ConferenceParticipantPlaybackEnded::EventType::TaggedSymbol,
            payload: Telnyx::ConferenceParticipantPlaybackEnded::Payload,
            record_type:
              Telnyx::ConferenceParticipantPlaybackEnded::RecordType::TaggedSymbol
          }
        )
      ...
      module EventType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::ConferenceParticipantPlaybackEnded::EventType)
          end
      ...
      class Payload < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::ConferenceParticipantPlaybackEnded::Payload,
              Telnyx::Internal::AnyHash
            )
          end
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::ConferenceParticipantPlaybackEnded::RecordType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
