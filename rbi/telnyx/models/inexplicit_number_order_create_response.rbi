  ...
  module Models
    class InexplicitNumberOrderCreateResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::InexplicitNumberOrderCreateResponse,
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::InexplicitNumberOrderCreateResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::InexplicitNumberOrderCreateResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::InexplicitNumberOrderCreateResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup
              ]
            )
          )
        end
        ...
        sig do
          params(
            ordering_groups:
              T::Array[
                Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::OrHash
              ]
          ).void
        end
        ...
        class OrderingGroup < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Order
                ]
              )
            )
          end
          ...
          sig do
            params(
              orders:
                T::Array[
                  Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Order::OrHash
                ]
            ).void
          end
          attr_writer :orders
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Strategy::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              strategy:
                Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Strategy::OrSymbol
            ).void
          end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Status
                )
              end
          ...
          module Strategy
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::InexplicitNumberOrderCreateResponse::Data::OrderingGroup::Strategy
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
