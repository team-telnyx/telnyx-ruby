  ...
  module Models
    module Networks
      class DefaultGatewayCreateResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(T::Array[Telnyx::Networks::NetworksDefaultGateway]))
        end
        attr_reader :data

        sig do
          params(
            data: T::Array[Telnyx::Networks::NetworksDefaultGateway::OrHash]
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: T::Array[Telnyx::Networks::NetworksDefaultGateway],
