...
module Telnyx
  module Models
    class DirListResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::Models::DirListResponse, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::DirListResponse::CallReason])
        )
      end
      ...
      sig do
        params(
          call_reasons:
            T::Array[Telnyx::Models::DirListResponse::CallReason::OrHash]
        ).void
      end
      ...
      sig do
        returns(T.nilable(T::Array[Telnyx::Models::DirListResponse::Document]))
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::DirListResponse::RejectionReason])
        )
      end
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::DirListResponse::Status::TaggedSymbol)
        )
      end
      attr_reader :status

      sig do
        params(status: Telnyx::Models::DirListResponse::Status::OrSymbol).void
      end
      attr_writer :status
      ...
      sig do
        params(
          ...
          documents:
            T.nilable(
              T::Array[Telnyx::Models::DirListResponse::Document::OrHash]
            ),
          ...
          rejection_reasons:
            T.nilable(
              T::Array[Telnyx::Models::DirListResponse::RejectionReason::OrHash]
            ),
          reselling: T::Boolean,
          status: Telnyx::Models::DirListResponse::Status::OrSymbol,
        ...
        override.returns(
          {
            ...
            authorizer_email: T.nilable(String),
            authorizer_name: T.nilable(String),
            call_reasons: T::Array[Telnyx::Models::DirListResponse::CallReason],
            certify_brand_is_accurate: T::Boolean,
            certify_ip_ownership: T::Boolean,
            certify_no_shaft_content: T::Boolean,
            created_at: Time,
            display_name: String,
            documents:
              T.nilable(T::Array[Telnyx::Models::DirListResponse::Document]),
            enterprise_id: String,
            expiring_at: T.nilable(Time),
            logo_url: T.nilable(String),
            rejected_at: T.nilable(Time),
            rejection_reasons:
              T.nilable(
                T::Array[Telnyx::Models::DirListResponse::RejectionReason]
              ),
            reselling: T::Boolean,
            status: Telnyx::Models::DirListResponse::Status::TaggedSymbol,
            submitted_at: T.nilable(Time),
            updated_at: Time,
            verified_at: T.nilable(Time)
          }
      ...
      class Document < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DirListResponse::Document,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            Telnyx::Models::DirListResponse::Document::DocumentType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            document_id: String,
            document_type:
              Telnyx::Models::DirListResponse::Document::DocumentType::OrSymbol,
            description: String
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module DocumentType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::DirListResponse::Document::DocumentType
              )
            end
      ...
      class RejectionReason < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DirListResponse::RejectionReason,
              Telnyx::Internal::AnyHash
            )
          end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::Models::DirListResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        DRAFT =
          T.let(:draft, Telnyx::Models::DirListResponse::Status::TaggedSymbol)
        SUBMITTED =
          T.let(
            :submitted,
            Telnyx::Models::DirListResponse::Status::TaggedSymbol
          )
        IN_REVIEW =
          T.let(
            :in_review,
        ...
        EXPIRED =
          T.let(:expired, Telnyx::Models::DirListResponse::Status::TaggedSymbol)
        ...
        sig do
          override.returns(
            T::Array[Telnyx::Models::DirListResponse::Status::TaggedSymbol]
          )
        end
        def self.values
        end
