  ...
  module Models
    class EnterpriseUpdateResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::EnterpriseUpdateResponse,
            Telnyx::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(Telnyx::Models::EnterpriseUpdateResponse::Data)) }
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::EnterpriseUpdateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::EnterpriseUpdateResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::EnterpriseUpdateResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseUpdateResponse::Data::BillingAddress
            )
          )
        end
        ...
        sig do
          params(
            billing_address:
              Telnyx::Models::EnterpriseUpdateResponse::Data::BillingAddress::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseUpdateResponse::Data::BillingContact
            )
          )
        end
        ...
        sig do
          params(
            billing_contact:
              Telnyx::Models::EnterpriseUpdateResponse::Data::BillingContact::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseUpdateResponse::Data::NumberOfEmployees::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationContact
            )
          )
        end
        ...
        sig do
          params(
            organization_contact:
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationContact::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationLegalType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            organization_physical_address:
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationPhysicalAddress::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            organization_type:
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseUpdateResponse::Data::RoleType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            role_type:
              Telnyx::Models::EnterpriseUpdateResponse::Data::RoleType::OrSymbol
          ).void
        end
        ...
        sig do
          params(
            ...
            number_of_employees:
              T.nilable(
                Telnyx::Models::EnterpriseUpdateResponse::Data::NumberOfEmployees::OrSymbol
              ),
            organization_contact:
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationContact::OrHash,
            organization_legal_type:
              T.nilable(
                Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationLegalType::OrSymbol
              ),
            organization_physical_address:
              Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationPhysicalAddress::OrHash,
            organization_type:
        ...
        module NumberOfEmployees
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseUpdateResponse::Data::NumberOfEmployees
              )
            end
        ...
        module OrganizationLegalType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationLegalType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module OrganizationType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseUpdateResponse::Data::OrganizationType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module RoleType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseUpdateResponse::Data::RoleType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
