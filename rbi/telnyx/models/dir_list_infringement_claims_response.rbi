  ...
  module Models
    class DirListInfringementClaimsResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::DirListInfringementClaimsResponse::ClaimType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          claim_type:
            Telnyx::Models::DirListInfringementClaimsResponse::ClaimType::OrSymbol
        ).void
      end
      ...
      sig do
        params(
          contest_documents:
            T::Array[
              Telnyx::Models::DirListInfringementClaimsResponse::ContestDocument::OrHash
            ]
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::DirListInfringementClaimsResponse::Dir)
        )
      end
      attr_reader :dir
      ...
      sig do
        params(
          dir: Telnyx::Models::DirListInfringementClaimsResponse::Dir::OrHash
        ).void
      end
      attr_writer :dir
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::DirListInfringementClaimsResponse::Resolution::TaggedSymbol
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::DirListInfringementClaimsResponse::Status::TaggedSymbol
          )
        )
      end
      attr_reader :status
      ...
      sig do
        params(
          status:
            Telnyx::Models::DirListInfringementClaimsResponse::Status::OrSymbol
        ).void
      end
      attr_writer :status
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              Telnyx::Models::DirListInfringementClaimsResponse::ContestHistory
            ]
          )
        )
      end
      ...
      sig do
        params(
          contest_history:
            T::Array[
              Telnyx::Models::DirListInfringementClaimsResponse::ContestHistory::OrHash
            ]
        ).void
      end
      ...
      sig do
        params(
          ...
          resolution:
            T.nilable(
              Telnyx::Models::DirListInfringementClaimsResponse::Resolution::OrSymbol
            ),
      ...
      module ClaimType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::DirListInfringementClaimsResponse::ClaimType
            )
          end
      ...
      class ContestDocument < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Telnyx::Models::DirListInfringementClaimsResponse::ContestDocument::DocumentType::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            document_id: String,
            document_type:
              Telnyx::Models::DirListInfringementClaimsResponse::ContestDocument::DocumentType::OrSymbol,
            description: String
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module DocumentType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::DirListInfringementClaimsResponse::ContestDocument::DocumentType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Dir < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DirListInfringementClaimsResponse::Dir,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::DirListInfringementClaimsResponse::Dir::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::DirListInfringementClaimsResponse::Dir::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::DirListInfringementClaimsResponse::Dir::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Resolution
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::DirListInfringementClaimsResponse::Resolution
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::DirListInfringementClaimsResponse::Status
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
