    ...
    module Organizations
      class UserRetrieveResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::Organizations::UserRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(Telnyx::Models::Organizations::UserRetrieveResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::Organizations::UserRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Organizations::UserRetrieveResponse::Data::UserStatus::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              user_status:
                Telnyx::Models::Organizations::UserRetrieveResponse::Data::UserStatus::OrSymbol
            ).void
          end
          ...
          module UserStatus
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Organizations::UserRetrieveResponse::Data::UserStatus
                )
              end
