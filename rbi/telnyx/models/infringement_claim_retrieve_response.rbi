  ...
  module Models
    class InfringementClaimRetrieveResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::InfringementClaimRetrieveResponse,
            Telnyx::Internal::AnyHash
          )
        end

      sig { returns(Telnyx::Models::InfringementClaimRetrieveResponse::Data) }
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::InfringementClaimRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::InfringementClaimRetrieveResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::ClaimType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            claim_type:
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::ClaimType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::ContestDocument
              ]
            )
          )
        end
        ...
        sig do
          params(
            contest_documents:
              T::Array[
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::ContestDocument::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::Dir
            )
          )
        end
        attr_reader :dir
        ...
        sig do
          params(
            dir:
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::Dir::OrHash
          ).void
        end
        attr_writer :dir
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::Resolution::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::ContestHistory
              ]
            )
          )
        end
        ...
        sig do
          params(
            contest_history:
              T::Array[
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::ContestHistory::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            ...
            resolution:
              T.nilable(
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::Resolution::OrSymbol
              ),
          ...
          override.returns(
            {
              ...
              created_at: Time,
              dir: Telnyx::Models::InfringementClaimRetrieveResponse::Data::Dir,
              dir_id: String,
              enterprise_id: String,
              resolution:
                T.nilable(
        ...
        module ClaimType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::ClaimType
              )
            end
        ...
        class ContestDocument < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Telnyx::Models::InfringementClaimRetrieveResponse::Data::ContestDocument::DocumentType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              document_id: String,
              document_type:
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::ContestDocument::DocumentType::OrSymbol,
              description: String
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::InfringementClaimRetrieveResponse::Data::ContestDocument::DocumentType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Dir < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::Dir::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::Dir::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::InfringementClaimRetrieveResponse::Data::Dir::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Resolution
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::Resolution
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::InfringementClaimRetrieveResponse::Data::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
