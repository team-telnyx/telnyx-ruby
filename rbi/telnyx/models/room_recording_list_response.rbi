...
module Telnyx
  module Models
    class RoomRecordingListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::RoomRecordingListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[Telnyx::Models::RoomRecordingListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::RoomRecordingListResponse::Data],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::RoomRecordingListResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::RoomRecordingListResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::RoomRecordingListResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::RoomRecordingListResponse::Data::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              Telnyx::Models::RoomRecordingListResponse::Data::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::RoomRecordingListResponse::Data::Status
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::RoomRecordingListResponse::Data::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
