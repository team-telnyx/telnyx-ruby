    ...
    module Actions
      class PurchaseCreateResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::Actions::PurchaseCreateResponse,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::Actions::PurchaseCreateResponse::Error]
            )
          )
        end
        attr_reader :errors
        ...
        sig do
          params(
            errors:
              T::Array[
                Telnyx::Models::Actions::PurchaseCreateResponse::Error::OrHash
              ]
          ).void
        end
        attr_writer :errors
        ...
        class Error < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::Actions::PurchaseCreateResponse::Error,
                Telnyx::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              source:
                Telnyx::Models::Actions::PurchaseCreateResponse::Error::Source::OrHash
            ).void
          end
          attr_writer :source
