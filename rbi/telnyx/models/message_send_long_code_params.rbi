...
module Telnyx
  module Models
    class MessageSendLongCodeParams < Telnyx::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Telnyx::MessageSendLongCodeParams, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(Telnyx::MessageSendLongCodeParams::Encoding::OrSymbol)
        )
      end
      ...
      sig do
        returns(T.nilable(Telnyx::MessageSendLongCodeParams::Type::OrSymbol))
      end
      attr_reader :type

      sig do
        params(type: Telnyx::MessageSendLongCodeParams::Type::OrSymbol).void
      end
      attr_writer :type
      ...
      module Encoding
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::MessageSendLongCodeParams::Encoding)
          end
        ...
        AUTO =
          T.let(
            :auto,
            Telnyx::MessageSendLongCodeParams::Encoding::TaggedSymbol
          )
        GSM7 =
          T.let(
            :gsm7,
        ...
        sig do
          override.returns(
            T::Array[Telnyx::MessageSendLongCodeParams::Encoding::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::MessageSendLongCodeParams::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        SMS = T.let(:SMS, Telnyx::MessageSendLongCodeParams::Type::TaggedSymbol)
        MMS = T.let(:MMS, Telnyx::MessageSendLongCodeParams::Type::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Telnyx::MessageSendLongCodeParams::Type::TaggedSymbol]
          )
        end
        def self.values
        end
