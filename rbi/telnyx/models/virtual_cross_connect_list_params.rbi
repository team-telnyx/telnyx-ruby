...
module Telnyx
  module Models
    class VirtualCrossConnectListParams < Telnyx::Internal::Type::BaseModel
      ...
      # page[size]
      sig { returns(T.nilable(Telnyx::VirtualCrossConnectListParams::Page)) }
      attr_reader :page

      sig do
        params(page: Telnyx::VirtualCrossConnectListParams::Page::OrHash).void
      end
      attr_writer :page
      ...
      class Page < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::VirtualCrossConnectListParams::Page,
              Telnyx::Internal::AnyHash
            )
          end
