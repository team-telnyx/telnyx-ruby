  ...
  module Models
    class CountryCoverageRetrieveCountryResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        params(
          data:
            Telnyx::Models::CountryCoverageRetrieveCountryResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          params(
            local:
              Telnyx::Models::CountryCoverageRetrieveCountryResponse::Data::Local::OrHash
          ).void
        end
        attr_writer :local
        ...
        sig do
          params(
            toll_free:
              Telnyx::Models::CountryCoverageRetrieveCountryResponse::Data::TollFree::OrHash
          ).void
        end
