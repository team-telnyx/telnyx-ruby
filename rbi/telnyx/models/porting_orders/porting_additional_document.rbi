    ...
    module PortingOrders
      class PortingAdditionalDocument < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::PortingOrders::PortingAdditionalDocument::DocumentType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            document_type:
              Telnyx::PortingOrders::PortingAdditionalDocument::DocumentType::OrSymbol
          ).void
        end
        ...
        module DocumentType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::PortingOrders::PortingAdditionalDocument::DocumentType
              )
            end
