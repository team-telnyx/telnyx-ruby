            ...
            returns(
              T.nilable(
                T.any(
                  ...
                  T::Array[
                    Telnyx::PortingOrders::PhoneNumberBlockListParams::Filter::Status::PortingOrderStatusArray::OrSymbol
                  ]
                )
              )
            )
            ...
            Variants =
              T.type_alias do
                T.any(
                  ...
                  T::Array[
                    Telnyx::PortingOrders::PhoneNumberBlockListParams::Filter::Status::PortingOrderStatusArray::TaggedSymbol
                  ]
                )
              end
