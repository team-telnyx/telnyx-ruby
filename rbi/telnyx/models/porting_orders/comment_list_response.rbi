    ...
    module PortingOrders
      class CommentListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::PortingOrders::CommentListResponse::Data]
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              T::Array[
                Telnyx::Models::PortingOrders::CommentListResponse::Data::OrHash
              ]
          ).void
        end
        attr_writer :data
          ...
          override.returns(
            {
              data:
                T::Array[
                  Telnyx::Models::PortingOrders::CommentListResponse::Data
                ],
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::PortingOrders::CommentListResponse::Data::UserType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              user_type:
                Telnyx::Models::PortingOrders::CommentListResponse::Data::UserType::OrSymbol
            ).void
          end
          ...
          module UserType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::PortingOrders::CommentListResponse::Data::UserType
                )
              end
