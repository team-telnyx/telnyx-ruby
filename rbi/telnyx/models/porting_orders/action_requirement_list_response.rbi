      ...
      class ActionRequirementListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::PortingOrders::ActionRequirementListResponse::Data
              ]
            )
          )
        end
        ...
        sig do
          params(
            data:
              T::Array[
                Telnyx::Models::PortingOrders::ActionRequirementListResponse::Data::OrHash
              ]
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::PortingOrders::ActionRequirementListResponse::Data::RecordType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              record_type:
                Telnyx::Models::PortingOrders::ActionRequirementListResponse::Data::RecordType::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::PortingOrders::ActionRequirementListResponse::Data::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::PortingOrders::ActionRequirementListResponse::Data::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module RecordType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::PortingOrders::ActionRequirementListResponse::Data::RecordType
                )
              end
