    ...
    module PortingOrders
      class PortingActionRequirement < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::PortingOrders::PortingActionRequirement,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::PortingOrders::PortingActionRequirement::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::PortingOrders::PortingActionRequirement::RecordType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::PortingOrders::PortingActionRequirement::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::PortingOrders::PortingActionRequirement::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::PortingOrders::PortingActionRequirement::RecordType
              )
            end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::PortingOrders::PortingActionRequirement::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
