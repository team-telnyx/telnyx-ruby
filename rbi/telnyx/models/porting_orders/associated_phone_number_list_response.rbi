    ...
    module PortingOrders
      class AssociatedPhoneNumberListResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::PortingOrders::AssociatedPhoneNumberListResponse,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::PortingOrders::PortingAssociatedPhoneNumber]
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              T::Array[
                Telnyx::PortingOrders::PortingAssociatedPhoneNumber::OrHash
              ]
          ).void
        end
        attr_writer :data
