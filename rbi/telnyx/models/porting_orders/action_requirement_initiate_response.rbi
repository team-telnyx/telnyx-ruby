    ...
    module PortingOrders
      class ActionRequirementInitiateResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          params(
            data:
              Telnyx::Models::PortingOrders::ActionRequirementInitiateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::PortingOrders::ActionRequirementInitiateResponse::Data::RecordType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              record_type:
                Telnyx::Models::PortingOrders::ActionRequirementInitiateResponse::Data::RecordType::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::PortingOrders::ActionRequirementInitiateResponse::Data::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::PortingOrders::ActionRequirementInitiateResponse::Data::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module RecordType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::PortingOrders::ActionRequirementInitiateResponse::Data::RecordType
                )
              end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::PortingOrders::ActionRequirementInitiateResponse::Data::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
