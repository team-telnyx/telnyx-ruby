      ...
      module Accounts
        class ConferenceUpdateResponse < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::ReasonConferenceEnded::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              reason_conference_ended:
                Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::ReasonConferenceEnded::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module ReasonConferenceEnded
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Texml::Accounts::ConferenceUpdateResponse::ReasonConferenceEnded
                )
              end
