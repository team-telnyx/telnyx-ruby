      ...
      module Accounts
        class ConferenceResource < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Texml::Accounts::ConferenceResource,
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Texml::Accounts::ConferenceResource::ReasonConferenceEnded::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              reason_conference_ended:
                Telnyx::Texml::Accounts::ConferenceResource::ReasonConferenceEnded::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Texml::Accounts::ConferenceResource::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Texml::Accounts::ConferenceResource::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module ReasonConferenceEnded
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Texml::Accounts::ConferenceResource::ReasonConferenceEnded
                )
              end
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Texml::Accounts::ConferenceResource::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
