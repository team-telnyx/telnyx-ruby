        ...
        module Conferences
          class ParticipantUpdateResponse < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Models::Texml::Accounts::Conferences::ParticipantUpdateResponse::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Telnyx::Models::Texml::Accounts::Conferences::ParticipantUpdateResponse::Status::OrSymbol
              ).void
            end
            attr_writer :status
