      ...
      module Accounts
        module Conferences
          class ParticipantParticipantsParams < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              params(machine_detection_beep_min_tone_duration: Integer).void
            end
            ...
            sig do
              params(machine_detection_beep_spectral_min_purity: Float).void
            end
            ...
            module MachineDetectionBeepProfile
              ...
              BOTH =
                T.let(
                  :both,
                  Telnyx::Texml::Accounts::Conferences::ParticipantParticipantsParams::MachineDetectionBeepProfile::TaggedSymbol
                )
              FREQ_ONLY =
                T.let(
                  :freq_only,
