        ...
        module Conferences
          class ParticipantResource < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Texml::Accounts::Conferences::ParticipantResource::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Telnyx::Texml::Accounts::Conferences::ParticipantResource::Status::OrSymbol
              ).void
            end
            attr_writer :status
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Texml::Accounts::Conferences::ParticipantResource::Status
                  )
                end
