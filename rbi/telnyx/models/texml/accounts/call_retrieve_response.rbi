      ...
      module Accounts
        class CallRetrieveResponse < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::Texml::Accounts::CallRetrieveResponse,
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Texml::Accounts::CallRetrieveResponse::AnsweredBy::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              answered_by:
                Telnyx::Models::Texml::Accounts::CallRetrieveResponse::AnsweredBy::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Texml::Accounts::CallRetrieveResponse::Direction::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              direction:
                Telnyx::Models::Texml::Accounts::CallRetrieveResponse::Direction::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Texml::Accounts::CallRetrieveResponse::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::Texml::Accounts::CallRetrieveResponse::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module AnsweredBy
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Texml::Accounts::CallRetrieveResponse::AnsweredBy
                )
              end
          ...
          module Direction
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Texml::Accounts::CallRetrieveResponse::Direction
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Texml::Accounts::CallRetrieveResponse::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
