        ...
        module Calls
          class RecordingRecordingSidJsonResponse < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              params(
                channels:
                  Telnyx::Models::Texml::Accounts::Calls::RecordingRecordingSidJsonResponse::Channels::OrInteger
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Models::Texml::Accounts::Calls::RecordingRecordingSidJsonResponse::Source::TaggedSymbol
                )
              )
            end
            attr_reader :source
            ...
            sig do
              params(
                source:
                  Telnyx::Models::Texml::Accounts::Calls::RecordingRecordingSidJsonResponse::Source::OrSymbol
              ).void
            end
            attr_writer :source
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Models::Texml::Accounts::Calls::RecordingRecordingSidJsonResponse::Track::TaggedSymbol
                )
              )
            end
            attr_reader :track
            ...
            sig do
              params(
                track:
                  Telnyx::Models::Texml::Accounts::Calls::RecordingRecordingSidJsonResponse::Track::OrSymbol
              ).void
            end
            attr_writer :track
