      ...
      class CollectionRetrieveDocumentsResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Data
              ]
            )
          )
        end
        ...
        sig do
          params(
            data:
              T::Array[
                Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Data::OrHash
              ]
          ).void
        end
        attr_writer :data
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Meta
            )
          )
        end
        attr_reader :meta
        ...
        sig do
          params(
            meta:
              Telnyx::Models::AI::CollectionRetrieveDocumentsResponse::Meta::OrHash
          ).void
        end
        attr_writer :meta
