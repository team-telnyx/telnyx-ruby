  ...
  module Models
    module AI
      class AssistantsList < Telnyx::Internal::Type::BaseModel
        ...
        sig { returns(T::Array[Telnyx::AI::AssistantsList::Data]) }
        attr_accessor :data

        sig do
          params(
            data: T::Array[Telnyx::AI::AssistantsList::Data::OrHash]
        ...
        sig do
          override.returns({ data: T::Array[Telnyx::AI::AssistantsList::Data] })
        end
        def to_hash
        end
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(Telnyx::AI::AssistantsList::Data, Telnyx::Internal::AnyHash)
            end
          ...
          sig do
            params(import_metadata: Telnyx::AI::ImportMetadata::OrHash).void
          end
