  ...
  module Models
    module AI
      class InferenceEmbedding < Telnyx::Internal::Type::BaseModel
        ...
        sig { returns(T.nilable(Telnyx::AI::ConversationFlow)) }
        attr_reader :conversation_flow

        sig do
          params(conversation_flow: Telnyx::AI::ConversationFlow::OrHash).void
        end
        ...
        sig do
          params(
            ...
            model: String,
            name: String,
            conversation_flow: Telnyx::AI::ConversationFlow::OrHash,
            description: String,
          ...
          override.returns(
            {
              ...
              model: String,
              name: String,
              conversation_flow: Telnyx::AI::ConversationFlow,
              description: String,
              dynamic_variables: T::Hash[Symbol, T.anything],
              dynamic_variables_webhook_timeout_ms: Integer,
              dynamic_variables_webhook_url: String,
