  ...
  module Models
    module AI
      class AssistantUpdateParams < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(Telnyx::AI::AssistantUpdateParams::WidgetSettings))
        end
          ...
          override.returns(
            {
              ...
              widget_settings:
                Telnyx::AI::AssistantUpdateParams::WidgetSettings,
        ...
        class WidgetSettings < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            params(
              audio_visualizer_config:
                Telnyx::AI::AssistantUpdateParams::WidgetSettings::AudioVisualizerConfig::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::AI::AssistantUpdateParams::WidgetSettings::DefaultState::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::AI::AssistantUpdateParams::WidgetSettings::Position::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::AI::AssistantUpdateParams::WidgetSettings::Theme::OrSymbol
              )
            )
          end
          attr_reader :theme
          ...
          class AudioVisualizerConfig < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::AI::AssistantUpdateParams::WidgetSettings::AudioVisualizerConfig::Color::OrSymbol
                )
              )
            end
            attr_reader :color
            ...
            module Color
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::AI::AssistantUpdateParams::WidgetSettings::AudioVisualizerConfig::Color
                  )
                end
              ...
              VERDANT =
                T.let(
                  :verdant,
                  Telnyx::AI::AssistantUpdateParams::WidgetSettings::AudioVisualizerConfig::Color::TaggedSymbol
                )
              TWILIGHT =
                T.let(
                  :twilight,
          ...
          module DefaultState
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::AI::AssistantUpdateParams::WidgetSettings::DefaultState
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            EXPANDED =
              T.let(
                :expanded,
                Telnyx::AI::AssistantUpdateParams::WidgetSettings::DefaultState::TaggedSymbol
              )
            COLLAPSED =
              T.let(
                :collapsed,
          ...
          module Position
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::AI::AssistantUpdateParams::WidgetSettings::Position
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            FIXED =
              T.let(
                :fixed,
                Telnyx::AI::AssistantUpdateParams::WidgetSettings::Position::TaggedSymbol
              )
            STATIC =
              T.let(
                :static,
          ...
          module Theme
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::AI::AssistantUpdateParams::WidgetSettings::Theme
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            LIGHT =
              T.let(
                :light,
                Telnyx::AI::AssistantUpdateParams::WidgetSettings::Theme::TaggedSymbol
              )
            DARK =
              T.let(
                :dark,
