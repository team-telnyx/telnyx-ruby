    ...
    module AI
      class CollectionRetrieveDocumentsParams < Telnyx::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::AI::CollectionRetrieveDocumentsParams,
        ...
        module RetrievalType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::AI::CollectionRetrieveDocumentsParams::RetrievalType
              )
            end
          ...
          VECTOR =
            T.let(
              :vector,
              Telnyx::AI::CollectionRetrieveDocumentsParams::RetrievalType::TaggedSymbol
            )
          HYBRID =
            T.let(
              :hybrid,
