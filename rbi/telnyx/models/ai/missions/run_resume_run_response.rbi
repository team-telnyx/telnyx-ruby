    ...
    module AI
      module Missions
        class RunResumeRunResponse < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(Telnyx::Models::AI::Missions::RunResumeRunResponse::Data)
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Telnyx::Models::AI::Missions::RunResumeRunResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          class Data < Telnyx::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Telnyx::Models::AI::Missions::RunResumeRunResponse::Data,
                  Telnyx::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                Telnyx::Models::AI::Missions::RunResumeRunResponse::Data::Status::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                ...
                started_at: Time,
                status:
                  Telnyx::Models::AI::Missions::RunResumeRunResponse::Data::Status::OrSymbol,
                updated_at: Time,
                error: String,
                finished_at: Time,
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Models::AI::Missions::RunResumeRunResponse::Data::Status
                  )
                end
