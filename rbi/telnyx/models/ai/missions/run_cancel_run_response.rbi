      ...
      module Missions
        class RunCancelRunResponse < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::AI::Missions::RunCancelRunResponse,
                Telnyx::Internal::AnyHash
              )
            end

          sig do
            returns(Telnyx::Models::AI::Missions::RunCancelRunResponse::Data)
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                Telnyx::Models::AI::Missions::RunCancelRunResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          class Data < Telnyx::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Telnyx::Models::AI::Missions::RunCancelRunResponse::Data,
                  Telnyx::Internal::AnyHash
                )
              end
            ...
            sig do
              returns(
                Telnyx::Models::AI::Missions::RunCancelRunResponse::Data::Status::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                ...
                started_at: Time,
                status:
                  Telnyx::Models::AI::Missions::RunCancelRunResponse::Data::Status::OrSymbol,
                updated_at: Time,
                error: String,
                finished_at: Time,
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Models::AI::Missions::RunCancelRunResponse::Data::Status
                  )
                end
