    ...
    module AI
      module Missions
        class RunListResponse < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Telnyx::Models::AI::Missions::RunListResponse::Status::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              ...
              started_at: Time,
              status:
                Telnyx::Models::AI::Missions::RunListResponse::Status::OrSymbol,
              updated_at: Time,
              error: String,
              finished_at: Time,
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::AI::Missions::RunListResponse::Status
                )
              end
