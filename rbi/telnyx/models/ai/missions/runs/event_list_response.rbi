      ...
      module Missions
        module Runs
          class EventListResponse < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Telnyx::Models::AI::Missions::Runs::EventListResponse::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                ...
                timestamp: Time,
                type:
                  Telnyx::Models::AI::Missions::Runs::EventListResponse::Type::OrSymbol,
                agent_id: String,
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Models::AI::Missions::Runs::EventListResponse::Type
                  )
                end
