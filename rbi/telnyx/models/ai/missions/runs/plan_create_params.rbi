...
module Telnyx
  module Models
    module AI
      module Missions
        module Runs
          class PlanCreateParams < Telnyx::Internal::Type::BaseModel
            ...
            OrHash =
              T.type_alias do
                T.any(
                  Telnyx::AI::Missions::Runs::PlanCreateParams,
            ...
            sig do
              returns(
                T::Array[Telnyx::AI::Missions::Runs::PlanCreateParams::Step]
              )
            end
            attr_accessor :steps
              ...
              override.returns(
                {
                  ...
                  steps:
                    T::Array[
                      Telnyx::AI::Missions::Runs::PlanCreateParams::Step
                    ],
