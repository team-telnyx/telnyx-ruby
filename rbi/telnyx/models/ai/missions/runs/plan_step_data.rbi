        ...
        module Runs
          class PlanStepData < Telnyx::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Telnyx::AI::Missions::Runs::PlanStepData,
            ...
            sig do
              returns(
                Telnyx::AI::Missions::Runs::PlanStepData::Status::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                ...
                sequence: Integer,
                status:
                  Telnyx::AI::Missions::Runs::PlanStepData::Status::OrSymbol,
                step_id: String,
                completed_at: Time,
            ...
            module Status
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::AI::Missions::Runs::PlanStepData::Status
                  )
                end
