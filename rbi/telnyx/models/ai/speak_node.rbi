...
module Telnyx
  module Models
    module AI
      class SpeakNode < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(Telnyx::AI::SpeakNode, Telnyx::Internal::AnyHash)
          end
        ...
        sig { returns(T.nilable(Telnyx::AI::SpeakNode::Type::TaggedSymbol)) }
        attr_reader :type

        sig { params(type: Telnyx::AI::SpeakNode::Type::OrSymbol).void }
        attr_writer :type
        ...
        sig do
          params(
            ...
            type: Telnyx::AI::SpeakNode::Type::OrSymbol
          ...
          override.returns(
            {
              ...
              type: Telnyx::AI::SpeakNode::Type::TaggedSymbol
            }
          )
        end
        def to_hash
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias { T.all(Symbol, Telnyx::AI::SpeakNode::Type) }
          OrSymbol = T.type_alias { T.any(Symbol, String) }

          SPEAK = T.let(:speak, Telnyx::AI::SpeakNode::Type::TaggedSymbol)

          sig do
            override.returns(
              T::Array[Telnyx::AI::SpeakNode::Type::TaggedSymbol]
            )
          end
          def self.values
          end
