  ...
  module Models
    class WebhookDeliveryListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Telnyx::Models::WebhookDeliveryListResponse::Attempt]
          )
        )
      end
      ...
      sig do
        params(
          attempts:
            T::Array[
              Telnyx::Models::WebhookDeliveryListResponse::Attempt::OrHash
            ]
        ).void
      end
      ...
      class Attempt < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::WebhookDeliveryListResponse::Attempt,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP
            )
          )
        end
        attr_reader :http
        ...
        sig do
          params(
            http:
              Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP::OrHash
          ).void
        end
        attr_writer :http
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::WebhookDeliveryListResponse::Attempt::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::WebhookDeliveryListResponse::Attempt::Status::OrSymbol
          ).void
        end
        attr_writer :status
          ...
          override.returns(
            {
              errors: T::Array[Integer],
              finished_at: Time,
              http: Telnyx::Models::WebhookDeliveryListResponse::Attempt::HTTP,
              started_at: Time,
              status:
                Telnyx::Models::WebhookDeliveryListResponse::Attempt::Status::TaggedSymbol
            }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::WebhookDeliveryListResponse::Attempt::Status
              )
            end
