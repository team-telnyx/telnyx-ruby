  ...
  module Models
    class RoomRecordingDeleteBulkParams < Telnyx::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::RoomRecordingDeleteBulkParams,
      ...
      sig { returns(T.nilable(Telnyx::RoomRecordingDeleteBulkParams::Filter)) }
      attr_reader :filter
      ...
      # page[number]
      sig { returns(T.nilable(Telnyx::RoomRecordingDeleteBulkParams::Page)) }
      attr_reader :page

      sig do
        params(page: Telnyx::RoomRecordingDeleteBulkParams::Page::OrHash).void
      end
      attr_writer :page
      ...
      class Filter < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          params(
            date_ended_at:
              Telnyx::RoomRecordingDeleteBulkParams::Filter::DateEndedAt::OrHash
          ).void
        end
        ...
        sig do
          params(
            date_started_at:
              Telnyx::RoomRecordingDeleteBulkParams::Filter::DateStartedAt::OrHash
          ).void
        end
