  ...
  module Models
    class MobilePhoneNumberUpdateResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::MobilePhoneNumberUpdateResponse,
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::MobilePhoneNumberUpdateResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::MobilePhoneNumberUpdateResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallForwarding
            )
          )
        end
        ...
        sig do
          params(
            call_forwarding:
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallForwarding::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording
            )
          )
        end
        ...
        sig do
          params(
            call_recording:
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CnamListing
            )
          )
        end
        ...
        sig do
          params(
            cnam_listing:
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CnamListing::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::Inbound
            )
          )
        end
        attr_reader :inbound
        ...
        sig do
          params(
            inbound:
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::Inbound::OrHash
          ).void
        end
        attr_writer :inbound
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::InboundCallScreening::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::NoiseSuppression::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            noise_suppression:
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::NoiseSuppression::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::Outbound
            )
          )
        end
        ...
        sig do
          params(
            outbound:
              Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::Outbound::OrHash
          ).void
        end
        ...
        sig do
          params(
            ...
            inbound_call_screening:
              T.nilable(
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::InboundCallScreening::OrSymbol
              ),
        ...
        class CallForwarding < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallForwarding::ForwardingType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              ...
              forwarding_type:
                T.nilable(
                  Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallForwarding::ForwardingType::OrSymbol
                ),
          ...
          module ForwardingType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallForwarding::ForwardingType
                )
              end
        ...
        class CallRecording < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording::InboundCallRecordingChannels::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              inbound_call_recording_channels:
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording::InboundCallRecordingChannels::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording::InboundCallRecordingFormat::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              inbound_call_recording_format:
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording::InboundCallRecordingFormat::OrSymbol
            ).void
          end
          ...
          module InboundCallRecordingChannels
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording::InboundCallRecordingChannels
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module InboundCallRecordingFormat
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::CallRecording::InboundCallRecordingFormat
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module InboundCallScreening
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::InboundCallScreening
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module NoiseSuppression
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::MobilePhoneNumberUpdateResponse::Data::NoiseSuppression
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
