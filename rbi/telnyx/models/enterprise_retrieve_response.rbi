...
module Telnyx
  module Models
    class EnterpriseRetrieveResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Telnyx::Models::EnterpriseRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::EnterpriseRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          params(
            billing_address:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::BillingAddress::OrHash
          ).void
        end
        ...
        sig do
          params(
            billing_contact:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::BillingContact::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseRetrieveResponse::Data::NumberOfEmployees::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            organization_contact:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationContact::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationLegalType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            organization_physical_address:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationPhysicalAddress::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            organization_type:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::EnterpriseRetrieveResponse::Data::RoleType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            role_type:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::RoleType::OrSymbol
          ).void
        end
        ...
        sig do
          params(
            ...
            number_of_employees:
              T.nilable(
                Telnyx::Models::EnterpriseRetrieveResponse::Data::NumberOfEmployees::OrSymbol
              ),
            organization_contact:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationContact::OrHash,
            organization_legal_type:
              T.nilable(
                Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationLegalType::OrSymbol
              ),
            organization_physical_address:
              Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationPhysicalAddress::OrHash,
            organization_type:
        ...
        module NumberOfEmployees
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseRetrieveResponse::Data::NumberOfEmployees
              )
            end
        ...
        module OrganizationLegalType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationLegalType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module OrganizationType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseRetrieveResponse::Data::OrganizationType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module RoleType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::EnterpriseRetrieveResponse::Data::RoleType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
