...
module Telnyx
  module Models
    class Connection < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Telnyx::Connection, Telnyx::Internal::AnyHash) }
      ...
      sig do
        returns(T.nilable(Telnyx::Connection::WebhookAPIVersion::TaggedSymbol))
      end
      attr_reader :webhook_api_version

      sig do
        params(
          webhook_api_version: Telnyx::Connection::WebhookAPIVersion::OrSymbol
        ).void
      end
        ...
        override.returns(
          {
            ...
            updated_at: String,
            webhook_api_version:
              Telnyx::Connection::WebhookAPIVersion::TaggedSymbol,
            webhook_event_failover_url: T.nilable(String),
            webhook_event_url: T.nilable(String)
          }
        )
      ...
      module WebhookAPIVersion
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Telnyx::Connection::WebhookAPIVersion) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        V1 = T.let(:"1", Telnyx::Connection::WebhookAPIVersion::TaggedSymbol)
        V2 = T.let(:"2", Telnyx::Connection::WebhookAPIVersion::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Telnyx::Connection::WebhookAPIVersion::TaggedSymbol]
          )
        end
        def self.values
        end
