  ...
  module Models
    class IPConnectionListResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::IPConnectionListResponse,
            Telnyx::Internal::AnyHash
          )
        end

      sig { returns(T.nilable(T::Array[Telnyx::IPConnection])) }
      attr_reader :data

      sig { params(data: T::Array[Telnyx::IPConnection::OrHash]).void }
      attr_writer :data
      ...
      sig do
        params(
          data: T::Array[Telnyx::IPConnection::OrHash],
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::IPConnection],
