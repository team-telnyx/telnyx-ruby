  ...
  module Models
    class DetailRecordListResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::DetailRecordListResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Telnyx::Models::DetailRecordListResponse::Data::Variants]
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[
              T.any(
                Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::OrHash,
                Telnyx::Models::DetailRecordListResponse::Data::ConferenceDetailRecord::OrHash,
                Telnyx::Models::DetailRecordListResponse::Data::ConferenceParticipantDetailRecord::OrHash,
                Telnyx::Models::DetailRecordListResponse::Data::AmdDetailRecord::OrHash,
                Telnyx::Models::DetailRecordListResponse::Data::VerifyDetailRecord::OrHash,
                Telnyx::Models::DetailRecordListResponse::Data::SimCardUsageDetailRecord::OrHash,
                Telnyx::Models::DetailRecordListResponse::Data::MediaStorageDetailRecord::OrHash
              )
            ]
        ).void
      end
      ...
      sig { returns(T.nilable(Telnyx::Models::DetailRecordListResponse::Meta)) }
      attr_reader :meta

      sig do
        params(
          meta: Telnyx::Models::DetailRecordListResponse::Meta::OrHash
        ).void
      end
      attr_writer :meta
        ...
        override.returns(
          {
            data:
              T::Array[
                Telnyx::Models::DetailRecordListResponse::Data::Variants
              ],
      ...
      module Data
        ...
        class MessageDetailRecord < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::Direction::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              direction:
                Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::Direction::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::MessageType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              message_type:
                Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::MessageType::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module MessageType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::DetailRecordListResponse::Data::MessageDetailRecord::MessageType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class AmdDetailRecord < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::DetailRecordListResponse::Data::AmdDetailRecord::Feature::TaggedSymbol
              )
            )
          end
          attr_reader :feature
          ...
          sig do
            params(
              feature:
                Telnyx::Models::DetailRecordListResponse::Data::AmdDetailRecord::Feature::OrSymbol
            ).void
          end
          attr_writer :feature
        ...
        class VerifyDetailRecord < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::DetailRecordListResponse::Data::VerifyDetailRecord::VerifyChannelType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              verify_channel_type:
                Telnyx::Models::DetailRecordListResponse::Data::VerifyDetailRecord::VerifyChannelType::OrSymbol
            ).void
          end
          ...
          module VerifyChannelType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::DetailRecordListResponse::Data::VerifyDetailRecord::VerifyChannelType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
