...
module Telnyx
  module Models
    class BrandListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(T::Array[Telnyx::Models::BrandListResponse::Record]))
      end
      attr_reader :records

      sig do
        params(
          records: T::Array[Telnyx::Models::BrandListResponse::Record::OrHash]
        ).void
      end
      attr_writer :records
      ...
      sig do
        override.returns(
          {
            page: Integer,
            records: T::Array[Telnyx::Models::BrandListResponse::Record],
            total_records: Integer
          }
        )
      end
      ...
      class Record < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::BrandListResponse::Record,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::BrandListResponse::Record::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status: Telnyx::Models::BrandListResponse::Record::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Models::BrandListResponse::Record::Status)
            end
