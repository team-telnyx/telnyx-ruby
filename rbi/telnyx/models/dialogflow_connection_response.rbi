...
module Telnyx
  module Models
    class DialogflowConnectionResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::DialogflowConnectionResponse, Telnyx::Internal::AnyHash)
        end

      sig { returns(Telnyx::DialogflowConnectionResponse::Data) }
      attr_reader :data

      sig do
        params(data: Telnyx::DialogflowConnectionResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(
          data: Telnyx::DialogflowConnectionResponse::Data::OrHash
      ...
      sig do
        override.returns({ data: Telnyx::DialogflowConnectionResponse::Data })
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::DialogflowConnectionResponse::Data,
