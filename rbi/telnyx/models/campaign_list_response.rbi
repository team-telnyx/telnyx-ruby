  ...
  module Models
    class CampaignListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::CampaignListResponse::CampaignStatus::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          campaign_status:
            Telnyx::Models::CampaignListResponse::CampaignStatus::OrSymbol
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::Models::CampaignListResponse::SubmissionStatus::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          submission_status:
            Telnyx::Models::CampaignListResponse::SubmissionStatus::OrSymbol
        ).void
      end
      ...
      module CampaignStatus
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::Models::CampaignListResponse::CampaignStatus)
          end
      ...
      module SubmissionStatus
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::Models::CampaignListResponse::SubmissionStatus
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
