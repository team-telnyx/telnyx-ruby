...
module Telnyx
  module Models
    class MesssageRcsResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::Models::MesssageRcsResponse, Telnyx::Internal::AnyHash)
        end

      sig { returns(T.nilable(Telnyx::Models::MesssageRcsResponse::Data)) }
      attr_reader :data

      sig do
        params(data: Telnyx::Models::MesssageRcsResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(data: Telnyx::Models::MesssageRcsResponse::Data::OrHash).returns(
          T.attached_class
        )
      end
      ...
      sig do
        override.returns({ data: Telnyx::Models::MesssageRcsResponse::Data })
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(T.nilable(Telnyx::Models::MesssageRcsResponse::Data::From))
        end
        attr_reader :from

        sig do
          params(
            from: Telnyx::Models::MesssageRcsResponse::Data::From::OrHash
          ).void
        end
        attr_writer :from
        ...
        sig do
          returns(
            T.nilable(T::Array[Telnyx::Models::MesssageRcsResponse::Data::To])
          )
        end
        attr_reader :to
        ...
        sig do
          params(
            to: T::Array[Telnyx::Models::MesssageRcsResponse::Data::To::OrHash]
          ).void
        end
        attr_writer :to
          ...
          override.returns(
            {
              ...
              received_at: Time,
              record_type: String,
              to: T::Array[Telnyx::Models::MesssageRcsResponse::Data::To],
              type: String
            }
          )
        end
        ...
        class To < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::MesssageRcsResponse::Data::To,
                Telnyx::Internal::AnyHash
              )
            end
