...
module Telnyx
  module Models
    class VoiceDesignRetrieveResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Telnyx::Models::VoiceDesignRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::VoiceDesignRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::VoiceDesignRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::VoiceDesignRetrieveResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::VoiceDesignRetrieveResponse::Data::Provider::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::VoiceDesignRetrieveResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::VoiceDesignRetrieveResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        sig do
          params(
            ...
            provider:
              T.nilable(
                Telnyx::Models::VoiceDesignRetrieveResponse::Data::Provider::OrSymbol
              ),
        ...
        module Provider
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::VoiceDesignRetrieveResponse::Data::Provider
              )
            end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::VoiceDesignRetrieveResponse::Data::RecordType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
