...
module Telnyx
  module Models
    class SubNumberOrdersReportCreateResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::SubNumberOrdersReportCreateResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::SubNumberOrdersReportCreateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::SubNumberOrdersReportCreateResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::SubNumberOrdersReportCreateResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::SubNumberOrdersReportCreateResponse::Data::Filters
            )
          )
        end
        attr_reader :filters
        ...
        sig do
          params(
            filters:
              Telnyx::Models::SubNumberOrdersReportCreateResponse::Data::Filters::OrHash
          ).void
        end
        attr_writer :filters
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::SubNumberOrdersReportCreateResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::SubNumberOrdersReportCreateResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::SubNumberOrdersReportCreateResponse::Data::Status
              )
            end
