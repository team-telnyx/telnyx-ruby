  ...
  module Models
    class InboundChannelUpdateResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::InboundChannelUpdateResponse,
            Telnyx::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Telnyx::Models::InboundChannelUpdateResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::InboundChannelUpdateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::InboundChannelUpdateResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::InboundChannelUpdateResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
