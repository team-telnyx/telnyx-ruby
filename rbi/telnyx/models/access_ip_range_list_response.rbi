...
module Telnyx
  module Models
    class AccessIPRangeListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig { returns(Telnyx::Models::AccessIPRangeListResponse::Meta) }
      attr_reader :meta

      sig do
        params(
          meta: Telnyx::Models::AccessIPRangeListResponse::Meta::OrHash
        ).void
      end
      attr_writer :meta
      ...
      class Meta < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::AccessIPRangeListResponse::Meta,
              Telnyx::Internal::AnyHash
            )
          end
