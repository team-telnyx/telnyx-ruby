  ...
  module Models
    class AlphanumericSenderIDRetrieveResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::AlphanumericSenderIDRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::AlphanumericSenderIDRetrieveResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::AlphanumericSenderIDRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::AlphanumericSenderIDRetrieveResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::AlphanumericSenderIDRetrieveResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::AlphanumericSenderIDRetrieveResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::AlphanumericSenderIDRetrieveResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::AlphanumericSenderIDRetrieveResponse::Data::RecordType
              )
            end
