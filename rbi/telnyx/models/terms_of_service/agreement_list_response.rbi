    ...
    module TermsOfService
      class AgreementListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::TermsOfService::AgreementListResponse::ProductType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            product_type:
              Telnyx::Models::TermsOfService::AgreementListResponse::ProductType::OrSymbol
          ).void
        end
        ...
        module ProductType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::TermsOfService::AgreementListResponse::ProductType
              )
            end
