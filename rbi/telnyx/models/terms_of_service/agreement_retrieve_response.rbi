    ...
    module TermsOfService
      class AgreementRetrieveResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::TermsOfService::AgreementRetrieveResponse,
        ...
        sig do
          returns(
            Telnyx::Models::TermsOfService::AgreementRetrieveResponse::Data
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::TermsOfService::AgreementRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::TermsOfService::AgreementRetrieveResponse::Data::ProductType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              product_type:
                Telnyx::Models::TermsOfService::AgreementRetrieveResponse::Data::ProductType::OrSymbol
            ).void
          end
          ...
          module ProductType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::TermsOfService::AgreementRetrieveResponse::Data::ProductType
                )
              end
