  ...
  module Models
    module TermsOfService
      class NumberReputationAgreeResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Telnyx::Models::TermsOfService::NumberReputationAgreeResponse::Data
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::TermsOfService::NumberReputationAgreeResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::TermsOfService::NumberReputationAgreeResponse::Data::ProductType::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              product_type:
                Telnyx::Models::TermsOfService::NumberReputationAgreeResponse::Data::ProductType::OrSymbol
            ).void
          end
          ...
          module ProductType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::TermsOfService::NumberReputationAgreeResponse::Data::ProductType
                )
              end
