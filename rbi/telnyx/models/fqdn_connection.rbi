...
module Telnyx
  module Models
    class FqdnConnection < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::FqdnConnection::NoiseSuppression::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          noise_suppression_details:
            Telnyx::FqdnConnection::NoiseSuppressionDetails::OrHash
        ).void
      end
      ...
      module NoiseSuppression
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::FqdnConnection::NoiseSuppression)
          end
        ...
        BOTH =
          T.let(:both, Telnyx::FqdnConnection::NoiseSuppression::TaggedSymbol)
        DISABLED =
          T.let(
            :disabled,
            Telnyx::FqdnConnection::NoiseSuppression::TaggedSymbol
        ...
        sig do
          override.returns(
            T::Array[Telnyx::FqdnConnection::NoiseSuppression::TaggedSymbol]
          )
        end
        def self.values
        end
