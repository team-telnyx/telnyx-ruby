  ...
  module Models
    class VirtualCrossConnectUpdateResponse < Telnyx::Internal::Type::BaseModel
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Telnyx::Models::VirtualCrossConnectUpdateResponse::Data::CloudProvider::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::VirtualCrossConnectUpdateResponse::Data::Region
            )
          )
        end
        attr_reader :region
        ...
        sig do
          params(
            region:
              Telnyx::Models::VirtualCrossConnectUpdateResponse::Data::Region::OrHash
          ).void
        end
        attr_writer :region
        ...
        sig do
          params(
            bgp_asn: Float,
            cloud_provider:
              Telnyx::Models::VirtualCrossConnectUpdateResponse::Data::CloudProvider::OrSymbol,
        ...
        module CloudProvider
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::VirtualCrossConnectUpdateResponse::Data::CloudProvider
              )
            end
