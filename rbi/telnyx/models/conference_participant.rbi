...
module Telnyx
  module Models
    class ConferenceParticipant < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::ConferenceParticipant, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(Telnyx::ConferenceParticipant::Status::TaggedSymbol))
      end
      attr_reader :status

      sig do
        params(status: Telnyx::ConferenceParticipant::Status::OrSymbol).void
      end
      attr_writer :status
      ...
      sig do
        params(
          ...
          status: Telnyx::ConferenceParticipant::Status::OrSymbol,
          updated_at: Time,
        ...
        override.returns(
          {
            ...
            on_hold: T::Boolean,
            soft_end_conference_on_exit: T::Boolean,
            status: Telnyx::ConferenceParticipant::Status::TaggedSymbol,
            updated_at: Time,
            whisper_call_control_ids: T::Array[String]
          }
        )
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Telnyx::ConferenceParticipant::Status) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        JOINING =
          T.let(:joining, Telnyx::ConferenceParticipant::Status::TaggedSymbol)
        JOINED =
          T.let(:joined, Telnyx::ConferenceParticipant::Status::TaggedSymbol)
        LEFT = T.let(:left, Telnyx::ConferenceParticipant::Status::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Telnyx::ConferenceParticipant::Status::TaggedSymbol]
          )
        end
        def self.values
        end
