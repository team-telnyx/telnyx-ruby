  ...
  module Models
    class GlobalIPHealthCheckDeleteResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::GlobalIPHealthCheckDeleteResponse,
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::GlobalIPHealthCheckDeleteResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Telnyx::Models::GlobalIPHealthCheckDeleteResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::GlobalIPHealthCheckDeleteResponse::Data }
        )
      end
      def to_hash
      end
