...
module Telnyx
  module Models
    class ConnectionListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::ConnectionListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: T::Array[Telnyx::Models::ConnectionListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::ConnectionListResponse::Data],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::ConnectionListResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::ConnectionListResponse::Data::WebhookAPIVersion::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            webhook_api_version:
              Telnyx::Models::ConnectionListResponse::Data::WebhookAPIVersion::OrSymbol
          ).void
        end
        ...
        module WebhookAPIVersion
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::ConnectionListResponse::Data::WebhookAPIVersion
              )
            end
