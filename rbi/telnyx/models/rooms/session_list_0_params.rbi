  ...
  module Models
    module Rooms
      class SessionList0Params < Telnyx::Internal::Type::BaseModel
        ...
        # page[number]
        sig { returns(T.nilable(Telnyx::Rooms::SessionList0Params::Page)) }
        attr_reader :page

        sig do
          params(page: Telnyx::Rooms::SessionList0Params::Page::OrHash).void
        end
        attr_writer :page
          ...
          override.returns(
            {
              ...
              include_participants: T::Boolean,
              page: Telnyx::Rooms::SessionList0Params::Page,
        ...
        class Page < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Rooms::SessionList0Params::Page,
                Telnyx::Internal::AnyHash
              )
            end
