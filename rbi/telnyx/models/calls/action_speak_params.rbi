          ...
          returns(
            T.nilable(
              T.any(
                ...
                Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure,
                Telnyx::Calls::ActionSpeakParams::VoiceSettings::Rime,
                Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble
              )
            )
          )
        end
          ...
          params(
            voice_settings:
              T.any(
                ...
                Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure::OrHash,
                Telnyx::Calls::ActionSpeakParams::VoiceSettings::Rime::OrHash,
                Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::OrHash
              )
          ).void
        end
        ...
        module VoiceSettings
          ...
          class Azure < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure::Effect::OrSymbol
                )
              )
            end
            attr_reader :effect
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure::Gender::OrSymbol
                )
              )
            end
            attr_reader :gender
            ...
            module Effect
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure::Effect
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              EQ_CAR =
                T.let(
                  :eq_car,
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure::Effect::TaggedSymbol
                )
              EQ_TELECOMHP8K =
                T.let(
                  :eq_telecomhp8k,
            ...
            module Gender
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure::Gender
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              MALE =
                T.let(
                  :Male,
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Azure::Gender::TaggedSymbol
                )
              FEMALE =
                T.let(
                  :Female,
          ...
          class Resemble < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::Format::OrSymbol
                )
              )
            end
            attr_reader :format_
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::Precision::OrSymbol
                )
              )
            end
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::SampleRate::OrSymbol
                )
              )
            end
            ...
            module Format
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::Format
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              WAV =
                T.let(
                  :wav,
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::Format::TaggedSymbol
                )
              MP3 =
                T.let(
                  :mp3,
            ...
            module Precision
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::Precision
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              PCM_16 =
                T.let(
                  :PCM_16,
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::Precision::TaggedSymbol
                )
              PCM_24 =
                T.let(
                  :PCM_24,
            ...
            module SampleRate
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::SampleRate
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              SAMPLE_RATE_8000 =
                T.let(
                  :"8000",
                  Telnyx::Calls::ActionSpeakParams::VoiceSettings::Resemble::SampleRate::TaggedSymbol
                )
              SAMPLE_RATE_16000 =
                T.let(
                  :"16000",
