      ...
      class PhoneNumberBatchListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document
              ]
            )
          )
        end
        ...
        sig do
          params(
            documents:
              T::Array[
                Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document::OrHash
              ]
          ).void
        end
        ...
        sig do
          params(
            phone_numbers:
              T::Array[
                Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Dir::PhoneNumberBatchListResponse::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::Dir::PhoneNumberBatchListResponse::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document::DocumentType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              document_id: String,
              document_type:
                Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document::DocumentType::OrSymbol,
              description: String
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Dir::PhoneNumberBatchListResponse::Document::DocumentType
                )
              end
        ...
        class PhoneNumber < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            params(
              rejection_reason:
                T.nilable(
                  Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::RejectionReason::OrHash
                )
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::Status::OrSymbol
            ).void
          end
          attr_writer :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::Dir::PhoneNumberBatchListResponse::PhoneNumber::Status
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::Dir::PhoneNumberBatchListResponse::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
