...
module Telnyx
  module Models
    class BulkSimCardActionDetailed < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::BulkSimCardActionDetailed, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(Telnyx::BulkSimCardActionDetailed::ActionType::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          action_type: Telnyx::BulkSimCardActionDetailed::ActionType::OrSymbol
        ).void
      end
        ...
        override.returns(
          {
            id: String,
            action_type:
              Telnyx::BulkSimCardActionDetailed::ActionType::TaggedSymbol,
            created_at: String,
            record_type: String,
            settings: T::Hash[Symbol, T.anything],
      ...
      module ActionType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::BulkSimCardActionDetailed::ActionType)
          end
