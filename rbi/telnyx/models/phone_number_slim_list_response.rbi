...
module Telnyx
  module Models
    class PhoneNumberSlimListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(T::Array[Telnyx::Models::PhoneNumberSlimListResponse::Data])
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            T::Array[Telnyx::Models::PhoneNumberSlimListResponse::Data::OrHash]
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::Models::PhoneNumberSlimListResponse::Data],
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::PhoneNumberSlimListResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::PhoneNumberSlimListResponse::Data::EmergencyStatus::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            emergency_status:
              Telnyx::Models::PhoneNumberSlimListResponse::Data::EmergencyStatus::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::PhoneNumberSlimListResponse::Data::InboundCallScreening::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            inbound_call_screening:
              Telnyx::Models::PhoneNumberSlimListResponse::Data::InboundCallScreening::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::PhoneNumberSlimListResponse::Data::PhoneNumberType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            phone_number_type:
              Telnyx::Models::PhoneNumberSlimListResponse::Data::PhoneNumberType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::PhoneNumberSlimListResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::PhoneNumberSlimListResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module EmergencyStatus
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::PhoneNumberSlimListResponse::Data::EmergencyStatus
              )
            end
        ...
        module InboundCallScreening
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::PhoneNumberSlimListResponse::Data::InboundCallScreening
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module PhoneNumberType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::PhoneNumberSlimListResponse::Data::PhoneNumberType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::PhoneNumberSlimListResponse::Data::Status
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
