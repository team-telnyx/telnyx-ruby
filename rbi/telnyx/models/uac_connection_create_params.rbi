...
module Telnyx
  module Models
    class UacConnectionCreateParams < Telnyx::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Telnyx::UacInboundRequest)) }
      attr_reader :inbound

      sig { params(inbound: Telnyx::UacInboundRequest::OrHash).void }
      attr_writer :inbound
      ...
      sig do
        params(
          ...
          inbound: Telnyx::UacInboundRequest::OrHash,
        ...
        override.returns(
          {
            ...
            inbound: Telnyx::UacInboundRequest,
