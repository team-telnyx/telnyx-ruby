...
module Telnyx
  module Models
    class OAuthClientUpdateResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(T.nilable(Telnyx::Models::OAuthClientUpdateResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::OAuthClientUpdateResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::OAuthClientUpdateResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::OAuthClientUpdateResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            Telnyx::Models::OAuthClientUpdateResponse::Data::ClientType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            Telnyx::Models::OAuthClientUpdateResponse::Data::RecordType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::OAuthClientUpdateResponse::Data::AllowedGrantType::TaggedSymbol
              ]
            )
          )
        end
        ...
        sig do
          params(
            allowed_grant_types:
              T::Array[
                Telnyx::Models::OAuthClientUpdateResponse::Data::AllowedGrantType::OrSymbol
              ]
          ).void
        end
        ...
        sig do
          params(
            client_id: String,
            client_type:
              Telnyx::Models::OAuthClientUpdateResponse::Data::ClientType::OrSymbol,
            created_at: Time,
            name: String,
            org_id: String,
            record_type:
              Telnyx::Models::OAuthClientUpdateResponse::Data::RecordType::OrSymbol,
        ...
        module ClientType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::OAuthClientUpdateResponse::Data::ClientType
              )
            end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::OAuthClientUpdateResponse::Data::RecordType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module AllowedGrantType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::OAuthClientUpdateResponse::Data::AllowedGrantType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
