...
module Telnyx
  module Models
    class MobileVoiceConnectionDeleteResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::Inbound
            )
          )
        end
        attr_reader :inbound
        ...
        sig do
          params(
            inbound:
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::Inbound::OrHash
          ).void
        end
        attr_writer :inbound
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::Outbound
            )
          )
        end
        ...
        sig do
          params(
            outbound:
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::Outbound::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::WebhookAPIVersion::TaggedSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        sig do
          params(
            ...
            webhook_api_version:
              T.nilable(
                Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::WebhookAPIVersion::OrSymbol
              ),
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::RecordType
              )
            end
        ...
        module WebhookAPIVersion
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::MobileVoiceConnectionDeleteResponse::Data::WebhookAPIVersion
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
