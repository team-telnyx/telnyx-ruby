    ...
    module Reputation
      class NumberRetrieveResponse < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::Reputation::NumberRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(Telnyx::Models::Reputation::NumberRetrieveResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Telnyx::Models::Reputation::NumberRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Telnyx::Models::Reputation::NumberRetrieveResponse::Data::ReputationData::Variants
              )
            )
          end
          ...
          sig do
            params(
              reputation_data:
                T.nilable(
                  T.any(
                    Telnyx::Models::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData::OrHash,
                    T.anything
                  )
                )
            ).void
          ...
          module ReputationData
            ...
            Variants =
              T.type_alias do
                T.nilable(
                  T.any(
                    Telnyx::Models::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData,
                    T.anything
                  )
                )
              end
            ...
            class ReputationData < Telnyx::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    Telnyx::Models::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData::SpamRisk::TaggedSymbol
                  )
                )
              end
              ...
              sig do
                params(
                  ...
                  spam_risk:
                    T.nilable(
                      Telnyx::Models::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData::SpamRisk::OrSymbol
                    )
                ).returns(T.attached_class)
              end
              def self.new(
              ...
              module SpamRisk
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Telnyx::Models::Reputation::NumberRetrieveResponse::Data::ReputationData::ReputationData::SpamRisk
                    )
                  end
