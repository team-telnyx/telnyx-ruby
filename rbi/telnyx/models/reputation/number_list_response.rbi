    ...
    module Reputation
      class NumberListResponse < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::Reputation::NumberListResponse::ReputationData::Variants
            )
          )
        end
        ...
        sig do
          params(
            reputation_data:
              T.nilable(
                T.any(
                  Telnyx::Models::Reputation::NumberListResponse::ReputationData::ReputationData::OrHash,
                  T.anything
                )
              )
          ).void
        ...
        module ReputationData
          ...
          Variants =
            T.type_alias do
              T.nilable(
                T.any(
                  Telnyx::Models::Reputation::NumberListResponse::ReputationData::ReputationData,
                  T.anything
                )
              )
            end
          ...
          class ReputationData < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Telnyx::Models::Reputation::NumberListResponse::ReputationData::ReputationData::SpamRisk::TaggedSymbol
                )
              )
            end
            ...
            sig do
              params(
                ...
                spam_risk:
                  T.nilable(
                    Telnyx::Models::Reputation::NumberListResponse::ReputationData::ReputationData::SpamRisk::OrSymbol
                  )
              ).returns(T.attached_class)
            end
            def self.new(
            ...
            module SpamRisk
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Models::Reputation::NumberListResponse::ReputationData::ReputationData::SpamRisk
                  )
                end
