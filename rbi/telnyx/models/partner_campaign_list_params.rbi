...
module Telnyx
  module Models
    class PartnerCampaignListParams < Telnyx::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(Telnyx::PartnerCampaignListParams, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(T.nilable(Telnyx::PartnerCampaignListParams::Sort::OrSymbol))
      end
      attr_reader :sort

      sig do
        params(sort: Telnyx::PartnerCampaignListParams::Sort::OrSymbol).void
      end
      attr_writer :sort
      ...
      module Sort
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::PartnerCampaignListParams::Sort)
          end
        ...
        ASSIGNED_PHONE_NUMBERS_COUNT =
          T.let(
            ...
            Telnyx::PartnerCampaignListParams::Sort::TaggedSymbol
          )
        ...
        sig do
          override.returns(
            T::Array[Telnyx::PartnerCampaignListParams::Sort::TaggedSymbol]
          )
        end
        def self.values
        end
