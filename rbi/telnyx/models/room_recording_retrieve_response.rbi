  ...
  module Models
    class RoomRecordingRetrieveResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::Models::RoomRecordingRetrieveResponse,
            Telnyx::Internal::AnyHash
          )
        end

      sig do
        returns(T.nilable(Telnyx::Models::RoomRecordingRetrieveResponse::Data))
      end
      attr_reader :data

      sig do
        params(
          data: Telnyx::Models::RoomRecordingRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::RoomRecordingRetrieveResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::RoomRecordingRetrieveResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::RoomRecordingRetrieveResponse::Data::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              Telnyx::Models::RoomRecordingRetrieveResponse::Data::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::RoomRecordingRetrieveResponse::Data::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
