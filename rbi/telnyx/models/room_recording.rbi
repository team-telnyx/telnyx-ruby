...
module Telnyx
  module Models
    class RoomRecording < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias { T.any(Telnyx::RoomRecording, Telnyx::Internal::AnyHash) }
      ...
      sig { returns(T.nilable(Telnyx::RoomRecording::Status::TaggedSymbol)) }
      attr_reader :status

      sig { params(status: Telnyx::RoomRecording::Status::OrSymbol).void }
      attr_writer :status

      # Shows the room recording type.
      sig { returns(T.nilable(Telnyx::RoomRecording::Type::TaggedSymbol)) }
      attr_reader :type

      sig { params(type: Telnyx::RoomRecording::Type::OrSymbol).void }
      attr_writer :type
      ...
      sig do
        params(
          ...
          size_mb: Float,
          started_at: Time,
          status: Telnyx::RoomRecording::Status::OrSymbol,
          type: Telnyx::RoomRecording::Type::OrSymbol,
          updated_at: Time
        ...
        override.returns(
          {
            ...
            size_mb: Float,
            started_at: Time,
            status: Telnyx::RoomRecording::Status::TaggedSymbol,
            type: Telnyx::RoomRecording::Type::TaggedSymbol,
            updated_at: Time
          }
        )
      end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Telnyx::RoomRecording::Status) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        COMPLETED =
          T.let(:completed, Telnyx::RoomRecording::Status::TaggedSymbol)
        PROCESSING =
          T.let(:processing, Telnyx::RoomRecording::Status::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Telnyx::RoomRecording::Status::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, Telnyx::RoomRecording::Type) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        AUDIO = T.let(:audio, Telnyx::RoomRecording::Type::TaggedSymbol)
        VIDEO = T.let(:video, Telnyx::RoomRecording::Type::TaggedSymbol)

        sig do
          override.returns(T::Array[Telnyx::RoomRecording::Type::TaggedSymbol])
        end
        def self.values
        end
      end
