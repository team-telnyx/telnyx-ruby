    ...
    class VoiceCloneUpdateResponse < Telnyx::Internal::Type::BaseModel
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::VoiceCloneUpdateResponse::Data::Provider::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            provider:
              Telnyx::Models::VoiceCloneUpdateResponse::Data::Provider::OrSymbol
          ).void
        end
        ...
        module Provider
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::VoiceCloneUpdateResponse::Data::Provider
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
