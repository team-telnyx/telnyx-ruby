  ...
  module Models
    class ConferenceParticipantPlaybackStarted < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Telnyx::ConferenceParticipantPlaybackStarted,
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::ConferenceParticipantPlaybackStarted::EventType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          event_type:
            Telnyx::ConferenceParticipantPlaybackStarted::EventType::OrSymbol
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Telnyx::ConferenceParticipantPlaybackStarted::Payload)
        )
      end
      attr_reader :payload
      ...
      sig do
        params(
          payload: Telnyx::ConferenceParticipantPlaybackStarted::Payload::OrHash
        ).void
      end
      attr_writer :payload
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::ConferenceParticipantPlaybackStarted::RecordType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          record_type:
            Telnyx::ConferenceParticipantPlaybackStarted::RecordType::OrSymbol
        ).void
      end
      ...
      sig do
        params(
          ...
          event_type:
            Telnyx::ConferenceParticipantPlaybackStarted::EventType::OrSymbol,
          payload:
            Telnyx::ConferenceParticipantPlaybackStarted::Payload::OrHash,
          record_type:
            Telnyx::ConferenceParticipantPlaybackStarted::RecordType::OrSymbol
        ...
        override.returns(
          {
            ...
            event_type:
              Telnyx::ConferenceParticipantPlaybackStarted::EventType::TaggedSymbol,
            payload: Telnyx::ConferenceParticipantPlaybackStarted::Payload,
            record_type:
              Telnyx::ConferenceParticipantPlaybackStarted::RecordType::TaggedSymbol
          }
        )
      ...
      module EventType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::ConferenceParticipantPlaybackStarted::EventType
            )
          end
      ...
      class Payload < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::ConferenceParticipantPlaybackStarted::Payload,
              Telnyx::Internal::AnyHash
            )
          end
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Telnyx::ConferenceParticipantPlaybackStarted::RecordType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
