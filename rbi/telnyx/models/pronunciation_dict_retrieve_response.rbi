...
module Telnyx
  module Models
    class PronunciationDictRetrieveResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::PronunciationDictRetrieveResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: Telnyx::Models::PronunciationDictRetrieveResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::PronunciationDictRetrieveResponse::Data::Item::Variants
              ]
            )
          )
        end
        ...
        sig do
          params(
            items:
              T::Array[
                T.any(
                  Telnyx::Models::PronunciationDictRetrieveResponse::Data::Item::Alias::OrHash,
                  Telnyx::Models::PronunciationDictRetrieveResponse::Data::Item::Phoneme::OrHash
                )
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::PronunciationDictRetrieveResponse::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::Models::PronunciationDictRetrieveResponse::Data::RecordType::OrSymbol
          ).void
        end
        ...
        module Item
          ...
          class Phoneme < Telnyx::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Telnyx::Models::PronunciationDictRetrieveResponse::Data::Item::Phoneme::Alphabet::TaggedSymbol
              )
            end
            ...
            sig do
              params(
                alphabet:
                  Telnyx::Models::PronunciationDictRetrieveResponse::Data::Item::Phoneme::Alphabet::OrSymbol,
                phoneme: String,
                text: String,
                type: Symbol
              ).returns(T.attached_class)
            ...
            module Alphabet
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Telnyx::Models::PronunciationDictRetrieveResponse::Data::Item::Phoneme::Alphabet
                  )
                end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::PronunciationDictRetrieveResponse::Data::RecordType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
