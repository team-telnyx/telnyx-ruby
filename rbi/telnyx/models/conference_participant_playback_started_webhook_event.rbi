  ...
  module Models
    class ConferenceParticipantPlaybackStartedWebhookEvent < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data
          )
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          {
            data: Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data
          }
        )
      end
      def to_hash
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::EventType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            event_type:
              Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::EventType::OrSymbol
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::Payload
            )
          )
        end
        attr_reader :payload
        ...
        sig do
          params(
            payload:
              Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::Payload::OrHash
          ).void
        end
        attr_writer :payload
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::RecordType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            record_type:
              Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::RecordType::OrSymbol
          ).void
        end
        ...
        module EventType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::EventType
              )
            end
        ...
        module RecordType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::ConferenceParticipantPlaybackStartedWebhookEvent::Data::RecordType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
