...
module Telnyx
  module Models
    class DirRetrieveResponse < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::Models::DirRetrieveResponse, Telnyx::Internal::AnyHash)
        end

      sig { returns(Telnyx::Models::DirRetrieveResponse::Data) }
      attr_reader :data

      sig do
        params(data: Telnyx::Models::DirRetrieveResponse::Data::OrHash).void
      end
      attr_writer :data

      sig do
        params(data: Telnyx::Models::DirRetrieveResponse::Data::OrHash).returns(
          T.attached_class
        )
      end
      def self.new(data:)
      ...
      sig do
        override.returns({ data: Telnyx::Models::DirRetrieveResponse::Data })
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::DirRetrieveResponse::Data,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::DirRetrieveResponse::Data::CallReason]
            )
          )
        end
        ...
        sig do
          params(
            call_reasons:
              T::Array[
                Telnyx::Models::DirRetrieveResponse::Data::CallReason::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Telnyx::Models::DirRetrieveResponse::Data::Document]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Telnyx::Models::DirRetrieveResponse::Data::RejectionReason
              ]
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::DirRetrieveResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status: Telnyx::Models::DirRetrieveResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        sig do
          params(
            ...
            documents:
              T.nilable(
                T::Array[
                  Telnyx::Models::DirRetrieveResponse::Data::Document::OrHash
                ]
              ),
            ...
            rejection_reasons:
              T.nilable(
                T::Array[
                  Telnyx::Models::DirRetrieveResponse::Data::RejectionReason::OrHash
                ]
              ),
            reselling: T::Boolean,
            status: Telnyx::Models::DirRetrieveResponse::Data::Status::OrSymbol,
        ...
        class CallReason < Telnyx::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Telnyx::Models::DirRetrieveResponse::Data::CallReason,
                Telnyx::Internal::AnyHash
              )
            end
        ...
        class Document < Telnyx::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Telnyx::Models::DirRetrieveResponse::Data::Document::DocumentType::TaggedSymbol
            )
          end
          ...
          sig do
            params(
              document_id: String,
              document_type:
                Telnyx::Models::DirRetrieveResponse::Data::Document::DocumentType::OrSymbol,
              description: String
            ).returns(T.attached_class)
          end
          def self.new(
          ...
          module DocumentType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Telnyx::Models::DirRetrieveResponse::Data::Document::DocumentType
                )
              end
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Telnyx::Models::DirRetrieveResponse::Data::Status)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
