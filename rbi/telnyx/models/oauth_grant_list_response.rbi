...
module Telnyx
  module Models
    class OAuthGrantListResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(T::Array[Telnyx::OAuthGrant])) }
      attr_reader :data

      sig { params(data: T::Array[Telnyx::OAuthGrant::OrHash]).void }
      attr_writer :data
      ...
      sig do
        params(
          data: T::Array[Telnyx::OAuthGrant::OrHash],
      ...
      sig do
        override.returns(
          {
            data: T::Array[Telnyx::OAuthGrant],
