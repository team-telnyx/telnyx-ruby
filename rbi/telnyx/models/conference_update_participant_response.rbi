...
module Telnyx
  module Models
    class ConferenceUpdateParticipantResponse < Telnyx::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Telnyx::Models::ConferenceUpdateParticipantResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data:
            Telnyx::Models::ConferenceUpdateParticipantResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      sig do
        override.returns(
          { data: Telnyx::Models::ConferenceUpdateParticipantResponse::Data }
        )
      end
      def to_hash
      end
      ...
      class Data < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::Models::ConferenceUpdateParticipantResponse::Data,
              Telnyx::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::Models::ConferenceUpdateParticipantResponse::Data::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              Telnyx::Models::ConferenceUpdateParticipantResponse::Data::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::Models::ConferenceUpdateParticipantResponse::Data::Status
              )
            end
