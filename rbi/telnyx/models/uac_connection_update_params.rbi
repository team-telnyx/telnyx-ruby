    ...
    class UacConnectionUpdateParams < Telnyx::Internal::Type::BaseModel
      ...
      class Inbound < Telnyx::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::UacConnectionUpdateParams::Inbound::SipRegion::OrSymbol
            )
          )
        end
        ...
        module SipRegion
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::UacConnectionUpdateParams::Inbound::SipRegion
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          US =
            T.let(
              :US,
              Telnyx::UacConnectionUpdateParams::Inbound::SipRegion::TaggedSymbol
            )
          EUROPE =
            T.let(
              :Europe,
