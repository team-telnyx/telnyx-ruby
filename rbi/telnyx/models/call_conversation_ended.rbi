...
module Telnyx
  module Models
    class CallConversationEnded < Telnyx::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Telnyx::CallConversationEnded, Telnyx::Internal::AnyHash)
        end
      ...
      sig do
        returns(
          T.nilable(Telnyx::CallConversationEnded::EventType::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          event_type: Telnyx::CallConversationEnded::EventType::OrSymbol
        ).void
      end
      ...
      sig { returns(T.nilable(Telnyx::CallConversationEnded::Payload)) }
      attr_reader :payload

      sig do
        params(payload: Telnyx::CallConversationEnded::Payload::OrHash).void
      end
      attr_writer :payload
      ...
      sig do
        returns(
          T.nilable(Telnyx::CallConversationEnded::RecordType::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          record_type: Telnyx::CallConversationEnded::RecordType::OrSymbol
        ).void
      end
      ...
      sig do
        params(
          ...
          event_type: Telnyx::CallConversationEnded::EventType::OrSymbol,
          occurred_at: Time,
          payload: Telnyx::CallConversationEnded::Payload::OrHash,
          record_type: Telnyx::CallConversationEnded::RecordType::OrSymbol
        ...
        override.returns(
          {
            id: String,
            created_at: Time,
            event_type: Telnyx::CallConversationEnded::EventType::TaggedSymbol,
            occurred_at: Time,
            payload: Telnyx::CallConversationEnded::Payload,
            record_type: Telnyx::CallConversationEnded::RecordType::TaggedSymbol
          }
        )
      end
      def to_hash
      ...
      module EventType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::CallConversationEnded::EventType)
          end
        ...
        CALL_CONVERSATION_ENDED =
          T.let(
            ...
            Telnyx::CallConversationEnded::EventType::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Telnyx::CallConversationEnded::EventType::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class Payload < Telnyx::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Telnyx::CallConversationEnded::Payload,
        ...
        sig do
          returns(
            T.nilable(
              Telnyx::CallConversationEnded::Payload::CallingPartyType::TaggedSymbol
            )
          )
        end
        ...
        sig do
          params(
            calling_party_type:
              Telnyx::CallConversationEnded::Payload::CallingPartyType::OrSymbol
          ).void
        end
        ...
        module CallingPartyType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Telnyx::CallConversationEnded::Payload::CallingPartyType
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module RecordType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Telnyx::CallConversationEnded::RecordType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        EVENT =
          T.let(:event, Telnyx::CallConversationEnded::RecordType::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Telnyx::CallConversationEnded::RecordType::TaggedSymbol]
          )
        end
        def self.values
        end
